...
export function activate(context) {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("valoride.mcpButtonClicked", (webview) => {
      const openMcp = (instance) =>
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand(
      "valoride.addTerminalOutputToChat",
      async () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand(
      ...
      async (range, diagnostics) => {
        ...
        const visibleWebview = WebviewProvider.getVisibleInstance();
        await visibleWebview?.controller.fixWithValorIDE(
          selectedText,
          filePath,
          languageId,
          diagnostics,
