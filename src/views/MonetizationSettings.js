...
export const MonetizationSettings = ({ applicationId, onSuccess, onError }) => {
  ...
  return _jsxs("div", {
    className: "monetization-settings",
    children: [
      _jsxs("div", {
        className: "settings-header",
        children: [
          _jsx("h3", { children: "\uD83D\uDCB0 Monetize This Service" }),
          _jsx("p", {
            className: "subtitle",
            children:
      ...
      error && _jsx("div", { className: "error-banner", children: error }),
      success &&
        _jsx("div", {
      ...
      _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            ...
            children: [
              _jsx("label", { children: "Pricing Model" }),
              _jsx("div", {
                className: "radio-group",
                children: ["PER_CALL", "PER_MONTH", "TIERED"].map((model) =>
                  _jsxs(
                    "label",
                    {
              ...
              children: [
                _jsxs("label", {
                  ...
                  children: [
                    ...
                    _jsx("span", {
                      className: "hint",
                      children: "Platform takes 30%, you get 70%",
                    }),
                  ],
                }),
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    _jsxs("span", {
                      className: "earnings-hint",
                      children: [
                        "\uD83D\uDCA1 At ~$0.01 per credit: $",
                        (costPerCall * 0.01 * 0.7).toFixed(2),
                        "/call for you",
                      ],
                    }),
                  ],
          ...
          _jsxs("div", {
            ...
            children: [
              _jsx("h4", { children: "Revenue Split" }),
              _jsxs("div", {
                className: "breakdown-item",
                children: [
                  _jsx("span", { children: "Your Earnings" }),
                  _jsx("strong", { children: "70%" }),
                ],
              }),
              _jsxs("div", {
                className: "breakdown-item",
                children: [
                  _jsx("span", { children: "Platform Fee" }),
              ...
              _jsx("p", {
                ...
                children:
                  "Payouts via Stripe, bank transfer, or crypto wallet. Minimum $10/month for payout.",
              }),
            ],
          }),
          _jsx("div", {
            className: "button-group",
            children: !isMonetized
              ? _jsx("button", {
                  onClick: handleEnableMonetization,
                  disabled: loading,
                  className: "btn btn-primary",
                  children: loading ? "Enabling..." : "Enable Monetization",
                })
              : _jsxs(_Fragment, {
                  children: [
                    _jsx("button", {
                      ...
                      children: loading ? "Updating..." : "Update Pricing",
                    }),
                    _jsx("button", {
                      className: "btn btn-tertiary",
                      children: "View Earnings Dashboard",
                    }),
                  ],
                }),
          }),
          _jsxs("div", {
            ...
            children: [
              _jsx("input", { type: "checkbox", id: "agreeTerms" }),
              _jsx("label", {
                htmlFor: "agreeTerms",
                children: "I agree to the Monetization Terms & Service",
              }),
            ],
          }),
        ],
