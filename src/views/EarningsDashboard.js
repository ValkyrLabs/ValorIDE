  ...
  return _jsxs("div", {
    ...
    children: [
      _jsxs("div", {
        ...
        children: [
          _jsx("h2", { children: "\uD83D\uDCB0 Creator Earnings" }),
          _jsx("p", {
            className: "dashboard-subtitle",
            children: "Track your MCP service revenue and manage payouts",
          }),
        ],
      }),
      error && _jsx("div", { className: "error-message", children: error }),
      _jsx("div", {
        className: "earnings-card total-card",
        children: _jsxs("div", {
          className: "card-content",
          children: [
            _jsx("h3", { children: "Total All-Time Earnings" }),
            _jsxs("div", {
              className: "total-amount",
              children: ["$", totalEarnings.toFixed(2)],
            }),
            _jsxs("p", {
        ...
        children: [
          ...
          monthlyEarnings
            ? _jsxs("div", {
                ...
                children: [
                  _jsxs("div", {
                    ...
                    children: [
                      _jsxs("h3", { children: ["Month of ", selectedMonth] }),
                      _jsx("span", {
                        className: `payout-badge ${getPayoutStatusColor(monthlyEarnings.payoutStatus)}`,
                        children: monthlyEarnings.payoutStatus || "PENDING",
                      }),
                    ],
                  }),
                  _jsxs("div", {
                    ...
                    children: [
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          ...
                          _jsx("div", {
                            className: "stat-value",
                            children: monthlyEarnings.totalInvocations,
                          }),
                        ],
                      }),
                      _jsxs("div", {
            ...
            : _jsx("div", {
                className: "no-data",
                children: _jsxs("p", {
                  children: ["No earnings data for ", selectedMonth],
                }),
              }),
        ],
      }),
      _jsxs("div", {
        ...
        children: [
          _jsx("h3", { children: "Your Monetized Services" }),
          services.length > 0
            ? _jsx("div", {
      ...
      _jsxs("div", {
        ...
        children: [
          _jsx("h3", { children: "Payout Settings" }),
          _jsxs("div", {
            ...
            children: [
              _jsxs("p", {
                children: [
                  "\uD83D\uDCB3 ",
                  _jsx("strong", { children: "Stripe Connect" }),
                ],
              }),
              _jsx("p", {
                className: "secondary",
                children: "Bank transfer to your account",
              }),
              _jsx("button", {
          ...
          _jsxs("div", {
            ...
            children: [
              _jsxs("p", {
                children: [
                  "\uD83D\uDD10 ",
                  _jsx("strong", { children: "Crypto Wallet" }),
                ],
              }),
              _jsx("p", {
                className: "secondary",
                children: "Direct USDC or Solana transfer",
              }),
              _jsx("button", {
                className: "btn btn-secondary",
                children: "Configure Wallet",
              }),
            ],
          }),
          _jsxs("div", {
            className: "minimum-notice",
            children: [
              _jsx("strong", { children: "\u2139\uFE0F Minimum Payout:" }),
              " Payouts process monthly when you have at least $10 in pending earnings.",
            ],
          }),
        ],
      }),
