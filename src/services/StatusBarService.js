...
export class StatusBarService {
    ...
    initialize(context) {
        ...
        context.subscriptions.push(vscode.commands.registerCommand("valoride.showModelStatus", () => this.showDetailedStatus()));
    ...
    estimateCost() {
        ...
        const cost = this.inputTokens * costPerMInput + this.outputTokens * costPerMOutput;
