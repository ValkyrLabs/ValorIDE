...
export async function parseSourceCodeForDefinitionsTopLevel(
	...
	const allowedFilesToParse = valorideIgnoreController ? valorideIgnoreController.filterPaths(filesToParse) : filesToParse
...
async function parseFile(
	...
	if (valorideIgnoreController && !valorideIgnoreController.validateAccess(filePath)) {
		return null
	}
