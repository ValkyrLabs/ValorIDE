...
function createToolCallTracker(webviewProvider) {
  ...
  webviewProvider.controller.postMessageToWebview = async (message) => {
    ...
    if (
      ...
      const toolName = message.partialMessage.text?.tool;
      if (toolName) {
  ...
  if (webviewProvider && webviewProvider.controller) {
    ...
    webviewProvider.controller.postMessageToWebview = async (message) => {
      ...
      if (
        ...
        const askType = message.partialMessage.ask;
 ...
 */
function autoRespondToAsk(webviewProvider, askType, askText) {
