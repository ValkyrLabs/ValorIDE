...
import { getSavedValorIDEMessages, getSavedApiConversationHistory, } from "@core/storage/disk";
/**
        ...
        req.on("end", async () => {
            try {
                ...
                if (!visibleWebview || !visibleWebview.controller) {
                    res.writeHead(500);
                    res.end(JSON.stringify({ error: "No active ValorIDE instance found" }));
                    return;
                }
                // Initiate a new task
                ...
                try {
                    ...
                    if (apiKey) {
                        ...
                        await storeSecret(visibleWebview.controller.context, "valorideApiKey", apiKey);
                        ...
                        await updateGlobalState(visibleWebview.controller.context, "apiProvider", "valoride");
                    ...
                    try {
                        ...
                        try {
                            if (typeof taskId === "string") {
                                messages = await getSavedValorIDEMessages(visibleWebview.controller.context, taskId);
                            }
                        }
                        catch (error) {
