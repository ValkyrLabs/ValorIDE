			...
			try {
				...
				try {
					...
					if (apiKey) {
						...
						await updateGlobalState(visibleWebview.controller.context, "apiProvider", "valoride" as ApiProvider)
 ...
 */
function autoRespondToAsk(webviewProvider: WebviewProvider, askType: ValorIDEAsk, askText?: string): void {
