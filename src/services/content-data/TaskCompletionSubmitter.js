 ...
 */
import { ContentDataContentTypeEnum, ContentDataCategoryEnum, ContentDataStatusEnum, } from "@thor/model";
export class TaskCompletionSubmitter {
     ...
     */
    async submitCompletedTask(data) {
        try {
            ...
            const contentData = {
                ...
                subtitle: data.taskDescription?.substring(0, 100) ||
...
//# sourceMappingURL=TaskCompletionSubmitter.js.map