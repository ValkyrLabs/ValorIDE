...
export class BrowserErrorCapture {
  ...
  private errorPatterns: Map<RegExp, ErrorAnalysis> = new Map();
   ...
   */
  analyzeError(error: CapturedError): ErrorAnalysis {
   ...
   */
  private groupErrorsBySeverity(): Record<string, CapturedError[]> {
    const grouped: Record<string, CapturedError[]> = {
      fatal: [],
      error: [],
      warning: [],
      info: [],
...
let browserErrorCapture: BrowserErrorCapture | null = null;
 ...
 */
export function getBrowserErrorCapture(): BrowserErrorCapture {
