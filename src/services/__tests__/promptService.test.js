...
describe("PromptService", () => {
    ...
    it("should verify prompt files exist", () => {
        const systemJsonPath = path.join(workspaceRoot, ".valoride", "prompts", "system.json");
        const catalogPath = path.join(workspaceRoot, ".valoride", "prompts", "thorapi-catalog.json");
        const swarmPath = path.join(workspaceRoot, ".valoride", "prompts", "swarm-rules.json");
    ...
    it("should have ApplicationService in catalog", async () => {
        await promptService.initialize();
        const catalog = promptService.getThorAPICatalog();
        const appService = catalog.services.find((s) => s.name === "ApplicationService");
