...
export class ThorAPIModelRegistry {
     ...
     */
    async scanRegistry() {
        this.logger.appendLine("[ThorAPIModelRegistry] Scanning for models and services...");
        const scanPaths = [
        ...
        this.logger.appendLine(`[ThorAPIModelRegistry] Scan complete: ${this.models.size} models, ${this.services.size} services`);
    }
    /**
        ...
        try {
            ...
            while ((match = interfaceRegex.exec(content)) !== null) {
                ...
                if (modelBody.includes("id:")) {
                    ...
                    this.logger.appendLine(`[ThorAPIModelRegistry] Found model: ${modelName} (${model.fields.length} fields)`);
                }
            }
            ...
            while ((match = serviceRegex.exec(content)) !== null) {
                ...
                this.logger.appendLine(`[ThorAPIModelRegistry] Found service: ${serviceName}`);
            }
        }
        catch (error) {
    ...
    extractPackage(filePath) {
        ...
        const idx = parts.findIndex((p) => p === "java" || p === "thor" || p === "generated");
    ...
    logSummary() {
        ...
        this.logger.appendLine(`  Last scan: ${new Date(this.lastScanTime).toISOString()}`);
    }
}
