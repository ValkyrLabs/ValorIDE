...
describe("PathAccess", () => {
    let workspaceRoot;
    beforeEach(async () => {
        workspaceRoot = await fsp.mkdtemp(path.join(os.tmpdir(), "valoride-path-access-"));
    });
    afterEach(async () => {
        if (workspaceRoot) {
