...
describe("openUrlWithSimpleBrowser", () => {
    ...
    it("uses simpleBrowser.open when available and does not fall back", async () => {
        ...
        expect(mockExecuteCommand).toHaveBeenCalledWith("simpleBrowser.open", "https://valkyrlabs.com/", undefined);
...
describe("normalizeUrl", () => {
    it("adds https to bare hostnames", () => {
        expect(normalizeUrl("valkyrlabs.com/docs")).toBe("https://valkyrlabs.com/docs");
    });
    it("returns null for javascript: urls", () => {
        expect(normalizeUrl("javascript:alert(1)")).toBeNull();
    });
});
//# sourceMappingURL=openUrl.test.js.map