export class ToolDescriptionService {
    static getToolDescription(toolName, params) {
        switch (toolName) {
            ...
            case "replace_in_file":
                return `[${toolName} for '${params.path}']`;
            case "search_files":
                return `[${toolName} for '${params.regex}'${params.file_pattern ? ` in '${params.file_pattern}'` : ""}]`;
            case "list_files":
                return `[${toolName} for '${params.path}']`;
...
//# sourceMappingURL=ToolDescriptionService.js.map