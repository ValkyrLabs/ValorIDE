import { ensureTaskDirectoryExists, getSavedApiConversationHistory, getSavedValorIDEMessages, } from "@core/storage/disk";
...
export class TaskLifecycleManager {
    ...
    ask;
    postStateToWebview;
    addToValorIDEMessages;
    overwriteValorIDEMessages;
    overwriteApiConversationHistory;
    initiateTaskLoop;
    constructor(context, taskId, chatSettings, contextManager, say, ask, postStateToWebview, addToValorIDEMessages, overwriteValorIDEMessages, overwriteApiConversationHistory, initiateTaskLoop) {
        ...
        this.addToValorIDEMessages = addToValorIDEMessages;
        ...
        this.initiateTaskLoop = initiateTaskLoop;
    }
    ...
    async resumeTaskFromHistory() {
        ...
        const modifiedValorIDEMessages = await getSavedValorIDEMessages(this.context, this.taskId);
        ...
        const apiConversationHistory = await getSavedApiConversationHistory(this.context, this.taskId);
        // load the context history state
        await this.contextManager.initializeContextHistory(await ensureTaskDirectoryExists(this.context, this.taskId));
        ...
        const [taskResumptionMessage, userResponseMessage] = formatResponse.taskResumption(this.chatSettings?.mode === "plan" ? "plan" : "act", agoText, process.cwd(), // Using process.cwd() as placeholder for cwd
        wasRecent, responseText);
...
//# sourceMappingURL=TaskLifecycleManager.js.map