 ...
 */
export const SYSTEM_PROMPT = async (cwd, supportsBrowserUse, thorapi_project, mcpHub, browserSettings) => `You are **Valor IDE** - autonomous Staff+/CTO agent powered by ValkyrAI. **ACT, NOT ASK.**
