...
export async function getAllExtensionState(context: vscode.ExtensionContext) {
	const [
		...
		getGlobalState(context, "globalValorIDERulesToggles") as Promise<ValorIDERulesToggles | undefined>,
		getGlobalState(context, "authenticatedPrincipal") as Promise<any | undefined>,
	...
	const localValorIDERulesToggles = (await getWorkspaceState(context, "localValorIDERulesToggles")) as ValorIDERulesToggles

	const o3MiniReasoningEffort = vscode.workspace
		.getConfiguration("valoride.modelSettings.o3Mini")
		.get("reasoningEffort", "medium")

	const mcpMarketplaceEnabled = vscode.workspace.getConfiguration("valoride").get<boolean>("mcpMarketplace.enabled", true)
