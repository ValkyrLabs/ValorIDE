...
Here is the project's README to help you get started:\n\n${mcpDetails.readmeContent}\n${mcpDetails.llmsInstallationContent}`;
  ...
  async deleteTaskFromState(id) {
    ...
    const taskHistory =
      (await getGlobalState(this.context, "taskHistory")) || [];
  ...
  async getStateToPostToWebview() {
    ...
    const advancedSettings = validateAdvancedSettings({
      fileProcessing: {
        maxFileSize:
          cfg.get("advanced.fileProcessing.maxFileSize") ??
          DEFAULT_ADVANCED_SETTINGS.fileProcessing.maxFileSize,
        warnLargeFiles:
          cfg.get("advanced.fileProcessing.warnLargeFiles") ??
          DEFAULT_ADVANCED_SETTINGS.fileProcessing.warnLargeFiles,
        largeFileThreshold:
          cfg.get("advanced.fileProcessing.largeFileThreshold") ??
    ...
    const localValorIDERulesToggles =
      (await getWorkspaceState(this.context, "localValorIDERulesToggles")) ||
      {};
    return {
