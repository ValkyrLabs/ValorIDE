...
import { ValorIDEAPI } from "./valoride"
import { getGlobalState } from "@core/storage/state"

export function createValorIDEAPI(outputChannel: vscode.OutputChannel, sidebarController: Controller): ValorIDEAPI {
	const api: ValorIDEAPI = {
