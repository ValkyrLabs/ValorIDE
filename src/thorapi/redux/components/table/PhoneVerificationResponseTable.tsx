...
const buildResourcePath = (rowId: string) =>
  `${BASE_PATH}/PhoneVerificationResponse/${rowId}`;
...
const PhoneVerificationResponseTable: React.FC = () => {
  ...
  // -------------------------------------------------------------------
  const [addPhoneVerificationResponse] =
    useAddPhoneVerificationResponseMutation();
  const [updatePhoneVerificationResponse] =
    useUpdatePhoneVerificationResponseMutation();
  const [deletePhoneVerificationResponse] =
    useDeletePhoneVerificationResponseMutation();
  const [deletePhoneVerificationResponseCascade] =
    useDeletePhoneVerificationResponseCascadeMutation();
  ...
  const [copiedRow, setCopiedRow] = useState<PhoneVerificationResponse | null>(
    null,
  );
  ...
  const reloadRowById = async (
    ...
    try {
      ...
      console.warn(
        "Could not reload PhoneVerificationResponse row",
        rowId,
        err,
      );
      return null;
  ...
  const persistRowUpdate = async (
    ...
    try {
      const saved = await updatePhoneVerificationResponse(
        updatedItem as any,
      ).unwrap();
  ...
  const handlePasteRow = async () => {
    ...
    try {
      ...
      console.error(
        "Failed to paste (create) PhoneVerificationResponse:",
        error,
      );
  ...
  return (
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            Filter PhoneVerificationResponse (Query By Example)
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <p>
