...
const buildResourcePath = (rowId: string) =>
  `${BASE_PATH}/ConfirmPasswordResetResponse/${rowId}`;
...
const ConfirmPasswordResetResponseTable: React.FC = () => {
  ...
  // -------------------------------------------------------------------
  const [addConfirmPasswordResetResponse] =
    useAddConfirmPasswordResetResponseMutation();
  const [updateConfirmPasswordResetResponse] =
    useUpdateConfirmPasswordResetResponseMutation();
  const [deleteConfirmPasswordResetResponse] =
    useDeleteConfirmPasswordResetResponseMutation();
  const [deleteConfirmPasswordResetResponseCascade] =
    useDeleteConfirmPasswordResetResponseCascadeMutation();
  ...
  const [copiedRow, setCopiedRow] =
    useState<ConfirmPasswordResetResponse | null>(null);
  ...
  const reloadRowById = async (
    rowId: string,
  ): Promise<ConfirmPasswordResetResponse | null> => {
    ...
    try {
      ...
      console.warn(
        "Could not reload ConfirmPasswordResetResponse row",
        rowId,
        err,
      );
      return null;
  ...
  const persistRowUpdate = async (
    ...
    try {
      const saved = await updateConfirmPasswordResetResponse(
        updatedItem as any,
      ).unwrap();
  ...
  const handlePasteRow = async () => {
    ...
    try {
      ...
      console.error(
        "Failed to paste (create) ConfirmPasswordResetResponse:",
        error,
      );
  ...
  return (
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            Filter ConfirmPasswordResetResponse (Query By Example)
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <p>
