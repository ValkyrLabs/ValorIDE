...
const buildResourcePath = (rowId: string) =>
  `${BASE_PATH}/PublishRestEndpointRequest/${rowId}`;
...
const PublishRestEndpointRequestTable: React.FC = () => {
  ...
  const [deletePublishRestEndpointRequest] =
    useDeletePublishRestEndpointRequestMutation();
  const [deletePublishRestEndpointRequestCascade] =
    useDeletePublishRestEndpointRequestCascadeMutation();
  ...
  const reloadRowById = async (
    rowId: string,
  ): Promise<PublishRestEndpointRequest | null> => {
    ...
    try {
      ...
      console.warn(
        "Could not reload PublishRestEndpointRequest row",
        rowId,
        err,
      );
      return null;
  ...
  const persistRowUpdate = async (
    ...
    try {
      const saved = await updatePublishRestEndpointRequest(
        updatedItem as any,
      ).unwrap();
