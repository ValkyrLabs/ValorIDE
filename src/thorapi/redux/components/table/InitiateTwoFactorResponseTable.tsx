...
const buildResourcePath = (rowId: string) =>
  `${BASE_PATH}/InitiateTwoFactorResponse/${rowId}`;
...
const InitiateTwoFactorResponseTable: React.FC = () => {
  ...
  // -------------------------------------------------------------------
  const [addInitiateTwoFactorResponse] =
    useAddInitiateTwoFactorResponseMutation();
  const [updateInitiateTwoFactorResponse] =
    useUpdateInitiateTwoFactorResponseMutation();
  const [deleteInitiateTwoFactorResponse] =
    useDeleteInitiateTwoFactorResponseMutation();
  const [deleteInitiateTwoFactorResponseCascade] =
    useDeleteInitiateTwoFactorResponseCascadeMutation();
  ...
  const [copiedRow, setCopiedRow] = useState<InitiateTwoFactorResponse | null>(
    null,
  );
  ...
  const reloadRowById = async (
    rowId: string,
  ): Promise<InitiateTwoFactorResponse | null> => {
    ...
    try {
      ...
      console.warn(
        "Could not reload InitiateTwoFactorResponse row",
        rowId,
        err,
      );
      return null;
  ...
  const persistRowUpdate = async (
    ...
    try {
      const saved = await updateInitiateTwoFactorResponse(
        updatedItem as any,
      ).unwrap();
  ...
  const handlePasteRow = async () => {
    ...
    try {
      ...
      console.error(
        "Failed to paste (create) InitiateTwoFactorResponse:",
        error,
      );
  ...
  return (
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            Filter InitiateTwoFactorResponse (Query By Example)
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <p>
