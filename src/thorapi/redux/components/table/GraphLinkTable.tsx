...
const GraphLinkTable: React.FC = () => {
  ...
  const persistRowUpdate = async (
    ...
    try {
      ...
      setAllData(
        (prev) =>
          mergeUpdatedRow(prev as any[], rowId, hydrated as any) as GraphLink[],
      );
      if (successField) {
      ...
      const errorMsg =
        error instanceof Error ? error.message : "Failed to update GraphLink";
