...
const buildResourcePath = (rowId: string) =>
  `${BASE_PATH}/VerifyTwoFactorRequest/${rowId}`;
...
const VerifyTwoFactorRequestTable: React.FC = () => {
  ...
  const [updateVerifyTwoFactorRequest] =
    useUpdateVerifyTwoFactorRequestMutation();
  const [deleteVerifyTwoFactorRequest] =
    useDeleteVerifyTwoFactorRequestMutation();
  const [deleteVerifyTwoFactorRequestCascade] =
    useDeleteVerifyTwoFactorRequestCascadeMutation();
  ...
  const [copiedRow, setCopiedRow] = useState<VerifyTwoFactorRequest | null>(
    null,
  );
  ...
  const reloadRowById = async (
    rowId: string,
  ): Promise<VerifyTwoFactorRequest | null> => {
  ...
  const persistRowUpdate = async (
    ...
    try {
      const saved = await updateVerifyTwoFactorRequest(
        updatedItem as any,
      ).unwrap();
  ...
  return (
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            Filter VerifyTwoFactorRequest (Query By Example)
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <p>
