...
const buildResourcePath = (rowId: string) =>
  `${BASE_PATH}/RegisterTrustPolicyRequest/${rowId}`;
...
const RegisterTrustPolicyRequestTable: React.FC = () => {
  ...
  // -------------------------------------------------------------------
  const [addRegisterTrustPolicyRequest] =
    useAddRegisterTrustPolicyRequestMutation();
  const [updateRegisterTrustPolicyRequest] =
    useUpdateRegisterTrustPolicyRequestMutation();
  const [deleteRegisterTrustPolicyRequest] =
    useDeleteRegisterTrustPolicyRequestMutation();
  const [deleteRegisterTrustPolicyRequestCascade] =
    useDeleteRegisterTrustPolicyRequestCascadeMutation();
  ...
  const [copiedRow, setCopiedRow] = useState<RegisterTrustPolicyRequest | null>(
    null,
  );
  ...
  const reloadRowById = async (
    rowId: string,
  ): Promise<RegisterTrustPolicyRequest | null> => {
    ...
    try {
      ...
      console.warn(
        "Could not reload RegisterTrustPolicyRequest row",
        rowId,
        err,
      );
      return null;
  ...
  const persistRowUpdate = async (
    ...
    try {
      const saved = await updateRegisterTrustPolicyRequest(
        updatedItem as any,
      ).unwrap();
      ...
      const errorMsg =
        error instanceof Error
          ? error.message
          : "Failed to update RegisterTrustPolicyRequest";
  ...
  const confirmDelete = async () => {
    ...
    try {
      await Promise.all(
        ids.map(async (id) => {
          try {
            await deleteRegisterTrustPolicyRequestCascade({
              id,
              cascade: true,
              trash: true,
            } as any).unwrap();
  ...
  const handlePasteRow = async () => {
    ...
    try {
      ...
      console.error(
        "Failed to paste (create) RegisterTrustPolicyRequest:",
        error,
      );
  ...
  return (
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            Filter RegisterTrustPolicyRequest (Query By Example)
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <p>
