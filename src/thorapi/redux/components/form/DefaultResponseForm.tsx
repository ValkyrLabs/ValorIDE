...
const DefaultResponseForm: React.FC = () => {
  ...
  const handleSubmit = async (
    values: FormikValues,
    { setSubmitting }: FormikHelpers<DefaultResponse>,
  ) => {
    try {
                  ...
                  <Accordion.Body>
                    ...
                    {(addDefaultResponseResult.isError || errorMessage) && (
                      <Alert variant="danger" className="mt-3">
                        {errorMessage ||
                          JSON.stringify(
                            "data" in (addDefaultResponseResult as any).error
                              ? (addDefaultResponseResult as any).error.data
                              : (addDefaultResponseResult as any).error,
                          )}
                      </Alert>
                    )}
