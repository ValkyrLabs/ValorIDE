...
const TrustPolicyBindingForm: React.FC = () => {
  ...
  const handleSubmit = async (values: FormikValues, { setSubmitting }: FormikHelpers<TrustPolicyBinding>) => {
    try {
      ...
      console.log("TrustPolicyBinding form values:", values);

      // NOTE: depending on your generated endpoint, you may need { body: values }
      const result = await addTrustPolicyBinding(values as any).unwrap();
  ...
  return (
    <div>
      <Formik
        validateOnBlur={true}
        initialValues={initialValues as TrustPolicyBinding}
...
/*
lowercase bindingstatuslookup
uppercase BINDINGSTATUSLOOKUP
snakecase binding_status_lookup
pascalcase BindingStatusLookup
camelcase bindingStatusLookup
kebabcase binding-status-lookup
*/
