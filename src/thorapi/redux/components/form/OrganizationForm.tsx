              ...
              <Accordion defaultActiveKey="1">
                  ...
                  <Accordion.Body>
                    ...
                    {(addOrganizationResult.isError || errorMessage) && (
                      <Alert variant="danger" className="mt-3">
                        {errorMessage ||
                          JSON.stringify(
                            "data" in (addOrganizationResult as any).error
                              ? (addOrganizationResult as any).error.data
                              : (addOrganizationResult as any).error,
                          )}
                      </Alert>
                    )}
                ...
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    ...
                    {JSON.stringify(addOrganizationResult)}
                  </Accordion.Body>
                </Accordion.Item>
              </Accordion>
            </form>
