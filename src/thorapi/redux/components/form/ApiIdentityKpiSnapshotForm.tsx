...
const ApiIdentityKpiSnapshotForm: React.FC = () => {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      console.log("ApiIdentityKpiSnapshot form values:", values);

      // NOTE: depending on your generated endpoint, you may need { body: values }
      const result = await addApiIdentityKpiSnapshot(values as any).unwrap();
  ...
  return (
    <div>
      <Formik
        validateOnBlur={true}
        initialValues={initialValues as ApiIdentityKpiSnapshot}
