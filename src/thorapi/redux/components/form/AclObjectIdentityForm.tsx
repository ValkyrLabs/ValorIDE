...
const AclObjectIdentityForm: React.FC = () => {
  const [addAclObjectIdentity, addAclObjectIdentityResult] =
              ...
              <Accordion defaultActiveKey="1">
                  ...
                  <Accordion.Body>
                    ...
                    {(addAclObjectIdentityResult.isError || errorMessage) && (
                      <Alert variant="danger" className="mt-3">
                        {errorMessage ||
                          JSON.stringify(
                            "data" in (addAclObjectIdentityResult as any).error
                              ? (addAclObjectIdentityResult as any).error.data
                              : (addAclObjectIdentityResult as any).error,
                          )}
                      </Alert>
                    )}

                    {(addAclObjectIdentityResult.isSuccess ||
                      successMessage) && (
                ...
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    ...
                    <br />
                    addAclObjectIdentityResult:{" "}
                    {JSON.stringify(addAclObjectIdentityResult)}
                  </Accordion.Body>
                </Accordion.Item>
              </Accordion>
            </form>
