...
import { LegalPrecedent } from '@thorapi/model/LegalPrecedent'
...
export const LegalPrecedentService = createApi({
  ...
  endpoints: (build) => ({
    ...
    deleteLegalPrecedentCascade: build.mutation<{ success: boolean; id: string }, { id: string; cascade?: boolean; trash?: boolean }>({
      ...
      invalidatesTags: (result, error, { id }) => [{ type: 'LegalPrecedent', id }, { type: 'LegalPrecedent', id: 'LIST' }],
    }),
  }),
})
