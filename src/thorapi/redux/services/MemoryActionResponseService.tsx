...
type MemoryActionResponsePagedQueryArg = {
  page: number
  size?: number
  example?: Partial<MemoryActionResponse>
  /**
...
type MemoryActionResponseListQueryArg = {
  example?: Partial<MemoryActionResponse>
  /**
...
export const MemoryActionResponseService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getMemoryActionResponsesPaged: build.query<MemoryActionResponseResponse, MemoryActionResponsePagedQueryArg>({
      ...
      providesTags: (result, error, { page }) => {
        ...
        return [
          ...
          { type: 'MemoryActionResponse', id: 'PARTIAL-LIST' },
        ]
      },
    }),

    // 2) Simple "get all" Query (optional)
    getMemoryActionResponses: build.query<MemoryActionResponseResponse, MemoryActionResponseListQueryArg | void>({
      query: (arg) => {
    ...
    // 5) Update
    updateMemoryActionResponse: build.mutation<MemoryActionResponse, Pick<MemoryActionResponse, 'id'> & Partial<MemoryActionResponse>>({
      query: ({ id, ...patch }) => ({
