...
type ExecModulePayloadConfigPagedQueryArg = {
  page: number
  size?: number
...
type ExecModulePayloadConfigListQueryArg = {
  example?: Partial<ExecModulePayloadConfig>
  /**
...
export const ExecModulePayloadConfigService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getExecModulePayloadConfigsPaged: build.query<ExecModulePayloadConfigResponse, ExecModulePayloadConfigPagedQueryArg>({
      ...
      providesTags: (result, error, { page }) => {
        ...
        return [
          ...
          { type: 'ExecModulePayloadConfig', id: 'PARTIAL-LIST' },
        ]
      },
    }),

    // 2) Simple "get all" Query (optional)
    getExecModulePayloadConfigs: build.query<ExecModulePayloadConfigResponse, ExecModulePayloadConfigListQueryArg | void>({
      query: (arg) => {
    ...
    // 5) Update
    updateExecModulePayloadConfig: build.mutation<ExecModulePayloadConfig, Pick<ExecModulePayloadConfig, 'id'> & Partial<ExecModulePayloadConfig>>({
      query: ({ id, ...patch }) => ({
