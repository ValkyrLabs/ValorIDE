...
type WebsocketSessionPagedQueryArg = {
  page: number
  size?: number
  example?: Partial<WebsocketSession>
  /**
...
type WebsocketSessionListQueryArg = {
  example?: Partial<WebsocketSession>
  /**
...
const toWebsocketSessionList = (result: unknown): WebsocketSessionResponse => {
  ...
  return Array.isArray(candidate) ? (candidate as WebsocketSessionResponse) : []
}
...
export const WebsocketSessionService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getWebsocketSessionsPaged: build.query<WebsocketSessionResponse, WebsocketSessionPagedQueryArg>({
      ...
      providesTags: (result, error, { page }) => {
        ...
        return [
          ...
          { type: 'WebsocketSession', id: 'PARTIAL-LIST' },
        ]
      },
    }),

    // 2) Simple "get all" Query (optional)
    getWebsocketSessions: build.query<WebsocketSessionResponse, WebsocketSessionListQueryArg | void>({
      query: (arg) => {
    ...
    // 5) Update
    updateWebsocketSession: build.mutation<WebsocketSession, Pick<WebsocketSession, 'id'> & Partial<WebsocketSession>>({
      query: ({ id, ...patch }) => ({
