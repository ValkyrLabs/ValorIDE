...
type ExecModuleAudienceConfigPagedQueryArg = {
  page: number
  size?: number
...
type ExecModuleAudienceConfigListQueryArg = {
  example?: Partial<ExecModuleAudienceConfig>
  /**
...
export const ExecModuleAudienceConfigService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getExecModuleAudienceConfigsPaged: build.query<ExecModuleAudienceConfigResponse, ExecModuleAudienceConfigPagedQueryArg>({
      ...
      providesTags: (result, error, { page }) => {
        ...
        return [
          ...
          { type: 'ExecModuleAudienceConfig', id: 'PARTIAL-LIST' },
        ]
      },
    }),

    // 2) Simple "get all" Query (optional)
    getExecModuleAudienceConfigs: build.query<ExecModuleAudienceConfigResponse, ExecModuleAudienceConfigListQueryArg | void>({
      query: (arg) => {
    ...
    // 5) Update
    updateExecModuleAudienceConfig: build.mutation<ExecModuleAudienceConfig, Pick<ExecModuleAudienceConfig, 'id'> & Partial<ExecModuleAudienceConfig>>({
      query: ({ id, ...patch }) => ({
