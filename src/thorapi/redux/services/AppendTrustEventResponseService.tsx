...
export const AppendTrustEventResponseService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getAppendTrustEventResponsesPaged: build.query<AppendTrustEventResponseResponse, { page: number; size?: number; example?: Partial<AppendTrustEventResponse> }>({
    ...
    getAppendTrustEventResponses: build.query<AppendTrustEventResponseResponse, { example?: Partial<AppendTrustEventResponse> } | void>({
      query: (arg) => {
    ...
    // 5) Update
    updateAppendTrustEventResponse: build.mutation<void, Pick<AppendTrustEventResponse, 'id'> & Partial<AppendTrustEventResponse>>({
      query: ({ id, ...patch }) => ({
      ...
      async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
        if (id) {
          const patchResult = dispatch(
            AppendTrustEventResponseService.util.updateQueryData('getAppendTrustEventResponse', id, (draft) => {
    ...
    deleteAppendTrustEventResponse: build.mutation<{ success: boolean; id: string }, number>({
      ...
      invalidatesTags: (result, error, id) => [{ type: 'AppendTrustEventResponse', id }],
    }),
    ...
    deleteAppendTrustEventResponseCascade: build.mutation<{ success: boolean; id: string }, { id: string; cascade?: boolean; trash?: boolean }>({
      ...
      invalidatesTags: (result, error, { id }) => [{ type: 'AppendTrustEventResponse', id }, { type: 'AppendTrustEventResponse', id: 'LIST' }],
    }),
  }),
})
