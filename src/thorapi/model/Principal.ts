...
export function PrincipalFromJSON(json: any): Principal {
  return {
    ...
    grantedAuthorities: !exists(json, "grantedAuthorities")
      ? undefined
      : (json["grantedAuthorities"] as Array<any>).map(AuthorityFromJSON),
...
export function PrincipalToJSON(value?: Principal): any {
  ...
  return {
    ...
    grantedAuthorities:
      value.grantedAuthorities === undefined
        ? undefined
        : (value.grantedAuthorities as Array<any>).map(AuthorityToJSON),
    userPreferences:
