...
function deleteLlmDetailsRaw<T>(
  requestParameters: DeleteLlmDetailsApiRequest,
...
function getLlmDetailsRaw<T>(
  requestParameters: GetLlmDetailsApiRequest,
...
function getLlmDetailsListRaw<T>(
  requestParameters: GetLlmDetailsListApiRequest,
 ...
 */
function patchLlmDetailsByIdRaw<T>(
  requestParameters: PatchLlmDetailsByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, LlmDetails> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchLlmDetailsById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "llmDetails",
      "Required parameter requestParameters.llmDetails was null or undefined when calling patchLlmDetailsById.",
    );
  }
 ...
 * Partially update an existing LlmDetails
 */
export function patchLlmDetailsById<T>(
  requestParameters: PatchLlmDetailsByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, LlmDetails>,
): QueryConfig<T> {
...
function postLlmDetailsRaw<T>(
  requestParameters: PostLlmDetailsApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, LlmDetails> = {},
): QueryConfig<T> {
  if (
    requestParameters.llmDetails === null ||
...
function updateLlmDetailsRaw<T>(
  requestParameters: UpdateLlmDetailsApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, LlmDetails> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
