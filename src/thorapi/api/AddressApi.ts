...
function deleteAddressRaw<T>(
  requestParameters: DeleteAddressApiRequest,
...
function getAddressRaw<T>(
  requestParameters: GetAddressApiRequest,
...
function getAddressListRaw<T>(
  requestParameters: GetAddressListApiRequest,
 ...
 */
function patchAddressByIdRaw<T>(
  requestParameters: PatchAddressByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Address> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchAddressById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "address",
      "Required parameter requestParameters.address was null or undefined when calling patchAddressById.",
    );
  }
 ...
 * Partially update an existing Address
 */
export function patchAddressById<T>(
  requestParameters: PatchAddressByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, Address>,
): QueryConfig<T> {
...
function postAddressRaw<T>(
  requestParameters: PostAddressApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Address> = {},
): QueryConfig<T> {
  if (
    requestParameters.address === null ||
...
function updateAddressRaw<T>(
  requestParameters: UpdateAddressApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Address> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
