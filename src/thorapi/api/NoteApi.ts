...
function deleteNoteRaw<T>(
  requestParameters: DeleteNoteApiRequest,
...
function getNoteRaw<T>(
  requestParameters: GetNoteApiRequest,
...
function getNoteListRaw<T>(
  requestParameters: GetNoteListApiRequest,
 ...
 */
function patchNoteByIdRaw<T>(
  requestParameters: PatchNoteByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Note> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchNoteById.",
    );
  }
  ...
  if (requestParameters.note === null || requestParameters.note === undefined) {
    throw new runtime.RequiredError(
      "note",
      "Required parameter requestParameters.note was null or undefined when calling patchNoteById.",
    );
  }
 ...
 * Partially update an existing Note
 */
export function patchNoteById<T>(
  requestParameters: PatchNoteByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, Note>,
): QueryConfig<T> {
...
function postNoteRaw<T>(
  requestParameters: PostNoteApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Note> = {},
): QueryConfig<T> {
  if (requestParameters.note === null || requestParameters.note === undefined) {
    throw new runtime.RequiredError(
...
function updateNoteRaw<T>(
  requestParameters: UpdateNoteApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Note> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
