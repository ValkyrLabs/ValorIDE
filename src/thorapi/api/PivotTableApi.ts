...
export interface PatchPivotTableByIdApiRequest {
    id: string;
 ...
 * Partially update an existing PivotTable
 */
function patchPivotTableByIdRaw<T>(requestParameters: PatchPivotTableByIdApiRequest, requestConfig: runtime.TypedQueryConfig<T, PivotTable> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
        throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling patchPivotTableById.');
    }

    if (requestParameters.pivotTable === null || requestParameters.pivotTable === undefined) {
        throw new runtime.RequiredError('pivotTable','Required parameter requestParameters.pivotTable was null or undefined when calling patchPivotTableById.');
    }
...
* Partially update an existing PivotTable
*/
export function patchPivotTableById<T>(requestParameters: PatchPivotTableByIdApiRequest, requestConfig?: runtime.TypedQueryConfig<T, PivotTable>): QueryConfig<T> {
    return patchPivotTableByIdRaw(requestParameters, requestConfig);
}
