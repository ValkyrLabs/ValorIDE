 ...
 */
function patchPtgRefByIdRaw<T>(
  requestParameters: PatchPtgRefByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, PtgRef> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchPtgRefById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "ptgRef",
      "Required parameter requestParameters.ptgRef was null or undefined when calling patchPtgRefById.",
    );
  }
 ...
 * Partially update an existing PtgRef
 */
export function patchPtgRefById<T>(
  requestParameters: PatchPtgRefByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, PtgRef>,
): QueryConfig<T> {
