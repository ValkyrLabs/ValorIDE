 ...
 */
function patchMcpServerByIdRaw<T>(
  requestParameters: PatchMcpServerByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, McpServer> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchMcpServerById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "mcpServer",
      "Required parameter requestParameters.mcpServer was null or undefined when calling patchMcpServerById.",
    );
  }
 ...
 * Partially update an existing McpServer
 */
export function patchMcpServerById<T>(
  requestParameters: PatchMcpServerByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, McpServer>,
): QueryConfig<T> {
