...
function deleteOpportunityRaw<T>(
  requestParameters: DeleteOpportunityApiRequest,
...
function getOpportunityRaw<T>(
  requestParameters: GetOpportunityApiRequest,
...
function getOpportunityListRaw<T>(
  requestParameters: GetOpportunityListApiRequest,
 ...
 */
function patchOpportunityByIdRaw<T>(
  requestParameters: PatchOpportunityByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Opportunity> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchOpportunityById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "opportunity",
      "Required parameter requestParameters.opportunity was null or undefined when calling patchOpportunityById.",
    );
  }
 ...
 * Partially update an existing Opportunity
 */
export function patchOpportunityById<T>(
  requestParameters: PatchOpportunityByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, Opportunity>,
): QueryConfig<T> {
...
function postOpportunityRaw<T>(
  requestParameters: PostOpportunityApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Opportunity> = {},
): QueryConfig<T> {
  if (
    requestParameters.opportunity === null ||
...
function updateOpportunityRaw<T>(
  requestParameters: UpdateOpportunityApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Opportunity> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
