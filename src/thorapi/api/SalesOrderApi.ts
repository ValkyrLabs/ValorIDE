...
export interface PatchSalesOrderByIdApiRequest {
    id: string;
 ...
 * Partially update an existing SalesOrder
 */
function patchSalesOrderByIdRaw<T>(requestParameters: PatchSalesOrderByIdApiRequest, requestConfig: runtime.TypedQueryConfig<T, SalesOrder> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
        throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling patchSalesOrderById.');
    }

    if (requestParameters.salesOrder === null || requestParameters.salesOrder === undefined) {
        throw new runtime.RequiredError('salesOrder','Required parameter requestParameters.salesOrder was null or undefined when calling patchSalesOrderById.');
    }
...
* Partially update an existing SalesOrder
*/
export function patchSalesOrderById<T>(requestParameters: PatchSalesOrderByIdApiRequest, requestConfig?: runtime.TypedQueryConfig<T, SalesOrder>): QueryConfig<T> {
    return patchSalesOrderByIdRaw(requestParameters, requestConfig);
}
