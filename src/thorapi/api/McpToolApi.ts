 ...
 */
function patchMcpToolByIdRaw<T>(
  requestParameters: PatchMcpToolByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, McpTool> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchMcpToolById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "mcpTool",
      "Required parameter requestParameters.mcpTool was null or undefined when calling patchMcpToolById.",
    );
  }
 ...
 * Partially update an existing McpTool
 */
export function patchMcpToolById<T>(
  requestParameters: PatchMcpToolByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, McpTool>,
): QueryConfig<T> {
