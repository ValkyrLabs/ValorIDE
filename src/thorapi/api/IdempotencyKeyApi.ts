 ...
 */
function patchIdempotencyKeyByIdRaw<T>(
  requestParameters: PatchIdempotencyKeyByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, IdempotencyKey> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchIdempotencyKeyById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "idempotencyKey",
      "Required parameter requestParameters.idempotencyKey was null or undefined when calling patchIdempotencyKeyById.",
    );
  }
 ...
 * Partially update an existing IdempotencyKey
 */
export function patchIdempotencyKeyById<T>(
  requestParameters: PatchIdempotencyKeyByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, IdempotencyKey>,
): QueryConfig<T> {
