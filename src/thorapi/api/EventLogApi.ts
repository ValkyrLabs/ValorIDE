...
function deleteEventLogRaw<T>(
  requestParameters: DeleteEventLogApiRequest,
...
function getEventLogRaw<T>(
  requestParameters: GetEventLogApiRequest,
...
function getEventLogListRaw<T>(
  requestParameters: GetEventLogListApiRequest,
 ...
 */
function patchEventLogByIdRaw<T>(
  requestParameters: PatchEventLogByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, EventLog> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchEventLogById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "eventLog",
      "Required parameter requestParameters.eventLog was null or undefined when calling patchEventLogById.",
    );
  }
 ...
 * Partially update an existing EventLog
 */
export function patchEventLogById<T>(
  requestParameters: PatchEventLogByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, EventLog>,
): QueryConfig<T> {
...
function postEventLogRaw<T>(
  requestParameters: PostEventLogApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, EventLog> = {},
): QueryConfig<T> {
  if (
    requestParameters.eventLog === null ||
...
function updateEventLogRaw<T>(
  requestParameters: UpdateEventLogApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, EventLog> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
