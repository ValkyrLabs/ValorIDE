...
function deleteMcpResourceResponseRaw<T>(
  requestParameters: DeleteMcpResourceResponseApiRequest,
...
function getMcpResourceResponseRaw<T>(
  requestParameters: GetMcpResourceResponseApiRequest,
...
function getMcpResourceResponseListRaw<T>(
  requestParameters: GetMcpResourceResponseListApiRequest,
 ...
 */
function patchMcpResourceResponseByIdRaw<T>(
  requestParameters: PatchMcpResourceResponseByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, McpResourceResponse> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchMcpResourceResponseById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "mcpResourceResponse",
      "Required parameter requestParameters.mcpResourceResponse was null or undefined when calling patchMcpResourceResponseById.",
    );
  }
 ...
 * Partially update an existing McpResourceResponse
 */
export function patchMcpResourceResponseById<T>(
  requestParameters: PatchMcpResourceResponseByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, McpResourceResponse>,
): QueryConfig<T> {
...
function postMcpResourceResponseRaw<T>(
  requestParameters: PostMcpResourceResponseApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, McpResourceResponse> = {},
): QueryConfig<T> {
  if (
    requestParameters.mcpResourceResponse === null ||
...
function updateMcpResourceResponseRaw<T>(
  requestParameters: UpdateMcpResourceResponseApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, McpResourceResponse> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
