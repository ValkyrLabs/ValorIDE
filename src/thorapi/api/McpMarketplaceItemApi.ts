...
export interface PatchMcpMarketplaceItemByIdApiRequest {
    id: string;
 ...
 * Partially update an existing McpMarketplaceItem
 */
function patchMcpMarketplaceItemByIdRaw<T>(requestParameters: PatchMcpMarketplaceItemByIdApiRequest, requestConfig: runtime.TypedQueryConfig<T, McpMarketplaceItem> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
        throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling patchMcpMarketplaceItemById.');
    }

    if (requestParameters.mcpMarketplaceItem === null || requestParameters.mcpMarketplaceItem === undefined) {
        throw new runtime.RequiredError('mcpMarketplaceItem','Required parameter requestParameters.mcpMarketplaceItem was null or undefined when calling patchMcpMarketplaceItemById.');
    }
...
* Partially update an existing McpMarketplaceItem
*/
export function patchMcpMarketplaceItemById<T>(requestParameters: PatchMcpMarketplaceItemByIdApiRequest, requestConfig?: runtime.TypedQueryConfig<T, McpMarketplaceItem>): QueryConfig<T> {
    return patchMcpMarketplaceItemByIdRaw(requestParameters, requestConfig);
}
