 ...
 */
function patchAccountBalanceByIdRaw<T>(
  requestParameters: PatchAccountBalanceByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, AccountBalance> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchAccountBalanceById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "accountBalance",
      "Required parameter requestParameters.accountBalance was null or undefined when calling patchAccountBalanceById.",
    );
  }
 ...
 * Partially update an existing AccountBalance
 */
export function patchAccountBalanceById<T>(
  requestParameters: PatchAccountBalanceByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, AccountBalance>,
): QueryConfig<T> {
