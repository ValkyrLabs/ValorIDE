...
function deleteSalesPipelineRaw<T>(
  requestParameters: DeleteSalesPipelineApiRequest,
...
function getSalesPipelineRaw<T>(
  requestParameters: GetSalesPipelineApiRequest,
...
function getSalesPipelineListRaw<T>(
  requestParameters: GetSalesPipelineListApiRequest,
 ...
 */
function patchSalesPipelineByIdRaw<T>(
  requestParameters: PatchSalesPipelineByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, SalesPipeline> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchSalesPipelineById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "salesPipeline",
      "Required parameter requestParameters.salesPipeline was null or undefined when calling patchSalesPipelineById.",
    );
  }
 ...
 * Partially update an existing SalesPipeline
 */
export function patchSalesPipelineById<T>(
  requestParameters: PatchSalesPipelineByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, SalesPipeline>,
): QueryConfig<T> {
...
function postSalesPipelineRaw<T>(
  requestParameters: PostSalesPipelineApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, SalesPipeline> = {},
): QueryConfig<T> {
  if (
    requestParameters.salesPipeline === null ||
...
function updateSalesPipelineRaw<T>(
  requestParameters: UpdateSalesPipelineApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, SalesPipeline> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
