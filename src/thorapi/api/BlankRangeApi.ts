 ...
 */
function patchBlankRangeByIdRaw<T>(
  requestParameters: PatchBlankRangeByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, BlankRange> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchBlankRangeById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "blankRange",
      "Required parameter requestParameters.blankRange was null or undefined when calling patchBlankRangeById.",
    );
  }
 ...
 * Partially update an existing BlankRange
 */
export function patchBlankRangeById<T>(
  requestParameters: PatchBlankRangeByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, BlankRange>,
): QueryConfig<T> {
