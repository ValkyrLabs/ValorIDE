...
/**
 * Combines sequences of command and command_output messages in an array of ValorIDEMessages.
 *
 * This function processes an array of ValorIDEMessages objects, looking for sequences
 ...
 * @returns A new array of ValorIDEMessage objects with command sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: ValorIDEMessage[]): ValorIDEMessage[] {
	const combinedCommands: ValorIDEMessage[] = []
