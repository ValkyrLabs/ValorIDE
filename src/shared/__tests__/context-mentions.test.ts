...
describe("Mention Regex", () => {
  ...
  describe("Invalid Patterns", () => {
    ...
    it("matches only until invalid characters", () => {
      const result = testMention(
        "@/C:\\folder\\file.txt invalid suffix",
        "@/C:\\folder\\file.txt",
      );
      assertMatch(result);
    });
  ...
  describe("In Context", () => {
    it("matches mentions within text", () => {
      const cases: Array<[string, string]> = [
        [
          "Check the file at @/C:\\folder\\file.txt for details.",
          "@/C:\\folder\\file.txt",
        ],
  ...
  describe("Special Characters in Paths", () => {
    it("handles special characters in file paths", () => {
      const cases: Array<[string, string]> = [
        [
          "@/path/with-dash/file_underscore.txt",
          "@/path/with-dash/file_underscore.txt",
        ],
        [
        ...
        [
          "@/path/with/file#hash%percent.txt",
          "@/path/with/file#hash%percent.txt",
        ],
        [
          "@/path/with/file@symbol$dollar.txt",
          "@/path/with/file@symbol$dollar.txt",
        ],
      ];
  ...
  describe("Mixed Path Types in Single String", () => {
    it("correctly identifies the first path in a string with multiple path types", () => {
      const text =
        "Check both @/unix/path and @/C:\\windows\\path for details.";
