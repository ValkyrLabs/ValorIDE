...
### ThorAPI-Generated Files (READ ONLY)

These files are auto-generated by ThorAPI and should NOT be edited:

- `webview-ui/src//model/ContentData.ts` - ContentData interface
- `webview-ui/src//api/ContentDataApi.ts` - Raw API functions
- `webview-ui/src//redux/services/ContentDataService.tsx` - RTK Query service
...
- `@thorapi/model/ContentData`
- `@reduxjs/toolkit/query/react`

## Related Documentation

- [UsageTracking Integration](../src/api/USAGE_TRACKING_INTEGRATION.md)
- [ThorAPI API Client Upgrade Checklist](./architecture/thorapi-client-upgrade-checklist.md)
