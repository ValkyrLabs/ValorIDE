...
export function OasObjectSchemaFromJSON(json: any): OasObjectSchema {
  return {
    ...
    oasEnum: !exists(json, "oasEnum")
      ? undefined
      : (json["oasEnum"] as Array<any>).map(OasEnumFromJSON),
    required: !exists(json, "required")
      ? undefined
      : (json["required"] as Array<any>).map(OasRequiredFromJSON),
  ...
  return {
    ...
    oasEnum:
      value.oasEnum === undefined
        ? undefined
        : (value.oasEnum as Array<any>).map(OasEnumToJSON),
    required:
      value.required === undefined
        ? undefined
        : (value.required as Array<any>).map(OasRequiredToJSON),
