...
export function ValkyrJobFromJSON(json) {
    return {
        ...
        'fileRecords': !exists(json, 'fileRecords') ? undefined : json['fileRecords'].map(FileRecordFromJSON),
...
export function ValkyrJobToJSON(value) {
    ...
    return {
        ...
        'result': value.result,
        'error': value.error,
        'fileRecords': value.fileRecords === undefined ? undefined : value.fileRecords.map(FileRecordToJSON),
