...
export function GoalFromJSON(json: any): Goal {
  return {
    ...
    keyMetrics: !exists(json, "keyMetrics")
      ? undefined
      : (json["keyMetrics"] as Array<any>).map(KeyMetricFromJSON),
  ...
  return {
    ...
    keyMetrics:
      value.keyMetrics === undefined
        ? undefined
        : (value.keyMetrics as Array<any>).map(KeyMetricToJSON),
    goalDependencies:
      value.goalDependencies === undefined
        ? undefined
        : (value.goalDependencies as Array<any>).map(GoalDependencyToJSON),
