...
import { GoalDependency, GoalDependencyFromJSON, GoalDependencyToJSON, KeyMetric, KeyMetricFromJSON, KeyMetricToJSON } from "./"
...
export function GoalFromJSON(json: any): Goal {
	return {
		...
		goalDependencies: !exists(json, "goalDependencies")
			? undefined
			: (json["goalDependencies"] as Array<any>).map(GoalDependencyFromJSON),
...
export function GoalToJSON(value?: Goal): any {
	...
	return {
		...
		goalDependencies:
			value.goalDependencies === undefined ? undefined : (value.goalDependencies as Array<any>).map(GoalDependencyToJSON),
