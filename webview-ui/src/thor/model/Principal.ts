...
export function PrincipalFromJSON(json: any): Principal {
  return {
    ...
    roles: !exists(json, "roles")
      ? undefined
      : (json["roles"] as Array<any>).map(PrincipalRolesFromJSON),
    authorityList: !exists(json, "authorityList")
      ? undefined
      : (json["authorityList"] as Array<any>).map(AuthorityFromJSON),
  ...
  return {
    ...
    roles:
      value.roles === undefined
        ? undefined
        : (value.roles as Array<any>).map(PrincipalRolesToJSON),
    authorityList:
      value.authorityList === undefined
        ? undefined
        : (value.authorityList as Array<any>).map(AuthorityToJSON),
    userPreferences:
