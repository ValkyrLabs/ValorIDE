...
exports.DiscardDeadLetterEntryRequestReasonEnum = void 0;
exports.DiscardDeadLetterEntryRequestFromJSON = DiscardDeadLetterEntryRequestFromJSON;
exports.DiscardDeadLetterEntryRequestToJSON = DiscardDeadLetterEntryRequestToJSON;
// tslint:disable
/**
...
function DiscardDeadLetterEntryRequestFromJSON(json) {
    return {
...
function DiscardDeadLetterEntryRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    return {
 ...
 * @enum {string}
 */
var DiscardDeadLetterEntryRequestReasonEnum;
...
})(DiscardDeadLetterEntryRequestReasonEnum || (exports.DiscardDeadLetterEntryRequestReasonEnum = DiscardDeadLetterEntryRequestReasonEnum = {}));
