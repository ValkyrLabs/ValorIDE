...
export function ProductFromJSON(json: any): Product {
  return {
    ...
    productContentData: !exists(json, "productContentData")
      ? undefined
      : (json["productContentData"] as Array<any>).map(ContentDataFromJSON),
    type: !exists(json, "type") ? undefined : json["type"],
    features: !exists(json, "features")
      ? undefined
      : (json["features"] as Array<any>).map(ProductFeatureFromJSON),
  ...
  return {
    ...
    productContentData:
      value.productContentData === undefined
        ? undefined
        : (value.productContentData as Array<any>).map(ContentDataToJSON),
    type: value.type,
    features:
      value.features === undefined
        ? undefined
        : (value.features as Array<any>).map(ProductFeatureToJSON),
