...
function SalesOrderFromJSON(json) {
    return {
        ...
        'orderDiscounts': !(0, runtime_1.exists)(json, 'orderDiscounts') ? undefined : json['orderDiscounts'].map(_1.LineItemFromJSON),
...
function SalesOrderToJSON(value) {
    ...
    return {
        ...
        'orderDiscounts': value.orderDiscounts === undefined ? undefined : value.orderDiscounts.map(_1.LineItemToJSON),
