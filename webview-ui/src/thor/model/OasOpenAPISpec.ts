...
export function OasOpenAPISpecFromJSON(json: any): OasOpenAPISpec {
  return {
    ...
    servers: !exists(json, "servers")
      ? undefined
      : (json["servers"] as Array<any>).map(OasServerFromJSON),
    paths: !exists(json, "paths")
      ? undefined
      : (json["paths"] as Array<any>).map(OasPathFromJSON),
  ...
  return {
    ...
    servers:
      value.servers === undefined
        ? undefined
        : (value.servers as Array<any>).map(OasServerToJSON),
    paths:
      value.paths === undefined
        ? undefined
        : (value.paths as Array<any>).map(OasPathToJSON),
