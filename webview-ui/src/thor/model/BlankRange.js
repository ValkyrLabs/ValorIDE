...
exports.BlankRangeFromJSON = BlankRangeFromJSON;
exports.BlankRangeToJSON = BlankRangeToJSON;
const runtime_1 = require("../src/runtime");
const _1 = require("./");
function BlankRangeFromJSON(json) {
    return {
...
function BlankRangeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    return {
...
//# sourceMappingURL=BlankRange.js.map