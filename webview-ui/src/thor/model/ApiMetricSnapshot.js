...
exports.ApiMetricSnapshotFromJSON = ApiMetricSnapshotFromJSON;
exports.ApiMetricSnapshotToJSON = ApiMetricSnapshotToJSON;
// tslint:disable
/**
...
function ApiMetricSnapshotFromJSON(json) {
    return {
...
function ApiMetricSnapshotToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    return {
...
//# sourceMappingURL=ApiMetricSnapshot.js.map