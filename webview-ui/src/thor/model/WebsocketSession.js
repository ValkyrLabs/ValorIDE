...
export function WebsocketSessionFromJSON(json) {
  return {
    ...
    statuses: !exists(json, "statuses")
      ? undefined
      : json["statuses"].map(WebsocketMessageFromJSON),
    messages: !exists(json, "messages")
      ? undefined
      : json["messages"].map(WebsocketMessageFromJSON),
  ...
  return {
    ...
    statuses:
      value.statuses === undefined
        ? undefined
        : value.statuses.map(WebsocketMessageToJSON),
    messages:
      value.messages === undefined
        ? undefined
        : value.messages.map(WebsocketMessageToJSON),
