...
export function McpFromJSON(json: any): Mcp {
  return {
    ...
    servers: !exists(json, "servers")
      ? undefined
      : (json["servers"] as Array<any>).map(McpServerFromJSON),
    marketplaceCatalogs: !exists(json, "marketplaceCatalogs")
      ? undefined
      : (json["marketplaceCatalogs"] as Array<any>).map(
          McpMarketplaceCatalogFromJSON,
        ),
    marketplaceItems: !exists(json, "marketplaceItems")
      ? undefined
      : (json["marketplaceItems"] as Array<any>).map(
          McpMarketplaceItemFromJSON,
        ),
    downloads: !exists(json, "downloads")
      ? undefined
      : (json["downloads"] as Array<any>).map(McpDownloadResponseFromJSON),
    resourceResponses: !exists(json, "resourceResponses")
      ? undefined
      : (json["resourceResponses"] as Array<any>).map(
          McpResourceResponseFromJSON,
        ),
    toolCallResponses: !exists(json, "toolCallResponses")
      ? undefined
      : (json["toolCallResponses"] as Array<any>).map(
          McpToolCallResponseFromJSON,
        ),
    toolPresets: !exists(json, "toolPresets")
      ? undefined
      : (json["toolPresets"] as Array<any>).map(McpToolPresetFromJSON),
  ...
  return {
    ...
    servers:
      value.servers === undefined
        ? undefined
        : (value.servers as Array<any>).map(McpServerToJSON),
    marketplaceCatalogs:
      value.marketplaceCatalogs === undefined
        ? undefined
        : (value.marketplaceCatalogs as Array<any>).map(
            McpMarketplaceCatalogToJSON,
          ),
    marketplaceItems:
      value.marketplaceItems === undefined
        ? undefined
        : (value.marketplaceItems as Array<any>).map(McpMarketplaceItemToJSON),
    downloads:
      value.downloads === undefined
        ? undefined
        : (value.downloads as Array<any>).map(McpDownloadResponseToJSON),
    resourceResponses:
      value.resourceResponses === undefined
        ? undefined
        : (value.resourceResponses as Array<any>).map(
            McpResourceResponseToJSON,
          ),
    toolCallResponses:
      value.toolCallResponses === undefined
        ? undefined
        : (value.toolCallResponses as Array<any>).map(
            McpToolCallResponseToJSON,
          ),
    toolPresets:
