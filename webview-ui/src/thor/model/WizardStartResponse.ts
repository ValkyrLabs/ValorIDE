 ...
 */
export type WizardStartResponse = DataObject & {
  /**
   * Unique identifier for the wizard session
   * @type {string}
...
export function WizardStartResponseToJSON(value?: WizardStartResponse): any {
  if (value === undefined) {
    return undefined;
  }
  return {
 ...
 * @enum {string}
 */
export enum WizardStartResponseStatusEnum {
  STARTED = "started",
