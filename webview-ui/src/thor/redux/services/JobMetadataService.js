    ...
    endpoints: (build) => ({
        ...
        updateJobMetadata: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(JobMetadataService.util.updateQueryData("getJobMetadata", id, (draft) => {
...
export const { useGetJobMetadatasPagedQuery, // immediate fetch
useLazyGetJobMetadatasPagedQuery, // lazy fetch
useGetJobMetadataQuery, useGetJobMetadatasQuery, useAddJobMetadataMutation, useUpdateJobMetadataMutation, useDeleteJobMetadataMutation, } = JobMetadataService;
