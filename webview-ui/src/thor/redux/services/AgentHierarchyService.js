    ...
    endpoints: (build) => ({
        ...
        updateAgentHierarchy: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(AgentHierarchyService.util.updateQueryData("getAgentHierarchy", id, (draft) => {
...
export const { useGetAgentHierarchysPagedQuery, // immediate fetch
useLazyGetAgentHierarchysPagedQuery, // lazy fetch
useGetAgentHierarchyQuery, useGetAgentHierarchysQuery, useAddAgentHierarchyMutation, useUpdateAgentHierarchyMutation, useDeleteAgentHierarchyMutation, } = AgentHierarchyService;
