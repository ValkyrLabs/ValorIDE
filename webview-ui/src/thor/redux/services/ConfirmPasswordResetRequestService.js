    ...
    endpoints: (build) => ({
        ...
        updateConfirmPasswordResetRequest: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(ConfirmPasswordResetRequestService.util.updateQueryData("getConfirmPasswordResetRequest", id, (draft) => {
...
export const { useGetConfirmPasswordResetRequestsPagedQuery, // immediate fetch
useLazyGetConfirmPasswordResetRequestsPagedQuery, // lazy fetch
useGetConfirmPasswordResetRequestQuery, useGetConfirmPasswordResetRequestsQuery, useAddConfirmPasswordResetRequestMutation, useUpdateConfirmPasswordResetRequestMutation, useDeleteConfirmPasswordResetRequestMutation, useDeleteConfirmPasswordResetRequestCascadeMutation, } = ConfirmPasswordResetRequestService;
