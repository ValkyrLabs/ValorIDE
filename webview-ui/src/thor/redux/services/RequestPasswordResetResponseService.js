    ...
    endpoints: (build) => ({
        ...
        updateRequestPasswordResetResponse: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(RequestPasswordResetResponseService.util.updateQueryData("getRequestPasswordResetResponse", id, (draft) => {
...
export const { useGetRequestPasswordResetResponsesPagedQuery, // immediate fetch
useLazyGetRequestPasswordResetResponsesPagedQuery, // lazy fetch
useGetRequestPasswordResetResponseQuery, useGetRequestPasswordResetResponsesQuery, useAddRequestPasswordResetResponseMutation, useUpdateRequestPasswordResetResponseMutation, useDeleteRequestPasswordResetResponseMutation, useDeleteRequestPasswordResetResponseCascadeMutation, } = RequestPasswordResetResponseService;
