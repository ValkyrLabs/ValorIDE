    ...
    endpoints: (build) => ({
        ...
        updatePhoneVerificationResponse: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(PhoneVerificationResponseService.util.updateQueryData("getPhoneVerificationResponse", id, (draft) => {
...
export const { useGetPhoneVerificationResponsesPagedQuery, // immediate fetch
useLazyGetPhoneVerificationResponsesPagedQuery, // lazy fetch
useGetPhoneVerificationResponseQuery, useGetPhoneVerificationResponsesQuery, useAddPhoneVerificationResponseMutation, useUpdatePhoneVerificationResponseMutation, useDeletePhoneVerificationResponseMutation, useDeletePhoneVerificationResponseCascadeMutation, } = PhoneVerificationResponseService;
