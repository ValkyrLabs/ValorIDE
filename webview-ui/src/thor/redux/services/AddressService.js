    ...
    endpoints: (build) => ({
        ...
        updateAddress: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(AddressService.util.updateQueryData('getAddress', id, (draft) => {
...
export const { useGetAddresssPagedQuery, // immediate fetch
useLazyGetAddresssPagedQuery, // lazy fetch
useGetAddressQuery, useGetAddresssQuery, useAddAddressMutation, useUpdateAddressMutation, useDeleteAddressMutation, } = AddressService;
