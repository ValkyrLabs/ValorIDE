    ...
    endpoints: (build) => ({
        ...
        updateVerifyTwoFactorRequest: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(VerifyTwoFactorRequestService.util.updateQueryData("getVerifyTwoFactorRequest", id, (draft) => {
...
export const { useGetVerifyTwoFactorRequestsPagedQuery, // immediate fetch
useLazyGetVerifyTwoFactorRequestsPagedQuery, // lazy fetch
useGetVerifyTwoFactorRequestQuery, useGetVerifyTwoFactorRequestsQuery, useAddVerifyTwoFactorRequestMutation, useUpdateVerifyTwoFactorRequestMutation, useDeleteVerifyTwoFactorRequestMutation, useDeleteVerifyTwoFactorRequestCascadeMutation, } = VerifyTwoFactorRequestService;
