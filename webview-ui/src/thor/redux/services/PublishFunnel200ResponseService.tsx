...
export const PublishFunnel200ResponseService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getPublishFunnel200ResponsesPaged: build.query<
      PublishFunnel200ResponseResponse,
      {
        page: number;
        size?: number;
        example?: Partial<PublishFunnel200Response>;
      }
    >({
      ...
      providesTags: (result, error, { page }) =>
        result
          ? [
              ...result.map(({ id }) => ({
                type: "PublishFunnel200Response" as const,
                id,
              })),
    ...
    getPublishFunnel200Responses: build.query<
      PublishFunnel200ResponseResponse,
      { example?: Partial<PublishFunnel200Response> } | void
    >({
      query: (arg) => {
    ...
    addPublishFunnel200Response: build.mutation<
      ...
      Partial<PublishFunnel200Response>
    >({
      query: (body) => ({
    ...
    updatePublishFunnel200Response: build.mutation<
      void,
      Pick<PublishFunnel200Response, "id"> & Partial<PublishFunnel200Response>
    >({
      query: ({ id, ...patch }) => ({
      ...
      invalidatesTags: (
        result,
        error,
        { id }: Pick<PublishFunnel200Response, "id">,
      ) => [
        { type: "PublishFunnel200Response", id },
        { type: "PublishFunnel200Response", id: "LIST" },
      ],
