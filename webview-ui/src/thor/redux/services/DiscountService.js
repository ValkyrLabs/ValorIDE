    ...
    endpoints: (build) => ({
        ...
        updateDiscount: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(DiscountService.util.updateQueryData('getDiscount', id, (draft) => {
...
export const { useGetDiscountsPagedQuery, // immediate fetch
useLazyGetDiscountsPagedQuery, // lazy fetch
useGetDiscountQuery, useGetDiscountsQuery, useAddDiscountMutation, useUpdateDiscountMutation, useDeleteDiscountMutation, } = DiscountService;
