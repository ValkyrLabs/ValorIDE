    ...
    endpoints: (build) => ({
        ...
        updateInitiateTwoFactorResponse: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(InitiateTwoFactorResponseService.util.updateQueryData("getInitiateTwoFactorResponse", id, (draft) => {
...
export const { useGetInitiateTwoFactorResponsesPagedQuery, // immediate fetch
useLazyGetInitiateTwoFactorResponsesPagedQuery, // lazy fetch
useGetInitiateTwoFactorResponseQuery, useGetInitiateTwoFactorResponsesQuery, useAddInitiateTwoFactorResponseMutation, useUpdateInitiateTwoFactorResponseMutation, useDeleteInitiateTwoFactorResponseMutation, useDeleteInitiateTwoFactorResponseCascadeMutation, } = InitiateTwoFactorResponseService;
