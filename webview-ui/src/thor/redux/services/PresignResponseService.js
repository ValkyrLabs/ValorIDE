    ...
    endpoints: (build) => ({
        ...
        updatePresignResponse: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(PresignResponseService.util.updateQueryData("getPresignResponse", id, (draft) => {
...
export const { useGetPresignResponsesPagedQuery, // immediate fetch
useLazyGetPresignResponsesPagedQuery, // lazy fetch
useGetPresignResponseQuery, useGetPresignResponsesQuery, useAddPresignResponseMutation, useUpdatePresignResponseMutation, useDeletePresignResponseMutation, } = PresignResponseService;
