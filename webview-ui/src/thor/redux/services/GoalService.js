    ...
    endpoints: (build) => ({
        ...
        updateGoal: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(GoalService.util.updateQueryData('getGoal', id, (draft) => {
...
export const { useGetGoalsPagedQuery, // immediate fetch
useLazyGetGoalsPagedQuery, // lazy fetch
useGetGoalQuery, useGetGoalsQuery, useAddGoalMutation, useUpdateGoalMutation, useDeleteGoalMutation, } = GoalService;
