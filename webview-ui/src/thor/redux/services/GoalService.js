...
export const GoalService = createApi({
    ...
    endpoints: (build) => ({
        ...
        deleteGoalCascade: build.mutation({
...
useGetGoalQuery, useGetGoalsQuery, useAddGoalMutation, useUpdateGoalMutation, useDeleteGoalMutation, useDeleteGoalCascadeMutation, } = GoalService;
