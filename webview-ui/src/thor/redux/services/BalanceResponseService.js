...
export const BalanceResponseService = createApi({
    ...
    endpoints: (build) => ({
        ...
        deleteBalanceResponseCascade: build.mutation({
...
useGetBalanceResponseQuery, useGetBalanceResponsesQuery, useAddBalanceResponseMutation, useUpdateBalanceResponseMutation, useDeleteBalanceResponseMutation, useDeleteBalanceResponseCascadeMutation, } = BalanceResponseService;
