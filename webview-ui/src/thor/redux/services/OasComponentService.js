    ...
    endpoints: (build) => ({
        ...
        getOasComponentsPaged: build.query({
            ...
            providesTags: (result, error, { page }) => result
                ? [
                    ...result.map(({ id }) => ({ type: 'OasComponent', id })),
...
useGetOasComponentQuery, useGetOasComponentsQuery, useAddOasComponentMutation, useUpdateOasComponentMutation, useDeleteOasComponentMutation, } = OasComponentService;
