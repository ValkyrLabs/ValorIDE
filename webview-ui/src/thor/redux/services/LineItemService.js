...
export const LineItemService = createApi({
    ...
    endpoints: (build) => ({
        ...
        deleteLineItemCascade: build.mutation({
...
useGetLineItemQuery, useGetLineItemsQuery, useAddLineItemMutation, useUpdateLineItemMutation, useDeleteLineItemMutation, useDeleteLineItemCascadeMutation, } = LineItemService;
