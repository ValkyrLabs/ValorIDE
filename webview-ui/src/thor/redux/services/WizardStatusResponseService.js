    ...
    endpoints: (build) => ({
        ...
        getWizardStatusResponsesPaged: build.query({
            ...
            providesTags: (result, error, { page }) => result
                ? [
                    ...result.map(({ id }) => ({ type: 'WizardStatusResponse', id })),
...
useGetWizardStatusResponseQuery, useGetWizardStatusResponsesQuery, useAddWizardStatusResponseMutation, useUpdateWizardStatusResponseMutation, useDeleteWizardStatusResponseMutation, } = WizardStatusResponseService;
