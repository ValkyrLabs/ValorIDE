    ...
    endpoints: (build) => ({
        ...
        updateLoginAudit: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(LoginAuditService.util.updateQueryData("getLoginAudit", id, (draft) => {
...
export const { useGetLoginAuditsPagedQuery, // immediate fetch
useLazyGetLoginAuditsPagedQuery, // lazy fetch
useGetLoginAuditQuery, useGetLoginAuditsQuery, useAddLoginAuditMutation, useUpdateLoginAuditMutation, useDeleteLoginAuditMutation, useDeleteLoginAuditCascadeMutation, } = LoginAuditService;
