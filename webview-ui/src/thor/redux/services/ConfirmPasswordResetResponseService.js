    ...
    endpoints: (build) => ({
        ...
        updateConfirmPasswordResetResponse: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(ConfirmPasswordResetResponseService.util.updateQueryData("getConfirmPasswordResetResponse", id, (draft) => {
...
export const { useGetConfirmPasswordResetResponsesPagedQuery, // immediate fetch
useLazyGetConfirmPasswordResetResponsesPagedQuery, // lazy fetch
useGetConfirmPasswordResetResponseQuery, useGetConfirmPasswordResetResponsesQuery, useAddConfirmPasswordResetResponseMutation, useUpdateConfirmPasswordResetResponseMutation, useDeleteConfirmPasswordResetResponseMutation, useDeleteConfirmPasswordResetResponseCascadeMutation, } = ConfirmPasswordResetResponseService;
