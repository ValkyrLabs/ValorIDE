...
export const IntegrationAccountService = createApi({
    ...
    endpoints: (build) => ({
        ...
        deleteIntegrationAccountCascade: build.mutation({
...
useGetIntegrationAccountQuery, useGetIntegrationAccountsQuery, useAddIntegrationAccountMutation, useUpdateIntegrationAccountMutation, useDeleteIntegrationAccountMutation, useDeleteIntegrationAccountCascadeMutation, } = IntegrationAccountService;
