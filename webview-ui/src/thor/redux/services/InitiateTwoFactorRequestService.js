    ...
    endpoints: (build) => ({
        ...
        updateInitiateTwoFactorRequest: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(InitiateTwoFactorRequestService.util.updateQueryData("getInitiateTwoFactorRequest", id, (draft) => {
...
export const { useGetInitiateTwoFactorRequestsPagedQuery, // immediate fetch
useLazyGetInitiateTwoFactorRequestsPagedQuery, // lazy fetch
useGetInitiateTwoFactorRequestQuery, useGetInitiateTwoFactorRequestsQuery, useAddInitiateTwoFactorRequestMutation, useUpdateInitiateTwoFactorRequestMutation, useDeleteInitiateTwoFactorRequestMutation, useDeleteInitiateTwoFactorRequestCascadeMutation, } = InitiateTwoFactorRequestService;
