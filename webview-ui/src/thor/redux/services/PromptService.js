    ...
    endpoints: (build) => ({
        ...
        updatePrompt: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(PromptService.util.updateQueryData("getPrompt", id, (draft) => {
...
export const { useGetPromptsPagedQuery, // immediate fetch
useLazyGetPromptsPagedQuery, // lazy fetch
useGetPromptQuery, useGetPromptsQuery, useAddPromptMutation, useUpdatePromptMutation, useDeletePromptMutation, } = PromptService;
