...
export const LegalPrecedentService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getLegalPrecedentsPaged: build.query<
      LegalPrecedentResponse,
      { page: number; size?: number; example?: Partial<LegalPrecedent> }
    >({
    ...
    getLegalPrecedents: build.query<
      LegalPrecedentResponse,
      { example?: Partial<LegalPrecedent> } | void
    >({
      query: (arg) => {
    ...
    updateLegalPrecedent: build.mutation<
      void,
      Pick<LegalPrecedent, "id"> & Partial<LegalPrecedent>
    >({
      query: ({ id, ...patch }) => ({
      ...
      invalidatesTags: (result, error, { id }: Pick<LegalPrecedent, "id">) => [
