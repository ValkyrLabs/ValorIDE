    ...
    endpoints: (build) => ({
        ...
        updateSkillProfile: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(SkillProfileService.util.updateQueryData("getSkillProfile", id, (draft) => {
...
export const { useGetSkillProfilesPagedQuery, // immediate fetch
useLazyGetSkillProfilesPagedQuery, // lazy fetch
useGetSkillProfileQuery, useGetSkillProfilesQuery, useAddSkillProfileMutation, useUpdateSkillProfileMutation, useDeleteSkillProfileMutation, } = SkillProfileService;
