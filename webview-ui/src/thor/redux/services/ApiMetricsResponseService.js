    ...
    endpoints: (build) => ({
        ...
        getApiMetricsResponsesPaged: build.query({
            ...
            providesTags: (result, error, { page }) => result
                ? [
                    ...result.map(({ id }) => ({ type: 'ApiMetricsResponse', id })),
...
useGetApiMetricsResponseQuery, useGetApiMetricsResponsesQuery, useAddApiMetricsResponseMutation, useUpdateApiMetricsResponseMutation, useDeleteApiMetricsResponseMutation, } = ApiMetricsResponseService;
