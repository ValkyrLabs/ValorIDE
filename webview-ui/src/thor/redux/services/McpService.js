    ...
    endpoints: (build) => ({
        ...
        updateMcp: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(McpService.util.updateQueryData('getMcp', id, (draft) => {
...
export const { useGetMcpsPagedQuery, // immediate fetch
useLazyGetMcpsPagedQuery, // lazy fetch
useGetMcpQuery, useGetMcpsQuery, useAddMcpMutation, useUpdateMcpMutation, useDeleteMcpMutation, } = McpService;
