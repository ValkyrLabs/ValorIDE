...
export const PrincipalRolesService = createApi({
    ...
    endpoints: (build) => ({
        ...
        deletePrincipalRolesCascade: build.mutation({
...
useGetPrincipalRolesQuery, useGetPrincipalRolessQuery, useAddPrincipalRolesMutation, useUpdatePrincipalRolesMutation, useDeletePrincipalRolesMutation, useDeletePrincipalRolesCascadeMutation, } = PrincipalRolesService;
