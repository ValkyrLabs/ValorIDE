...
export const McpTransportConfigService = createApi({
    ...
    endpoints: (build) => ({
        ...
        // 4) Get single by ID
        getMcpTransportConfig: build.query({
        ...
        updateMcpTransportConfig: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(McpTransportConfigService.util.updateQueryData("getMcpTransportConfig", id, (draft) => {
...
export const { useGetMcpTransportConfigsPagedQuery, // immediate fetch
useLazyGetMcpTransportConfigsPagedQuery, // lazy fetch
useGetMcpTransportConfigQuery, useGetMcpTransportConfigsQuery, useAddMcpTransportConfigMutation, useUpdateMcpTransportConfigMutation, useDeleteMcpTransportConfigMutation, } = McpTransportConfigService;
//# sourceMappingURL=McpTransportConfigService.js.map