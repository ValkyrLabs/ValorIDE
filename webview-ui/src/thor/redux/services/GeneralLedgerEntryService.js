    ...
    endpoints: (build) => ({
        ...
        getGeneralLedgerEntrysPaged: build.query({
            ...
            providesTags: (result, error, { page }) => result
                ? [
                    ...result.map(({ id }) => ({ type: 'GeneralLedgerEntry', id })),
        ...
        // 4) Get single by ID
        getGeneralLedgerEntry: build.query({
        ...
        updateGeneralLedgerEntry: build.mutation({
            ...
            async onQueryStarted({ id, ...patch }, { dispatch, queryFulfilled }) {
                if (id) {
                    const patchResult = dispatch(GeneralLedgerEntryService.util.updateQueryData('getGeneralLedgerEntry', id, (draft) => {
...
export const { useGetGeneralLedgerEntrysPagedQuery, // immediate fetch
useLazyGetGeneralLedgerEntrysPagedQuery, // lazy fetch
useGetGeneralLedgerEntryQuery, useGetGeneralLedgerEntrysQuery, useAddGeneralLedgerEntryMutation, useUpdateGeneralLedgerEntryMutation, useDeleteGeneralLedgerEntryMutation, } = GeneralLedgerEntryService;
//# sourceMappingURL=GeneralLedgerEntryService.js.map