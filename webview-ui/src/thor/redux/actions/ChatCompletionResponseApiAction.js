...
export const fetchChatCompletionResponseSuccess = (ChatCompletionResponses) => ({
...
export const updateChatCompletionResponseRequest = (ChatCompletionResponse) => ({
    type: UPDATE_CHATCOMPLETIONRESPONSE_REQUEST,
    payload: ChatCompletionResponse,
});
export const updateChatCompletionResponseSuccess = (ChatCompletionResponse) => ({
...
export const deleteChatCompletionResponseRequest = (ChatCompletionResponse) => ({
    type: DELETE_CHATCOMPLETIONRESPONSE_REQUEST,
    payload: ChatCompletionResponse,
});
export const deleteChatCompletionResponseSuccess = (ChatCompletionResponse) => ({
