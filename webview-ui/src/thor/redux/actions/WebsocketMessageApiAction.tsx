...
export const UPDATE_WEBSOCKETMESSAGE_REQUEST =
  "UPDATE_WEBSOCKETMESSAGE_REQUEST";
export const UPDATE_WEBSOCKETMESSAGE_SUCCESS =
  "UPDATE_WEBSOCKETMESSAGE_SUCCESS";
export const UPDATE_WEBSOCKETMESSAGE_FAILURE =
  "UPDATE_WEBSOCKETMESSAGE_FAILURE";

export const DELETE_WEBSOCKETMESSAGE_REQUEST =
  "DELETE_WEBSOCKETMESSAGE_REQUEST";
export const DELETE_WEBSOCKETMESSAGE_SUCCESS =
  "DELETE_WEBSOCKETMESSAGE_SUCCESS";
export const DELETE_WEBSOCKETMESSAGE_FAILURE =
  "DELETE_WEBSOCKETMESSAGE_FAILURE";
