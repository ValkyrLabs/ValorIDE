...
export const FETCH_MCPMARKETPLACEITEM_REQUEST =
  "FETCH_MCPMARKETPLACEITEM_REQUEST";
export const FETCH_MCPMARKETPLACEITEM_SUCCESS =
  "FETCH_MCPMARKETPLACEITEM_SUCCESS";
export const FETCH_MCPMARKETPLACEITEM_FAILURE =
  "FETCH_MCPMARKETPLACEITEM_FAILURE";
...
export const UPDATE_MCPMARKETPLACEITEM_REQUEST =
  "UPDATE_MCPMARKETPLACEITEM_REQUEST";
export const UPDATE_MCPMARKETPLACEITEM_SUCCESS =
  "UPDATE_MCPMARKETPLACEITEM_SUCCESS";
export const UPDATE_MCPMARKETPLACEITEM_FAILURE =
  "UPDATE_MCPMARKETPLACEITEM_FAILURE";

export const DELETE_MCPMARKETPLACEITEM_REQUEST =
  "DELETE_MCPMARKETPLACEITEM_REQUEST";
export const DELETE_MCPMARKETPLACEITEM_SUCCESS =
  "DELETE_MCPMARKETPLACEITEM_SUCCESS";
export const DELETE_MCPMARKETPLACEITEM_FAILURE =
  "DELETE_MCPMARKETPLACEITEM_FAILURE";

export const LIST_MCPMARKETPLACEITEM_REQUEST =
  "LIST_MCPMARKETPLACEITEM_REQUEST";
export const LIST_MCPMARKETPLACEITEM_SUCCESS =
  "LIST_MCPMARKETPLACEITEM_SUCCESS";
export const LIST_MCPMARKETPLACEITEM_FAILURE =
  "LIST_MCPMARKETPLACEITEM_FAILURE";
