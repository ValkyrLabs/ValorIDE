...
export const FETCH_MCPRESOURCETEMPLATE_REQUEST =
  "FETCH_MCPRESOURCETEMPLATE_REQUEST";
export const FETCH_MCPRESOURCETEMPLATE_SUCCESS =
  "FETCH_MCPRESOURCETEMPLATE_SUCCESS";
export const FETCH_MCPRESOURCETEMPLATE_FAILURE =
  "FETCH_MCPRESOURCETEMPLATE_FAILURE";

export const ADD_MCPRESOURCETEMPLATE_REQUEST =
  "ADD_MCPRESOURCETEMPLATE_REQUEST";
export const ADD_MCPRESOURCETEMPLATE_SUCCESS =
  "ADD_MCPRESOURCETEMPLATE_SUCCESS";
export const ADD_MCPRESOURCETEMPLATE_FAILURE =
  "ADD_MCPRESOURCETEMPLATE_FAILURE";

export const UPDATE_MCPRESOURCETEMPLATE_REQUEST =
  "UPDATE_MCPRESOURCETEMPLATE_REQUEST";
export const UPDATE_MCPRESOURCETEMPLATE_SUCCESS =
  "UPDATE_MCPRESOURCETEMPLATE_SUCCESS";
export const UPDATE_MCPRESOURCETEMPLATE_FAILURE =
  "UPDATE_MCPRESOURCETEMPLATE_FAILURE";

export const DELETE_MCPRESOURCETEMPLATE_REQUEST =
  "DELETE_MCPRESOURCETEMPLATE_REQUEST";
export const DELETE_MCPRESOURCETEMPLATE_SUCCESS =
  "DELETE_MCPRESOURCETEMPLATE_SUCCESS";
export const DELETE_MCPRESOURCETEMPLATE_FAILURE =
  "DELETE_MCPRESOURCETEMPLATE_FAILURE";

export const LIST_MCPRESOURCETEMPLATE_REQUEST =
  "LIST_MCPRESOURCETEMPLATE_REQUEST";
export const LIST_MCPRESOURCETEMPLATE_SUCCESS =
  "LIST_MCPRESOURCETEMPLATE_SUCCESS";
export const LIST_MCPRESOURCETEMPLATE_FAILURE =
  "LIST_MCPRESOURCETEMPLATE_FAILURE";
