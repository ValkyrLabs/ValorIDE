	...
	reducers: {
		...
		McpMarketplaceItemValueToggled(state, action) {
			...
			const McpMarketplaceItem: McpMarketplaceItem = state.find(
				(McpMarketplaceItem) => McpMarketplaceItem.id === action.payload.McpMarketplaceItemId,
			)
...
export const { McpMarketplaceItemAdded, McpMarketplaceItemValueToggled, McpMarketplaceItempropertySet } =
