	...
	reducers: {
		...
		McpMarketplaceItemTagValueToggled(state, action) {
			...
			const McpMarketplaceItemTag: McpMarketplaceItemTag = state.find(
				(McpMarketplaceItemTag) => McpMarketplaceItemTag.id === action.payload.McpMarketplaceItemTagId,
			)
...
export const { McpMarketplaceItemTagAdded, McpMarketplaceItemTagValueToggled, McpMarketplaceItemTagpropertySet } =
