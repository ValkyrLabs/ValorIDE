	...
	reducers: {
		...
		IntegrationAccountValueToggled(state, action) {
			...
			const IntegrationAccount: IntegrationAccount = state.find(
				(IntegrationAccount) => IntegrationAccount.id === action.payload.IntegrationAccountId,
			)
...
export const { IntegrationAccountAdded, IntegrationAccountValueToggled, IntegrationAccountpropertySet } =
