	...
	reducers: {
		...
		McpToolCallResponseValueToggled(state, action) {
			...
			const McpToolCallResponse: McpToolCallResponse = state.find(
				(McpToolCallResponse) => McpToolCallResponse.id === action.payload.McpToolCallResponseId,
			)
...
export const { McpToolCallResponseAdded, McpToolCallResponseValueToggled, McpToolCallResponsepropertySet } =
