	...
	reducers: {
		...
		OasSecuritySchemeValueToggled(state, action) {
			...
			const OasSecurityScheme: OasSecurityScheme = state.find(
				(OasSecurityScheme) => OasSecurityScheme.id === action.payload.OasSecuritySchemeId,
			)
...
export const { OasSecuritySchemeAdded, OasSecuritySchemeValueToggled, OasSecuritySchemepropertySet } =
