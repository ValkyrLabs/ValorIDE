...
const PromptRatingSlice = createSlice({
    ...
    reducers: {
        ...
        PromptRatingValueToggled(state, action) {
            ...
            const PromptRating = state.find((PromptRating) => PromptRating.id === action.payload.PromptRatingId);
            if (PromptRating) {
...
export const { PromptRatingAdded, PromptRatingValueToggled, PromptRatingpropertySet, } = PromptRatingSlice.actions;
export default PromptRatingSlice.reducer;
//# sourceMappingURL=PromptRatingReducer.js.map