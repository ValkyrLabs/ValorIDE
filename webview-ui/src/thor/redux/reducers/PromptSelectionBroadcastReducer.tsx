...
const PromptSelectionBroadcastSlice = createSlice({
  ...
  reducers: {
    ...
    PromptSelectionBroadcastValueToggled(state, action) {
      ...
      const PromptSelectionBroadcast: PromptSelectionBroadcast = state.find(
        (PromptSelectionBroadcast) =>
          PromptSelectionBroadcast.id ===
    ...
    PromptSelectionBroadcastpropertySet(state, action) {
      const PromptSelectionBroadcast = state.find(
        (PromptSelectionBroadcast) =>
          PromptSelectionBroadcast.id ===
          action.payload.PromptSelectionBroadcastId,
      );
...
export const {
  PromptSelectionBroadcastAdded,
  PromptSelectionBroadcastValueToggled,
  PromptSelectionBroadcastpropertySet,
} = PromptSelectionBroadcastSlice.actions;
