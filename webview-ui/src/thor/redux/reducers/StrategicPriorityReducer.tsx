	...
	reducers: {
		...
		StrategicPriorityValueToggled(state, action) {
			...
			const StrategicPriority: StrategicPriority = state.find(
				(StrategicPriority) => StrategicPriority.id === action.payload.StrategicPriorityId,
			)
...
export const { StrategicPriorityAdded, StrategicPriorityValueToggled, StrategicPrioritypropertySet } =
