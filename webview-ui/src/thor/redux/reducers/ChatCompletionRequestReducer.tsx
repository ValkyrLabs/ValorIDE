	...
	reducers: {
		...
		ChatCompletionRequestValueToggled(state, action) {
			...
			const ChatCompletionRequest: ChatCompletionRequest = state.find(
				(ChatCompletionRequest) => ChatCompletionRequest.id === action.payload.ChatCompletionRequestId,
			)
...
export const { ChatCompletionRequestAdded, ChatCompletionRequestValueToggled, ChatCompletionRequestpropertySet } =
