	...
	reducers: {
		...
		ChatCompletionResponseValueToggled(state, action) {
			...
			const ChatCompletionResponse: ChatCompletionResponse = state.find(
				(ChatCompletionResponse) => ChatCompletionResponse.id === action.payload.ChatCompletionResponseId,
			)
...
export const { ChatCompletionResponseAdded, ChatCompletionResponseValueToggled, ChatCompletionResponsepropertySet } =
