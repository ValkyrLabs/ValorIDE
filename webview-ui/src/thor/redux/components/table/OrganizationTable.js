    ...
    children: [
      ...
      _jsxs(Modal, {
        ...
        children: [
          _jsx(Modal.Header, {
            closeButton: true,
            children: _jsx(Modal.Title, { children: "Create Organization" }),
          }),
          _jsx(Modal.Body, { children: _jsx(OrganizationForm, {}) }),
        ],
      }),
      _jsxs(Modal, {
        show: showQbeModal,
        ...
        children: [
          _jsx(Modal.Header, {
            ...
            children: _jsx(Modal.Title, {
              children: "Filter Organization (Query By Example)",
            }),
          }),
          _jsxs(Modal.Body, {
            children: [
      ...
      _jsxs(Modal, {
        ...
        children: [
          _jsx(Modal.Header, {
            closeButton: true,
            children: _jsx(Modal.Title, { children: "Editing Organization" }),
          }),
          _jsxs(Modal.Body, {
            children: [
      ...
      isError &&
        _jsxs("div", {
          ...
          children: ["Error fetching page ", page, " of Organizations."],
        }),
      _jsx(QBEPicker, {
        show: qbePicker.show,
