...
import { useLazyGetMcpToolCallResponsesPagedQuery, useAddMcpToolCallResponseMutation, useUpdateMcpToolCallResponseMutation, useDeleteMcpToolCallResponseMutation, useDeleteMcpToolCallResponseCascadeMutation, } from "@thor/redux/services/McpToolCallResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteMcpToolCallResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateMcpToolCallResponse(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update McpToolCallResponse";
            console.error("Failed to update McpToolCallResponse:", error);
