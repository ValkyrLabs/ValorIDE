...
import { useLazyGetIntegrationAccountsPagedQuery, useAddIntegrationAccountMutation, useUpdateIntegrationAccountMutation, useDeleteIntegrationAccountMutation, useDeleteIntegrationAccountCascadeMutation, } from "@thor/redux/services/IntegrationAccountService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteIntegrationAccountCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateIntegrationAccount(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update IntegrationAccount";
            console.error("Failed to update IntegrationAccount:", error);
