...
import { useLazyGetActivateAgent200ResponsesPagedQuery, useAddActivateAgent200ResponseMutation, useUpdateActivateAgent200ResponseMutation, useDeleteActivateAgent200ResponseMutation, useDeleteActivateAgent200ResponseCascadeMutation, } from "@thor/redux/services/ActivateAgent200ResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteActivateAgent200ResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateActivateAgent200Response(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update ActivateAgent200Response";
            console.error("Failed to update ActivateAgent200Response:", error);
