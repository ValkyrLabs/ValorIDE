...
const PublishFunnel200ResponseTable: React.FC = () => {
  ...
  // -------------------------------------------------------------------
  const [addPublishFunnel200Response] =
    useAddPublishFunnel200ResponseMutation();
  const [updatePublishFunnel200Response] =
    useUpdatePublishFunnel200ResponseMutation();
  const [deletePublishFunnel200Response] =
    useDeletePublishFunnel200ResponseMutation();
  ...
  const [copiedRow, setCopiedRow] = useState<PublishFunnel200Response | null>(
    null,
  );
  ...
  const handlePasteRow = async () => {
    ...
    try {
      ...
      console.error(
        "Failed to paste (create) PublishFunnel200Response:",
        error,
      );
    ...
    <>
      <div className="tableContainer">
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>
              Filter PublishFunnel200Response (Query By Example)
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <p>
