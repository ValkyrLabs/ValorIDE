...
import { useLazyGetGoalDependencysPagedQuery, useAddGoalDependencyMutation, useUpdateGoalDependencyMutation, useDeleteGoalDependencyMutation, useDeleteGoalDependencyCascadeMutation, } from "@thor/redux/services/GoalDependencyService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteGoalDependencyCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update GoalDependency";
            console.error("Failed to update GoalDependency:", error);
