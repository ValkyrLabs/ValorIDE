...
import { useLazyGetConversationBranchsPagedQuery, useAddConversationBranchMutation, useUpdateConversationBranchMutation, useDeleteConversationBranchMutation, useDeleteConversationBranchCascadeMutation, } from "@thor/redux/services/ConversationBranchService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteConversationBranchCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateConversationBranch(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update ConversationBranch";
            console.error("Failed to update ConversationBranch:", error);
