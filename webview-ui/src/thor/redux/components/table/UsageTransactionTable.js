...
import { useLazyGetUsageTransactionsPagedQuery, useAddUsageTransactionMutation, useUpdateUsageTransactionMutation, useDeleteUsageTransactionMutation, useDeleteUsageTransactionCascadeMutation, } from "@thor/redux/services/UsageTransactionService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteUsageTransactionCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateUsageTransaction(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update UsageTransaction";
            console.error("Failed to update UsageTransaction:", error);
