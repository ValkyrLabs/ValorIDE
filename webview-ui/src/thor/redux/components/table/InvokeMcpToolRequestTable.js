...
import { useLazyGetInvokeMcpToolRequestsPagedQuery, useAddInvokeMcpToolRequestMutation, useUpdateInvokeMcpToolRequestMutation, useDeleteInvokeMcpToolRequestMutation, useDeleteInvokeMcpToolRequestCascadeMutation, } from "@thor/redux/services/InvokeMcpToolRequestService";
...
const InvokeMcpToolRequestTable = () => {
    ...
    const [deleteInvokeMcpToolRequestCascade] = useDeleteInvokeMcpToolRequestCascadeMutation();
    // -------------------------------------------------------------------
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteInvokeMcpToolRequestCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update InvokeMcpToolRequest";
            console.error("Failed to update InvokeMcpToolRequest:", error);
