...
import { useLazyGetSwarmSecuritysPagedQuery, useAddSwarmSecurityMutation, useUpdateSwarmSecurityMutation, useDeleteSwarmSecurityMutation, useDeleteSwarmSecurityCascadeMutation, } from "@thor/redux/services/SwarmSecurityService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSwarmSecurityCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update SwarmSecurity";
            console.error("Failed to update SwarmSecurity:", error);
