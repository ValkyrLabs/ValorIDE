...
import { useLazyGetOasResponsesPagedQuery, useAddOasResponseMutation, useUpdateOasResponseMutation, useDeleteOasResponseMutation, useDeleteOasResponseCascadeMutation, } from "@thor/redux/services/OasResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteOasResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
