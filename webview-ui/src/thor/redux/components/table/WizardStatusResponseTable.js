...
import { useLazyGetWizardStatusResponsesPagedQuery, useAddWizardStatusResponseMutation, useUpdateWizardStatusResponseMutation, useDeleteWizardStatusResponseMutation, useDeleteWizardStatusResponseCascadeMutation, } from "@thor/redux/services/WizardStatusResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteWizardStatusResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateWizardStatusResponse(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update WizardStatusResponse";
            console.error("Failed to update WizardStatusResponse:", error);
