...
import { useLazyGetStacksPagedQuery, useAddStackMutation, useUpdateStackMutation, useDeleteStackMutation, useDeleteStackCascadeMutation, } from "@thor/redux/services/StackService";
...
const StackTable = () => {
    ...
    const [deleteStackCascade] = useDeleteStackCascadeMutation();
    // -------------------------------------------------------------------
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error ? error.message : "Failed to update Stack";
            console.error("Failed to update Stack:", error);
