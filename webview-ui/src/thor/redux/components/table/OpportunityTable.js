...
import { useLazyGetOpportunitysPagedQuery, useAddOpportunityMutation, useUpdateOpportunityMutation, useDeleteOpportunityMutation, useDeleteOpportunityCascadeMutation, } from "@thor/redux/services/OpportunityService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteOpportunityCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
