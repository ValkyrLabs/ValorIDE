...
import { useLazyGetSwarmUnregisterRequestsPagedQuery, useAddSwarmUnregisterRequestMutation, useUpdateSwarmUnregisterRequestMutation, useDeleteSwarmUnregisterRequestMutation, useDeleteSwarmUnregisterRequestCascadeMutation, } from "@thor/redux/services/SwarmUnregisterRequestService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSwarmUnregisterRequestCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateSwarmUnregisterRequest(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update SwarmUnregisterRequest";
            console.error("Failed to update SwarmUnregisterRequest:", error);
