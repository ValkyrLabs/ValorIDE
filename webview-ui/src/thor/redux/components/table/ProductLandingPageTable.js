...
import { useLazyGetProductLandingPagesPagedQuery, useAddProductLandingPageMutation, useUpdateProductLandingPageMutation, useDeleteProductLandingPageMutation, useDeleteProductLandingPageCascadeMutation, } from "@thor/redux/services/ProductLandingPageService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteProductLandingPageCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateProductLandingPage(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update ProductLandingPage";
            console.error("Failed to update ProductLandingPage:", error);
