...
import { useLazyGetSalesPipelinesPagedQuery, useAddSalesPipelineMutation, useUpdateSalesPipelineMutation, useDeleteSalesPipelineMutation, useDeleteSalesPipelineCascadeMutation, } from "@thor/redux/services/SalesPipelineService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSalesPipelineCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update SalesPipeline";
            console.error("Failed to update SalesPipeline:", error);
