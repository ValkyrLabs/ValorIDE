...
const DiscardDeadLetterEntryRequestTable: React.FC = () => {
  ...
  // -------------------------------------------------------------------
  const [addDiscardDeadLetterEntryRequest] =
    useAddDiscardDeadLetterEntryRequestMutation();
  const [updateDiscardDeadLetterEntryRequest] =
    useUpdateDiscardDeadLetterEntryRequestMutation();
  const [deleteDiscardDeadLetterEntryRequest] =
    useDeleteDiscardDeadLetterEntryRequestMutation();
  ...
  const [copiedRow, setCopiedRow] =
    useState<DiscardDeadLetterEntryRequest | null>(null);
  ...
  const handlePasteRow = async () => {
    ...
    try {
      ...
      console.error(
        "Failed to paste (create) DiscardDeadLetterEntryRequest:",
        error,
      );
    ...
    <>
      <div className="tableContainer">
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>
              Filter DiscardDeadLetterEntryRequest (Query By Example)
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <p>
        ...
        <MarkdownEditorModal
          ...
          onSave={async (updatedText) => {
            try {
              ...
              const field =
                richModal.field as keyof DiscardDeadLetterEntryRequest;
              if (!rid || !field) {
