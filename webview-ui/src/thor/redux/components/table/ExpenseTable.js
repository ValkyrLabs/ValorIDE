    ...
    children: [
      ...
      _jsxs(Modal, {
        ...
        children: [
          _jsx(Modal.Header, {
            closeButton: true,
            children: _jsx(Modal.Title, { children: "Create Expense" }),
          }),
          _jsx(Modal.Body, { children: _jsx(ExpenseForm, {}) }),
        ],
      }),
      _jsxs(Modal, {
        show: showQbeModal,
        ...
        children: [
          _jsx(Modal.Header, {
            ...
            children: _jsx(Modal.Title, {
              children: "Filter Expense (Query By Example)",
            }),
          }),
          _jsxs(Modal.Body, {
            children: [
      ...
      _jsxs(Modal, {
        ...
        children: [
          _jsx(Modal.Header, {
            closeButton: true,
            children: _jsx(Modal.Title, { children: "Editing Expense" }),
          }),
          _jsxs(Modal.Body, {
            children: [
      ...
      isError &&
        _jsxs("div", {
          ...
          children: ["Error fetching page ", page, " of Expenses."],
        }),
      _jsx(QBEPicker, {
        show: qbePicker.show,
