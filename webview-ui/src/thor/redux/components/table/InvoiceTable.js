...
import { useLazyGetInvoicesPagedQuery, useAddInvoiceMutation, useUpdateInvoiceMutation, useDeleteInvoiceMutation, useDeleteInvoiceCascadeMutation, } from "@thor/redux/services/InvoiceService";
...
const InvoiceTable = () => {
    ...
    const [deleteInvoiceCascade] = useDeleteInvoiceCascadeMutation();
    // -------------------------------------------------------------------
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error ? error.message : "Failed to update Invoice";
            console.error("Failed to update Invoice:", error);
