...
import { useLazyGetRetryPolicysPagedQuery, useAddRetryPolicyMutation, useUpdateRetryPolicyMutation, useDeleteRetryPolicyMutation, useDeleteRetryPolicyCascadeMutation, } from "@thor/redux/services/RetryPolicyService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteRetryPolicyCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
