...
import { useLazyGetOasRequiredsPagedQuery, useAddOasRequiredMutation, useUpdateOasRequiredMutation, useDeleteOasRequiredMutation, useDeleteOasRequiredCascadeMutation, } from "@thor/redux/services/OasRequiredService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteOasRequiredCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
