...
import { useLazyGetChatResponsesPagedQuery, useAddChatResponseMutation, useUpdateChatResponseMutation, useDeleteChatResponseMutation, useDeleteChatResponseCascadeMutation, } from "@thor/redux/services/ChatResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteChatResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
