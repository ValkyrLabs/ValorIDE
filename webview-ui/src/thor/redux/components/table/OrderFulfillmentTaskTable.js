...
import { useLazyGetOrderFulfillmentTasksPagedQuery, useAddOrderFulfillmentTaskMutation, useUpdateOrderFulfillmentTaskMutation, useDeleteOrderFulfillmentTaskMutation, useDeleteOrderFulfillmentTaskCascadeMutation, } from "@thor/redux/services/OrderFulfillmentTaskService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteOrderFulfillmentTaskCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateOrderFulfillmentTask(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update OrderFulfillmentTask";
            console.error("Failed to update OrderFulfillmentTask:", error);
