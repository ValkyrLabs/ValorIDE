...
import { useLazyGetSwarmGraphSnapshotsPagedQuery, useAddSwarmGraphSnapshotMutation, useUpdateSwarmGraphSnapshotMutation, useDeleteSwarmGraphSnapshotMutation, useDeleteSwarmGraphSnapshotCascadeMutation, } from "@thor/redux/services/SwarmGraphSnapshotService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSwarmGraphSnapshotCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateSwarmGraphSnapshot(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update SwarmGraphSnapshot";
            console.error("Failed to update SwarmGraphSnapshot:", error);
