...
import { useLazyGetMcpTransportConfigsPagedQuery, useAddMcpTransportConfigMutation, useUpdateMcpTransportConfigMutation, useDeleteMcpTransportConfigMutation, useDeleteMcpTransportConfigCascadeMutation, } from "@thor/redux/services/McpTransportConfigService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteMcpTransportConfigCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateMcpTransportConfig(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update McpTransportConfig";
            console.error("Failed to update McpTransportConfig:", error);
