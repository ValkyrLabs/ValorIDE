...
import { useLazyGetLegalPrecedentsPagedQuery, useAddLegalPrecedentMutation, useUpdateLegalPrecedentMutation, useDeleteLegalPrecedentMutation, useDeleteLegalPrecedentCascadeMutation, } from "@thor/redux/services/LegalPrecedentService";
...
const LegalPrecedentTable = () => {
    ...
    const [deleteLegalPrecedentCascade] = useDeleteLegalPrecedentCascadeMutation();
    // -------------------------------------------------------------------
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteLegalPrecedentCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update LegalPrecedent";
            console.error("Failed to update LegalPrecedent:", error);
