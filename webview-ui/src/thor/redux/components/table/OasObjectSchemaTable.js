...
import { useLazyGetOasObjectSchemasPagedQuery, useAddOasObjectSchemaMutation, useUpdateOasObjectSchemaMutation, useDeleteOasObjectSchemaMutation, useDeleteOasObjectSchemaCascadeMutation, } from "@thor/redux/services/OasObjectSchemaService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteOasObjectSchemaCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update OasObjectSchema";
            console.error("Failed to update OasObjectSchema:", error);
