...
import { useLazyGetReferralLinksPagedQuery, useAddReferralLinkMutation, useUpdateReferralLinkMutation, useDeleteReferralLinkMutation, useDeleteReferralLinkCascadeMutation, } from "@thor/redux/services/ReferralLinkService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteReferralLinkCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
