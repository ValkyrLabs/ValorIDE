...
import { useLazyGetProductFeaturesPagedQuery, useAddProductFeatureMutation, useUpdateProductFeatureMutation, useDeleteProductFeatureMutation, useDeleteProductFeatureCascadeMutation, } from "@thor/redux/services/ProductFeatureService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteProductFeatureCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
