...
const SwarmUnregisterRequestTable: React.FC = () => {
  ...
  const [updateSwarmUnregisterRequest] =
    useUpdateSwarmUnregisterRequestMutation();
  const [deleteSwarmUnregisterRequest] =
    useDeleteSwarmUnregisterRequestMutation();
  ...
  const [copiedRow, setCopiedRow] = useState<SwarmUnregisterRequest | null>(
    null,
  );
    ...
    <>
      <div className="tableContainer">
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>
              Filter SwarmUnregisterRequest (Query By Example)
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <p>
