...
import { useLazyGetProductFunnelWizardsPagedQuery, useAddProductFunnelWizardMutation, useUpdateProductFunnelWizardMutation, useDeleteProductFunnelWizardMutation, useDeleteProductFunnelWizardCascadeMutation, } from "@thor/redux/services/ProductFunnelWizardService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteProductFunnelWizardCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateProductFunnelWizard(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update ProductFunnelWizard";
            console.error("Failed to update ProductFunnelWizard:", error);
