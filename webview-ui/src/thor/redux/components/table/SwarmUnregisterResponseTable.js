...
import { useLazyGetSwarmUnregisterResponsesPagedQuery, useAddSwarmUnregisterResponseMutation, useUpdateSwarmUnregisterResponseMutation, useDeleteSwarmUnregisterResponseMutation, useDeleteSwarmUnregisterResponseCascadeMutation, } from "@thor/redux/services/SwarmUnregisterResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSwarmUnregisterResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateSwarmUnregisterResponse(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update SwarmUnregisterResponse";
            console.error("Failed to update SwarmUnregisterResponse:", error);
