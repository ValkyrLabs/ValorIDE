...
import { useLazyGetCompleteUploadRequestPartsInnersPagedQuery, useAddCompleteUploadRequestPartsInnerMutation, useUpdateCompleteUploadRequestPartsInnerMutation, useDeleteCompleteUploadRequestPartsInnerMutation, useDeleteCompleteUploadRequestPartsInnerCascadeMutation, } from "@thor/redux/services/CompleteUploadRequestPartsInnerService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteCompleteUploadRequestPartsInnerCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateCompleteUploadRequestPartsInner(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update CompleteUploadRequestPartsInner";
            console.error("Failed to update CompleteUploadRequestPartsInner:", error);
