...
import { useLazyGetFileProcessingJobsPagedQuery, useAddFileProcessingJobMutation, useUpdateFileProcessingJobMutation, useDeleteFileProcessingJobMutation, useDeleteFileProcessingJobCascadeMutation, } from "@thor/redux/services/FileProcessingJobService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteFileProcessingJobCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateFileProcessingJob(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update FileProcessingJob";
            console.error("Failed to update FileProcessingJob:", error);
