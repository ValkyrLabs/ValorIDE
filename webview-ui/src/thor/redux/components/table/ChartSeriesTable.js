...
import { useLazyGetChartSeriessPagedQuery, useAddChartSeriesMutation, useUpdateChartSeriesMutation, useDeleteChartSeriesMutation, useDeleteChartSeriesCascadeMutation, } from "@thor/redux/services/ChartSeriesService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteChartSeriesCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
