...
import { useLazyGetGeneralLedgerEntrysPagedQuery, useAddGeneralLedgerEntryMutation, useUpdateGeneralLedgerEntryMutation, useDeleteGeneralLedgerEntryMutation, useDeleteGeneralLedgerEntryCascadeMutation, } from "@thor/redux/services/GeneralLedgerEntryService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteGeneralLedgerEntryCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateGeneralLedgerEntry(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update GeneralLedgerEntry";
            console.error("Failed to update GeneralLedgerEntry:", error);
