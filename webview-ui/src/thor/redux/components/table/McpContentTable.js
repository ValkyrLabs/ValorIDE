...
import { useLazyGetMcpContentsPagedQuery, useAddMcpContentMutation, useUpdateMcpContentMutation, useDeleteMcpContentMutation, useDeleteMcpContentCascadeMutation, } from "@thor/redux/services/McpContentService";
...
const McpContentTable = () => {
    ...
    const [deleteMcpContentCascade] = useDeleteMcpContentCascadeMutation();
    // -------------------------------------------------------------------
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error ? error.message : "Failed to update McpContent";
            console.error("Failed to update McpContent:", error);
