...
import { useLazyGetContentMediaLinksPagedQuery, useAddContentMediaLinkMutation, useUpdateContentMediaLinkMutation, useDeleteContentMediaLinkMutation, useDeleteContentMediaLinkCascadeMutation, } from "@thor/redux/services/ContentMediaLinkService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteContentMediaLinkCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateContentMediaLink(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update ContentMediaLink";
            console.error("Failed to update ContentMediaLink:", error);
