...
import { useLazyGetSwarmMessagesPagedQuery, useAddSwarmMessageMutation, useUpdateSwarmMessageMutation, useDeleteSwarmMessageMutation, useDeleteSwarmMessageCascadeMutation, } from "@thor/redux/services/SwarmMessageService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSwarmMessageCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
