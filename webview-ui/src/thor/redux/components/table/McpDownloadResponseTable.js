...
import { useLazyGetMcpDownloadResponsesPagedQuery, useAddMcpDownloadResponseMutation, useUpdateMcpDownloadResponseMutation, useDeleteMcpDownloadResponseMutation, useDeleteMcpDownloadResponseCascadeMutation, } from "@thor/redux/services/McpDownloadResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteMcpDownloadResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateMcpDownloadResponse(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update McpDownloadResponse";
            console.error("Failed to update McpDownloadResponse:", error);
