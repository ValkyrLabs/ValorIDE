...
import { useLazyGetSwarmPayloadsPagedQuery, useAddSwarmPayloadMutation, useUpdateSwarmPayloadMutation, useDeleteSwarmPayloadMutation, useDeleteSwarmPayloadCascadeMutation, } from "@thor/redux/services/SwarmPayloadService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSwarmPayloadCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
