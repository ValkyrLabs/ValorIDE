...
import { useLazyGetPublishFunnel200ResponsesPagedQuery, useAddPublishFunnel200ResponseMutation, useUpdatePublishFunnel200ResponseMutation, useDeletePublishFunnel200ResponseMutation, useDeletePublishFunnel200ResponseCascadeMutation, } from "@thor/redux/services/PublishFunnel200ResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deletePublishFunnel200ResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updatePublishFunnel200Response(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update PublishFunnel200Response";
            console.error("Failed to update PublishFunnel200Response:", error);
