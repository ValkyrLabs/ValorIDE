...
import { useLazyGetWizardStartResponsesPagedQuery, useAddWizardStartResponseMutation, useUpdateWizardStartResponseMutation, useDeleteWizardStartResponseMutation, useDeleteWizardStartResponseCascadeMutation, } from "@thor/redux/services/WizardStartResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteWizardStartResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateWizardStartResponse(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update WizardStartResponse";
            console.error("Failed to update WizardStartResponse:", error);
