...
import { useLazyGetPublishWorkflowRequestsPagedQuery, useAddPublishWorkflowRequestMutation, useUpdatePublishWorkflowRequestMutation, useDeletePublishWorkflowRequestMutation, useDeletePublishWorkflowRequestCascadeMutation, } from "@thor/redux/services/PublishWorkflowRequestService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deletePublishWorkflowRequestCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updatePublishWorkflowRequest(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update PublishWorkflowRequest";
            console.error("Failed to update PublishWorkflowRequest:", error);
