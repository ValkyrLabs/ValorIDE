...
import { useLazyGetConsultingProfilesPagedQuery, useAddConsultingProfileMutation, useUpdateConsultingProfileMutation, useDeleteConsultingProfileMutation, useDeleteConsultingProfileCascadeMutation, } from "@thor/redux/services/ConsultingProfileService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteConsultingProfileCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateConsultingProfile(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update ConsultingProfile";
            console.error("Failed to update ConsultingProfile:", error);
