...
import { useLazyGetValkyrJobsPagedQuery, useAddValkyrJobMutation, useUpdateValkyrJobMutation, useDeleteValkyrJobMutation, useDeleteValkyrJobCascadeMutation, } from "@thor/redux/services/ValkyrJobService";
...
const ValkyrJobTable = () => {
    ...
    const [deleteValkyrJobCascade] = useDeleteValkyrJobCascadeMutation();
    // -------------------------------------------------------------------
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error ? error.message : "Failed to update ValkyrJob";
            console.error("Failed to update ValkyrJob:", error);
