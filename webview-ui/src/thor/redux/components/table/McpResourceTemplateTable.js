...
import { useLazyGetMcpResourceTemplatesPagedQuery, useAddMcpResourceTemplateMutation, useUpdateMcpResourceTemplateMutation, useDeleteMcpResourceTemplateMutation, useDeleteMcpResourceTemplateCascadeMutation, } from "@thor/redux/services/McpResourceTemplateService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteMcpResourceTemplateCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateMcpResourceTemplate(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update McpResourceTemplate";
            console.error("Failed to update McpResourceTemplate:", error);
