...
import { useLazyGetPresignRequestsPagedQuery, useAddPresignRequestMutation, useUpdatePresignRequestMutation, useDeletePresignRequestMutation, useDeletePresignRequestCascadeMutation, } from "@thor/redux/services/PresignRequestService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deletePresignRequestCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update PresignRequest";
            console.error("Failed to update PresignRequest:", error);
