...
import { useLazyGetLoginsPagedQuery, useAddLoginMutation, useUpdateLoginMutation, useDeleteLoginMutation, useDeleteLoginCascadeMutation, } from "@thor/redux/services/LoginService";
...
const LoginTable = () => {
    ...
    const [deleteLoginCascade] = useDeleteLoginCascadeMutation();
    // -------------------------------------------------------------------
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error ? error.message : "Failed to update Login";
            console.error("Failed to update Login:", error);
