    ...
    children: [
      ...
      _jsxs(Modal, {
        ...
        children: [
          _jsx(Modal.Header, {
            closeButton: true,
            children: _jsx(Modal.Title, { children: "Create Login" }),
          }),
          _jsx(Modal.Body, { children: _jsx(LoginForm, {}) }),
        ],
      }),
      _jsxs(Modal, {
        show: showQbeModal,
        ...
        children: [
          _jsx(Modal.Header, {
            ...
            children: _jsx(Modal.Title, {
              children: "Filter Login (Query By Example)",
            }),
          }),
          _jsxs(Modal.Body, {
            children: [
      ...
      _jsxs(Modal, {
        ...
        children: [
          _jsx(Modal.Header, {
            closeButton: true,
            children: _jsx(Modal.Title, { children: "Editing Login" }),
          }),
          _jsxs(Modal.Body, {
            children: [
      ...
      isError &&
        _jsxs("div", {
          ...
          children: ["Error fetching page ", page, " of Logins."],
        }),
      _jsx(QBEPicker, {
        show: qbePicker.show,
