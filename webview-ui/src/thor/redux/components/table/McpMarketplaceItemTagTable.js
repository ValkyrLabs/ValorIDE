...
import { useLazyGetMcpMarketplaceItemTagsPagedQuery, useAddMcpMarketplaceItemTagMutation, useUpdateMcpMarketplaceItemTagMutation, useDeleteMcpMarketplaceItemTagMutation, useDeleteMcpMarketplaceItemTagCascadeMutation, } from "@thor/redux/services/McpMarketplaceItemTagService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteMcpMarketplaceItemTagCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateMcpMarketplaceItemTag(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update McpMarketplaceItemTag";
            console.error("Failed to update McpMarketplaceItemTag:", error);
