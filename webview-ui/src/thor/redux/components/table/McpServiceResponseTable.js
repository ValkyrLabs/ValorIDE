...
import { useLazyGetMcpServiceResponsesPagedQuery, useAddMcpServiceResponseMutation, useUpdateMcpServiceResponseMutation, useDeleteMcpServiceResponseMutation, useDeleteMcpServiceResponseCascadeMutation, } from "@thor/redux/services/McpServiceResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteMcpServiceResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateMcpServiceResponse(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update McpServiceResponse";
            console.error("Failed to update McpServiceResponse:", error);
