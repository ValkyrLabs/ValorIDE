...
import { useLazyGetApiMetricsResponsesPagedQuery, useAddApiMetricsResponseMutation, useUpdateApiMetricsResponseMutation, useDeleteApiMetricsResponseMutation, useDeleteApiMetricsResponseCascadeMutation, } from "@thor/redux/services/ApiMetricsResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteApiMetricsResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateApiMetricsResponse(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update ApiMetricsResponse";
            console.error("Failed to update ApiMetricsResponse:", error);
