...
import { useLazyGetPersistentLoginsPagedQuery, useAddPersistentLoginMutation, useUpdatePersistentLoginMutation, useDeletePersistentLoginMutation, useDeletePersistentLoginCascadeMutation, } from "@thor/redux/services/PersistentLoginService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deletePersistentLoginCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update PersistentLogin";
            console.error("Failed to update PersistentLogin:", error);
