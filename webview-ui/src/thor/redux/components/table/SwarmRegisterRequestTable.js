...
import { useLazyGetSwarmRegisterRequestsPagedQuery, useAddSwarmRegisterRequestMutation, useUpdateSwarmRegisterRequestMutation, useDeleteSwarmRegisterRequestMutation, useDeleteSwarmRegisterRequestCascadeMutation, } from "@thor/redux/services/SwarmRegisterRequestService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSwarmRegisterRequestCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateSwarmRegisterRequest(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update SwarmRegisterRequest";
            console.error("Failed to update SwarmRegisterRequest:", error);
