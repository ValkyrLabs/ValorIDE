...
import { useLazyGetPrincipalRolessPagedQuery, useAddPrincipalRolesMutation, useUpdatePrincipalRolesMutation, useDeletePrincipalRolesMutation, useDeletePrincipalRolesCascadeMutation, } from "@thor/redux/services/PrincipalRolesService";
...
const PrincipalRolesTable = () => {
    ...
    const [deletePrincipalRolesCascade] = useDeletePrincipalRolesCascadeMutation();
    // -------------------------------------------------------------------
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deletePrincipalRolesCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update PrincipalRoles";
            console.error("Failed to update PrincipalRoles:", error);
