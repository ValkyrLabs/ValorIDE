...
import { useLazyGetWebsocketMessagesPagedQuery, useAddWebsocketMessageMutation, useUpdateWebsocketMessageMutation, useDeleteWebsocketMessageMutation, useDeleteWebsocketMessageCascadeMutation, } from "@thor/redux/services/WebsocketMessageService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteWebsocketMessageCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateWebsocketMessage(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update WebsocketMessage";
            console.error("Failed to update WebsocketMessage:", error);
