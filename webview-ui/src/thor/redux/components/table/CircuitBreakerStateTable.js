...
import { useLazyGetCircuitBreakerStatesPagedQuery, useAddCircuitBreakerStateMutation, useUpdateCircuitBreakerStateMutation, useDeleteCircuitBreakerStateMutation, useDeleteCircuitBreakerStateCascadeMutation, } from "@thor/redux/services/CircuitBreakerStateService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteCircuitBreakerStateCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateCircuitBreakerState(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update CircuitBreakerState";
            console.error("Failed to update CircuitBreakerState:", error);
