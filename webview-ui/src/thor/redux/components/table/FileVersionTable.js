...
import { useLazyGetFileVersionsPagedQuery, useAddFileVersionMutation, useUpdateFileVersionMutation, useDeleteFileVersionMutation, useDeleteFileVersionCascadeMutation, } from "@thor/redux/services/FileVersionService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteFileVersionCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
