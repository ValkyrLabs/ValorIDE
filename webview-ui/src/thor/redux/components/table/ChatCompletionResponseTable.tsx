...
const ChatCompletionResponseTable: React.FC = () => {
  ...
  const [updateChatCompletionResponse] =
    useUpdateChatCompletionResponseMutation();
  const [deleteChatCompletionResponse] =
    useDeleteChatCompletionResponseMutation();
  ...
  const [copiedRow, setCopiedRow] = useState<ChatCompletionResponse | null>(
    null,
  );
    ...
    <>
      <div className="tableContainer">
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>
              Filter ChatCompletionResponse (Query By Example)
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <p>
