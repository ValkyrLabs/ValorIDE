...
import { useLazyGetSalesOrdersPagedQuery, useAddSalesOrderMutation, useUpdateSalesOrderMutation, useDeleteSalesOrderMutation, useDeleteSalesOrderCascadeMutation, } from "@thor/redux/services/SalesOrderService";
...
const SalesOrderTable = () => {
    ...
    const [deleteSalesOrderCascade] = useDeleteSalesOrderCascadeMutation();
    // -------------------------------------------------------------------
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error ? error.message : "Failed to update SalesOrder";
            console.error("Failed to update SalesOrder:", error);
