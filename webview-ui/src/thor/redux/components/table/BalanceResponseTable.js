...
import { useLazyGetBalanceResponsesPagedQuery, useAddBalanceResponseMutation, useUpdateBalanceResponseMutation, useDeleteBalanceResponseMutation, useDeleteBalanceResponseCascadeMutation, } from "@thor/redux/services/BalanceResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteBalanceResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update BalanceResponse";
            console.error("Failed to update BalanceResponse:", error);
