...
import { useLazyGetCampaignsPagedQuery, useAddCampaignMutation, useUpdateCampaignMutation, useDeleteCampaignMutation, useDeleteCampaignCascadeMutation, } from "@thor/redux/services/CampaignService";
...
const CampaignTable = () => {
    ...
    const [deleteCampaignCascade] = useDeleteCampaignCascadeMutation();
    // -------------------------------------------------------------------
