...
import { useLazyGetAgentHierarchyNodesPagedQuery, useAddAgentHierarchyNodeMutation, useUpdateAgentHierarchyNodeMutation, useDeleteAgentHierarchyNodeMutation, useDeleteAgentHierarchyNodeCascadeMutation, } from "@thor/redux/services/AgentHierarchyNodeService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteAgentHierarchyNodeCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateAgentHierarchyNode(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update AgentHierarchyNode";
            console.error("Failed to update AgentHierarchyNode:", error);
