...
import { useLazyGetApiMetricSnapshotsPagedQuery, useAddApiMetricSnapshotMutation, useUpdateApiMetricSnapshotMutation, useDeleteApiMetricSnapshotMutation, useDeleteApiMetricSnapshotCascadeMutation, } from "@thor/redux/services/ApiMetricSnapshotService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteApiMetricSnapshotCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateApiMetricSnapshot(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update ApiMetricSnapshot";
            console.error("Failed to update ApiMetricSnapshot:", error);
