...
import { useLazyGetSkillProfilesPagedQuery, useAddSkillProfileMutation, useUpdateSkillProfileMutation, useDeleteSkillProfileMutation, useDeleteSkillProfileCascadeMutation, } from "@thor/redux/services/SkillProfileService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSkillProfileCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
