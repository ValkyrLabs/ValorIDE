...
import { useLazyGetChatCompletionResponsesPagedQuery, useAddChatCompletionResponseMutation, useUpdateChatCompletionResponseMutation, useDeleteChatCompletionResponseMutation, useDeleteChatCompletionResponseCascadeMutation, } from "@thor/redux/services/ChatCompletionResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteChatCompletionResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateChatCompletionResponse(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update ChatCompletionResponse";
            console.error("Failed to update ChatCompletionResponse:", error);
