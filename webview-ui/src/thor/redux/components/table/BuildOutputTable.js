...
import { useLazyGetBuildOutputsPagedQuery, useAddBuildOutputMutation, useUpdateBuildOutputMutation, useDeleteBuildOutputMutation, useDeleteBuildOutputCascadeMutation, } from "@thor/redux/services/BuildOutputService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteBuildOutputCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
