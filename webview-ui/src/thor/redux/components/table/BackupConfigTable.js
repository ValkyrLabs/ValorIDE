...
import { useLazyGetBackupConfigsPagedQuery, useAddBackupConfigMutation, useUpdateBackupConfigMutation, useDeleteBackupConfigMutation, useDeleteBackupConfigCascadeMutation, } from "@thor/redux/services/BackupConfigService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteBackupConfigCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
