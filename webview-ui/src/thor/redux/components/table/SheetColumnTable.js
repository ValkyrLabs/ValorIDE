...
import { useLazyGetSheetColumnsPagedQuery, useAddSheetColumnMutation, useUpdateSheetColumnMutation, useDeleteSheetColumnMutation, useDeleteSheetColumnCascadeMutation, } from "@thor/redux/services/SheetColumnService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSheetColumnCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
