...
import { useLazyGetMediaObjectsPagedQuery, useAddMediaObjectMutation, useUpdateMediaObjectMutation, useDeleteMediaObjectMutation, useDeleteMediaObjectCascadeMutation, } from "@thor/redux/services/MediaObjectService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteMediaObjectCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
