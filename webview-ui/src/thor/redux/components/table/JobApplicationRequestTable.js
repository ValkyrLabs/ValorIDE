...
import { useLazyGetJobApplicationRequestsPagedQuery, useAddJobApplicationRequestMutation, useUpdateJobApplicationRequestMutation, useDeleteJobApplicationRequestMutation, useDeleteJobApplicationRequestCascadeMutation, } from "@thor/redux/services/JobApplicationRequestService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteJobApplicationRequestCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateJobApplicationRequest(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update JobApplicationRequest";
            console.error("Failed to update JobApplicationRequest:", error);
