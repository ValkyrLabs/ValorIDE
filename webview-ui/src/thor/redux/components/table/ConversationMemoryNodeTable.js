...
import { useLazyGetConversationMemoryNodesPagedQuery, useAddConversationMemoryNodeMutation, useUpdateConversationMemoryNodeMutation, useDeleteConversationMemoryNodeMutation, useDeleteConversationMemoryNodeCascadeMutation, } from "@thor/redux/services/ConversationMemoryNodeService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteConversationMemoryNodeCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateConversationMemoryNode(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update ConversationMemoryNode";
            console.error("Failed to update ConversationMemoryNode:", error);
