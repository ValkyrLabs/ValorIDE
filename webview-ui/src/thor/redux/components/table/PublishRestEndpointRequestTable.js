...
import { useLazyGetPublishRestEndpointRequestsPagedQuery, useAddPublishRestEndpointRequestMutation, useUpdatePublishRestEndpointRequestMutation, useDeletePublishRestEndpointRequestMutation, useDeletePublishRestEndpointRequestCascadeMutation, } from "@thor/redux/services/PublishRestEndpointRequestService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deletePublishRestEndpointRequestCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updatePublishRestEndpointRequest(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update PublishRestEndpointRequest";
            console.error("Failed to update PublishRestEndpointRequest:", error);
