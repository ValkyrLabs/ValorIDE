...
import { useLazyGetMcpResourceResponsesPagedQuery, useAddMcpResourceResponseMutation, useUpdateMcpResourceResponseMutation, useDeleteMcpResourceResponseMutation, useDeleteMcpResourceResponseCascadeMutation, } from "@thor/redux/services/McpResourceResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteMcpResourceResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateMcpResourceResponse(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update McpResourceResponse";
            console.error("Failed to update McpResourceResponse:", error);
