...
import { useLazyGetDigitalAssetsPagedQuery, useAddDigitalAssetMutation, useUpdateDigitalAssetMutation, useDeleteDigitalAssetMutation, useDeleteDigitalAssetCascadeMutation, } from "@thor/redux/services/DigitalAssetService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteDigitalAssetCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
