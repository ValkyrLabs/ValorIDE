...
import { useLazyGetWorkflowExecutionsPagedQuery, useAddWorkflowExecutionMutation, useUpdateWorkflowExecutionMutation, useDeleteWorkflowExecutionMutation, useDeleteWorkflowExecutionCascadeMutation, } from "@thor/redux/services/WorkflowExecutionService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteWorkflowExecutionCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateWorkflowExecution(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update WorkflowExecution";
            console.error("Failed to update WorkflowExecution:", error);
