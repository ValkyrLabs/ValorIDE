...
import { useLazyGetExecuteModuleRequestsPagedQuery, useAddExecuteModuleRequestMutation, useUpdateExecuteModuleRequestMutation, useDeleteExecuteModuleRequestMutation, useDeleteExecuteModuleRequestCascadeMutation, } from "@thor/redux/services/ExecuteModuleRequestService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteExecuteModuleRequestCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateExecuteModuleRequest(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update ExecuteModuleRequest";
            console.error("Failed to update ExecuteModuleRequest:", error);
