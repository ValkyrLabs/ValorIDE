    ...
    children: [
      ...
      _jsxs(Modal, {
        ...
        children: [
          _jsx(Modal.Header, {
            closeButton: true,
            children: _jsx(Modal.Title, { children: "Create Chart" }),
          }),
          _jsx(Modal.Body, { children: _jsx(ChartForm, {}) }),
        ],
      }),
      _jsxs(Modal, {
        show: showQbeModal,
        ...
        children: [
          _jsx(Modal.Header, {
            ...
            children: _jsx(Modal.Title, {
              children: "Filter Chart (Query By Example)",
            }),
          }),
          _jsxs(Modal.Body, {
            children: [
      ...
      _jsxs(Modal, {
        ...
        children: [
          _jsx(Modal.Header, {
            closeButton: true,
            children: _jsx(Modal.Title, { children: "Editing Chart" }),
          }),
          _jsxs(Modal.Body, {
            children: [
      ...
      isError &&
        _jsxs("div", {
          ...
          children: ["Error fetching page ", page, " of Charts."],
        }),
      _jsx(QBEPicker, {
        show: qbePicker.show,
