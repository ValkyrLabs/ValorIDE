...
import { useLazyGetApiTrafficEventsPagedQuery, useAddApiTrafficEventMutation, useUpdateApiTrafficEventMutation, useDeleteApiTrafficEventMutation, useDeleteApiTrafficEventCascadeMutation, } from "@thor/redux/services/ApiTrafficEventService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteApiTrafficEventCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update ApiTrafficEvent";
            console.error("Failed to update ApiTrafficEvent:", error);
