...
import { useLazyGetAgentChatMessageRequestsPagedQuery, useAddAgentChatMessageRequestMutation, useUpdateAgentChatMessageRequestMutation, useDeleteAgentChatMessageRequestMutation, useDeleteAgentChatMessageRequestCascadeMutation, } from "@thor/redux/services/AgentChatMessageRequestService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteAgentChatMessageRequestCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateAgentChatMessageRequest(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update AgentChatMessageRequest";
            console.error("Failed to update AgentChatMessageRequest:", error);
