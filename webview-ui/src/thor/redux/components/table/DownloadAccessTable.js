...
import { useLazyGetDownloadAccesssPagedQuery, useAddDownloadAccessMutation, useUpdateDownloadAccessMutation, useDeleteDownloadAccessMutation, useDeleteDownloadAccessCascadeMutation, } from "@thor/redux/services/DownloadAccessService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteDownloadAccessCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update DownloadAccess";
            console.error("Failed to update DownloadAccess:", error);
