...
import { useLazyGetOasSecuritySchemesPagedQuery, useAddOasSecuritySchemeMutation, useUpdateOasSecuritySchemeMutation, useDeleteOasSecuritySchemeMutation, useDeleteOasSecuritySchemeCascadeMutation, } from "@thor/redux/services/OasSecuritySchemeService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteOasSecuritySchemeCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateOasSecurityScheme(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update OasSecurityScheme";
            console.error("Failed to update OasSecurityScheme:", error);
