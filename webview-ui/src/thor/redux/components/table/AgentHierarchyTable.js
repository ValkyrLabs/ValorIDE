...
import { useLazyGetAgentHierarchysPagedQuery, useAddAgentHierarchyMutation, useUpdateAgentHierarchyMutation, useDeleteAgentHierarchyMutation, useDeleteAgentHierarchyCascadeMutation, } from "@thor/redux/services/AgentHierarchyService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteAgentHierarchyCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update AgentHierarchy";
            console.error("Failed to update AgentHierarchy:", error);
