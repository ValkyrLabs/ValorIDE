...
import { useLazyGetOasParametersPagedQuery, useAddOasParameterMutation, useUpdateOasParameterMutation, useDeleteOasParameterMutation, useDeleteOasParameterCascadeMutation, } from "@thor/redux/services/OasParameterService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteOasParameterCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
