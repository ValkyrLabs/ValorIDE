...
const ProductDeliveryConfigTable: React.FC = () => {
  ...
  const [updateProductDeliveryConfig] =
    useUpdateProductDeliveryConfigMutation();
  const [deleteProductDeliveryConfig] =
    useDeleteProductDeliveryConfigMutation();
  ...
  const [copiedRow, setCopiedRow] = useState<ProductDeliveryConfig | null>(
    null,
  );
    ...
    <>
      <div className="tableContainer">
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>
              Filter ProductDeliveryConfig (Query By Example)
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <p>
