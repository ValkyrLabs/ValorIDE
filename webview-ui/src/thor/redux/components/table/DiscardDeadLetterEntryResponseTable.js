...
import { useLazyGetDiscardDeadLetterEntryResponsesPagedQuery, useAddDiscardDeadLetterEntryResponseMutation, useUpdateDiscardDeadLetterEntryResponseMutation, useDeleteDiscardDeadLetterEntryResponseMutation, useDeleteDiscardDeadLetterEntryResponseCascadeMutation, } from "@thor/redux/services/DiscardDeadLetterEntryResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteDiscardDeadLetterEntryResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateDiscardDeadLetterEntryResponse(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update DiscardDeadLetterEntryResponse";
            console.error("Failed to update DiscardDeadLetterEntryResponse:", error);
