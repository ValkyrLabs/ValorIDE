...
import { useLazyGetFileDownloadTokensPagedQuery, useAddFileDownloadTokenMutation, useUpdateFileDownloadTokenMutation, useDeleteFileDownloadTokenMutation, useDeleteFileDownloadTokenCascadeMutation, } from "@thor/redux/services/FileDownloadTokenService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteFileDownloadTokenCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateFileDownloadToken(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update FileDownloadToken";
            console.error("Failed to update FileDownloadToken:", error);
