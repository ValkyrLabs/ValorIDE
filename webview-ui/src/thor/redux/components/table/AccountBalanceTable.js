...
import { useLazyGetAccountBalancesPagedQuery, useAddAccountBalanceMutation, useUpdateAccountBalanceMutation, useDeleteAccountBalanceMutation, useDeleteAccountBalanceCascadeMutation, } from "@thor/redux/services/AccountBalanceService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteAccountBalanceCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update AccountBalance";
            console.error("Failed to update AccountBalance:", error);
