...
import { useLazyGetPresignResponsesPagedQuery, useAddPresignResponseMutation, useUpdatePresignResponseMutation, useDeletePresignResponseMutation, useDeletePresignResponseCascadeMutation, } from "@thor/redux/services/PresignResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deletePresignResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update PresignResponse";
            console.error("Failed to update PresignResponse:", error);
