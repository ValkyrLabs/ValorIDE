...
import { useLazyGetCareerOpportunitysPagedQuery, useAddCareerOpportunityMutation, useUpdateCareerOpportunityMutation, useDeleteCareerOpportunityMutation, useDeleteCareerOpportunityCascadeMutation, } from "@thor/redux/services/CareerOpportunityService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteCareerOpportunityCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateCareerOpportunity(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update CareerOpportunity";
            console.error("Failed to update CareerOpportunity:", error);
