...
import { useLazyGetFileAuditLogsPagedQuery, useAddFileAuditLogMutation, useUpdateFileAuditLogMutation, useDeleteFileAuditLogMutation, useDeleteFileAuditLogCascadeMutation, } from "@thor/redux/services/FileAuditLogService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteFileAuditLogCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
