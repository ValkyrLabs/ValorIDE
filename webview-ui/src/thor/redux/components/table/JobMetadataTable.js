...
import { useLazyGetJobMetadatasPagedQuery, useAddJobMetadataMutation, useUpdateJobMetadataMutation, useDeleteJobMetadataMutation, useDeleteJobMetadataCascadeMutation, } from "@thor/redux/services/JobMetadataService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteJobMetadataCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
