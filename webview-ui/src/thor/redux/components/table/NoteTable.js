...
import { useLazyGetNotesPagedQuery, useAddNoteMutation, useUpdateNoteMutation, useDeleteNoteMutation, useDeleteNoteCascadeMutation, } from "@thor/redux/services/NoteService";
...
const NoteTable = () => {
    ...
    const [deleteNoteCascade] = useDeleteNoteCascadeMutation();
    // -------------------------------------------------------------------
