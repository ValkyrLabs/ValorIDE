...
import { useLazyGetAgentChatMessagesPagedQuery, useAddAgentChatMessageMutation, useUpdateAgentChatMessageMutation, useDeleteAgentChatMessageMutation, useDeleteAgentChatMessageCascadeMutation, } from "@thor/redux/services/AgentChatMessageService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteAgentChatMessageCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateAgentChatMessage(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update AgentChatMessage";
            console.error("Failed to update AgentChatMessage:", error);
