...
import { useLazyGetAgentEventTriggersPagedQuery, useAddAgentEventTriggerMutation, useUpdateAgentEventTriggerMutation, useDeleteAgentEventTriggerMutation, useDeleteAgentEventTriggerCascadeMutation, } from "@thor/redux/services/AgentEventTriggerService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteAgentEventTriggerCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateAgentEventTrigger(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update AgentEventTrigger";
            console.error("Failed to update AgentEventTrigger:", error);
