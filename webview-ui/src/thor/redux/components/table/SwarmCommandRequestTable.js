...
import { useLazyGetSwarmCommandRequestsPagedQuery, useAddSwarmCommandRequestMutation, useUpdateSwarmCommandRequestMutation, useDeleteSwarmCommandRequestMutation, useDeleteSwarmCommandRequestCascadeMutation, } from "@thor/redux/services/SwarmCommandRequestService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSwarmCommandRequestCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateSwarmCommandRequest(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update SwarmCommandRequest";
            console.error("Failed to update SwarmCommandRequest:", error);
