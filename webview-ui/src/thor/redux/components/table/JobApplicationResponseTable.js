...
import { useLazyGetJobApplicationResponsesPagedQuery, useAddJobApplicationResponseMutation, useUpdateJobApplicationResponseMutation, useDeleteJobApplicationResponseMutation, useDeleteJobApplicationResponseCascadeMutation, } from "@thor/redux/services/JobApplicationResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteJobApplicationResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateJobApplicationResponse(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update JobApplicationResponse";
            console.error("Failed to update JobApplicationResponse:", error);
