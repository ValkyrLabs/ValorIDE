...
import { useLazyGetUpdateFileRequestsPagedQuery, useAddUpdateFileRequestMutation, useUpdateUpdateFileRequestMutation, useDeleteUpdateFileRequestMutation, useDeleteUpdateFileRequestCascadeMutation, } from "@thor/redux/services/UpdateFileRequestService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteUpdateFileRequestCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateUpdateFileRequest(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update UpdateFileRequest";
            console.error("Failed to update UpdateFileRequest:", error);
