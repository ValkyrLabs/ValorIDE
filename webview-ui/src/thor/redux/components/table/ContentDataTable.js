...
import { useLazyGetContentDatasPagedQuery, useAddContentDataMutation, useUpdateContentDataMutation, useDeleteContentDataMutation, useDeleteContentDataCascadeMutation, } from "@thor/redux/services/ContentDataService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteContentDataCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
