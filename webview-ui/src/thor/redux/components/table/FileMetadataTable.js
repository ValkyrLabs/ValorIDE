...
import { useLazyGetFileMetadatasPagedQuery, useAddFileMetadataMutation, useUpdateFileMetadataMutation, useDeleteFileMetadataMutation, useDeleteFileMetadataCascadeMutation, } from "@thor/redux/services/FileMetadataService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteFileMetadataCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
