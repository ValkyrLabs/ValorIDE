...
import { useLazyGetUserPreferencesPagedQuery, useAddUserPreferenceMutation, useUpdateUserPreferenceMutation, useDeleteUserPreferenceMutation, useDeleteUserPreferenceCascadeMutation, } from "@thor/redux/services/UserPreferenceService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteUserPreferenceCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update UserPreference";
            console.error("Failed to update UserPreference:", error);
