...
import { useLazyGetInitUploadRequestsPagedQuery, useAddInitUploadRequestMutation, useUpdateInitUploadRequestMutation, useDeleteInitUploadRequestMutation, useDeleteInitUploadRequestCascadeMutation, } from "@thor/redux/services/InitUploadRequestService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteInitUploadRequestCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateInitUploadRequest(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update InitUploadRequest";
            console.error("Failed to update InitUploadRequest:", error);
