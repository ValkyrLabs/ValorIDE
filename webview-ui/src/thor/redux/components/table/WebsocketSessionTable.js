...
import { useLazyGetWebsocketSessionsPagedQuery, useAddWebsocketSessionMutation, useUpdateWebsocketSessionMutation, useDeleteWebsocketSessionMutation, useDeleteWebsocketSessionCascadeMutation, } from "@thor/redux/services/WebsocketSessionService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteWebsocketSessionCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateWebsocketSession(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update WebsocketSession";
            console.error("Failed to update WebsocketSession:", error);
