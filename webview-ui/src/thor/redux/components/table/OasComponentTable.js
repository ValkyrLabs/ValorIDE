...
import { useLazyGetOasComponentsPagedQuery, useAddOasComponentMutation, useUpdateOasComponentMutation, useDeleteOasComponentMutation, useDeleteOasComponentCascadeMutation, } from "@thor/redux/services/OasComponentService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteOasComponentCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
