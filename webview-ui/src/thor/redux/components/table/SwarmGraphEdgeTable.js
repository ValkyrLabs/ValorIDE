...
import { useLazyGetSwarmGraphEdgesPagedQuery, useAddSwarmGraphEdgeMutation, useUpdateSwarmGraphEdgeMutation, useDeleteSwarmGraphEdgeMutation, useDeleteSwarmGraphEdgeCascadeMutation, } from "@thor/redux/services/SwarmGraphEdgeService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSwarmGraphEdgeCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update SwarmGraphEdge";
            console.error("Failed to update SwarmGraphEdge:", error);
