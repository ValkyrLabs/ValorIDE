...
import { useLazyGetSpaceMembersPagedQuery, useAddSpaceMemberMutation, useUpdateSpaceMemberMutation, useDeleteSpaceMemberMutation, useDeleteSpaceMemberCascadeMutation, } from "@thor/redux/services/SpaceMemberService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSpaceMemberCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
