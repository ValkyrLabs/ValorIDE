...
import { useLazyGetChatMessagesPagedQuery, useAddChatMessageMutation, useUpdateChatMessageMutation, useDeleteChatMessageMutation, useDeleteChatMessageCascadeMutation, } from "@thor/redux/services/ChatMessageService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteChatMessageCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
