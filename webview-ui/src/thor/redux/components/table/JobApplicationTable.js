...
import { useLazyGetJobApplicationsPagedQuery, useAddJobApplicationMutation, useUpdateJobApplicationMutation, useDeleteJobApplicationMutation, useDeleteJobApplicationCascadeMutation, } from "@thor/redux/services/JobApplicationService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteJobApplicationCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update JobApplication";
            console.error("Failed to update JobApplication:", error);
