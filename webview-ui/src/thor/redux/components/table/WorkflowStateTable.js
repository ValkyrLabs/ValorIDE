...
import { useLazyGetWorkflowStatesPagedQuery, useAddWorkflowStateMutation, useUpdateWorkflowStateMutation, useDeleteWorkflowStateMutation, useDeleteWorkflowStateCascadeMutation, } from "@thor/redux/services/WorkflowStateService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteWorkflowStateCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update WorkflowState";
            console.error("Failed to update WorkflowState:", error);
