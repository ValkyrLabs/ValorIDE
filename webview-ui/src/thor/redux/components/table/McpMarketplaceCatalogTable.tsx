...
const McpMarketplaceCatalogTable: React.FC = () => {
  ...
  const [updateMcpMarketplaceCatalog] =
    useUpdateMcpMarketplaceCatalogMutation();
  const [deleteMcpMarketplaceCatalog] =
    useDeleteMcpMarketplaceCatalogMutation();
  ...
  const [copiedRow, setCopiedRow] = useState<McpMarketplaceCatalog | null>(
    null,
  );
    ...
    <>
      <div className="tableContainer">
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>
              Filter McpMarketplaceCatalog (Query By Example)
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <p>
