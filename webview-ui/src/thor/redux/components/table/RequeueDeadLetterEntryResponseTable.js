...
import { useLazyGetRequeueDeadLetterEntryResponsesPagedQuery, useAddRequeueDeadLetterEntryResponseMutation, useUpdateRequeueDeadLetterEntryResponseMutation, useDeleteRequeueDeadLetterEntryResponseMutation, useDeleteRequeueDeadLetterEntryResponseCascadeMutation, } from "@thor/redux/services/RequeueDeadLetterEntryResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteRequeueDeadLetterEntryResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateRequeueDeadLetterEntryResponse(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update RequeueDeadLetterEntryResponse";
            console.error("Failed to update RequeueDeadLetterEntryResponse:", error);
