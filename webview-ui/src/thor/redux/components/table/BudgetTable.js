...
import { useLazyGetBudgetsPagedQuery, useAddBudgetMutation, useUpdateBudgetMutation, useDeleteBudgetMutation, useDeleteBudgetCascadeMutation, } from "@thor/redux/services/BudgetService";
...
const BudgetTable = () => {
    ...
    const [deleteBudgetCascade] = useDeleteBudgetCascadeMutation();
    // -------------------------------------------------------------------
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error ? error.message : "Failed to update Budget";
            console.error("Failed to update Budget:", error);
