...
import { useLazyGetAgentBillingChargesPagedQuery, useAddAgentBillingChargeMutation, useUpdateAgentBillingChargeMutation, useDeleteAgentBillingChargeMutation, useDeleteAgentBillingChargeCascadeMutation, } from "@thor/redux/services/AgentBillingChargeService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteAgentBillingChargeCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateAgentBillingCharge(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update AgentBillingCharge";
            console.error("Failed to update AgentBillingCharge:", error);
