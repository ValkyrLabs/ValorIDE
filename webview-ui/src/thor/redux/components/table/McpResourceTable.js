...
import { useLazyGetMcpResourcesPagedQuery, useAddMcpResourceMutation, useUpdateMcpResourceMutation, useDeleteMcpResourceMutation, useDeleteMcpResourceCascadeMutation, } from "@thor/redux/services/McpResourceService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteMcpResourceCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
