...
import { useLazyGetSwarmGraphNodesPagedQuery, useAddSwarmGraphNodeMutation, useUpdateSwarmGraphNodeMutation, useDeleteSwarmGraphNodeMutation, useDeleteSwarmGraphNodeCascadeMutation, } from "@thor/redux/services/SwarmGraphNodeService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSwarmGraphNodeCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update SwarmGraphNode";
            console.error("Failed to update SwarmGraphNode:", error);
