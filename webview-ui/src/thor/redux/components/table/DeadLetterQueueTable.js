...
import { useLazyGetDeadLetterQueuesPagedQuery, useAddDeadLetterQueueMutation, useUpdateDeadLetterQueueMutation, useDeleteDeadLetterQueueMutation, useDeleteDeadLetterQueueCascadeMutation, } from "@thor/redux/services/DeadLetterQueueService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteDeadLetterQueueCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update DeadLetterQueue";
            console.error("Failed to update DeadLetterQueue:", error);
