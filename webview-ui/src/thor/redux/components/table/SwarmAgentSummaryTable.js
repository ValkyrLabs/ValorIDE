...
import { useLazyGetSwarmAgentSummarysPagedQuery, useAddSwarmAgentSummaryMutation, useUpdateSwarmAgentSummaryMutation, useDeleteSwarmAgentSummaryMutation, useDeleteSwarmAgentSummaryCascadeMutation, } from "@thor/redux/services/SwarmAgentSummaryService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSwarmAgentSummaryCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateSwarmAgentSummary(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update SwarmAgentSummary";
            console.error("Failed to update SwarmAgentSummary:", error);
