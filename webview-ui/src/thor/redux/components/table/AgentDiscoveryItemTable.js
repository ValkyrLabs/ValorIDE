...
import { useLazyGetAgentDiscoveryItemsPagedQuery, useAddAgentDiscoveryItemMutation, useUpdateAgentDiscoveryItemMutation, useDeleteAgentDiscoveryItemMutation, useDeleteAgentDiscoveryItemCascadeMutation, } from "@thor/redux/services/AgentDiscoveryItemService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteAgentDiscoveryItemCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateAgentDiscoveryItem(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update AgentDiscoveryItem";
            console.error("Failed to update AgentDiscoveryItem:", error);
