...
const ActivateAgent200ResponseTable: React.FC = () => {
  ...
  // -------------------------------------------------------------------
  const [addActivateAgent200Response] =
    useAddActivateAgent200ResponseMutation();
  const [updateActivateAgent200Response] =
    useUpdateActivateAgent200ResponseMutation();
  const [deleteActivateAgent200Response] =
    useDeleteActivateAgent200ResponseMutation();
  ...
  const [copiedRow, setCopiedRow] = useState<ActivateAgent200Response | null>(
    null,
  );
  ...
  const handlePasteRow = async () => {
    ...
    try {
      ...
      console.error(
        "Failed to paste (create) ActivateAgent200Response:",
        error,
      );
    ...
    <>
      <div className="tableContainer">
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>
              Filter ActivateAgent200Response (Query By Example)
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <p>
