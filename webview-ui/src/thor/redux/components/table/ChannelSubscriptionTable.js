...
import { useLazyGetChannelSubscriptionsPagedQuery, useAddChannelSubscriptionMutation, useUpdateChannelSubscriptionMutation, useDeleteChannelSubscriptionMutation, useDeleteChannelSubscriptionCascadeMutation, } from "@thor/redux/services/ChannelSubscriptionService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteChannelSubscriptionCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateChannelSubscription(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update ChannelSubscription";
            console.error("Failed to update ChannelSubscription:", error);
