...
import { useLazyGetGrantPermissionRequestsPagedQuery, useAddGrantPermissionRequestMutation, useUpdateGrantPermissionRequestMutation, useDeleteGrantPermissionRequestMutation, useDeleteGrantPermissionRequestCascadeMutation, } from "@thor/redux/services/GrantPermissionRequestService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteGrantPermissionRequestCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateGrantPermissionRequest(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update GrantPermissionRequest";
            console.error("Failed to update GrantPermissionRequest:", error);
