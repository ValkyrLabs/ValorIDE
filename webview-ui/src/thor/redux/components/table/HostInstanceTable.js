...
import { useLazyGetHostInstancesPagedQuery, useAddHostInstanceMutation, useUpdateHostInstanceMutation, useDeleteHostInstanceMutation, useDeleteHostInstanceCascadeMutation, } from "@thor/redux/services/HostInstanceService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteHostInstanceCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
