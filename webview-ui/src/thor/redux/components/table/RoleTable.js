    ...
    children: [
      ...
      _jsxs(Modal, {
        ...
        children: [
          _jsx(Modal.Header, {
            closeButton: true,
            children: _jsx(Modal.Title, { children: "Create Role" }),
          }),
          _jsx(Modal.Body, { children: _jsx(RoleForm, {}) }),
        ],
      }),
      _jsxs(Modal, {
        show: showQbeModal,
        ...
        children: [
          _jsx(Modal.Header, {
            ...
            children: _jsx(Modal.Title, {
              children: "Filter Role (Query By Example)",
            }),
          }),
          _jsxs(Modal.Body, {
            children: [
      ...
      _jsxs(Modal, {
        ...
        children: [
          _jsx(Modal.Header, {
            closeButton: true,
            children: _jsx(Modal.Title, { children: "Editing Role" }),
          }),
          _jsxs(Modal.Body, {
            children: [
      ...
      isError &&
        _jsxs("div", {
          ...
          children: ["Error fetching page ", page, " of Roles."],
        }),
      _jsx(QBEPicker, {
        show: qbePicker.show,
