...
import { useLazyGetRolesPagedQuery, useAddRoleMutation, useUpdateRoleMutation, useDeleteRoleMutation, useDeleteRoleCascadeMutation, } from "@thor/redux/services/RoleService";
...
const RoleTable = () => {
    ...
    const [deleteRoleCascade] = useDeleteRoleCascadeMutation();
    // -------------------------------------------------------------------
