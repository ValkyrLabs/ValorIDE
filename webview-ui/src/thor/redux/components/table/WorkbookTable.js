...
import { useLazyGetWorkbooksPagedQuery, useAddWorkbookMutation, useUpdateWorkbookMutation, useDeleteWorkbookMutation, useDeleteWorkbookCascadeMutation, } from "@thor/redux/services/WorkbookService";
...
const WorkbookTable = () => {
    ...
    const [deleteWorkbookCascade] = useDeleteWorkbookCascadeMutation();
    // -------------------------------------------------------------------
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error ? error.message : "Failed to update Workbook";
            console.error("Failed to update Workbook:", error);
