...
import { useLazyGetAgentBillingsPagedQuery, useAddAgentBillingMutation, useUpdateAgentBillingMutation, useDeleteAgentBillingMutation, useDeleteAgentBillingCascadeMutation, } from "@thor/redux/services/AgentBillingService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteAgentBillingCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
