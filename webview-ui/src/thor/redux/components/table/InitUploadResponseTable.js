...
import { useLazyGetInitUploadResponsesPagedQuery, useAddInitUploadResponseMutation, useUpdateInitUploadResponseMutation, useDeleteInitUploadResponseMutation, useDeleteInitUploadResponseCascadeMutation, } from "@thor/redux/services/InitUploadResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteInitUploadResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateInitUploadResponse(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update InitUploadResponse";
            console.error("Failed to update InitUploadResponse:", error);
