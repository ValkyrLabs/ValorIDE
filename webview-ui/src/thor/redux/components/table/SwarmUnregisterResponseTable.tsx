...
const SwarmUnregisterResponseTable: React.FC = () => {
  ...
  const [updateSwarmUnregisterResponse] =
    useUpdateSwarmUnregisterResponseMutation();
  const [deleteSwarmUnregisterResponse] =
    useDeleteSwarmUnregisterResponseMutation();
  ...
  const [copiedRow, setCopiedRow] = useState<SwarmUnregisterResponse | null>(
    null,
  );
    ...
    <>
      <div className="tableContainer">
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>
              Filter SwarmUnregisterResponse (Query By Example)
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <p>
