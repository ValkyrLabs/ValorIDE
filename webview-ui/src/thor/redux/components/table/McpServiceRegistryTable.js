...
import { useLazyGetMcpServiceRegistrysPagedQuery, useAddMcpServiceRegistryMutation, useUpdateMcpServiceRegistryMutation, useDeleteMcpServiceRegistryMutation, useDeleteMcpServiceRegistryCascadeMutation, } from "@thor/redux/services/McpServiceRegistryService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteMcpServiceRegistryCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateMcpServiceRegistry(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update McpServiceRegistry";
            console.error("Failed to update McpServiceRegistry:", error);
