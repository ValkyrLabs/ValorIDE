...
import { useLazyGetPaymentTransactionsPagedQuery, useAddPaymentTransactionMutation, useUpdatePaymentTransactionMutation, useDeletePaymentTransactionMutation, useDeletePaymentTransactionCascadeMutation, } from "@thor/redux/services/PaymentTransactionService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deletePaymentTransactionCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updatePaymentTransaction(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update PaymentTransaction";
            console.error("Failed to update PaymentTransaction:", error);
