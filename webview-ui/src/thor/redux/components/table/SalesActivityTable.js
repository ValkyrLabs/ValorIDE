...
import { useLazyGetSalesActivitysPagedQuery, useAddSalesActivityMutation, useUpdateSalesActivityMutation, useDeleteSalesActivityMutation, useDeleteSalesActivityCascadeMutation, } from "@thor/redux/services/SalesActivityService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSalesActivityCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update SalesActivity";
            console.error("Failed to update SalesActivity:", error);
