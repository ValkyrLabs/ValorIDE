...
import { useLazyGetAgentChatMessageResponsesPagedQuery, useAddAgentChatMessageResponseMutation, useUpdateAgentChatMessageResponseMutation, useDeleteAgentChatMessageResponseMutation, useDeleteAgentChatMessageResponseCascadeMutation, } from "@thor/redux/services/AgentChatMessageResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteAgentChatMessageResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateAgentChatMessageResponse(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update AgentChatMessageResponse";
            console.error("Failed to update AgentChatMessageResponse:", error);
