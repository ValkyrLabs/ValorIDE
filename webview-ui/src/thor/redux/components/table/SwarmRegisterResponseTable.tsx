...
const SwarmRegisterResponseTable: React.FC = () => {
  ...
  const [updateSwarmRegisterResponse] =
    useUpdateSwarmRegisterResponseMutation();
  const [deleteSwarmRegisterResponse] =
    useDeleteSwarmRegisterResponseMutation();
  ...
  const [copiedRow, setCopiedRow] = useState<SwarmRegisterResponse | null>(
    null,
  );
    ...
    <>
      <div className="tableContainer">
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>
              Filter SwarmRegisterResponse (Query By Example)
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <p>
