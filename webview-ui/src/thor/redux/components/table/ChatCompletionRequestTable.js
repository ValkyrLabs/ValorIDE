...
import { useLazyGetChatCompletionRequestsPagedQuery, useAddChatCompletionRequestMutation, useUpdateChatCompletionRequestMutation, useDeleteChatCompletionRequestMutation, useDeleteChatCompletionRequestCascadeMutation, } from "@thor/redux/services/ChatCompletionRequestService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteChatCompletionRequestCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateChatCompletionRequest(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update ChatCompletionRequest";
            console.error("Failed to update ChatCompletionRequest:", error);
