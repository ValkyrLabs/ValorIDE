...
import { useLazyGetMcpMarketplaceItemsPagedQuery, useAddMcpMarketplaceItemMutation, useUpdateMcpMarketplaceItemMutation, useDeleteMcpMarketplaceItemMutation, useDeleteMcpMarketplaceItemCascadeMutation, } from "@thor/redux/services/McpMarketplaceItemService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteMcpMarketplaceItemCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateMcpMarketplaceItem(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update McpMarketplaceItem";
            console.error("Failed to update McpMarketplaceItem:", error);
