...
import { useLazyGetDiscardDeadLetterEntryRequestsPagedQuery, useAddDiscardDeadLetterEntryRequestMutation, useUpdateDiscardDeadLetterEntryRequestMutation, useDeleteDiscardDeadLetterEntryRequestMutation, useDeleteDiscardDeadLetterEntryRequestCascadeMutation, } from "@thor/redux/services/DiscardDeadLetterEntryRequestService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteDiscardDeadLetterEntryRequestCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateDiscardDeadLetterEntryRequest(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update DiscardDeadLetterEntryRequest";
            console.error("Failed to update DiscardDeadLetterEntryRequest:", error);
