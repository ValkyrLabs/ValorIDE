...
import { useLazyGetSwarmRegisterResponsesPagedQuery, useAddSwarmRegisterResponseMutation, useUpdateSwarmRegisterResponseMutation, useDeleteSwarmRegisterResponseMutation, useDeleteSwarmRegisterResponseCascadeMutation, } from "@thor/redux/services/SwarmRegisterResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSwarmRegisterResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateSwarmRegisterResponse(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update SwarmRegisterResponse";
            console.error("Failed to update SwarmRegisterResponse:", error);
