...
import { useLazyGetApplicationsPagedQuery, useAddApplicationMutation, useUpdateApplicationMutation, useDeleteApplicationMutation, useDeleteApplicationCascadeMutation, } from "@thor/redux/services/ApplicationService";
...
const ApplicationTable = () => {
    ...
    const [deleteApplicationCascade] = useDeleteApplicationCascadeMutation();
    // -------------------------------------------------------------------
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteApplicationCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error ? error.message : "Failed to update Application";
            console.error("Failed to update Application:", error);
