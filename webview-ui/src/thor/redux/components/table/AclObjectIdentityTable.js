...
import { useLazyGetAclObjectIdentitysPagedQuery, useAddAclObjectIdentityMutation, useUpdateAclObjectIdentityMutation, useDeleteAclObjectIdentityMutation, useDeleteAclObjectIdentityCascadeMutation, } from "@thor/redux/services/AclObjectIdentityService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteAclObjectIdentityCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateAclObjectIdentity(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update AclObjectIdentity";
            console.error("Failed to update AclObjectIdentity:", error);
