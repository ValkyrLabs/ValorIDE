...
import { useLazyGetStrategicPrioritysPagedQuery, useAddStrategicPriorityMutation, useUpdateStrategicPriorityMutation, useDeleteStrategicPriorityMutation, useDeleteStrategicPriorityCascadeMutation, } from "@thor/redux/services/StrategicPriorityService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteStrategicPriorityCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateStrategicPriority(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update StrategicPriority";
            console.error("Failed to update StrategicPriority:", error);
