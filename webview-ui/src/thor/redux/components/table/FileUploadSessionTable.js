...
import { useLazyGetFileUploadSessionsPagedQuery, useAddFileUploadSessionMutation, useUpdateFileUploadSessionMutation, useDeleteFileUploadSessionMutation, useDeleteFileUploadSessionCascadeMutation, } from "@thor/redux/services/FileUploadSessionService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteFileUploadSessionCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateFileUploadSession(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update FileUploadSession";
            console.error("Failed to update FileUploadSession:", error);
