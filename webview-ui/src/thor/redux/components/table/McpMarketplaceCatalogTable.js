...
import { useLazyGetMcpMarketplaceCatalogsPagedQuery, useAddMcpMarketplaceCatalogMutation, useUpdateMcpMarketplaceCatalogMutation, useDeleteMcpMarketplaceCatalogMutation, useDeleteMcpMarketplaceCatalogCascadeMutation, } from "@thor/redux/services/McpMarketplaceCatalogService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteMcpMarketplaceCatalogCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateMcpMarketplaceCatalog(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update McpMarketplaceCatalog";
            console.error("Failed to update McpMarketplaceCatalog:", error);
