...
import { useLazyGetSwarmCommandResponsesPagedQuery, useAddSwarmCommandResponseMutation, useUpdateSwarmCommandResponseMutation, useDeleteSwarmCommandResponseMutation, useDeleteSwarmCommandResponseCascadeMutation, } from "@thor/redux/services/SwarmCommandResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteSwarmCommandResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateSwarmCommandResponse(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update SwarmCommandResponse";
            console.error("Failed to update SwarmCommandResponse:", error);
