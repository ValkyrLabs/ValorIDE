...
import { useLazyGetCompleteUploadRequestsPagedQuery, useAddCompleteUploadRequestMutation, useUpdateCompleteUploadRequestMutation, useDeleteCompleteUploadRequestMutation, useDeleteCompleteUploadRequestCascadeMutation, } from "@thor/redux/services/CompleteUploadRequestService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteCompleteUploadRequestCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateCompleteUploadRequest(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update CompleteUploadRequest";
            console.error("Failed to update CompleteUploadRequest:", error);
