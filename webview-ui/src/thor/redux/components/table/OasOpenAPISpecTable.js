...
import { useLazyGetOasOpenAPISpecsPagedQuery, useAddOasOpenAPISpecMutation, useUpdateOasOpenAPISpecMutation, useDeleteOasOpenAPISpecMutation, useDeleteOasOpenAPISpecCascadeMutation, } from "@thor/redux/services/OasOpenAPISpecService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteOasOpenAPISpecCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update OasOpenAPISpec";
            console.error("Failed to update OasOpenAPISpec:", error);
