...
import { useLazyGetMcpToolPresetsPagedQuery, useAddMcpToolPresetMutation, useUpdateMcpToolPresetMutation, useDeleteMcpToolPresetMutation, useDeleteMcpToolPresetCascadeMutation, } from "@thor/redux/services/McpToolPresetService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteMcpToolPresetCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update McpToolPreset";
            console.error("Failed to update McpToolPreset:", error);
