...
const McpMarketplaceItemTagTable: React.FC = () => {
  ...
  const [updateMcpMarketplaceItemTag] =
    useUpdateMcpMarketplaceItemTagMutation();
  const [deleteMcpMarketplaceItemTag] =
    useDeleteMcpMarketplaceItemTagMutation();
  ...
  const [copiedRow, setCopiedRow] = useState<McpMarketplaceItemTag | null>(
    null,
  );
    ...
    <>
      <div className="tableContainer">
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>
              Filter McpMarketplaceItemTag (Query By Example)
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <p>
