...
import { useLazyGetProductDeliveryConfigsPagedQuery, useAddProductDeliveryConfigMutation, useUpdateProductDeliveryConfigMutation, useDeleteProductDeliveryConfigMutation, useDeleteProductDeliveryConfigCascadeMutation, } from "@thor/redux/services/ProductDeliveryConfigService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteProductDeliveryConfigCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
                    ...
                    if (picked) {
                        ...
                        setTimeout(() => {
                            setFormData((prev) => {
                                ...
                                try {
                                    updateProductDeliveryConfig(updated);
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update ProductDeliveryConfig";
            console.error("Failed to update ProductDeliveryConfig:", error);
