...
import { useLazyGetDefaultResponsesPagedQuery, useAddDefaultResponseMutation, useUpdateDefaultResponseMutation, useDeleteDefaultResponseMutation, useDeleteDefaultResponseCascadeMutation, } from "@thor/redux/services/DefaultResponseService";
    ...
    const confirmDelete = async () => {
        ...
        try {
            await Promise.all(ids.map(async (id) => {
                try {
                    await deleteDefaultResponseCascade({
                        id,
                        cascade: true,
                        trash: true,
                    }).unwrap();
    ...
    const handleSave = async (editKey) => {
        ...
        try {
            ...
            const errorMsg = error instanceof Error
                ? error.message
                : "Failed to update DefaultResponse";
            console.error("Failed to update DefaultResponse:", error);
