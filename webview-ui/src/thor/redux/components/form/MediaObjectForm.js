                        ...
                        (addMediaObjectResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addMediaObjectResult.error
                                  ? addMediaObjectResult.error.data
                                  : addMediaObjectResult.error,
                              ),
                          }),
...
const TypeLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "image", label: "Media Image" }),
      _jsx("option", { value: "audio", label: "Media Audio" }),
      _jsx("option", { value: "video", label: "Media Video" }),
      _jsx("option", { value: "shape", label: "Media Shape" }),
    ],
  });
};
