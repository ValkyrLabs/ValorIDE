                        ...
                        _jsxs("label", {
                          ...
                          children: [
                            ...
                            _jsxs(BSForm.Select, {
                              ...
                              className: errors.currentStatus
                        ...
                        (addOpportunityResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addOpportunityResult.error
                  ...
                  children: [
                    ...
                    _jsxs(Accordion.Body, {
                      children: [
                        ...
                        JSON.stringify(addOpportunityResult),
                      ],
                    }),
                  ],
                }),
...
const CurrentStatusLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "discovery", label: "Discovery" }),
      _jsx("option", { value: "won", label: "Won" }),
      _jsx("option", { value: "open", label: "Open" }),
      _jsx("option", { value: "lost", label: "Lost" }),
      _jsx("option", { value: "inactive", label: "Inactive" }),
      _jsx("option", { value: "revive", label: "Revive" }),
