                  ...
                  children: [
                    _jsxs(Accordion.Header, {
                      children: [
                        ...
                        " \u00A0 Add New RequestPasswordResetResponse",
                      ],
                    }),
                      ...
                      children: [
                        ...
                        _jsxs("label", {
                          ...
                          children: [
                            ...
                            _jsx(BSForm.Check, {
                              ...
                              checked:
                                values.requiresPhoneVerification || false,
                              onChange: (e) => {
                                setFieldTouched(
                              ...
                              className: errors.requiresPhoneVerification
                                ? "error"
                                : "",
                            }),
                            _jsx(ErrorMessage, {
                        ...
                        _jsxs(CoolButton, {
                          ...
                          children: [
                            ...
                            " Create New RequestPasswordResetResponse",
                          ],
                        }),
                        (addRequestPasswordResetResponseResult.isError ||
                          ...
                          _jsx(Alert, {
                            ...
                            children:
                              ...
                              JSON.stringify(
                                "data" in
                                  addRequestPasswordResetResponseResult.error
                                  ? addRequestPasswordResetResponseResult.error
                                      .data
                                  : addRequestPasswordResetResponseResult.error,
                              ),
...
const StatusLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsx("option", { value: "USER_NOT_FOUND", label: "User Not Found" }),
