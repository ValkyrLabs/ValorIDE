...
/* -----------------------------------------------------
   COMPONENT
-------------------------------------------------------- */
const RequestPasswordResetResponseForm = () => {
    ...
    const handleSubmit = async (values, { setSubmitting }) => {
        try {
            ...
            const result = await addRequestPasswordResetResponse(values).unwrap();
            if (result && result.id && currentUser.permissions.canGrantPermissions) {
                const shouldSetPermissions = window.confirm(`RequestPasswordResetResponse created successfully! Would you like to set permissions for this object?`);
    ...
    return (_jsxs("div", { children: [_jsx(Formik, { validateOnBlur: true, initialValues: initialValues, validationSchema: validationSchema, onSubmit: handleSubmit, children: ({ isSubmitting, isValid, errors, values, setFieldValue, touched, setFieldTouched, handleSubmit, }) => {
                    ...
                    return (_jsx("form", { onSubmit: handleSubmit, className: "form", children: _jsxs(Accordion, { defaultActiveKey: "1", children: [_jsxs(Accordion.Item, { eventKey: "1", children: [_jsxs(Accordion.Header, { children: [_jsx(FaRegPlusSquare, { size: 28 }), " \u00A0 Add New RequestPasswordResetResponse"] }), _jsxs(Accordion.Body, { children: [_jsxs("label", { htmlFor: "status", className: "nice-form-control", children: [_jsxs("b", { children: ["Status:", touched.status && !errors.status && (_jsxs("span", { className: "okCheck", children: [_jsx(FaCheckCircle, {}), " looks good!"] }))] }), _jsxs(BSForm.Select, { name: "status", value: values.status || "", className: errors.status
                                                        ...
                                                        ? isSaving
                                                            ? "disabled"
                                                            : "success"
                                                        : "warning", type: "submit", disabled: !isValid || isSaving, children: [isSaving && (_jsx("span", { style: { float: "left", minHeight: 0 }, children: _jsx(LoadingSpinner, { label: "", size: 18 }) })), _jsx(FaCheckCircle, { size: 28 }), " Create New RequestPasswordResetResponse"] }), (addRequestPasswordResetResponseResult.isError ||
                                                    errorMessage) && (_jsx(Alert, { variant: "danger", className: "mt-3", children: errorMessage ||
                                                        JSON.stringify("data" in
                                                            ...
                                                            ? addRequestPasswordResetResponseResult
                                                                .error.data
                                                            : addRequestPasswordResetResponseResult
                                                                .error) })), (addRequestPasswordResetResponseResult.isSuccess ||
                                                    successMessage) && (_jsx(Alert, { variant: "success", className: "mt-3", children: successMessage || "Saved successfully." }))] })] }), _jsxs(Accordion.Item, { eventKey: "0", children: [_jsxs(Accordion.Header, { children: [_jsx(FaCogs, { size: 28 }), " \u00A0Server Messages"] }), _jsxs(Accordion.Body, { children: ["errors: ", JSON.stringify(errors), _jsx("br", {}), "addRequestPasswordResetResponseResult:", " ", JSON.stringify(addRequestPasswordResetResponseResult)] })] })] }) }));
                } }), createdObjectId && (_jsx(PermissionDialog, { objectType: "com.valkyrlabs.model.RequestPasswordResetResponse", objectId: createdObjectId, isVisible: showPermissionDialog, onClose: handlePermissionDialogClose, onSave: handlePermissionsSave, currentUser: currentUser }))] }));
};
/*
...
*/
const StatusLookup = () => {
    return (_jsxs(_Fragment, { children: [_jsx("option", { value: "SENT", label: "Sent" }), _jsx("option", { value: "USER_NOT_FOUND", label: "User Not Found" }), _jsx("option", { value: "ACCOUNT_LOCKED", label: "Account Locked" })] }));
};
/* Export the generated form */
export default RequestPasswordResetResponseForm;
//# sourceMappingURL=RequestPasswordResetResponseForm.js.map