...
const ChannelSubscriptionForm: React.FC = () => {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      const result = await addChannelSubscription(values as any).unwrap();
  ...
  return (
    <div>
      <Formik
        validateOnBlur={true}
        initialValues={initialValues as ChannelSubscription}
                ...
                <Accordion.Body>
                  ...
                  {addChannelSubscriptionResult.error && (
                    <div className="error" style={{ marginTop: 12 }}>
                      {JSON.stringify(
                        "data" in (addChannelSubscriptionResult as any).error
