                        ...
                        (addSpaceResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addSpaceResult.error
                                  ? addSpaceResult.error.data
                                  : addSpaceResult.error,
                              ),
                          }),
...
const TypeLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "personal", label: "Personal" }),
      _jsx("option", { value: "shared", label: "Shared" }),
      _jsx("option", { value: "public", label: "Public" }),
      _jsx("option", { value: "data_room", label: "Data Room" }),
    ],
  });
};
