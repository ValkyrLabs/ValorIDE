...
/* -----------------------------------------------------
   COMPONENT
-------------------------------------------------------- */
const InitiateTwoFactorRequestForm = () => {
    ...
    const handleSubmit = async (values, { setSubmitting }) => {
        try {
            ...
            const result = await addInitiateTwoFactorRequest(values).unwrap();
            if (result && result.id && currentUser.permissions.canGrantPermissions) {
                const shouldSetPermissions = window.confirm(`InitiateTwoFactorRequest created successfully! Would you like to set permissions for this object?`);
    ...
    return (_jsxs("div", { children: [_jsx(Formik, { validateOnBlur: true, initialValues: initialValues, validationSchema: validationSchema, onSubmit: handleSubmit, children: ({ isSubmitting, isValid, errors, values, setFieldValue, touched, setFieldTouched, handleSubmit, }) => {
                    ...
                    return (_jsx("form", { onSubmit: handleSubmit, className: "form", children: _jsxs(Accordion, { defaultActiveKey: "1", children: [_jsxs(Accordion.Item, { eventKey: "1", children: [_jsxs(Accordion.Header, { children: [_jsx(FaRegPlusSquare, { size: 28 }), " \u00A0 Add New InitiateTwoFactorRequest"] }), _jsxs(Accordion.Body, { children: [_jsxs("label", { htmlFor: "principalId", className: "nice-form-control", children: [_jsxs("b", { children: ["Principal Id:", touched.principalId && !errors.principalId && (_jsxs("span", { className: "okCheck", children: [_jsx(FaCheckCircle, {}), " looks good!"] }))] }), _jsx(SmartField, { name: "principalId", value: values?.principalId, placeholder: "Principal Id", setFieldValue: setFieldValue, setFieldTouched: setFieldTouched }), _jsx(ErrorMessage, { className: "error", name: "principalId", component: "span" })] }), _jsx("br", {}), _jsxs("label", { htmlFor: "method", className: "nice-form-control", children: [_jsxs("b", { children: ["Method:", touched.method && !errors.method && (_jsxs("span", { className: "okCheck", children: [_jsx(FaCheckCircle, {}), " looks good!"] }))] }), _jsxs(BSForm.Select, { name: "method", value: values.method || "", className: errors.method
                                                        ...
                                                        ? isSaving
                                                            ? "disabled"
                                                            : "success"
                                                        : "warning", type: "submit", disabled: !isValid || isSaving, children: [isSaving && (_jsx("span", { style: { float: "left", minHeight: 0 }, children: _jsx(LoadingSpinner, { label: "", size: 18 }) })), _jsx(FaCheckCircle, { size: 28 }), " Create New InitiateTwoFactorRequest"] }), (addInitiateTwoFactorRequestResult.isError ||
                                                    errorMessage) && (_jsx(Alert, { variant: "danger", className: "mt-3", children: errorMessage ||
                                                        JSON.stringify("data" in
                                                            addInitiateTwoFactorRequestResult.error
                                                            ? addInitiateTwoFactorRequestResult.error
                                                                .data
                                                            : addInitiateTwoFactorRequestResult
                                                                .error) })), (addInitiateTwoFactorRequestResult.isSuccess ||
                                                    successMessage) && (_jsx(Alert, { variant: "success", className: "mt-3", children: successMessage || "Saved successfully." }))] })] }), _jsxs(Accordion.Item, { eventKey: "0", children: [_jsxs(Accordion.Header, { children: [_jsx(FaCogs, { size: 28 }), " \u00A0Server Messages"] }), _jsxs(Accordion.Body, { children: ["errors: ", JSON.stringify(errors), _jsx("br", {}), "addInitiateTwoFactorRequestResult:", " ", JSON.stringify(addInitiateTwoFactorRequestResult)] })] })] }) }));
                } }), createdObjectId && (_jsx(PermissionDialog, { objectType: "com.valkyrlabs.model.InitiateTwoFactorRequest", objectId: createdObjectId, isVisible: showPermissionDialog, onClose: handlePermissionDialogClose, onSave: handlePermissionsSave, currentUser: currentUser }))] }));
};
/*
...
*/
const MethodLookup = () => {
    return (_jsxs(_Fragment, { children: [_jsx("option", { value: "TOTP", label: "Totp" }), _jsx("option", { value: "SMS", label: "Sms" })] }));
};
/* Export the generated form */
export default InitiateTwoFactorRequestForm;
//# sourceMappingURL=InitiateTwoFactorRequestForm.js.map