                        ...
                        (addPresignRequestResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addPresignRequestResult.error
...
const DispositionLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "inline", label: "Inline" }),
      _jsx("option", { value: "attachment", label: "Attachment" }),
    ],
  });
};
