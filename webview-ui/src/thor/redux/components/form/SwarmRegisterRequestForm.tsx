...
const SwarmRegisterRequestForm: React.FC = () => {
  const [addSwarmRegisterRequest, addSwarmRegisterRequestResult] =
  ...
  const handleSubmit = async (
    values: FormikValues,
    { setSubmitting }: FormikHelpers<SwarmRegisterRequest>,
  ) => {
    try {
                ...
                <Accordion.Body>
                  ...
                  {addSwarmRegisterRequestResult.error && (
                    <div className="error" style={{ marginTop: 12 }}>
                      {JSON.stringify(
                        "data" in (addSwarmRegisterRequestResult as any).error
                          ? (addSwarmRegisterRequestResult as any).error.data
                          : (addSwarmRegisterRequestResult as any).error,
                      )}
                    </div>
                  )}
                </Accordion.Body>
