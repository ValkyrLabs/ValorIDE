                      ...
                      children: [
                          ...
                          children: [
                            ...
                            _jsxs(BSForm.Select, {
                              ...
                              children: [
                                _jsx("option", {
                                  value: "",
                                  label: "Select Wizard Status",
                                }),
                                _jsx(WizardStatusLookup, {}),
                              ],
                            }),
                            _jsx(ErrorMessage, {
                              className: "error",
                        ...
                        _jsxs(CoolButton, {
                          ...
                          children: [
                            ...
                            " Create New ProductFunnelWizard",
                          ],
                        }),
                        (addProductFunnelWizardResult.isError ||
                          errorMessage) &&
                          _jsx(Alert, {
                            variant: "danger",
                            className: "mt-3",
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addProductFunnelWizardResult.error
...
const TemplateTypeLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "BASIC", label: "Basic" }),
      _jsx("option", { value: "PREMIUM", label: "Premium" }),
      _jsx("option", { value: "ENTERPRISE", label: "Enterprise" }),
    ],
  });
};
/*
...
const WizardStatusLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsx("option", { value: "GENERATING", label: "Generating" }),
