...
const DefaultResponseForm = () => {
  const [addDefaultResponse, addDefaultResponseResult] =
                        ...
                        (addDefaultResponseResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addDefaultResponseResult.error
                                  ? addDefaultResponseResult.error.data
                                  : addDefaultResponseResult.error,
                              ),
                          }),
                        (addDefaultResponseResult.isSuccess ||
                          successMessage) &&
                          _jsx(Alert, {
                            variant: "success",
                            className: "mt-3",
                  ...
                  children: [
                    ...
                    _jsxs(Accordion.Body, {
                      children: [
                        ...
                        _jsx("br", {}),
                        "addDefaultResponseResult:",
                        " ",
                        JSON.stringify(addDefaultResponseResult),
                      ],
                    }),
                  ],
                }),
