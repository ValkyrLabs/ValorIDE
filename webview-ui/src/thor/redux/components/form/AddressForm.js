                        ...
                        (addAddressResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addAddressResult.error
                  ...
                  children: [
                    ...
                    _jsxs(Accordion.Body, {
                      children: [
                        ...
                        _jsx("br", {}),
                        "addAddressResult: ",
                        JSON.stringify(addAddressResult),
                      ],
                    }),
                  ],
                }),
...
const AddressTypeLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "home", label: "Home" }),
      _jsx("option", { value: "mail", label: "Mail" }),
      _jsx("option", { value: "work", label: "Work" }),
      _jsx("option", { value: "school", label: "School" }),
