                        ...
                        (addRatingResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addRatingResult.error
                                  ? addRatingResult.error.data
                                  : addRatingResult.error,
                              ),
                          }),
                  ...
                  children: [
                    ...
                    _jsxs(Accordion.Body, {
                      children: [
                        ...
                        _jsx("br", {}),
                        "addRatingResult: ",
                        JSON.stringify(addRatingResult),
                      ],
                    }),
                  ],
                }),
...
const TargetTypeLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "homepage", label: "Homepage" }),
      _jsx("option", { value: "webpage", label: "Webpage" }),
      _jsx("option", { value: "application", label: "Application" }),
      _jsx("option", { value: "function", label: "Function" }),
      _jsx("option", { value: "api", label: "Api" }),
      _jsx("option", { value: "service", label: "Service" }),
      _jsx("option", { value: "content", label: "Content" }),
      _jsx("option", { value: "schema", label: "Schema" }),
      _jsx("option", { value: "application", label: "Application 2" }),
      _jsx("option", { value: "feature", label: "Feature" }),
      _jsx("option", { value: "helpfulness", label: "Helpfulness" }),
      _jsx("option", { value: "satisfaction", label: "Satisfaction" }),
