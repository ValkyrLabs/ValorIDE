                        ...
                        _jsxs("label", {
                          ...
                          children: [
                            ...
                            _jsxs(BSForm.Select, {
                              ...
                              className: errors.priorityLevel
                        ...
                        (addStrategicPriorityResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addStrategicPriorityResult.error
                                  ? addStrategicPriorityResult.error.data
                                  : addStrategicPriorityResult.error,
                              ),
                          }),
...
const PriorityLevelLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsx("option", { value: "critical", label: "Critical" }),
    ],
  });
};
/*
...
const StatusLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "Not-Started", label: "Not Started" }),
      _jsx("option", { value: "In-Progress", label: "In Progress" }),
      _jsx("option", { value: "Complete", label: "Complete" }),
    ],
  });
};
