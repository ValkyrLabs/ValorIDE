...
const validationSchema = Yup.object().shape({
  ...
  status: asNumber(
    Yup.number().integer().typeError("status must be a number"),
  ).required("status is required."),
  durationMs: asNumber(
    Yup.number().integer().typeError("durationMs must be a number"),
  ).required("durationMs is required."),
  timestamp: Yup.date()
                        ...
                        (addApiTrafficEventResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addApiTrafficEventResult.error
                                  ? addApiTrafficEventResult.error.data
                                  : addApiTrafficEventResult.error,
                              ),
                          }),
                        (addApiTrafficEventResult.isSuccess ||
                          successMessage) &&
                          _jsx(Alert, {
                            variant: "success",
                            className: "mt-3",
