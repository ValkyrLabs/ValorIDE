...
const ProductDeliveryConfigForm = () => {
    ...
    return (_jsxs("div", { children: [_jsx(Formik, { validateOnBlur: true, initialValues: initialValues, validationSchema: validationSchema, onSubmit: handleSubmit, children: ({ isSubmitting, isValid, errors, values, setFieldValue, touched, setFieldTouched, handleSubmit, }) => (_jsx("form", { onSubmit: handleSubmit, className: "form", children: _jsxs(Accordion, { defaultActiveKey: "1", children: [_jsxs(Accordion.Item, { eventKey: "1", children: [_jsxs(Accordion.Header, { children: [_jsx(FaRegPlusSquare, { size: 28 }), " \u00A0 Add New ProductDeliveryConfig"] }), _jsxs(Accordion.Body, { children: [_jsxs("label", { htmlFor: "productId", className: "nice-form-control", children: [_jsxs("b", { children: ["Product Id:", touched.productId && !errors.productId && (_jsxs("span", { className: "okCheck", children: [_jsx(FaCheckCircle, {}), " looks good!"] }))] }), _jsx(SmartField, { name: "productId", value: values?.productId, placeholder: "Product Id", setFieldValue: setFieldValue, setFieldTouched: setFieldTouched }), _jsx(ErrorMessage, { className: "error", name: "productId", component: "span" })] }), _jsx("br", {}), _jsxs("label", { htmlFor: "deliveryType", className: "nice-form-control", children: [_jsxs("b", { children: ["Delivery Type:", touched.deliveryType && !errors.deliveryType && (_jsxs("span", { className: "okCheck", children: [_jsx(FaCheckCircle, {}), " looks good!"] }))] }), _jsxs(BSForm.Select, { name: "deliveryType", value: values.deliveryType || "", className: errors.deliveryType
                                                    ...
                                                    ? isSubmitting
                                                        ? "disabled"
                                                        : "success"
                                                    : "warning", type: "submit", disabled: !isValid || isSubmitting, children: [isSubmitting && (_jsx("span", { style: { float: "left", minHeight: 0 }, children: _jsx(LoadingSpinner, { label: "", size: 18 }) })), _jsx(FaCheckCircle, { size: 28 }), " Create New ProductDeliveryConfig"] }), addProductDeliveryConfigResult.error && (_jsx("div", { className: "error", style: { marginTop: 12 }, children: JSON.stringify("data" in addProductDeliveryConfigResult.error
                                                    ? addProductDeliveryConfigResult.error.data
                                                    : addProductDeliveryConfigResult.error) }))] })] }), _jsxs(Accordion.Item, { eventKey: "0", children: [_jsxs(Accordion.Header, { children: [_jsx(FaCogs, { size: 28 }), " \u00A0Server Messages"] }), _jsxs(Accordion.Body, { children: ["errors: ", JSON.stringify(errors), _jsx("br", {}), "addProductDeliveryConfigResult:", " ", JSON.stringify(addProductDeliveryConfigResult)] })] })] }) })) }), createdObjectId && (_jsx(PermissionDialog, { objectType: "com.valkyrlabs.model.ProductDeliveryConfig", objectId: createdObjectId, isVisible: showPermissionDialog, onClose: handlePermissionDialogClose, onSave: handlePermissionsSave, currentUser: currentUser }))] }));
};
/*
