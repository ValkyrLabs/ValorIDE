                        ...
                        (addReferralLinkResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addReferralLinkResult.error
                                  ? addReferralLinkResult.error.data
                                  : addReferralLinkResult.error,
                              ),
                          }),
...
const ReferralTypeLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "internal", label: "Internal" }),
