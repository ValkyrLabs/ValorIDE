                        ...
                        (addApplicationResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addApplicationResult.error
                                  ? addApplicationResult.error.data
                                  : addApplicationResult.error,
                              ),
                          }),
...
const TypeLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "full-stack", label: "Full Stack" }),
      _jsx("option", { value: "automation", label: "Automation" }),
      _jsx("option", { value: "agent", label: "Agent" }),
      _jsx("option", { value: "service", label: "Service" }),
      _jsx("option", { value: "front-end", label: "Front End" }),
      _jsx("option", { value: "mobile", label: "Mobile" }),
      _jsx("option", { value: "ci-cd", label: "Ci Cd" }),
      _jsx("option", { value: "lambda", label: "Lambda" }),
    ],
  });
};
/*
...
const StatusLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsx("option", { value: "deployed", label: "Deployed" }),
      _jsx("option", { value: "staging", label: "Staging" }),
