                        ...
                        (addSecureKeyResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addSecureKeyResult.error
...
const StatusLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "ACTIVE", label: "Key Active" }),
      _jsx("option", { value: "DEFAULT", label: "Key Default" }),
      _jsx("option", { value: "ARCHIVED", label: "Key Archived" }),
      _jsx("option", { value: "REVOKED", label: "Key Revoked" }),
      _jsx("option", { value: "INVALID", label: "Key Invalid" }),
    ],
  });
};
