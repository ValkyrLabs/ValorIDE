...
const BackupConfigForm: React.FC = () => {
	...
	/* SUBMIT HANDLER */
	const handleSubmit = (values: FormikValues, { setSubmitting }: FormikHelpers<BackupConfig>) => {
								...
								<Accordion.Body>
									...
									<label htmlFor="runNumber" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.runNumber ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="backupDir" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.backupDir ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="workingDir" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.workingDir ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="skiplist" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.skiplist ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
