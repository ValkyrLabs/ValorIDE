                        ...
                        (addMcpServerResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addMcpServerResult.error
                  ...
                  children: [
                    ...
                    _jsxs(Accordion.Body, {
                      children: [
                        ...
                        _jsx("br", {}),
                        "addMcpServerResult: ",
                        JSON.stringify(addMcpServerResult),
                      ],
                    }),
                  ],
                }),
...
const StatusLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "connected", label: "Connected" }),
      _jsx("option", { value: "connecting", label: "Connecting" }),
      _jsx("option", { value: "disconnected", label: "Disconnected" }),
    ],
  });
};
