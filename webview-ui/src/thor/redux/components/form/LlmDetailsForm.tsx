...
const ProviderValidation = () => {
	return ["valkyrai", "openai", "llama", "phi", "gemma", "mistral", "claude", "gemini", "other", "chatgpt_pass_through"]
}
...
const LlmDetailsForm: React.FC = () => {
	...
	const initialValues: Partial<LlmDetails> = {
		...
		id: "8cc4df0c-f41d-4c3d-a806-663eb4e54e60",

		ownerId: "a8ab8376-19fc-4056-b443-9bbd763ab2b6",

		keyHash: "null",

		lastAccessedById: "a564116f-4297-47d6-9226-ae6b7dbe423a",

		lastModifiedById: "b84829b1-cfef-4c82-912e-af455ae0a782",
	}

	/* SUBMIT HANDLER */
	const handleSubmit = (values: FormikValues, { setSubmitting }: FormikHelpers<LlmDetails>) => {
								...
								<Accordion.Body>
									...
									<label htmlFor="provider" className="nice-form-control">
										...
										<BSForm.Select
											name="provider"
											className={
												errors.provider ? "form-control field-error" : "nice-form-control form-control"
											}
											onChange={(e) => {
									...
									<label htmlFor="apiType" className="nice-form-control">
										...
										<BSForm.Select
											name="apiType"
											className={
												errors.apiType ? "form-control field-error" : "nice-form-control form-control"
											}
											onChange={(e) => {
									...
									<label htmlFor="apiKey" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.apiKey ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="credential" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.credential ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="credentialPassword" className="nice-form-control">
										<b>
											Credential Password:
											{touched.credentialPassword && !errors.credentialPassword && (
												<span className="okCheck">
													<FaCheckCircle /> looks good!
												</span>
											)}
									...
									<label htmlFor="requestParameters" className="nice-form-control">
										<b>
											Request Parameters:
											{touched.requestParameters && !errors.requestParameters && (
												<span className="okCheck">
													<FaCheckCircle /> looks good!
												</span>
											)}
									...
									<label htmlFor="meta" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.meta ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
