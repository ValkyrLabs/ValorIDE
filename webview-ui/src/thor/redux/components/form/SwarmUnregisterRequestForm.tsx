...
const SwarmUnregisterRequestForm: React.FC = () => {
  const [addSwarmUnregisterRequest, addSwarmUnregisterRequestResult] =
  ...
  const handleSubmit = async (
    values: FormikValues,
    { setSubmitting }: FormikHelpers<SwarmUnregisterRequest>,
  ) => {
    try {
            ...
            <Accordion defaultActiveKey="1">
                ...
                <Accordion.Body>
                  ...
                  {addSwarmUnregisterRequestResult.error && (
                    <div className="error" style={{ marginTop: 12 }}>
                      {JSON.stringify(
                        "data" in (addSwarmUnregisterRequestResult as any).error
                          ? (addSwarmUnregisterRequestResult as any).error.data
                          : (addSwarmUnregisterRequestResult as any).error,
                      )}
                    </div>
                  )}
                </Accordion.Body>
              ...
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  ...
                  {JSON.stringify(addSwarmUnregisterRequestResult)}
                </Accordion.Body>
              </Accordion.Item>
            </Accordion>
          </form>
