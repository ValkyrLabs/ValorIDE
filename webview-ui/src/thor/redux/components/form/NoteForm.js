...
const validationSchema = Yup.object().shape({
  ...
  entityType: Yup.mixed().oneOf(
    EntityTypeValidation(),
    "Invalid value for entityType",
  ),
  name: Yup.string(),
...
const EntityTypeLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "customer", label: "Customer" }),
      _jsx("option", { value: "opportunity", label: "Opportunity" }),
      _jsx("option", { value: "contact", label: "Contact" }),
      _jsx("option", { value: "sales-activity", label: "Sales Activity" }),
    ],
  });
};
