...
const validationSchema = Yup.object().shape({
	...
	entityType: Yup.mixed().oneOf(EntityTypeValidation(), "Invalid value for entityType").required("entityType is required."),
	content: Yup.string()
...
const NoteForm: React.FC = () => {
	...
	/* SUBMIT HANDLER */
	const handleSubmit = (values: FormikValues, { setSubmitting }: FormikHelpers<Note>) => {
								...
								<Accordion.Body>
									<label htmlFor="noteId" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.noteId ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="associatedEntityId" className="nice-form-control">
										<b>
											...
											{touched.associatedEntityId && !errors.associatedEntityId && (
												<span className="okCheck">
													<FaCheckCircle /> looks good!
												</span>
											)}
									...
									<label htmlFor="entityType" className="nice-form-control">
										...
										<BSForm.Select
											name="entityType"
											className={
												errors.entityType ? "form-control field-error" : "nice-form-control form-control"
											}
											onChange={(e) => {
									...
									<label htmlFor="createdBy" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.createdBy ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
