...
const StatusLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "UP_TO_DATE", label: "Up To Date" }),
      _jsx("option", { value: "OUTDATED", label: "Outdated" }),
      _jsx("option", { value: "MISSING", label: "Missing" }),
    ],
  });
};
