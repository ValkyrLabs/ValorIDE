...
const validationSchema = Yup.object().shape({
	...
	appliedFix: Yup.boolean().oneOf([true], "The appliedFix must be true.").required("appliedFix is required."),
	id: Yup.string(),
...
const SolutionForm: React.FC = () => {
	...
	/* SUBMIT HANDLER */
	const handleSubmit = (values: FormikValues, { setSubmitting }: FormikHelpers<Solution>) => {
