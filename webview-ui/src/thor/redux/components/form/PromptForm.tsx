...
import { Prompt, PromptPromptTypeEnum } from "@thor/model";
...
const validationSchema = Yup.object().shape({
  ...
  promptType: Yup.mixed().oneOf(
    PromptTypeValidation(),
    "Invalid value for promptType",
  ),
  id: Yup.string(),
  ownerId: Yup.string(),
...
const PromptForm: React.FC = () => {
  ...
  -------------------------------------------------------- */
  const initialValues: Partial<Prompt> = {
    name: "",
    description: "",
    promptText: "",
    initialPrompt: "",
  ...
  const handleSubmit = async (
    values: FormikValues,
    { setSubmitting }: FormikHelpers<Prompt>,
  ) => {
    try {
      console.log("Prompt form values:", values);

      // NOTE: depending on your generated endpoint, you may need { body: values }
      const result = await addPrompt(values as any).unwrap();

      if (result && result.id && currentUser.permissions.canGrantPermissions) {
        const shouldSetPermissions = window.confirm(
          `Prompt created successfully! Would you like to set permissions for this object?`,
        );
  ...
  return (
    <div>
      <Formik
        validateOnBlur={true}
        initialValues={initialValues as Prompt}
          ...
          <form onSubmit={handleSubmit} className="form">
            <Accordion defaultActiveKey="1">
              ...
              <Accordion.Item eventKey="1">
                <Accordion.Header>
                  <FaRegPlusSquare size={28} /> &nbsp; Add New Prompt
                </Accordion.Header>
                <Accordion.Body>
                  ...
                  <br />
                  <label htmlFor="promptText" className="nice-form-control">
                    <b>
                      Prompt Text:
                      {touched.promptText && !errors.promptText && (
                        <span className="okCheck">
                          <FaCheckCircle /> looks good!
                        </span>
                      )}
                  ...
                  <br />
                  <label htmlFor="promptType" className="nice-form-control">
                    <b>
                      Prompt Type:
                      {touched.promptType && !errors.promptType && (
                        <span className="okCheck">
                          <FaCheckCircle /> looks good!
                        </span>
                      )}
                    ...
                    >
                      <option value="" label="Select Prompt Type" />
                      <PromptTypeLookup />
                    </BSForm.Select>
                  ...
                  <label htmlFor="ratingScore" className="nice-form-control">
                    <b>
                      Rating Score:
                      {touched.ratingScore && !errors.ratingScore && (
                        <span className="okCheck">
                          <FaCheckCircle /> looks good!
                        </span>
                      )}
                  ...
                  >
                    ...
                    <FaCheckCircle size={28} /> Create New Prompt
                  </CoolButton>

                  {addPromptResult.error && (
                    <div className="error" style={{ marginTop: 12 }}>
                      {JSON.stringify(
                        "data" in (addPromptResult as any).error
                          ? (addPromptResult as any).error.data
                          : (addPromptResult as any).error,
                      )}
                    </div>
                  )}
                </Accordion.Body>
              ...
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  ...
                  <br />
                  addPromptResult: {JSON.stringify(addPromptResult)}
                </Accordion.Body>
              </Accordion.Item>
            </Accordion>
          </form>
...
const PromptTypeLookup = () => {
  return (
    <>
      ...
      <option value="APPEND" label="Append" />
    </>
  );
};
