...
const SwarmRegisterResponseForm: React.FC = () => {
  const [addSwarmRegisterResponse, addSwarmRegisterResponseResult] =
  ...
  const handleSubmit = async (
    values: FormikValues,
    { setSubmitting }: FormikHelpers<SwarmRegisterResponse>,
  ) => {
    try {
            ...
            <Accordion defaultActiveKey="1">
                ...
                <Accordion.Body>
                  ...
                  {addSwarmRegisterResponseResult.error && (
                    <div className="error" style={{ marginTop: 12 }}>
                      {JSON.stringify(
                        "data" in (addSwarmRegisterResponseResult as any).error
                          ? (addSwarmRegisterResponseResult as any).error.data
                          : (addSwarmRegisterResponseResult as any).error,
                      )}
                    </div>
                  )}
                </Accordion.Body>
              ...
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  ...
                  {JSON.stringify(addSwarmRegisterResponseResult)}
                </Accordion.Body>
              </Accordion.Item>
            </Accordion>
          </form>
