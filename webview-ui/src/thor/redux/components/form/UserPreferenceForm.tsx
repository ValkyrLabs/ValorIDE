...
import { UserPreference, UserPreferencePreferenceTypeEnum } from "../../../model"
...
const UserPreferenceForm: React.FC = () => {
	...
	const initialValues: Partial<UserPreference> = {
		...
		preferenceType: UserPreferencePreferenceTypeEnum[Object.keys(UserPreferencePreferenceTypeEnum)[0]],
	...
	/* SUBMIT HANDLER */
	const handleSubmit = (values: FormikValues, { setSubmitting }: FormikHelpers<UserPreference>) => {
								...
								<Accordion.Body>
									...
									<label htmlFor="preference" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.preference ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
