...
const McpToolForm: React.FC = () => {
	...
	/* SUBMIT HANDLER */
	const handleSubmit = (values: FormikValues, { setSubmitting }: FormikHelpers<McpTool>) => {
								...
								<Accordion.Body>
									...
									<label htmlFor="inputSchema" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.inputSchema ? "form-control field-error" : "nice-form-control form-control"
											}
										/>

										<ErrorMessage className="error" name="inputSchema" component="span" />
									</label>
									<br />
									...
									<label htmlFor="autoApprove" className="nice-form-control">
										...
										<ErrorMessage className="error" name="autoApprove" component="span" />
									</label>
									<br />
