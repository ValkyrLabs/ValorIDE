                          ...
                          children: [
                            ...
                            _jsxs(BSForm.Select, {
                              ...
                              children: [
                                _jsx("option", {
                                  value: "",
                                  label: "Select Template Repo",
                                }),
                                _jsx(TemplateRepoLookup, {}),
                              ],
                            }),
                            _jsx(ErrorMessage, {
                              className: "error",
...
const CategoryLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsx("option", { value: "Data Library", label: "Data Library" }),
      _jsx("option", { value: "Infrastructure", label: "Infrastructure" }),
...
const LanguageLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "valkyrai_java_spring", label: "Java Spring" }),
      _jsx("option", {
        value: "valkyrai_kotlin_spring",
        label: "Kotlin Spring",
      }),
    ],
  });
...
const TemplateRepoLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "java_spring", label: "Java Spring" }),
      _jsx("option", {
...
const StatusLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsx("option", { value: "syntax_error", label: "Syntax Error" }),
      _jsx("option", {
        value: "compilation_error",
        label: "Compilation Error",
      }),
      _jsx("option", { value: "runtime_error", label: "Runtime Error" }),
      _jsx("option", { value: "database_error", label: "Database Error" }),
      _jsx("option", { value: "locked", label: "Locked" }),
    ],
  });
};
