                        ...
                        _jsxs("label", {
                          ...
                          children: [
                            ...
                            _jsxs(BSForm.Select, {
                              ...
                              className: errors.preferenceType
                        ...
                        (addUserPreferenceResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addUserPreferenceResult.error
                                  ? addUserPreferenceResult.error.data
                                  : addUserPreferenceResult.error,
                              ),
                          }),
...
const PreferenceTypeLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "ux-layout", label: "Ux Layout" }),
      _jsx("option", { value: "ux-mode", label: "Ux Mode" }),
      _jsx("option", { value: "ux-theme", label: "Ux Theme" }),
      _jsx("option", { value: "measurement", label: "Measurement" }),
      _jsx("option", { value: "chatmemory", label: "Chatmemory" }),
    ],
  });
};
