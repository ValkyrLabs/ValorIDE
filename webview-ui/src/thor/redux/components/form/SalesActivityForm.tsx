...
const validationSchema = Yup.object().shape({
	...
	type: Yup.mixed().oneOf(TypeValidation(), "Invalid value for type").required("type is required."),
...
const SalesActivityForm: React.FC = () => {
	...
	/* SUBMIT HANDLER */
	const handleSubmit = (values: FormikValues, { setSubmitting }: FormikHelpers<SalesActivity>) => {
								...
								<Accordion.Body>
									...
									<label htmlFor="performedBy" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.performedBy ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="details" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.details ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
