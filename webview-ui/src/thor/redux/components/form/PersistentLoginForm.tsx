...
const PersistentLoginForm: React.FC = () => {
	...
	/* SUBMIT HANDLER */
	const handleSubmit = (values: FormikValues, { setSubmitting }: FormikHelpers<PersistentLogin>) => {
								...
								<Accordion.Body>
									...
									<label htmlFor="series" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.series ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="token" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.token ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
