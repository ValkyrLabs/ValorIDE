...
const RoleLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "ANONYMOUS", label: "ROLE _ ANONYMOUS" }),
      _jsx("option", { value: "EVERYONE", label: "ROLE _ EVERYONE" }),
      _jsx("option", { value: "SYSTEM", label: "ROLE _ SYSTEM" }),
      _jsx("option", { value: "USER", label: "ROLE _ USER" }),
      _jsx("option", { value: "STAFF", label: "ROLE _ STAFF" }),
      _jsx("option", { value: "ADMIN", label: "ROLE _ ADMIN" }),
      _jsx("option", { value: "CUSTOM", label: "ROLE _ CUSTOM" }),
    ],
  });
};
