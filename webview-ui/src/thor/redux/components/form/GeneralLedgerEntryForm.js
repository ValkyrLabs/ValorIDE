                        ...
                        _jsxs("label", {
                          ...
                          children: [
                            ...
                            _jsxs(BSForm.Select, {
                              ...
                              className: errors.referenceType
                                ? "form-control field-error"
                                : "nice-form-control form-control",
                              onChange: (e) => {
                        ...
                        (addGeneralLedgerEntryResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addGeneralLedgerEntryResult.error
...
const ReferenceTypeLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsx("option", { value: "UsageTransaction", label: "Usage Transaction" }),
      _jsx("option", { value: "SalesOrder", label: "Sales Order" }),
      _jsx("option", { value: "Invoice", label: "Invoice" }),
      _jsx("option", { value: "Expense", label: "Expense" }),
    ],
  });
};
