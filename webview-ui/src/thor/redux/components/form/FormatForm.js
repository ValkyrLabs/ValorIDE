...
const FormatForm = () => {
    ...
    return (_jsxs("div", { children: [_jsx(Formik, { validateOnBlur: true, initialValues: initialValues, validationSchema: validationSchema, onSubmit: handleSubmit, children: ({ isSubmitting, isValid, errors, values, setFieldValue, touched, setFieldTouched, handleSubmit, }) => (_jsx("form", { onSubmit: handleSubmit, className: "form", children: _jsxs(Accordion, { defaultActiveKey: "1", children: [_jsxs(Accordion.Item, { eventKey: "1", children: [_jsxs(Accordion.Header, { children: [_jsx(FaRegPlusSquare, { size: 28 }), " \u00A0 Add New Format"] }), _jsxs(Accordion.Body, { children: [_jsxs("label", { htmlFor: "workbookId", className: "nice-form-control", children: [_jsxs("b", { children: ["Workbook Id:", touched.workbookId && !errors.workbookId && (_jsxs("span", { className: "okCheck", children: [_jsx(FaCheckCircle, {}), " looks good!"] }))] }), _jsx(SmartField, { name: "workbookId", value: values?.workbookId, placeholder: "Workbook Id", setFieldValue: setFieldValue, setFieldTouched: setFieldTouched }), _jsx(ErrorMessage, { className: "error", name: "workbookId", component: "span" })] }), _jsx("br", {}), _jsxs("label", { htmlFor: "fontWeight", className: "nice-form-control", children: [_jsxs("b", { children: ["Font Weight:", touched.fontWeight && !errors.fontWeight && (_jsxs("span", { className: "okCheck", children: [_jsx(FaCheckCircle, {}), " looks good!"] }))] }), _jsxs(BSForm.Select, { name: "fontWeight", value: values.fontWeight || "", className: errors.fontWeight
                                                    ...
                                                    ? isSubmitting
                                                        ? "disabled"
                                                        : "success"
                                                    : "warning", type: "submit", disabled: !isValid || isSubmitting, children: [isSubmitting && (_jsx("span", { style: { float: "left", minHeight: 0 }, children: _jsx(LoadingSpinner, { label: "", size: 18 }) })), _jsx(FaCheckCircle, { size: 28 }), " Create New Format"] }), addFormatResult.error && (_jsx("div", { className: "error", style: { marginTop: 12 }, children: JSON.stringify("data" in addFormatResult.error
                                                    ? addFormatResult.error.data
                                                    : addFormatResult.error) }))] })] }), _jsxs(Accordion.Item, { eventKey: "0", children: [_jsxs(Accordion.Header, { children: [_jsx(FaCogs, { size: 28 }), " \u00A0Server Messages"] }), _jsxs(Accordion.Body, { children: ["errors: ", JSON.stringify(errors), _jsx("br", {}), "addFormatResult: ", JSON.stringify(addFormatResult)] })] })] }) })) }), createdObjectId && (_jsx(PermissionDialog, { objectType: "com.valkyrlabs.model.Format", objectId: createdObjectId, isVisible: showPermissionDialog, onClose: handlePermissionDialogClose, onSave: handlePermissionsSave, currentUser: currentUser }))] }));
};
/*
