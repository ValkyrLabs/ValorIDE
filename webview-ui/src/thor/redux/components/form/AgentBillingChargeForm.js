                        ...
                        (addAgentBillingChargeResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addAgentBillingChargeResult.error
                                  ? addAgentBillingChargeResult.error.data
                                  : addAgentBillingChargeResult.error,
                              ),
                          }),
...
const ChargeTypeLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "INSTANTIATION", label: "Instantiation" }),
      _jsx("option", { value: "USAGE_METERED", label: "Usage Metered" }),
      _jsx("option", { value: "OVERAGE", label: "Overage" }),
    ],
  });
};
/*
...
const StatusLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsx("option", { value: "APPLIED", label: "Applied" }),
      _jsx("option", { value: "DISPUTED", label: "Disputed" }),
      _jsx("option", { value: "REFUNDED", label: "Refunded" }),
    ],
  });
};
