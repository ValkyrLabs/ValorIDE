...
const AgentForm: React.FC = () => {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      const result = await addAgent(values as any).unwrap();
  ...
  return (
    <div>
      <Formik
        validateOnBlur={true}
        initialValues={initialValues as Agent}
              ...
              <Accordion.Item eventKey="1">
                ...
                <Accordion.Body>
                  ...
                  >
                    <b>
                      Heartbeat Enabled:
                      {touched.heartbeatEnabled && !errors.heartbeatEnabled && (
                        <span className="okCheck">
                          <FaCheckCircle /> looks good!
                        </span>
                      )}
