                        ...
                        (addWorkflowExecutionResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addWorkflowExecutionResult.error
...
const StateLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsx("option", { value: "TIMEOUT", label: "Timeout" }),
    ],
  });
};
/*
...
const TriggerTypeLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsx("option", { value: "CRON", label: "Cron" }),
      _jsx("option", { value: "EVENT", label: "Event" }),
      _jsx("option", { value: "WEBHOOK", label: "Webhook" }),
      _jsx("option", { value: "QUEUE", label: "Queue" }),
    ],
  });
};
