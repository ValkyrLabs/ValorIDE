...
const AgentChatMessageRequestForm: React.FC = () => {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      const result = await addAgentChatMessageRequest(values as any).unwrap();
  ...
  return (
    <div>
      <Formik
        validateOnBlur={true}
        initialValues={initialValues as AgentChatMessageRequest}
                    ...
                    <div className="error" style={{ marginTop: 12 }}>
                      {JSON.stringify(
                        "data" in
                          ...
                          ? (addAgentChatMessageRequestResult as any).error.data
                          : (addAgentChatMessageRequestResult as any).error,
                      )}
                    </div>
                  )}
