...
const McpResourceResponseForm: React.FC = () => {
	...
	/* SUBMIT HANDLER */
	const handleSubmit = (values: FormikValues, { setSubmitting }: FormikHelpers<McpResourceResponse>) => {
								...
								<Accordion.Body>
									...
									<label htmlFor="mcpResourceResponseId" className="nice-form-control">
										<b>
											...
											{touched.mcpResourceResponseId && !errors.mcpResourceResponseId && (
												<span className="okCheck">
													<FaCheckCircle /> looks good!
												</span>
											)}
										...
										<ErrorMessage className="error" name="mcpResourceResponseId" component="span" />
									</label>
									<br />
									...
									<label htmlFor="binaryContent" className="nice-form-control">
										...
										<ErrorMessage className="error" name="binaryContent" component="span" />
									</label>
									<br />
