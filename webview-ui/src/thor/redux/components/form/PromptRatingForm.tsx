...
/* -----------------------------------------------------
   COMPONENT
-------------------------------------------------------- */
const PromptRatingForm: React.FC = () => {
  ...
  -------------------------------------------------------- */
  const initialValues: Partial<PromptRating> = {
    taskId: "",
    promptId: "",
    success: false,
    feedback: "",
  ...
  const handleSubmit = async (
    values: FormikValues,
    { setSubmitting }: FormikHelpers<PromptRating>,
  ) => {
    try {
      console.log("PromptRating form values:", values);

      // NOTE: depending on your generated endpoint, you may need { body: values }
      const result = await addPromptRating(values as any).unwrap();

      if (result && result.id && currentUser.permissions.canGrantPermissions) {
        const shouldSetPermissions = window.confirm(
          `PromptRating created successfully! Would you like to set permissions for this object?`,
        );
  ...
  return (
    <div>
      <Formik
        validateOnBlur={true}
        initialValues={initialValues as PromptRating}
          ...
          <form onSubmit={handleSubmit} className="form">
            <Accordion defaultActiveKey="1">
              ...
              <Accordion.Item eventKey="1">
                <Accordion.Header>
                  <FaRegPlusSquare size={28} /> &nbsp; Add New PromptRating
                </Accordion.Header>
                <Accordion.Body>
                  ...
                  <br />
                  <label htmlFor="promptId" className="nice-form-control">
                    <b>
                      Prompt Id:
                      {touched.promptId && !errors.promptId && (
                        <span className="okCheck">
                          <FaCheckCircle /> looks good!
                        </span>
                      )}
                  ...
                  <br />
                  <label htmlFor="tokensCost" className="nice-form-control">
                    <b>
                      Tokens Cost:
                      {touched.tokensCost && !errors.tokensCost && (
                        <span className="okCheck">
                          <FaCheckCircle /> looks good!
                        </span>
                      )}
                  ...
                  <br />
                  <label htmlFor="userRating" className="nice-form-control">
                    <b>
                      User Rating:
                  ...
                  <br />
                  <label htmlFor="feedback" className="nice-form-control">
                    <b>
                      Feedback:
                  ...
                  >
                    ...
                    <FaCheckCircle size={28} /> Create New PromptRating
                  </CoolButton>

                  {addPromptRatingResult.error && (
                    <div className="error" style={{ marginTop: 12 }}>
                      {JSON.stringify(
                        "data" in (addPromptRatingResult as any).error
                          ? (addPromptRatingResult as any).error.data
                          : (addPromptRatingResult as any).error,
                      )}
                    </div>
                  )}
                </Accordion.Body>
              ...
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  ...
                  <br />
                  addPromptRatingResult: {JSON.stringify(addPromptRatingResult)}
                </Accordion.Body>
              </Accordion.Item>
            </Accordion>
          </form>
