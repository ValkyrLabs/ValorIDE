...
const BalanceResponseForm: React.FC = () => {
	...
	const initialValues: Partial<BalanceResponse> = {
		id: "50bc09fc-a57e-4081-9c7f-69261912ae9e",

		ownerId: "451e3da3-1be9-4b06-b126-520786464363",

		keyHash: "null",

		lastAccessedById: "adaae556-d169-41db-a5bf-cdd053b4377c",

		lastModifiedById: "7ee1a617-a6d2-4ed6-a19c-7e11c1798b69",
	}

	/* SUBMIT HANDLER */
	const handleSubmit = (values: FormikValues, { setSubmitting }: FormikHelpers<BalanceResponse>) => {
		// Simulate slow network or do what you need:
		setTimeout(() => {
			console.log("BalanceResponse form values:", values)
			addBalanceResponse(values)
			setSubmitting(false)
		}, 500)
	}
							...
							<Accordion.Item eventKey="1">
								...
								<Accordion.Body>
									<label htmlFor="currentBalance" className="nice-form-control">
										...
										<ErrorMessage className="error" name="currentBalance" component="span" />
									</label>
									<br />
