...
const GoalForm: React.FC = () => {
	...
	const initialValues: Partial<Goal> = {
		...
		id: "ca669049-4eec-425c-9806-086dc5803285",

		ownerId: "3a747f8b-bf89-4e95-a57d-377738bbdcc6",

		keyHash: "null",

		lastAccessedById: "9d870127-442c-48d3-8b1c-3bf56c6321d1",

		lastModifiedById: "9a1c78a1-18bb-4209-abb0-019c63ef09ae",
	}

	/* SUBMIT HANDLER */
	const handleSubmit = (values: FormikValues, { setSubmitting }: FormikHelpers<Goal>) => {
								...
								<Accordion.Body>
									<label htmlFor="strategicPriorityId" className="nice-form-control">
										<b>
											...
											{touched.strategicPriorityId && !errors.strategicPriorityId && (
									...
									<label htmlFor="risks" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.risks ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="timeline" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.timeline ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
