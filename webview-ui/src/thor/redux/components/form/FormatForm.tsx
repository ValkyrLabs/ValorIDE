...
const AlignmentHorizontalValidation = () => {
	return ["Left", "Center", "Right", "Fill", "Justify", "CenterAcrossSelection"]
}
...
const FormatForm: React.FC = () => {
	...
	const initialValues: Partial<Format> = {
		...
		id: "b4e23a4f-c2be-4912-8798-51f19b7c2a34",

		ownerId: "d9292a56-cb8e-458c-8167-2e2d6e3a1309",

		keyHash: "null",

		lastAccessedById: "c83deeb5-edad-4ec2-84d6-18a643658bff",

		lastModifiedById: "49861720-241c-4770-8fc0-298e5625b065",
	}

	/* SUBMIT HANDLER */
	const handleSubmit = (values: FormikValues, { setSubmitting }: FormikHelpers<Format>) => {
								...
								<Accordion.Body>
									...
									<label htmlFor="fontWeight" className="nice-form-control">
										...
										<BSForm.Select
											name="fontWeight"
											className={
												errors.fontWeight ? "form-control field-error" : "nice-form-control form-control"
											}
											onChange={(e) => {
									...
									<label htmlFor="fontSize" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.fontSize ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="fontFace" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.fontFace ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="underline" className="nice-form-control">
										...
										<BSForm.Select
											name="underline"
											className={
												errors.underline ? "form-control field-error" : "nice-form-control form-control"
											}
											onChange={(e) => {
									...
									<label htmlFor="alignment-horizontal" className="nice-form-control">
										<b>
											...
											{touched.alignmentHorizontal && !errors.alignmentHorizontal && (
												<span className="okCheck">
													<FaCheckCircle /> looks good!
												</span>
											)}
									...
									<label htmlFor="alignment-vertical" className="nice-form-control">
										<b>
											Alignment - vertical:
											{touched.alignmentVertical && !errors.alignmentVertical && (
												<span className="okCheck">
													<FaCheckCircle /> looks good!
												</span>
											)}
									...
									<label htmlFor="pattern" className="nice-form-control">
										...
										<BSForm.Select
											name="pattern"
											className={
												errors.pattern ? "form-control field-error" : "nice-form-control form-control"
											}
											onChange={(e) => {
