...
const validationSchema = Yup.object().shape({
	...
	success: Yup.boolean().oneOf([true], "The success must be true.").required("success is required."),
	output: Yup.string()
...
const BuildOutputForm: React.FC = () => {
	...
	/* SUBMIT HANDLER */
	const handleSubmit = (values: FormikValues, { setSubmitting }: FormikHelpers<BuildOutput>) => {
								...
								<Accordion.Body>
									...
									<label htmlFor="output" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.output ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="lastSuccessfulRun" className="nice-form-control">
										<b>
											Last Successful Run:
											{touched.lastSuccessfulRun && !errors.lastSuccessfulRun && (
												<span className="okCheck">
													<FaCheckCircle /> looks good!
												</span>
											)}
