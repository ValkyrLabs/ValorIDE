...
const FileProcessingJobForm: React.FC = () => {
  const [addFileProcessingJob, addFileProcessingJobResult] =
  ...
  const handleSubmit = async (
    values: FormikValues,
    { setSubmitting }: FormikHelpers<FileProcessingJob>,
  ) => {
    try {
              ...
              <Accordion defaultActiveKey="1">
                  ...
                  <Accordion.Body>
                    ...
                    {(addFileProcessingJobResult.isError || errorMessage) && (
                      <Alert variant="danger" className="mt-3">
                        {errorMessage ||
                          JSON.stringify(
                            "data" in (addFileProcessingJobResult as any).error
                              ? (addFileProcessingJobResult as any).error.data
                              : (addFileProcessingJobResult as any).error,
                          )}
                      </Alert>
                    )}

                    {(addFileProcessingJobResult.isSuccess ||
                      successMessage) && (
                ...
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    ...
                    <br />
                    addFileProcessingJobResult:{" "}
                    {JSON.stringify(addFileProcessingJobResult)}
                  </Accordion.Body>
                </Accordion.Item>
              </Accordion>
            </form>
