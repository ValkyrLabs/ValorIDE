...
const ChatCompletionResponseForm: React.FC = () => {
  const [addChatCompletionResponse, addChatCompletionResponseResult] =
  ...
  const handleSubmit = async (
    values: FormikValues,
    { setSubmitting }: FormikHelpers<ChatCompletionResponse>,
  ) => {
    try {
            ...
            <Accordion defaultActiveKey="1">
                ...
                <Accordion.Body>
                  ...
                  {addChatCompletionResponseResult.error && (
                    <div className="error" style={{ marginTop: 12 }}>
                      {JSON.stringify(
                        "data" in (addChatCompletionResponseResult as any).error
                          ? (addChatCompletionResponseResult as any).error.data
                          : (addChatCompletionResponseResult as any).error,
                      )}
                    </div>
                  )}
                </Accordion.Body>
              ...
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  ...
                  <br />
                  addChatCompletionResponseResult:{" "}
                  {JSON.stringify(addChatCompletionResponseResult)}
                </Accordion.Body>
              </Accordion.Item>
            </Accordion>
          </form>
