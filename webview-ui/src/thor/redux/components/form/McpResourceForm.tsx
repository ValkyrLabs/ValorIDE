...
const McpResourceForm: React.FC = () => {
	...
	/* SUBMIT HANDLER */
	const handleSubmit = (values: FormikValues, { setSubmitting }: FormikHelpers<McpResource>) => {
								...
								<Accordion.Body>
									<label htmlFor="uri" className="nice-form-control">
										...
										<Field
											name="uri"
											type="text"
											className={errors.uri ? "form-control field-error" : "nice-form-control form-control"}
										/>

										<ErrorMessage className="error" name="uri" component="span" />
									</label>
									<br />
