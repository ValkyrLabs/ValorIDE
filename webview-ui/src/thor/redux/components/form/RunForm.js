...
const ErrorTypeLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "TRANSIENT", label: "Transient" }),
      _jsx("option", { value: "PERMANENT", label: "Permanent" }),
      _jsx("option", { value: "TIMEOUT", label: "Timeout" }),
      _jsx("option", { value: "CIRCUIT_OPEN", label: "Circuit Open" }),
    ],
  });
};
