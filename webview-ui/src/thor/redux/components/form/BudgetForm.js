                        ...
                        _jsxs("label", {
                          ...
                          children: [
                            ...
                            _jsx(BSForm.Check, {
                              ...
                              className: errors.killSwitchEnabled
                                ? "error"
                                : "",
                            }),
                            _jsx(ErrorMessage, {
                        ...
                        (addBudgetResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addBudgetResult.error
                                  ? addBudgetResult.error.data
                                  : addBudgetResult.error,
                              ),
                          }),
                  ...
                  children: [
                    ...
                    _jsxs(Accordion.Body, {
                      children: [
                        ...
                        _jsx("br", {}),
                        "addBudgetResult: ",
                        JSON.stringify(addBudgetResult),
                      ],
                    }),
                  ],
                }),
...
const StatusLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsx("option", { value: "EXCEEDED", label: "Exceeded" }),
      _jsx("option", { value: "EXPIRED", label: "Expired" }),
    ],
  });
};
