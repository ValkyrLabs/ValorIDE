                      ...
                      children: [
                        ...
                        _jsxs(CoolButton, {
                          ...
                          children: [
                            ...
                            " Create New ChannelSubscription",
                          ],
                        }),
                        (addChannelSubscriptionResult.isError ||
                          errorMessage) &&
                          _jsx(Alert, {
                            variant: "danger",
                            className: "mt-3",
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addChannelSubscriptionResult.error
...
const ChannelLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "EMAIL", label: "Email" }),
      _jsx("option", { value: "SWARM", label: "Swarm" }),
      _jsx("option", { value: "WORKFLOW", label: "Workflow" }),
      _jsx("option", { value: "NOTIFICATIONS", label: "Notifications" }),
      _jsx("option", { value: "ALERTS", label: "Alerts" }),
      _jsx("option", { value: "SOCKET", label: "Socket" }),
    ],
  });
};
