...
/* -----------------------------------------------------
   COMPONENT
-------------------------------------------------------- */
const ToolFailureForm: React.FC = () => {
  ...
  -------------------------------------------------------- */
  const initialValues: Partial<ToolFailure> = {
    toolName: "",
    id: "",
    ownerId: "",
  ...
  const handleSubmit = async (
    values: FormikValues,
    { setSubmitting }: FormikHelpers<ToolFailure>,
  ) => {
    try {
      console.log("ToolFailure form values:", values);

      // NOTE: depending on your generated endpoint, you may need { body: values }
      const result = await addToolFailure(values as any).unwrap();

      if (result && result.id && currentUser.permissions.canGrantPermissions) {
        const shouldSetPermissions = window.confirm(
          `ToolFailure created successfully! Would you like to set permissions for this object?`,
        );
  ...
  return (
    <div>
      <Formik
        validateOnBlur={true}
        initialValues={initialValues as ToolFailure}
          ...
          <form onSubmit={handleSubmit} className="form">
            <Accordion defaultActiveKey="1">
              ...
              <Accordion.Item eventKey="1">
                <Accordion.Header>
                  <FaRegPlusSquare size={28} /> &nbsp; Add New ToolFailure
                </Accordion.Header>
                <Accordion.Body>
                  ...
                  >
                    ...
                    <FaCheckCircle size={28} /> Create New ToolFailure
                  </CoolButton>

                  {addToolFailureResult.error && (
                    <div className="error" style={{ marginTop: 12 }}>
                      {JSON.stringify(
                        "data" in (addToolFailureResult as any).error
                          ? (addToolFailureResult as any).error.data
                          : (addToolFailureResult as any).error,
                      )}
                    </div>
                  )}
                </Accordion.Body>
              ...
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  ...
                  <br />
                  addToolFailureResult: {JSON.stringify(addToolFailureResult)}
                </Accordion.Body>
              </Accordion.Item>
            </Accordion>
          </form>
