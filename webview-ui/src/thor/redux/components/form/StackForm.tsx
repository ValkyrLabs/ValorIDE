...
import { Stack, StackCategoryEnum, StackLanguageEnum, StackTemplateRepoEnum, StackStatusEnum } from "../../../model"
...
const CategoryValidation = () => {
	return ["Full Stack", "Front End", "API", "Data Library", "Infrastructure", "Documentation"]
}
...
const StatusValidation = () => {
	return ["available", "syntax_error", "compilation_error", "runtime_error", "database_error", "locked"]
}
...
const StackForm: React.FC = () => {
	...
	const initialValues: Partial<Stack> = {
		...
		id: "880e42f2-470b-4a5d-833e-7ae89a86cf89",

		ownerId: "91980aa4-a5c9-4ba7-a446-3b0906e7d8c6",

		keyHash: "null",

		lastAccessedById: "0c7d3c27-453e-4018-b043-e8a68760e97a",

		lastModifiedById: "d9d7d540-dedd-4181-b1a7-714fff841d5f",
	}

	/* SUBMIT HANDLER */
	const handleSubmit = (values: FormikValues, { setSubmitting }: FormikHelpers<Stack>) => {
								...
								<Accordion.Body>
									...
									<label htmlFor="schemaData" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.schemaData ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="hostName" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.hostName ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="hostPort" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.hostPort ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="orgName" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.orgName ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="gitUser" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.gitUser ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="gitRepo" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.gitRepo ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="thorApiSecureKey" className="nice-form-control">
										<b>
											Thor Api Secure Key:
											{touched.thorApiSecureKey && !errors.thorApiSecureKey && (
												<span className="okCheck">
													<FaCheckCircle /> looks good!
												</span>
											)}
									...
									<label htmlFor="dbUrl" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.dbUrl ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="dbName" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.dbName ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="dbUser" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.dbUser ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="dbPassword" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.dbPassword ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="schemaName" className="nice-form-control">
										...
										<Field
											...
											type="text"
											className={
												errors.schemaName ? "form-control field-error" : "nice-form-control form-control"
											}
										/>
									...
									<label htmlFor="language" className="nice-form-control">
										...
										<BSForm.Select
											name="language"
											className={
												errors.language ? "form-control field-error" : "nice-form-control form-control"
											}
											onChange={(e) => {
