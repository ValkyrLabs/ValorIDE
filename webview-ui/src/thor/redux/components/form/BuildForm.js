                          ...
                          children: [
                            ...
                            _jsxs(BSForm.Select, {
                              ...
                              children: [
                                _jsx("option", {
                                  value: "",
                                  label: "Select Test Enum Codegen",
                                }),
                                _jsx(TestEnumCodegenLookup, {}),
                              ],
                            }),
                            _jsx(ErrorMessage, {
                              className: "error",
                        ...
                        (addBuildResult.isError || errorMessage) &&
                          _jsx(Alert, {
                            ...
                            children:
                              errorMessage ||
                              JSON.stringify(
                                "data" in addBuildResult.error
                                  ? addBuildResult.error.data
                                  : addBuildResult.error,
                              ),
                          }),
...
const StatusLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsx("option", { value: "FAILURE", label: "Failure" }),
    ],
  });
};
/*
...
const TestEnumCodegenLookup = () => {
  return _jsxs(_Fragment, {
    children: [
      _jsx("option", { value: "0", label: "broke" }),
      _jsx("option", { value: "10", label: "poor" }),
      _jsx("option", { value: "1000", label: "rich" }),
    ],
  });
};
