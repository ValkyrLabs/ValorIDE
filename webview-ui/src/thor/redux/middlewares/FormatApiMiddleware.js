...
############################## DO NOT EDIT: GENERATED FILE ##############################
*/
import { getFormat, postFormat, getFormatList, deleteFormat, updateFormat } from '@thor/api/FormatApi';
import { ADD_FORMAT_REQUEST, FETCH_FORMAT_REQUEST, LIST_FORMAT_REQUEST, UPDATE_FORMAT_REQUEST, DELETE_FORMAT_REQUEST, addFormatFailure, addFormatSuccess, fetchFormatFailure, fetchFormatSuccess, listFormatFailure, listFormatSuccess, updateFormatFailure, updateFormatSuccess, deleteFormatFailure, deleteFormatSuccess, } from '../actions/FormatApiAction';
/**
############################## DO NOT EDIT: GENERATED FILE ##############################
