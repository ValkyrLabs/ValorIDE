...
############################## DO NOT EDIT: GENERATED FILE ##############################
*/
import { getUserPreference, postUserPreference, getUserPreferenceList, deleteUserPreference, updateUserPreference } from '@thor/api/UserPreferenceApi';
import { ADD_USERPREFERENCE_REQUEST, FETCH_USERPREFERENCE_REQUEST, LIST_USERPREFERENCE_REQUEST, UPDATE_USERPREFERENCE_REQUEST, DELETE_USERPREFERENCE_REQUEST, addUserPreferenceFailure, addUserPreferenceSuccess, fetchUserPreferenceFailure, fetchUserPreferenceSuccess, listUserPreferenceFailure, listUserPreferenceSuccess, updateUserPreferenceFailure, updateUserPreferenceSuccess, deleteUserPreferenceFailure, deleteUserPreferenceSuccess, } from '../actions/UserPreferenceApiAction';
/**
############################## DO NOT EDIT: GENERATED FILE ##############################
