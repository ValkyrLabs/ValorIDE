...
############################## DO NOT EDIT: GENERATED FILE ##############################
*/
import { getWebsocketMessage, postWebsocketMessage, getWebsocketMessageList, deleteWebsocketMessage, updateWebsocketMessage } from '@thor/api/WebsocketMessageApi';
import { ADD_WEBSOCKETMESSAGE_REQUEST, FETCH_WEBSOCKETMESSAGE_REQUEST, LIST_WEBSOCKETMESSAGE_REQUEST, UPDATE_WEBSOCKETMESSAGE_REQUEST, DELETE_WEBSOCKETMESSAGE_REQUEST, addWebsocketMessageFailure, addWebsocketMessageSuccess, fetchWebsocketMessageFailure, fetchWebsocketMessageSuccess, listWebsocketMessageFailure, listWebsocketMessageSuccess, updateWebsocketMessageFailure, updateWebsocketMessageSuccess, deleteWebsocketMessageFailure, deleteWebsocketMessageSuccess, } from '../actions/WebsocketMessageApiAction';
/**
############################## DO NOT EDIT: GENERATED FILE ##############################
