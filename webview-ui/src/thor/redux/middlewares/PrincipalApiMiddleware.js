...
############################## DO NOT EDIT: GENERATED FILE ##############################
*/
import { getPrincipal, postPrincipal, getPrincipalList, deletePrincipal, updatePrincipal } from '@thor/api/PrincipalApi';
import { ADD_PRINCIPAL_REQUEST, FETCH_PRINCIPAL_REQUEST, LIST_PRINCIPAL_REQUEST, UPDATE_PRINCIPAL_REQUEST, DELETE_PRINCIPAL_REQUEST, addPrincipalFailure, addPrincipalSuccess, fetchPrincipalFailure, fetchPrincipalSuccess, listPrincipalFailure, listPrincipalSuccess, updatePrincipalFailure, updatePrincipalSuccess, deletePrincipalFailure, deletePrincipalSuccess, } from '../actions/PrincipalApiAction';
/**
############################## DO NOT EDIT: GENERATED FILE ##############################
