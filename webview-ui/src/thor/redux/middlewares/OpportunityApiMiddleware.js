...
############################## DO NOT EDIT: GENERATED FILE ##############################
*/
import { getOpportunity, postOpportunity, getOpportunityList, deleteOpportunity, updateOpportunity } from '@thor/api/OpportunityApi';
import { ADD_OPPORTUNITY_REQUEST, FETCH_OPPORTUNITY_REQUEST, LIST_OPPORTUNITY_REQUEST, UPDATE_OPPORTUNITY_REQUEST, DELETE_OPPORTUNITY_REQUEST, addOpportunityFailure, addOpportunitySuccess, fetchOpportunityFailure, fetchOpportunitySuccess, listOpportunityFailure, listOpportunitySuccess, updateOpportunityFailure, updateOpportunitySuccess, deleteOpportunityFailure, deleteOpportunitySuccess, } from '../actions/OpportunityApiAction';
/**
############################## DO NOT EDIT: GENERATED FILE ##############################
...
//# sourceMappingURL=OpportunityApiMiddleware.js.map