...
############################## DO NOT EDIT: GENERATED FILE ##############################
*/
import { getCampaign, postCampaign, getCampaignList, deleteCampaign, updateCampaign } from '@thor/api/CampaignApi';
import { ADD_CAMPAIGN_REQUEST, FETCH_CAMPAIGN_REQUEST, LIST_CAMPAIGN_REQUEST, UPDATE_CAMPAIGN_REQUEST, DELETE_CAMPAIGN_REQUEST, addCampaignFailure, addCampaignSuccess, fetchCampaignFailure, fetchCampaignSuccess, listCampaignFailure, listCampaignSuccess, updateCampaignFailure, updateCampaignSuccess, deleteCampaignFailure, deleteCampaignSuccess, } from '../actions/CampaignApiAction';
/**
############################## DO NOT EDIT: GENERATED FILE ##############################
