...
############################## DO NOT EDIT: GENERATED FILE ##############################
*/
import { getOasPath, postOasPath, getOasPathList, deleteOasPath, updateOasPath } from '@thor/api/OasPathApi';
import { ADD_OASPATH_REQUEST, FETCH_OASPATH_REQUEST, LIST_OASPATH_REQUEST, UPDATE_OASPATH_REQUEST, DELETE_OASPATH_REQUEST, addOasPathFailure, addOasPathSuccess, fetchOasPathFailure, fetchOasPathSuccess, listOasPathFailure, listOasPathSuccess, updateOasPathFailure, updateOasPathSuccess, deleteOasPathFailure, deleteOasPathSuccess, } from '../actions/OasPathApiAction';
/**
############################## DO NOT EDIT: GENERATED FILE ##############################
...
//# sourceMappingURL=OasPathApiMiddleware.js.map