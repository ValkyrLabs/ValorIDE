...
############################## DO NOT EDIT: GENERATED FILE ##############################
*/
import { getOasObjectSchema, postOasObjectSchema, getOasObjectSchemaList, deleteOasObjectSchema, updateOasObjectSchema } from '@thor/api/OasObjectSchemaApi';
import { ADD_OASOBJECTSCHEMA_REQUEST, FETCH_OASOBJECTSCHEMA_REQUEST, LIST_OASOBJECTSCHEMA_REQUEST, UPDATE_OASOBJECTSCHEMA_REQUEST, DELETE_OASOBJECTSCHEMA_REQUEST, addOasObjectSchemaFailure, addOasObjectSchemaSuccess, fetchOasObjectSchemaFailure, fetchOasObjectSchemaSuccess, listOasObjectSchemaFailure, listOasObjectSchemaSuccess, updateOasObjectSchemaFailure, updateOasObjectSchemaSuccess, deleteOasObjectSchemaFailure, deleteOasObjectSchemaSuccess, } from '../actions/OasObjectSchemaApiAction';
/**
############################## DO NOT EDIT: GENERATED FILE ##############################
...
//# sourceMappingURL=OasObjectSchemaApiMiddleware.js.map