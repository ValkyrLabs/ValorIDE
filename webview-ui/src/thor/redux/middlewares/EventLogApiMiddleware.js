...
############################## DO NOT EDIT: GENERATED FILE ##############################
*/
import { getEventLog, postEventLog, getEventLogList, deleteEventLog, updateEventLog } from '@thor/api/EventLogApi';
import { ADD_EVENTLOG_REQUEST, FETCH_EVENTLOG_REQUEST, LIST_EVENTLOG_REQUEST, UPDATE_EVENTLOG_REQUEST, DELETE_EVENTLOG_REQUEST, addEventLogFailure, addEventLogSuccess, fetchEventLogFailure, fetchEventLogSuccess, listEventLogFailure, listEventLogSuccess, updateEventLogFailure, updateEventLogSuccess, deleteEventLogFailure, deleteEventLogSuccess, } from '../actions/EventLogApiAction';
/**
############################## DO NOT EDIT: GENERATED FILE ##############################
