...
############################## DO NOT EDIT: GENERATED FILE ##############################
*/
import { getMediaObject, postMediaObject, getMediaObjectList, deleteMediaObject, updateMediaObject } from '@thor/api/MediaObjectApi';
import { ADD_MEDIAOBJECT_REQUEST, FETCH_MEDIAOBJECT_REQUEST, LIST_MEDIAOBJECT_REQUEST, UPDATE_MEDIAOBJECT_REQUEST, DELETE_MEDIAOBJECT_REQUEST, addMediaObjectFailure, addMediaObjectSuccess, fetchMediaObjectFailure, fetchMediaObjectSuccess, listMediaObjectFailure, listMediaObjectSuccess, updateMediaObjectFailure, updateMediaObjectSuccess, deleteMediaObjectFailure, deleteMediaObjectSuccess, } from '../actions/MediaObjectApiAction';
/**
############################## DO NOT EDIT: GENERATED FILE ##############################
