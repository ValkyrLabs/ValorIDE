...
############################## DO NOT EDIT: GENERATED FILE ##############################
*/
import { getAddress, postAddress, getAddressList, deleteAddress, updateAddress } from '@thor/api/AddressApi';
import { ADD_ADDRESS_REQUEST, FETCH_ADDRESS_REQUEST, LIST_ADDRESS_REQUEST, UPDATE_ADDRESS_REQUEST, DELETE_ADDRESS_REQUEST, addAddressFailure, addAddressSuccess, fetchAddressFailure, fetchAddressSuccess, listAddressFailure, listAddressSuccess, updateAddressFailure, updateAddressSuccess, deleteAddressFailure, deleteAddressSuccess, } from '../actions/AddressApiAction';
/**
############################## DO NOT EDIT: GENERATED FILE ##############################
