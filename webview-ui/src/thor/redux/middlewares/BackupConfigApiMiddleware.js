...
############################## DO NOT EDIT: GENERATED FILE ##############################
*/
import { getBackupConfig, postBackupConfig, getBackupConfigList, deleteBackupConfig, updateBackupConfig } from '@thor/api/BackupConfigApi';
import { ADD_BACKUPCONFIG_REQUEST, FETCH_BACKUPCONFIG_REQUEST, LIST_BACKUPCONFIG_REQUEST, UPDATE_BACKUPCONFIG_REQUEST, DELETE_BACKUPCONFIG_REQUEST, addBackupConfigFailure, addBackupConfigSuccess, fetchBackupConfigFailure, fetchBackupConfigSuccess, listBackupConfigFailure, listBackupConfigSuccess, updateBackupConfigFailure, updateBackupConfigSuccess, deleteBackupConfigFailure, deleteBackupConfigSuccess, } from '../actions/BackupConfigApiAction';
/**
############################## DO NOT EDIT: GENERATED FILE ##############################
