...
export interface GetOasSecuritySchemeListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getOasSecuritySchemeListRaw<T>(requestParameters: GetOasSecuritySchemeListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<OasSecurityScheme>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of OasSecuritySchemes
*/
export function getOasSecuritySchemeList<T>(requestParameters: GetOasSecuritySchemeListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<OasSecurityScheme>>): QueryConfig<T> {
