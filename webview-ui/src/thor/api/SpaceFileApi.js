...
function deleteSpaceFileRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling deleteSpaceFile.",
    );
  }
  ...
  const config = {
    url: `${runtime.Configuration.basePath}/SpaceFile/{id}`.replace(
      `{${"id"}}`,
...
function getSpaceFileRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling getSpaceFile.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
  ...
  if (requestTransform) {
    config.transform = (body, text) =>
      requestTransform(SpaceFileFromJSON(body), text);
  }
  return config;
}
/**
...
function getSpaceFileListRaw(requestParameters, requestConfig = {}) {
  ...
  if (requestTransform) {
    config.transform = (body, text) =>
      requestTransform(body.map(SpaceFileFromJSON), text);
  }
  return config;
}
/**
...
function postSpaceFileRaw(requestParameters, requestConfig = {}) {
  if (
    requestParameters.spaceFile === null ||
    requestParameters.spaceFile === undefined
  ) {
    throw new runtime.RequiredError(
      "spaceFile",
      "Required parameter requestParameters.spaceFile was null or undefined when calling postSpaceFile.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
...
function updateSpaceFileRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling updateSpaceFile.",
    );
  }
  if (
    requestParameters.spaceFile === null ||
    ...
    throw new runtime.RequiredError(
      "spaceFile",
      "Required parameter requestParameters.spaceFile was null or undefined when calling updateSpaceFile.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
