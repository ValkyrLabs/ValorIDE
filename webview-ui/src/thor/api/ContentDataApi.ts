...
export interface GetContentDataListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getContentDataListRaw<T>(requestParameters: GetContentDataListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<ContentData>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of ContentDatas
*/
export function getContentDataList<T>(requestParameters: GetContentDataListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<ContentData>>): QueryConfig<T> {
