...
export interface GetOasOpenAPISpecListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getOasOpenAPISpecListRaw<T>(requestParameters: GetOasOpenAPISpecListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<OasOpenAPISpec>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of OasOpenAPISpecs
*/
export function getOasOpenAPISpecList<T>(requestParameters: GetOasOpenAPISpecListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<OasOpenAPISpec>>): QueryConfig<T> {
