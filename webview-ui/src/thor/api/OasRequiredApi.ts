...
export interface GetOasRequiredListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getOasRequiredListRaw<T>(requestParameters: GetOasRequiredListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<OasRequired>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of OasRequireds
*/
export function getOasRequiredList<T>(requestParameters: GetOasRequiredListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<OasRequired>>): QueryConfig<T> {
