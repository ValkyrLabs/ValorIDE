...
export interface GetSalesActivityListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getSalesActivityListRaw<T>(requestParameters: GetSalesActivityListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<SalesActivity>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of SalesActivitys
*/
export function getSalesActivityList<T>(requestParameters: GetSalesActivityListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<SalesActivity>>): QueryConfig<T> {
