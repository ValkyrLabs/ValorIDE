...
function deleteFileRecordRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling deleteFileRecord.",
    );
  }
  ...
  const config = {
    url: `${runtime.Configuration.basePath}/FileRecord/{id}`.replace(
      `{${"id"}}`,
...
function getFileRecordRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling getFileRecord.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
  ...
  if (requestTransform) {
    config.transform = (body, text) =>
      requestTransform(FileRecordFromJSON(body), text);
  }
  return config;
}
/**
...
function getFileRecordListRaw(requestParameters, requestConfig = {}) {
  ...
  if (requestTransform) {
    config.transform = (body, text) =>
      requestTransform(body.map(FileRecordFromJSON), text);
  }
  return config;
}
/**
...
function postFileRecordRaw(requestParameters, requestConfig = {}) {
  if (
    requestParameters.fileRecord === null ||
    requestParameters.fileRecord === undefined
  ) {
    throw new runtime.RequiredError(
      "fileRecord",
      "Required parameter requestParameters.fileRecord was null or undefined when calling postFileRecord.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
...
function updateFileRecordRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling updateFileRecord.",
    );
  }
  if (
    requestParameters.fileRecord === null ||
    ...
    throw new runtime.RequiredError(
      "fileRecord",
      "Required parameter requestParameters.fileRecord was null or undefined when calling updateFileRecord.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
