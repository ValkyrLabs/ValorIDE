...
function deleteOrganizationRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling deleteOrganization.",
    );
  }
  ...
  const config = {
    url: `${runtime.Configuration.basePath}/Organization/{id}`.replace(
      `{${"id"}}`,
...
function getOrganizationRaw(requestParameters, requestConfig = {}) {
  ...
  if (requestTransform) {
    config.transform = (body, text) =>
      requestTransform(OrganizationFromJSON(body), text);
  }
  return config;
}
/**
...
function getOrganizationListRaw(requestParameters, requestConfig = {}) {
  ...
  if (requestTransform) {
    config.transform = (body, text) =>
      requestTransform(body.map(OrganizationFromJSON), text);
  }
  return config;
}
/**
...
function postOrganizationRaw(requestParameters, requestConfig = {}) {
  if (
    ...
    throw new runtime.RequiredError(
      "organization",
      "Required parameter requestParameters.organization was null or undefined when calling postOrganization.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
...
function updateOrganizationRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling updateOrganization.",
    );
  }
  if (
    requestParameters.organization === null ||
    ...
    throw new runtime.RequiredError(
      "organization",
      "Required parameter requestParameters.organization was null or undefined when calling updateOrganization.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
