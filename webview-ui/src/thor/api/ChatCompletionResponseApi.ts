...
export interface GetChatCompletionResponseListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function deleteChatCompletionResponseRaw<T>(requestParameters: DeleteChatCompletionResponseRequest, requestConfig: runtime.TypedQueryConfig<T, void> = {}): QueryConfig<T> {
...
* Delete a ChatCompletionResponse.
*/
export function deleteChatCompletionResponse<T>(requestParameters: DeleteChatCompletionResponseRequest, requestConfig?: runtime.TypedQueryConfig<T, void>): QueryConfig<T> {
 ...
 */
function getChatCompletionResponseRaw<T>(requestParameters: GetChatCompletionResponseRequest, requestConfig: runtime.TypedQueryConfig<T, ChatCompletionResponse> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Retrieve a single ChatCompletionResponse
*/
export function getChatCompletionResponse<T>(requestParameters: GetChatCompletionResponseRequest, requestConfig?: runtime.TypedQueryConfig<T, ChatCompletionResponse>): QueryConfig<T> {
 ...
 */
function getChatCompletionResponseListRaw<T>(requestParameters: GetChatCompletionResponseListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<ChatCompletionResponse>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of ChatCompletionResponses
*/
export function getChatCompletionResponseList<T>(requestParameters: GetChatCompletionResponseListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<ChatCompletionResponse>>): QueryConfig<T> {
 ...
 */
function postChatCompletionResponseRaw<T>(requestParameters: PostChatCompletionResponseRequest, requestConfig: runtime.TypedQueryConfig<T, ChatCompletionResponse> = {}): QueryConfig<T> {
...
* Create a new ChatCompletionResponse
*/
export function postChatCompletionResponse<T>(requestParameters: PostChatCompletionResponseRequest, requestConfig?: runtime.TypedQueryConfig<T, ChatCompletionResponse>): QueryConfig<T> {
 ...
 */
function updateChatCompletionResponseRaw<T>(requestParameters: UpdateChatCompletionResponseRequest, requestConfig: runtime.TypedQueryConfig<T, ChatCompletionResponse> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Update an existing ChatCompletionResponse
*/
export function updateChatCompletionResponse<T>(requestParameters: UpdateChatCompletionResponseRequest, requestConfig?: runtime.TypedQueryConfig<T, ChatCompletionResponse>): QueryConfig<T> {
