...
export interface DeleteWorkflowApiRequest {
    id: string;
}

export interface GetWorkflowApiRequest {
    id: string;
}

export interface GetWorkflowListApiRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
...
export interface UpdateWorkflowApiRequest {
    id: string;
    workflow: Workflow;
}
 ...
 * Delete a Workflow.
 */
function deleteWorkflowRaw<T>(requestParameters: DeleteWorkflowApiRequest, requestConfig: runtime.TypedQueryConfig<T, void> = {}): QueryConfig<T> {
...
* Delete a Workflow.
*/
export function deleteWorkflow<T>(requestParameters: DeleteWorkflowApiRequest, requestConfig?: runtime.TypedQueryConfig<T, void>): QueryConfig<T> {
 ...
 */
function getWorkflowRaw<T>(requestParameters: GetWorkflowApiRequest, requestConfig: runtime.TypedQueryConfig<T, Workflow> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Retrieve a single Workflow
*/
export function getWorkflow<T>(requestParameters: GetWorkflowApiRequest, requestConfig?: runtime.TypedQueryConfig<T, Workflow>): QueryConfig<T> {
 ...
 */
function getWorkflowListRaw<T>(requestParameters: GetWorkflowListApiRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Workflow>> = {}): QueryConfig<T> {
    let queryParameters = null;
 ...
 */
function postWorkflowRaw<T>(requestParameters: PostWorkflowApiRequest, requestConfig: runtime.TypedQueryConfig<T, Workflow> = {}): QueryConfig<T> {
...
* Create a new Workflow
*/
export function postWorkflow<T>(requestParameters: PostWorkflowApiRequest, requestConfig?: runtime.TypedQueryConfig<T, Workflow>): QueryConfig<T> {
 ...
 */
function updateWorkflowRaw<T>(requestParameters: UpdateWorkflowApiRequest, requestConfig: runtime.TypedQueryConfig<T, Workflow> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Update an existing Workflow
*/
export function updateWorkflow<T>(requestParameters: UpdateWorkflowApiRequest, requestConfig?: runtime.TypedQueryConfig<T, Workflow>): QueryConfig<T> {
