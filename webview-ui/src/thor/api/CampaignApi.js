...
function deleteCampaignRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling deleteCampaign.",
    );
  }
  ...
  const config = {
    url: `${runtime.Configuration.basePath}/Campaign/{id}`.replace(
      `{${"id"}}`,
...
function getCampaignRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling getCampaign.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
  ...
  if (requestTransform) {
    config.transform = (body, text) =>
      requestTransform(CampaignFromJSON(body), text);
  }
  return config;
}
/**
...
function getCampaignListRaw(requestParameters, requestConfig = {}) {
  ...
  if (requestTransform) {
    config.transform = (body, text) =>
      requestTransform(body.map(CampaignFromJSON), text);
  }
  return config;
}
/**
...
function postCampaignRaw(requestParameters, requestConfig = {}) {
  if (
    requestParameters.campaign === null ||
    requestParameters.campaign === undefined
  ) {
    throw new runtime.RequiredError(
      "campaign",
      "Required parameter requestParameters.campaign was null or undefined when calling postCampaign.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
...
function updateCampaignRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling updateCampaign.",
    );
  }
  if (
    requestParameters.campaign === null ||
    ...
    throw new runtime.RequiredError(
      "campaign",
      "Required parameter requestParameters.campaign was null or undefined when calling updateCampaign.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
