 ...
 */
function getBuildListRaw<T>(requestParameters: GetBuildListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Build>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of Builds
*/
export function getBuildList<T>(requestParameters: GetBuildListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<Build>>): QueryConfig<T> {
