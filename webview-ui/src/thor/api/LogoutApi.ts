...
export interface GetLogoutListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getLogoutListRaw<T>(requestParameters: GetLogoutListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Logout>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of Logouts
*/
export function getLogoutList<T>(requestParameters: GetLogoutListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<Logout>>): QueryConfig<T> {
