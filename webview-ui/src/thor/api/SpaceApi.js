...
function deleteSpaceRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling deleteSpace.",
    );
  }
  ...
  const config = {
    url: `${runtime.Configuration.basePath}/Space/{id}`.replace(
      `{${"id"}}`,
...
function getSpaceRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling getSpace.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
  ...
  if (requestTransform) {
    config.transform = (body, text) =>
      requestTransform(SpaceFromJSON(body), text);
  }
  return config;
}
/**
...
function getSpaceListRaw(requestParameters, requestConfig = {}) {
  ...
  if (requestTransform) {
    config.transform = (body, text) =>
      requestTransform(body.map(SpaceFromJSON), text);
  }
  return config;
}
/**
...
function postSpaceRaw(requestParameters, requestConfig = {}) {
  if (
    ...
    throw new runtime.RequiredError(
      "space",
      "Required parameter requestParameters.space was null or undefined when calling postSpace.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
...
function updateSpaceRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling updateSpace.",
    );
  }
  if (
    requestParameters.space === null ||
    ...
    throw new runtime.RequiredError(
      "space",
      "Required parameter requestParameters.space was null or undefined when calling updateSpace.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
