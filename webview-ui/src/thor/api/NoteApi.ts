 ...
 */
function getNoteListRaw<T>(requestParameters: GetNoteListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Note>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of Notes
*/
export function getNoteList<T>(requestParameters: GetNoteListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<Note>>): QueryConfig<T> {
