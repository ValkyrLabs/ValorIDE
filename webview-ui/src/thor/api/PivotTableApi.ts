...
export interface GetPivotTableListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getPivotTableListRaw<T>(requestParameters: GetPivotTableListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<PivotTable>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of PivotTables
*/
export function getPivotTableList<T>(requestParameters: GetPivotTableListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<PivotTable>>): QueryConfig<T> {
