...
function deleteFileVersionRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling deleteFileVersion.",
    );
  }
  ...
  const config = {
    url: `${runtime.Configuration.basePath}/FileVersion/{id}`.replace(
      `{${"id"}}`,
...
function getFileVersionRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling getFileVersion.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
  ...
  if (requestTransform) {
    config.transform = (body, text) =>
      requestTransform(FileVersionFromJSON(body), text);
  }
  return config;
}
/**
...
function getFileVersionListRaw(requestParameters, requestConfig = {}) {
  ...
  if (requestTransform) {
    config.transform = (body, text) =>
      requestTransform(body.map(FileVersionFromJSON), text);
  }
  return config;
}
/**
...
function postFileVersionRaw(requestParameters, requestConfig = {}) {
  if (
    requestParameters.fileVersion === null ||
    requestParameters.fileVersion === undefined
  ) {
    throw new runtime.RequiredError(
      "fileVersion",
      "Required parameter requestParameters.fileVersion was null or undefined when calling postFileVersion.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
...
function updateFileVersionRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling updateFileVersion.",
    );
  }
  if (
    requestParameters.fileVersion === null ||
    ...
    throw new runtime.RequiredError(
      "fileVersion",
      "Required parameter requestParameters.fileVersion was null or undefined when calling updateFileVersion.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
