...
function deleteFileAuditLogRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling deleteFileAuditLog.",
    );
  }
  ...
  const config = {
    url: `${runtime.Configuration.basePath}/FileAuditLog/{id}`.replace(
      `{${"id"}}`,
...
function getFileAuditLogRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling getFileAuditLog.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
  ...
  if (requestTransform) {
    config.transform = (body, text) =>
      requestTransform(FileAuditLogFromJSON(body), text);
  }
  return config;
}
/**
...
function getFileAuditLogListRaw(requestParameters, requestConfig = {}) {
  ...
  if (requestTransform) {
    config.transform = (body, text) =>
      requestTransform(body.map(FileAuditLogFromJSON), text);
  }
  return config;
}
/**
...
function postFileAuditLogRaw(requestParameters, requestConfig = {}) {
  if (
    requestParameters.fileAuditLog === null ||
    requestParameters.fileAuditLog === undefined
  ) {
    throw new runtime.RequiredError(
      "fileAuditLog",
      "Required parameter requestParameters.fileAuditLog was null or undefined when calling postFileAuditLog.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
...
function updateFileAuditLogRaw(requestParameters, requestConfig = {}) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling updateFileAuditLog.",
    );
  }
  if (
    requestParameters.fileAuditLog === null ||
    ...
    throw new runtime.RequiredError(
      "fileAuditLog",
      "Required parameter requestParameters.fileAuditLog was null or undefined when calling updateFileAuditLog.",
    );
  }
  let queryParameters = null;
  const headerParameters = {};
