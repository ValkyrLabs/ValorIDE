...
export interface GetMcpDownloadResponseListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function deleteMcpDownloadResponseRaw<T>(requestParameters: DeleteMcpDownloadResponseRequest, requestConfig: runtime.TypedQueryConfig<T, void> = {}): QueryConfig<T> {
...
* Delete a McpDownloadResponse.
*/
export function deleteMcpDownloadResponse<T>(requestParameters: DeleteMcpDownloadResponseRequest, requestConfig?: runtime.TypedQueryConfig<T, void>): QueryConfig<T> {
 ...
 */
function getMcpDownloadResponseRaw<T>(requestParameters: GetMcpDownloadResponseRequest, requestConfig: runtime.TypedQueryConfig<T, McpDownloadResponse> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Retrieve a single McpDownloadResponse
*/
export function getMcpDownloadResponse<T>(requestParameters: GetMcpDownloadResponseRequest, requestConfig?: runtime.TypedQueryConfig<T, McpDownloadResponse>): QueryConfig<T> {
 ...
 */
function getMcpDownloadResponseListRaw<T>(requestParameters: GetMcpDownloadResponseListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<McpDownloadResponse>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of McpDownloadResponses
*/
export function getMcpDownloadResponseList<T>(requestParameters: GetMcpDownloadResponseListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<McpDownloadResponse>>): QueryConfig<T> {
 ...
 */
function postMcpDownloadResponseRaw<T>(requestParameters: PostMcpDownloadResponseRequest, requestConfig: runtime.TypedQueryConfig<T, McpDownloadResponse> = {}): QueryConfig<T> {
...
* Create a new McpDownloadResponse
*/
export function postMcpDownloadResponse<T>(requestParameters: PostMcpDownloadResponseRequest, requestConfig?: runtime.TypedQueryConfig<T, McpDownloadResponse>): QueryConfig<T> {
 ...
 */
function updateMcpDownloadResponseRaw<T>(requestParameters: UpdateMcpDownloadResponseRequest, requestConfig: runtime.TypedQueryConfig<T, McpDownloadResponse> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Update an existing McpDownloadResponse
*/
export function updateMcpDownloadResponse<T>(requestParameters: UpdateMcpDownloadResponseRequest, requestConfig?: runtime.TypedQueryConfig<T, McpDownloadResponse>): QueryConfig<T> {
