...
export interface GetOasOperationListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getOasOperationListRaw<T>(requestParameters: GetOasOperationListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<OasOperation>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of OasOperations
*/
export function getOasOperationList<T>(requestParameters: GetOasOperationListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<OasOperation>>): QueryConfig<T> {
