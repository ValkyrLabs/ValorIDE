...
export interface GetSheetRowListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getSheetRowListRaw<T>(requestParameters: GetSheetRowListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<SheetRow>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of SheetRows
*/
export function getSheetRowList<T>(requestParameters: GetSheetRowListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<SheetRow>>): QueryConfig<T> {
