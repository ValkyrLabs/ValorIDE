 ...
 * Delete a Sheet.
 */
function deleteSheetRaw<T>(requestParameters: DeleteSheetApiRequest, requestConfig: runtime.TypedQueryConfig<T, void> = {}): QueryConfig<T> {
...
* Delete a Sheet.
*/
export function deleteSheet<T>(requestParameters: DeleteSheetApiRequest, requestConfig?: runtime.TypedQueryConfig<T, void>): QueryConfig<T> {
 ...
 */
function getSheetRaw<T>(requestParameters: GetSheetApiRequest, requestConfig: runtime.TypedQueryConfig<T, Sheet> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Retrieve a single Sheet
*/
export function getSheet<T>(requestParameters: GetSheetApiRequest, requestConfig?: runtime.TypedQueryConfig<T, Sheet>): QueryConfig<T> {
 ...
 */
function getSheetListRaw<T>(requestParameters: GetSheetListApiRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Sheet>> = {}): QueryConfig<T> {
    let queryParameters = null;
 ...
 * Create a new Sheet
 */
function postSheetRaw<T>(requestParameters: PostSheetApiRequest, requestConfig: runtime.TypedQueryConfig<T, Sheet> = {}): QueryConfig<T> {
...
* Create a new Sheet
*/
export function postSheet<T>(requestParameters: PostSheetApiRequest, requestConfig?: runtime.TypedQueryConfig<T, Sheet>): QueryConfig<T> {
 ...
 */
function updateSheetRaw<T>(requestParameters: UpdateSheetApiRequest, requestConfig: runtime.TypedQueryConfig<T, Sheet> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Update an existing Sheet
*/
export function updateSheet<T>(requestParameters: UpdateSheetApiRequest, requestConfig?: runtime.TypedQueryConfig<T, Sheet>): QueryConfig<T> {
