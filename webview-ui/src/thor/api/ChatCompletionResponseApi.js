 ...
 */
function deleteChatCompletionResponseRaw(
  requestParameters,
  requestConfig = {},
) {
 ...
 */
function getChatCompletionResponseListRaw(
  requestParameters,
  requestConfig = {},
) {
  let queryParameters = null;
 ...
 * Retrieve a list of ChatCompletionResponses
 */
export function getChatCompletionResponseList(
  requestParameters,
  requestConfig,
) {
 ...
 */
function updateChatCompletionResponseRaw(
  requestParameters,
  requestConfig = {},
) {
  if (requestParameters.id === null || requestParameters.id === undefined) {
