 ...
 */
function getContentDataBySlugRaw(requestParameters, requestConfig = {}) {
 ...
 * Retrieve ContentData by slug
 */
export function getContentDataBySlug(requestParameters, requestConfig) {
...
function postContentDataRaw(requestParameters, requestConfig = {}) {
    if (requestParameters.contentData === null ||
