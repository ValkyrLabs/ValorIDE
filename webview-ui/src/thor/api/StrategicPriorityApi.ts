...
export interface GetStrategicPriorityListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getStrategicPriorityListRaw<T>(requestParameters: GetStrategicPriorityListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<StrategicPriority>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of StrategicPrioritys
*/
export function getStrategicPriorityList<T>(requestParameters: GetStrategicPriorityListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<StrategicPriority>>): QueryConfig<T> {
