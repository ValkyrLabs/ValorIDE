...
function deleteIdempotencyKeyRaw(requestParameters, requestConfig = {}) {
    if (requestParameters.id === null || requestParameters.id === undefined) {
        throw new runtime.RequiredError("id", "Required parameter requestParameters.id was null or undefined when calling deleteIdempotencyKey.");
    }
...
function getIdempotencyKeyRaw(requestParameters, requestConfig = {}) {
    if (requestParameters.id === null || requestParameters.id === undefined) {
        throw new runtime.RequiredError("id", "Required parameter requestParameters.id was null or undefined when calling getIdempotencyKey.");
    }
    let queryParameters = null;
    const headerParameters = {};
    const { meta = {} } = requestConfig;
    ...
    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body, text) => requestTransform(IdempotencyKeyFromJSON(body), text);
    }
    return config;
}
/**
...
function getIdempotencyKeyListRaw(requestParameters, requestConfig = {}) {
    ...
    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body, text) => requestTransform(body.map(IdempotencyKeyFromJSON), text);
    }
    return config;
}
/**
...
function postIdempotencyKeyRaw(requestParameters, requestConfig = {}) {
    if (requestParameters.idempotencyKey === null ||
        ...
        throw new runtime.RequiredError("idempotencyKey", "Required parameter requestParameters.idempotencyKey was null or undefined when calling postIdempotencyKey.");
    }
    let queryParameters = null;
    const headerParameters = {};
...
function updateIdempotencyKeyRaw(requestParameters, requestConfig = {}) {
    if (requestParameters.id === null || requestParameters.id === undefined) {
        throw new runtime.RequiredError("id", "Required parameter requestParameters.id was null or undefined when calling updateIdempotencyKey.");
    }
    if (requestParameters.idempotencyKey === null ||
        requestParameters.idempotencyKey === undefined) {
        throw new runtime.RequiredError("idempotencyKey", "Required parameter requestParameters.idempotencyKey was null or undefined when calling updateIdempotencyKey.");
    }
    let queryParameters = null;
    const headerParameters = {};
    headerParameters["Content-Type"] = "application/json";
