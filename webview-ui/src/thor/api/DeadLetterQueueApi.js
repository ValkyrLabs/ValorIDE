...
function discardDeadLetterEntryRaw(requestParameters, requestConfig = {}) {
    ...
    if (requestParameters.discardDeadLetterEntryRequest === null ||
    ...
    const config = {
        ...
        body: queryParameters ||
            DiscardDeadLetterEntryRequestToJSON(requestParameters.discardDeadLetterEntryRequest),
    };
...
function requeueDeadLetterEntryRaw(requestParameters, requestConfig = {}) {
    ...
    const config = {
        ...
        body: queryParameters ||
            RequeueDeadLetterEntryRequestToJSON(requestParameters.requeueDeadLetterEntryRequest),
    };
    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
