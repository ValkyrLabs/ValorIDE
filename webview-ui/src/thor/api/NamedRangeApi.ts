...
export interface GetNamedRangeListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getNamedRangeListRaw<T>(requestParameters: GetNamedRangeListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<NamedRange>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of NamedRanges
*/
export function getNamedRangeList<T>(requestParameters: GetNamedRangeListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<NamedRange>>): QueryConfig<T> {
