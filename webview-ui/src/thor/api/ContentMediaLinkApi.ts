...
export interface GetContentMediaLinkListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getContentMediaLinkListRaw<T>(requestParameters: GetContentMediaLinkListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<ContentMediaLink>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of ContentMediaLinks
*/
export function getContentMediaLinkList<T>(requestParameters: GetContentMediaLinkListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<ContentMediaLink>>): QueryConfig<T> {
