...
export interface GetSalesOrderListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getSalesOrderListRaw<T>(requestParameters: GetSalesOrderListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<SalesOrder>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of SalesOrders
*/
export function getSalesOrderList<T>(requestParameters: GetSalesOrderListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<SalesOrder>>): QueryConfig<T> {
