...
export interface GetCellListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getCellListRaw<T>(requestParameters: GetCellListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Cell>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of Cells
*/
export function getCellList<T>(requestParameters: GetCellListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<Cell>>): QueryConfig<T> {
