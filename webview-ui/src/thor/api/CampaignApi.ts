 ...
 */
function getCampaignListRaw<T>(requestParameters: GetCampaignListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Campaign>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of Campaigns
*/
export function getCampaignList<T>(requestParameters: GetCampaignListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<Campaign>>): QueryConfig<T> {
