...
export interface GetSolutionListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getSolutionListRaw<T>(requestParameters: GetSolutionListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Solution>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of Solutions
*/
export function getSolutionList<T>(requestParameters: GetSolutionListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<Solution>>): QueryConfig<T> {
