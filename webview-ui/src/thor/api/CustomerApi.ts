 ...
 */
function getCustomerListRaw<T>(requestParameters: GetCustomerListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Customer>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of Customers
*/
export function getCustomerList<T>(requestParameters: GetCustomerListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<Customer>>): QueryConfig<T> {
