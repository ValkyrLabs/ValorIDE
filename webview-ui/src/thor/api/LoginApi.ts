...
export interface GetLoginListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getLoginListRaw<T>(requestParameters: GetLoginListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Login>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of Logins
*/
export function getLoginList<T>(requestParameters: GetLoginListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<Login>>): QueryConfig<T> {
