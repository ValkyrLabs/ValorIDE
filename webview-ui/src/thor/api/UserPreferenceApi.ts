...
export interface GetUserPreferenceListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function deleteUserPreferenceRaw<T>(requestParameters: DeleteUserPreferenceRequest, requestConfig: runtime.TypedQueryConfig<T, void> = {}): QueryConfig<T> {
...
* Delete a UserPreference.
*/
export function deleteUserPreference<T>(requestParameters: DeleteUserPreferenceRequest, requestConfig?: runtime.TypedQueryConfig<T, void>): QueryConfig<T> {
 ...
 */
function getUserPreferenceRaw<T>(requestParameters: GetUserPreferenceRequest, requestConfig: runtime.TypedQueryConfig<T, UserPreference> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Retrieve a single UserPreference
*/
export function getUserPreference<T>(requestParameters: GetUserPreferenceRequest, requestConfig?: runtime.TypedQueryConfig<T, UserPreference>): QueryConfig<T> {
 ...
 */
function getUserPreferenceListRaw<T>(requestParameters: GetUserPreferenceListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<UserPreference>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of UserPreferences
*/
export function getUserPreferenceList<T>(requestParameters: GetUserPreferenceListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<UserPreference>>): QueryConfig<T> {
 ...
 */
function postUserPreferenceRaw<T>(requestParameters: PostUserPreferenceRequest, requestConfig: runtime.TypedQueryConfig<T, UserPreference> = {}): QueryConfig<T> {
...
* Create a new UserPreference
*/
export function postUserPreference<T>(requestParameters: PostUserPreferenceRequest, requestConfig?: runtime.TypedQueryConfig<T, UserPreference>): QueryConfig<T> {
 ...
 */
function updateUserPreferenceRaw<T>(requestParameters: UpdateUserPreferenceRequest, requestConfig: runtime.TypedQueryConfig<T, UserPreference> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Update an existing UserPreference
*/
export function updateUserPreference<T>(requestParameters: UpdateUserPreferenceRequest, requestConfig?: runtime.TypedQueryConfig<T, UserPreference>): QueryConfig<T> {
