...
export interface GetMergeRangeListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getMergeRangeListRaw<T>(requestParameters: GetMergeRangeListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<MergeRange>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of MergeRanges
*/
export function getMergeRangeList<T>(requestParameters: GetMergeRangeListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<MergeRange>>): QueryConfig<T> {
