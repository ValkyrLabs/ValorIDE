...
export interface GetAclEntryListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getAclEntryListRaw<T>(requestParameters: GetAclEntryListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<AclEntry>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of AclEntrys
*/
export function getAclEntryList<T>(requestParameters: GetAclEntryListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<AclEntry>>): QueryConfig<T> {
