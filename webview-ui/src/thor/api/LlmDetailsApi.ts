...
export interface GetLlmDetailsListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getLlmDetailsListRaw<T>(requestParameters: GetLlmDetailsListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<LlmDetails>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of LlmDetailss
*/
export function getLlmDetailsList<T>(requestParameters: GetLlmDetailsListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<LlmDetails>>): QueryConfig<T> {
