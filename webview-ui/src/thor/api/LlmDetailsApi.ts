...
export interface DeleteLlmDetailsApiRequest {
    id: string;
}

export interface GetLlmDetailsApiRequest {
    id: string;
}

export interface GetLlmDetailsListApiRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
...
export interface UpdateLlmDetailsApiRequest {
    id: string;
    llmDetails: LlmDetails;
}
 ...
 * Delete a LlmDetails.
 */
function deleteLlmDetailsRaw<T>(requestParameters: DeleteLlmDetailsApiRequest, requestConfig: runtime.TypedQueryConfig<T, void> = {}): QueryConfig<T> {
...
* Delete a LlmDetails.
*/
export function deleteLlmDetails<T>(requestParameters: DeleteLlmDetailsApiRequest, requestConfig?: runtime.TypedQueryConfig<T, void>): QueryConfig<T> {
 ...
 */
function getLlmDetailsRaw<T>(requestParameters: GetLlmDetailsApiRequest, requestConfig: runtime.TypedQueryConfig<T, LlmDetails> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Retrieve a single LlmDetails
*/
export function getLlmDetails<T>(requestParameters: GetLlmDetailsApiRequest, requestConfig?: runtime.TypedQueryConfig<T, LlmDetails>): QueryConfig<T> {
 ...
 */
function getLlmDetailsListRaw<T>(requestParameters: GetLlmDetailsListApiRequest, requestConfig: runtime.TypedQueryConfig<T, Array<LlmDetails>> = {}): QueryConfig<T> {
    let queryParameters = null;
 ...
 */
function postLlmDetailsRaw<T>(requestParameters: PostLlmDetailsApiRequest, requestConfig: runtime.TypedQueryConfig<T, LlmDetails> = {}): QueryConfig<T> {
...
* Create a new LlmDetails
*/
export function postLlmDetails<T>(requestParameters: PostLlmDetailsApiRequest, requestConfig?: runtime.TypedQueryConfig<T, LlmDetails>): QueryConfig<T> {
 ...
 */
function updateLlmDetailsRaw<T>(requestParameters: UpdateLlmDetailsApiRequest, requestConfig: runtime.TypedQueryConfig<T, LlmDetails> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Update an existing LlmDetails
*/
export function updateLlmDetails<T>(requestParameters: UpdateLlmDetailsApiRequest, requestConfig?: runtime.TypedQueryConfig<T, LlmDetails>): QueryConfig<T> {
