...
export interface GetPtgRefListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getPtgRefListRaw<T>(requestParameters: GetPtgRefListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<PtgRef>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of PtgRefs
*/
export function getPtgRefList<T>(requestParameters: GetPtgRefListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<PtgRef>>): QueryConfig<T> {
