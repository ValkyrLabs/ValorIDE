...
import SplitPane, { SplitPaneTop, SplitPaneBottom, Divider } from "./components/SplitPane"
...
const AppContent = () => {
	...
	const [currentApplicationId, setCurrentApplicationId] = useState<string | undefined>(undefined)
	...
	const isMainViewHidden = showSettings || showHistory || showMcp || showAccount
		...
		<>
			{showWelcome ? (
				...
				<>
					...
					{!isMainViewHidden && (
						<SplitPane style={{ flexDirection: 'column', height: '100%', flex: 1 }}>
