...
export const ExtensionStateContextProvider = ({ children }) => {
  ...
  const [mcpMarketplaceCatalog, setMcpMarketplaceCatalog] = useState({
    items: [],
  });
  ...
  const handleMessage = useCallback((event) => {
    ...
    switch (message.type) {
      ...
      case "loginSuccess": {
        ...
        const authenticatedPrincipalStr = message.authenticatedPrincipal;
  ...
  return _jsx(ExtensionStateContext.Provider, {
    value: contextValue,
    children: children,
  });
};
