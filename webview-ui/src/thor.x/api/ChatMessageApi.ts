 ...
 */
function getChatMessageListRaw<T>(requestParameters: GetChatMessageListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<ChatMessage>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of ChatMessages
*/
export function getChatMessageList<T>(requestParameters: GetChatMessageListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<ChatMessage>>): QueryConfig<T> {
