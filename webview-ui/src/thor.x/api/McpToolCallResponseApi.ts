...
export interface GetMcpToolCallResponseListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function deleteMcpToolCallResponseRaw<T>(requestParameters: DeleteMcpToolCallResponseRequest, requestConfig: runtime.TypedQueryConfig<T, void> = {}): QueryConfig<T> {
...
* Delete a McpToolCallResponse.
*/
export function deleteMcpToolCallResponse<T>(requestParameters: DeleteMcpToolCallResponseRequest, requestConfig?: runtime.TypedQueryConfig<T, void>): QueryConfig<T> {
 ...
 */
function getMcpToolCallResponseRaw<T>(requestParameters: GetMcpToolCallResponseRequest, requestConfig: runtime.TypedQueryConfig<T, McpToolCallResponse> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Retrieve a single McpToolCallResponse
*/
export function getMcpToolCallResponse<T>(requestParameters: GetMcpToolCallResponseRequest, requestConfig?: runtime.TypedQueryConfig<T, McpToolCallResponse>): QueryConfig<T> {
 ...
 */
function getMcpToolCallResponseListRaw<T>(requestParameters: GetMcpToolCallResponseListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<McpToolCallResponse>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of McpToolCallResponses
*/
export function getMcpToolCallResponseList<T>(requestParameters: GetMcpToolCallResponseListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<McpToolCallResponse>>): QueryConfig<T> {
 ...
 */
function postMcpToolCallResponseRaw<T>(requestParameters: PostMcpToolCallResponseRequest, requestConfig: runtime.TypedQueryConfig<T, McpToolCallResponse> = {}): QueryConfig<T> {
...
* Create a new McpToolCallResponse
*/
export function postMcpToolCallResponse<T>(requestParameters: PostMcpToolCallResponseRequest, requestConfig?: runtime.TypedQueryConfig<T, McpToolCallResponse>): QueryConfig<T> {
 ...
 */
function updateMcpToolCallResponseRaw<T>(requestParameters: UpdateMcpToolCallResponseRequest, requestConfig: runtime.TypedQueryConfig<T, McpToolCallResponse> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Update an existing McpToolCallResponse
*/
export function updateMcpToolCallResponse<T>(requestParameters: UpdateMcpToolCallResponseRequest, requestConfig?: runtime.TypedQueryConfig<T, McpToolCallResponse>): QueryConfig<T> {
