...
export interface GetRatingListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getRatingListRaw<T>(requestParameters: GetRatingListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Rating>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of Ratings
*/
export function getRatingList<T>(requestParameters: GetRatingListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<Rating>>): QueryConfig<T> {
