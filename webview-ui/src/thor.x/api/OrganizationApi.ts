 ...
 */
function getOrganizationListRaw<T>(requestParameters: GetOrganizationListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Organization>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of Organizations
*/
export function getOrganizationList<T>(requestParameters: GetOrganizationListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<Organization>>): QueryConfig<T> {
