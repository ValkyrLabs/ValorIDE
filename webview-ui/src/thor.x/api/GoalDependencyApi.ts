...
export interface GetGoalDependencyListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getGoalDependencyListRaw<T>(requestParameters: GetGoalDependencyListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<GoalDependency>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of GoalDependencys
*/
export function getGoalDependencyList<T>(requestParameters: GetGoalDependencyListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<GoalDependency>>): QueryConfig<T> {
