...
export interface GetChartSeriesListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getChartSeriesListRaw<T>(requestParameters: GetChartSeriesListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<ChartSeries>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of ChartSeriess
*/
export function getChartSeriesList<T>(requestParameters: GetChartSeriesListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<ChartSeries>>): QueryConfig<T> {
