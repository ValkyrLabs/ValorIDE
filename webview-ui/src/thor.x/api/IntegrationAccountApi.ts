...
export interface GetIntegrationAccountListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getIntegrationAccountListRaw<T>(requestParameters: GetIntegrationAccountListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<IntegrationAccount>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of IntegrationAccounts
*/
export function getIntegrationAccountList<T>(requestParameters: GetIntegrationAccountListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<IntegrationAccount>>): QueryConfig<T> {
