...
export interface GetMediaObjectListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getMediaObjectListRaw<T>(requestParameters: GetMediaObjectListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<MediaObject>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of MediaObjects
*/
export function getMediaObjectList<T>(requestParameters: GetMediaObjectListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<MediaObject>>): QueryConfig<T> {
