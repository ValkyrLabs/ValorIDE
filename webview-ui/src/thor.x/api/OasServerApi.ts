...
export interface GetOasServerListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getOasServerListRaw<T>(requestParameters: GetOasServerListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<OasServer>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of OasServers
*/
export function getOasServerList<T>(requestParameters: GetOasServerListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<OasServer>>): QueryConfig<T> {
