...
export interface GetBorderListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getBorderListRaw<T>(requestParameters: GetBorderListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Border>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of Borders
*/
export function getBorderList<T>(requestParameters: GetBorderListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<Border>>): QueryConfig<T> {
