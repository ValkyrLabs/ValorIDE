...
export interface GetOasComponentListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function deleteOasComponentRaw<T>(requestParameters: DeleteOasComponentRequest, requestConfig: runtime.TypedQueryConfig<T, void> = {}): QueryConfig<T> {
...
* Delete a OasComponent.
*/
export function deleteOasComponent<T>(requestParameters: DeleteOasComponentRequest, requestConfig?: runtime.TypedQueryConfig<T, void>): QueryConfig<T> {
 ...
 */
function getOasComponentRaw<T>(requestParameters: GetOasComponentRequest, requestConfig: runtime.TypedQueryConfig<T, OasComponent> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Retrieve a single OasComponent
*/
export function getOasComponent<T>(requestParameters: GetOasComponentRequest, requestConfig?: runtime.TypedQueryConfig<T, OasComponent>): QueryConfig<T> {
 ...
 */
function getOasComponentListRaw<T>(requestParameters: GetOasComponentListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<OasComponent>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of OasComponents
*/
export function getOasComponentList<T>(requestParameters: GetOasComponentListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<OasComponent>>): QueryConfig<T> {
 ...
 */
function postOasComponentRaw<T>(requestParameters: PostOasComponentRequest, requestConfig: runtime.TypedQueryConfig<T, OasComponent> = {}): QueryConfig<T> {
...
* Create a new OasComponent
*/
export function postOasComponent<T>(requestParameters: PostOasComponentRequest, requestConfig?: runtime.TypedQueryConfig<T, OasComponent>): QueryConfig<T> {
 ...
 */
function updateOasComponentRaw<T>(requestParameters: UpdateOasComponentRequest, requestConfig: runtime.TypedQueryConfig<T, OasComponent> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Update an existing OasComponent
*/
export function updateOasComponent<T>(requestParameters: UpdateOasComponentRequest, requestConfig?: runtime.TypedQueryConfig<T, OasComponent>): QueryConfig<T> {
