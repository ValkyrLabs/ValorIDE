...
export interface GetFormatListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getFormatListRaw<T>(requestParameters: GetFormatListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Format>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of Formats
*/
export function getFormatList<T>(requestParameters: GetFormatListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<Format>>): QueryConfig<T> {
