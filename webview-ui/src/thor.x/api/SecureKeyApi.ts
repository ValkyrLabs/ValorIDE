...
export interface GetSecureKeyListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getSecureKeyListRaw<T>(requestParameters: GetSecureKeyListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<SecureKey>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of SecureKeys
*/
export function getSecureKeyList<T>(requestParameters: GetSecureKeyListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<SecureKey>>): QueryConfig<T> {
