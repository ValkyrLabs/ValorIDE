...
export interface GetOasResponseListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getOasResponseListRaw<T>(requestParameters: GetOasResponseListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<OasResponse>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of OasResponses
*/
export function getOasResponseList<T>(requestParameters: GetOasResponseListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<OasResponse>>): QueryConfig<T> {
