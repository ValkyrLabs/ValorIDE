 ...
 */
function getApplicationListRaw<T>(requestParameters: GetApplicationListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Application>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of Applications
*/
export function getApplicationList<T>(requestParameters: GetApplicationListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<Application>>): QueryConfig<T> {
