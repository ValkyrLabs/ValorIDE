...
export interface GetWorkflowStateListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getWorkflowStateListRaw<T>(requestParameters: GetWorkflowStateListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<WorkflowState>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of WorkflowStates
*/
export function getWorkflowStateList<T>(requestParameters: GetWorkflowStateListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<WorkflowState>>): QueryConfig<T> {
