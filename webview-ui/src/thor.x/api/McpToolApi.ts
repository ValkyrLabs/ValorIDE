 ...
 * Delete a McpTool.
 */
function deleteMcpToolRaw<T>(requestParameters: DeleteMcpToolRequest, requestConfig: runtime.TypedQueryConfig<T, void> = {}): QueryConfig<T> {
...
* Delete a McpTool.
*/
export function deleteMcpTool<T>(requestParameters: DeleteMcpToolRequest, requestConfig?: runtime.TypedQueryConfig<T, void>): QueryConfig<T> {
 ...
 */
function getMcpToolRaw<T>(requestParameters: GetMcpToolRequest, requestConfig: runtime.TypedQueryConfig<T, McpTool> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Retrieve a single McpTool
*/
export function getMcpTool<T>(requestParameters: GetMcpToolRequest, requestConfig?: runtime.TypedQueryConfig<T, McpTool>): QueryConfig<T> {
 ...
 */
function getMcpToolListRaw<T>(requestParameters: GetMcpToolListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<McpTool>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of McpTools
*/
export function getMcpToolList<T>(requestParameters: GetMcpToolListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<McpTool>>): QueryConfig<T> {
 ...
 */
function postMcpToolRaw<T>(requestParameters: PostMcpToolRequest, requestConfig: runtime.TypedQueryConfig<T, McpTool> = {}): QueryConfig<T> {
...
* Create a new McpTool
*/
export function postMcpTool<T>(requestParameters: PostMcpToolRequest, requestConfig?: runtime.TypedQueryConfig<T, McpTool>): QueryConfig<T> {
 ...
 */
function updateMcpToolRaw<T>(requestParameters: UpdateMcpToolRequest, requestConfig: runtime.TypedQueryConfig<T, McpTool> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Update an existing McpTool
*/
export function updateMcpTool<T>(requestParameters: UpdateMcpToolRequest, requestConfig?: runtime.TypedQueryConfig<T, McpTool>): QueryConfig<T> {
