...
export interface GetChartListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getChartListRaw<T>(requestParameters: GetChartListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Chart>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of Charts
*/
export function getChartList<T>(requestParameters: GetChartListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<Chart>>): QueryConfig<T> {
