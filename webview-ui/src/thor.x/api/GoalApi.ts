...
export interface GetGoalListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getGoalListRaw<T>(requestParameters: GetGoalListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<Goal>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of Goals
*/
export function getGoalList<T>(requestParameters: GetGoalListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<Goal>>): QueryConfig<T> {
