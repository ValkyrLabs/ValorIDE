...
export interface GetOasEnumListRequest {
    page?: number;
    size?: number;
    sort?: Array<string>;
}
 ...
 */
function getOasEnumListRaw<T>(requestParameters: GetOasEnumListRequest, requestConfig: runtime.TypedQueryConfig<T, Array<OasEnum>> = {}): QueryConfig<T> {
    let queryParameters = null;
...
* Retrieve a list of OasEnums
*/
export function getOasEnumList<T>(requestParameters: GetOasEnumListRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<OasEnum>>): QueryConfig<T> {
