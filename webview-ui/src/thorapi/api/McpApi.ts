...
import {
    ...
    PublishMcpToolRequestFromJSON,
    PublishMcpToolRequestToJSON,
    PublishMcpToolResponse,
    PublishMcpToolResponseFromJSON,
    PublishMcpToolResponseToJSON,
...
export interface GetMcpServiceContractsApiRequest {
    slug: string;
}
...
export interface PublishMcpToolApiRequest {
    publishMcpToolRequest: PublishMcpToolRequest;
}
...
/**
 * Returns workflow/module bindings and invocation payload contracts for a published MCP service.
 * Get MCP service tool contracts
 */
function getMcpServiceContractsRaw<T>(requestParameters: GetMcpServiceContractsApiRequest, requestConfig: runtime.TypedQueryConfig<T, { [key: string]: any | undefined; }> = {}): QueryConfig<T> {
    if (requestParameters.slug === null || requestParameters.slug === undefined) {
        throw new runtime.RequiredError('slug','Required parameter requestParameters.slug was null or undefined when calling getMcpServiceContracts.');
    }
    ...
    const config: QueryConfig<T> = {
        url: `${runtime.Configuration.basePath}/mcp/services/{slug}/contracts`.replace(`{${"slug"}}`, encodeURIComponent(String(requestParameters.slug))),
        meta,
        update: requestConfig.update,
        queryKey: requestConfig.queryKey,
        optimisticUpdate: requestConfig.optimisticUpdate,
...
* Get MCP service tool contracts
*/
export function getMcpServiceContracts<T>(requestParameters: GetMcpServiceContractsApiRequest, requestConfig?: runtime.TypedQueryConfig<T, { [key: string]: any | undefined; }>): QueryConfig<T> {
    return getMcpServiceContractsRaw(requestParameters, requestConfig);
}
...
/**
 * Creates MCP tool preset artifacts so ValorIDE can consume a generated API.
 * Publish generated API as an MCP tool preset
 */
function publishMcpToolRaw<T>(requestParameters: PublishMcpToolApiRequest, requestConfig: runtime.TypedQueryConfig<T, PublishMcpToolResponse> = {}): QueryConfig<T> {
    if (requestParameters.publishMcpToolRequest === null || requestParameters.publishMcpToolRequest === undefined) {
        throw new runtime.RequiredError('publishMcpToolRequest','Required parameter requestParameters.publishMcpToolRequest was null or undefined when calling publishMcpTool.');
    }
    ...
    const config: QueryConfig<T> = {
        url: `${runtime.Configuration.basePath}/mcp/publish`,
        meta,
        update: requestConfig.update,
        queryKey: requestConfig.queryKey,
        optimisticUpdate: requestConfig.optimisticUpdate,
        ...
        body: queryParameters || PublishMcpToolRequestToJSON(requestParameters.publishMcpToolRequest),
    };

    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(PublishMcpToolResponseFromJSON(body), text);
    }
...
* Publish generated API as an MCP tool preset
*/
export function publishMcpTool<T>(requestParameters: PublishMcpToolApiRequest, requestConfig?: runtime.TypedQueryConfig<T, PublishMcpToolResponse>): QueryConfig<T> {
    return publishMcpToolRaw(requestParameters, requestConfig);
}
