...
function deleteApplicationRaw<T>(
  requestParameters: DeleteApplicationApiRequest,
...
function getApplicationRaw<T>(
  requestParameters: GetApplicationApiRequest,
...
function getApplicationListRaw<T>(
  requestParameters: GetApplicationListApiRequest,
 ...
 */
function patchApplicationByIdRaw<T>(
  requestParameters: PatchApplicationByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Application> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchApplicationById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "application",
      "Required parameter requestParameters.application was null or undefined when calling patchApplicationById.",
    );
  }
 ...
 * Partially update an existing Application
 */
export function patchApplicationById<T>(
  requestParameters: PatchApplicationByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, Application>,
): QueryConfig<T> {
...
function postApplicationRaw<T>(
  requestParameters: PostApplicationApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Application> = {},
): QueryConfig<T> {
  if (
    requestParameters.application === null ||
...
function updateApplicationRaw<T>(
  requestParameters: UpdateApplicationApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Application> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
