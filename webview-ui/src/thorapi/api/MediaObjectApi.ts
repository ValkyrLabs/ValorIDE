 ...
 */
function patchMediaObjectByIdRaw<T>(
  requestParameters: PatchMediaObjectByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, MediaObject> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchMediaObjectById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "mediaObject",
      "Required parameter requestParameters.mediaObject was null or undefined when calling patchMediaObjectById.",
    );
  }
 ...
 * Partially update an existing MediaObject
 */
export function patchMediaObjectById<T>(
  requestParameters: PatchMediaObjectByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, MediaObject>,
): QueryConfig<T> {
