...
function deletePrincipalRaw<T>(
  requestParameters: DeletePrincipalApiRequest,
...
function getPrincipalRaw<T>(
  requestParameters: GetPrincipalApiRequest,
...
function getPrincipalListRaw<T>(
  requestParameters: GetPrincipalListApiRequest,
 ...
 */
function patchPrincipalByIdRaw<T>(
  requestParameters: PatchPrincipalByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Principal> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchPrincipalById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "principal",
      "Required parameter requestParameters.principal was null or undefined when calling patchPrincipalById.",
    );
  }
 ...
 * Partially update an existing Principal
 */
export function patchPrincipalById<T>(
  requestParameters: PatchPrincipalByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, Principal>,
): QueryConfig<T> {
...
function postPrincipalRaw<T>(
  requestParameters: PostPrincipalApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Principal> = {},
): QueryConfig<T> {
  if (
    requestParameters.principal === null ||
...
function updatePrincipalRaw<T>(
  requestParameters: UpdatePrincipalApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Principal> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
