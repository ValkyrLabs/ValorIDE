...
function deleteChatCompletionResponseRaw<T>(
  requestParameters: DeleteChatCompletionResponseApiRequest,
...
function getChatCompletionResponseRaw<T>(
  requestParameters: GetChatCompletionResponseApiRequest,
...
function getChatCompletionResponseListRaw<T>(
  requestParameters: GetChatCompletionResponseListApiRequest,
 ...
 */
function patchChatCompletionResponseByIdRaw<T>(
  requestParameters: PatchChatCompletionResponseByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, ChatCompletionResponse> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchChatCompletionResponseById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "chatCompletionResponse",
      "Required parameter requestParameters.chatCompletionResponse was null or undefined when calling patchChatCompletionResponseById.",
    );
  }
 ...
 * Partially update an existing ChatCompletionResponse
 */
export function patchChatCompletionResponseById<T>(
  requestParameters: PatchChatCompletionResponseByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, ChatCompletionResponse>,
): QueryConfig<T> {
...
function postChatCompletionResponseRaw<T>(
  requestParameters: PostChatCompletionResponseApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, ChatCompletionResponse> = {},
): QueryConfig<T> {
  if (
    requestParameters.chatCompletionResponse === null ||
...
function updateChatCompletionResponseRaw<T>(
  requestParameters: UpdateChatCompletionResponseApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, ChatCompletionResponse> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
