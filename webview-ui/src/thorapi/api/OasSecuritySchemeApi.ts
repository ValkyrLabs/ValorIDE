...
function deleteOasSecuritySchemeRaw<T>(
  requestParameters: DeleteOasSecuritySchemeApiRequest,
...
function getOasSecuritySchemeRaw<T>(
  requestParameters: GetOasSecuritySchemeApiRequest,
...
function getOasSecuritySchemeListRaw<T>(
  requestParameters: GetOasSecuritySchemeListApiRequest,
 ...
 */
function patchOasSecuritySchemeByIdRaw<T>(
  requestParameters: PatchOasSecuritySchemeByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, OasSecurityScheme> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchOasSecuritySchemeById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "oasSecurityScheme",
      "Required parameter requestParameters.oasSecurityScheme was null or undefined when calling patchOasSecuritySchemeById.",
    );
  }
 ...
 * Partially update an existing OasSecurityScheme
 */
export function patchOasSecuritySchemeById<T>(
  requestParameters: PatchOasSecuritySchemeByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, OasSecurityScheme>,
): QueryConfig<T> {
...
function postOasSecuritySchemeRaw<T>(
  requestParameters: PostOasSecuritySchemeApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, OasSecurityScheme> = {},
): QueryConfig<T> {
  if (
    requestParameters.oasSecurityScheme === null ||
...
function updateOasSecuritySchemeRaw<T>(
  requestParameters: UpdateOasSecuritySchemeApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, OasSecurityScheme> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
