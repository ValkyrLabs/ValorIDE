 ...
 */
function patchWorkbookByIdRaw<T>(
  requestParameters: PatchWorkbookByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Workbook> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchWorkbookById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "workbook",
      "Required parameter requestParameters.workbook was null or undefined when calling patchWorkbookById.",
    );
  }
 ...
 * Partially update an existing Workbook
 */
export function patchWorkbookById<T>(
  requestParameters: PatchWorkbookByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, Workbook>,
): QueryConfig<T> {
