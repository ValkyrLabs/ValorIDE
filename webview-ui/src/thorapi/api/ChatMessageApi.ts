...
function deleteChatMessageRaw<T>(
  requestParameters: DeleteChatMessageApiRequest,
...
function getChatMessageRaw<T>(
  requestParameters: GetChatMessageApiRequest,
...
function getChatMessageListRaw<T>(
  requestParameters: GetChatMessageListApiRequest,
 ...
 */
function patchChatMessageByIdRaw<T>(
  requestParameters: PatchChatMessageByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, ChatMessage> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchChatMessageById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "chatMessage",
      "Required parameter requestParameters.chatMessage was null or undefined when calling patchChatMessageById.",
    );
  }
 ...
 * Partially update an existing ChatMessage
 */
export function patchChatMessageById<T>(
  requestParameters: PatchChatMessageByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, ChatMessage>,
): QueryConfig<T> {
...
function postChatMessageRaw<T>(
  requestParameters: PostChatMessageApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, ChatMessage> = {},
): QueryConfig<T> {
  if (
    requestParameters.chatMessage === null ||
...
function updateChatMessageRaw<T>(
  requestParameters: UpdateChatMessageApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, ChatMessage> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
