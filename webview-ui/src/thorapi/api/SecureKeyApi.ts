 ...
 */
function patchSecureKeyByIdRaw<T>(
  requestParameters: PatchSecureKeyByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, SecureKey> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchSecureKeyById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "secureKey",
      "Required parameter requestParameters.secureKey was null or undefined when calling patchSecureKeyById.",
    );
  }
 ...
 * Partially update an existing SecureKey
 */
export function patchSecureKeyById<T>(
  requestParameters: PatchSecureKeyByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, SecureKey>,
): QueryConfig<T> {
