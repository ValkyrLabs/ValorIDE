...
function deleteAclEntryRaw<T>(
  requestParameters: DeleteAclEntryApiRequest,
...
function getAclEntryRaw<T>(
  requestParameters: GetAclEntryApiRequest,
...
function getAclEntryListRaw<T>(
  requestParameters: GetAclEntryListApiRequest,
 ...
 */
function patchAclEntryByIdRaw<T>(
  requestParameters: PatchAclEntryByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, AclEntry> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchAclEntryById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "aclEntry",
      "Required parameter requestParameters.aclEntry was null or undefined when calling patchAclEntryById.",
    );
  }
 ...
 * Partially update an existing AclEntry
 */
export function patchAclEntryById<T>(
  requestParameters: PatchAclEntryByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, AclEntry>,
): QueryConfig<T> {
...
function postAclEntryRaw<T>(
  requestParameters: PostAclEntryApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, AclEntry> = {},
): QueryConfig<T> {
  if (
    requestParameters.aclEntry === null ||
...
function updateAclEntryRaw<T>(
  requestParameters: UpdateAclEntryApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, AclEntry> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
