 ...
 */
function patchFormatByIdRaw<T>(
  requestParameters: PatchFormatByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Format> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchFormatById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "format",
      "Required parameter requestParameters.format was null or undefined when calling patchFormatById.",
    );
  }
 ...
 * Partially update an existing Format
 */
export function patchFormatById<T>(
  requestParameters: PatchFormatByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, Format>,
): QueryConfig<T> {
