...
function deleteNamedRangeRaw<T>(
  requestParameters: DeleteNamedRangeApiRequest,
...
function getNamedRangeRaw<T>(
  requestParameters: GetNamedRangeApiRequest,
...
function getNamedRangeListRaw<T>(
  requestParameters: GetNamedRangeListApiRequest,
 ...
 */
function patchNamedRangeByIdRaw<T>(
  requestParameters: PatchNamedRangeByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, NamedRange> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchNamedRangeById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "namedRange",
      "Required parameter requestParameters.namedRange was null or undefined when calling patchNamedRangeById.",
    );
  }
 ...
 * Partially update an existing NamedRange
 */
export function patchNamedRangeById<T>(
  requestParameters: PatchNamedRangeByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, NamedRange>,
): QueryConfig<T> {
...
function postNamedRangeRaw<T>(
  requestParameters: PostNamedRangeApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, NamedRange> = {},
): QueryConfig<T> {
  if (
    requestParameters.namedRange === null ||
...
function updateNamedRangeRaw<T>(
  requestParameters: UpdateNamedRangeApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, NamedRange> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
