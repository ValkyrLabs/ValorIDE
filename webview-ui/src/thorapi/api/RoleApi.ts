...
function deleteRoleRaw<T>(
  requestParameters: DeleteRoleApiRequest,
...
function getRoleRaw<T>(
  requestParameters: GetRoleApiRequest,
...
function getRoleListRaw<T>(
  requestParameters: GetRoleListApiRequest,
 ...
 */
function patchRoleByIdRaw<T>(
  requestParameters: PatchRoleByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Role> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchRoleById.",
    );
  }
  ...
  if (requestParameters.role === null || requestParameters.role === undefined) {
    throw new runtime.RequiredError(
      "role",
      "Required parameter requestParameters.role was null or undefined when calling patchRoleById.",
    );
  }
 ...
 * Partially update an existing Role
 */
export function patchRoleById<T>(
  requestParameters: PatchRoleByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, Role>,
): QueryConfig<T> {
...
function postRoleRaw<T>(
  requestParameters: PostRoleApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Role> = {},
): QueryConfig<T> {
  if (requestParameters.role === null || requestParameters.role === undefined) {
    throw new runtime.RequiredError(
...
function updateRoleRaw<T>(
  requestParameters: UpdateRoleApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Role> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
