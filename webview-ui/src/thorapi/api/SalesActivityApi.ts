 ...
 */
function patchSalesActivityByIdRaw<T>(
  requestParameters: PatchSalesActivityByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, SalesActivity> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchSalesActivityById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "salesActivity",
      "Required parameter requestParameters.salesActivity was null or undefined when calling patchSalesActivityById.",
    );
  }
 ...
 * Partially update an existing SalesActivity
 */
export function patchSalesActivityById<T>(
  requestParameters: PatchSalesActivityByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, SalesActivity>,
): QueryConfig<T> {
