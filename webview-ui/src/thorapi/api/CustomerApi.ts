...
function deleteCustomerRaw<T>(
  requestParameters: DeleteCustomerApiRequest,
...
function getCustomerRaw<T>(
  requestParameters: GetCustomerApiRequest,
...
function getCustomerListRaw<T>(
  requestParameters: GetCustomerListApiRequest,
 ...
 */
function patchCustomerByIdRaw<T>(
  requestParameters: PatchCustomerByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Customer> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchCustomerById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "customer",
      "Required parameter requestParameters.customer was null or undefined when calling patchCustomerById.",
    );
  }
 ...
 * Partially update an existing Customer
 */
export function patchCustomerById<T>(
  requestParameters: PatchCustomerByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, Customer>,
): QueryConfig<T> {
...
function postCustomerRaw<T>(
  requestParameters: PostCustomerApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Customer> = {},
): QueryConfig<T> {
  if (
    requestParameters.customer === null ||
...
function updateCustomerRaw<T>(
  requestParameters: UpdateCustomerApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Customer> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
