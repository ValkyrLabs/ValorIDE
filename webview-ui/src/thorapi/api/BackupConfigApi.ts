...
function deleteBackupConfigRaw<T>(
  requestParameters: DeleteBackupConfigApiRequest,
...
function getBackupConfigRaw<T>(
  requestParameters: GetBackupConfigApiRequest,
...
function getBackupConfigListRaw<T>(
  requestParameters: GetBackupConfigListApiRequest,
 ...
 */
function patchBackupConfigByIdRaw<T>(
  requestParameters: PatchBackupConfigByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, BackupConfig> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchBackupConfigById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "backupConfig",
      "Required parameter requestParameters.backupConfig was null or undefined when calling patchBackupConfigById.",
    );
  }
 ...
 * Partially update an existing BackupConfig
 */
export function patchBackupConfigById<T>(
  requestParameters: PatchBackupConfigByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, BackupConfig>,
): QueryConfig<T> {
...
function postBackupConfigRaw<T>(
  requestParameters: PostBackupConfigApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, BackupConfig> = {},
): QueryConfig<T> {
  if (
    requestParameters.backupConfig === null ||
...
function updateBackupConfigRaw<T>(
  requestParameters: UpdateBackupConfigApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, BackupConfig> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
