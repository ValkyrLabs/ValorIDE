...
export interface PatchMcpResourceByIdApiRequest {
    id: string;
 ...
 * Partially update an existing McpResource
 */
function patchMcpResourceByIdRaw<T>(requestParameters: PatchMcpResourceByIdApiRequest, requestConfig: runtime.TypedQueryConfig<T, McpResource> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
        throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling patchMcpResourceById.');
    }

    if (requestParameters.mcpResource === null || requestParameters.mcpResource === undefined) {
        throw new runtime.RequiredError('mcpResource','Required parameter requestParameters.mcpResource was null or undefined when calling patchMcpResourceById.');
    }
...
* Partially update an existing McpResource
*/
export function patchMcpResourceById<T>(requestParameters: PatchMcpResourceByIdApiRequest, requestConfig?: runtime.TypedQueryConfig<T, McpResource>): QueryConfig<T> {
    return patchMcpResourceByIdRaw(requestParameters, requestConfig);
}
