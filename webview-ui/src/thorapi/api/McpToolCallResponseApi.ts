...
function deleteMcpToolCallResponseRaw<T>(
  requestParameters: DeleteMcpToolCallResponseApiRequest,
...
function getMcpToolCallResponseRaw<T>(
  requestParameters: GetMcpToolCallResponseApiRequest,
...
function getMcpToolCallResponseListRaw<T>(
  requestParameters: GetMcpToolCallResponseListApiRequest,
 ...
 */
function patchMcpToolCallResponseByIdRaw<T>(
  requestParameters: PatchMcpToolCallResponseByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, McpToolCallResponse> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchMcpToolCallResponseById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "mcpToolCallResponse",
      "Required parameter requestParameters.mcpToolCallResponse was null or undefined when calling patchMcpToolCallResponseById.",
    );
  }
 ...
 * Partially update an existing McpToolCallResponse
 */
export function patchMcpToolCallResponseById<T>(
  requestParameters: PatchMcpToolCallResponseByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, McpToolCallResponse>,
): QueryConfig<T> {
...
function postMcpToolCallResponseRaw<T>(
  requestParameters: PostMcpToolCallResponseApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, McpToolCallResponse> = {},
): QueryConfig<T> {
  if (
    requestParameters.mcpToolCallResponse === null ||
...
function updateMcpToolCallResponseRaw<T>(
  requestParameters: UpdateMcpToolCallResponseApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, McpToolCallResponse> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
