...
function deleteIntegrationAccountRaw<T>(
  requestParameters: DeleteIntegrationAccountApiRequest,
...
function getIntegrationAccountRaw<T>(
  requestParameters: GetIntegrationAccountApiRequest,
...
function getIntegrationAccountListRaw<T>(
  requestParameters: GetIntegrationAccountListApiRequest,
 ...
 */
function patchIntegrationAccountByIdRaw<T>(
  requestParameters: PatchIntegrationAccountByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, IntegrationAccount> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchIntegrationAccountById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "integrationAccount",
      "Required parameter requestParameters.integrationAccount was null or undefined when calling patchIntegrationAccountById.",
    );
  }
 ...
 * Partially update an existing IntegrationAccount
 */
export function patchIntegrationAccountById<T>(
  requestParameters: PatchIntegrationAccountByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, IntegrationAccount>,
): QueryConfig<T> {
...
function postIntegrationAccountRaw<T>(
  requestParameters: PostIntegrationAccountApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, IntegrationAccount> = {},
): QueryConfig<T> {
  if (
    requestParameters.integrationAccount === null ||
...
function updateIntegrationAccountRaw<T>(
  requestParameters: UpdateIntegrationAccountApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, IntegrationAccount> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
