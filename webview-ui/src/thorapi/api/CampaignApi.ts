 ...
 */
function patchCampaignByIdRaw<T>(requestParameters: PatchCampaignByIdApiRequest, requestConfig: runtime.TypedQueryConfig<T, Campaign> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
        throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling patchCampaignById.');
    }

    if (requestParameters.campaign === null || requestParameters.campaign === undefined) {
        throw new runtime.RequiredError('campaign','Required parameter requestParameters.campaign was null or undefined when calling patchCampaignById.');
    }
...
* Partially update an existing Campaign
*/
export function patchCampaignById<T>(requestParameters: PatchCampaignByIdApiRequest, requestConfig?: runtime.TypedQueryConfig<T, Campaign>): QueryConfig<T> {
