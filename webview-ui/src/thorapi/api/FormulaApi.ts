 ...
 */
function patchFormulaByIdRaw<T>(
  requestParameters: PatchFormulaByIdApiRequest,
  requestConfig: runtime.TypedQueryConfig<T, Formula> = {},
): QueryConfig<T> {
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError(
      "id",
      "Required parameter requestParameters.id was null or undefined when calling patchFormulaById.",
    );
  }
  ...
  if (
    ...
    throw new runtime.RequiredError(
      "formula",
      "Required parameter requestParameters.formula was null or undefined when calling patchFormulaById.",
    );
  }
 ...
 * Partially update an existing Formula
 */
export function patchFormulaById<T>(
  requestParameters: PatchFormulaByIdApiRequest,
  requestConfig?: runtime.TypedQueryConfig<T, Formula>,
): QueryConfig<T> {
