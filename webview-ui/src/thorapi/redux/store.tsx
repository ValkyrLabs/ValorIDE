...
import { AppGenerationRequestService } from './services/AppGenerationRequestService';
import { AppGenerationTraceResponseService } from './services/AppGenerationTraceResponseService';
import { AppObjectModelService } from './services/AppObjectModelService';
import { AppSpecDraftService } from './services/AppSpecDraftService';
...
import { ApplicationDataPlaneBindingService } from './services/ApplicationDataPlaneBindingService';
...
import { ContextCompressionReceiptService } from './services/ContextCompressionReceiptService';
import { ContextPageService } from './services/ContextPageService';
import { ContextPageCompileRequestService } from './services/ContextPageCompileRequestService';
import { ContextPageHydrateRequestService } from './services/ContextPageHydrateRequestService';
import { ContextPageItemService } from './services/ContextPageItemService';
import { ContextPageRecompressRequestService } from './services/ContextPageRecompressRequestService';
import { ContextPageResponseService } from './services/ContextPageResponseService';
import { ContextPageTraverseRequestService } from './services/ContextPageTraverseRequestService';
import { ContextTraversalEventService } from './services/ContextTraversalEventService';
...
import { CreditDebitReceiptService } from './services/CreditDebitReceiptService';
import { CreditPricingMatrixService } from './services/CreditPricingMatrixService';
import { CreditReservationService } from './services/CreditReservationService';
...
import { FileListResponseService } from './services/FileListResponseService';
...
import { GeneratedArtifactService } from './services/GeneratedArtifactService';
import { GeneratedArtifactSetService } from './services/GeneratedArtifactSetService';
import { GenerationReceiptService } from './services/GenerationReceiptService';
...
import { HydrationPointerService } from './services/HydrationPointerService';
...
import { LlmCommandService } from './services/LlmCommandService';
import { LlmCommandResultService } from './services/LlmCommandResultService';
...
import { McpResponsePartService } from './services/McpResponsePartService';
import { McpServerService } from './services/McpServerService';
import { McpServiceContractsResponseService } from './services/McpServiceContractsResponseService';
...
import { OpenClawLightsailLaunchEstimateService } from './services/OpenClawLightsailLaunchEstimateService';
import { OpenClawLightsailLaunchRequestService } from './services/OpenClawLightsailLaunchRequestService';
import { OpenClawLightsailLaunchResponseService } from './services/OpenClawLightsailLaunchResponseService';
import { OpenClawLightsailProvisioningEventService } from './services/OpenClawLightsailProvisioningEventService';
...
import { ProjectObjectLinkService } from './services/ProjectObjectLinkService';
...
import { PublishMcpToolRequestService } from './services/PublishMcpToolRequestService';
import { PublishMcpToolResponseService } from './services/PublishMcpToolResponseService';
...
import { RefundRecordService } from './services/RefundRecordService';
...
import { RetrievalCoverageService } from './services/RetrievalCoverageService';
import { RetrievalEvaluatorResultService } from './services/RetrievalEvaluatorResultService';
import { RetrievalPolicyDecisionService } from './services/RetrievalPolicyDecisionService';
import { RetrievalProvenanceService } from './services/RetrievalProvenanceService';
import { RetrievalQualityScoreService } from './services/RetrievalQualityScoreService';
import { RetrievalReceiptService } from './services/RetrievalReceiptService';
import { RetrievalReceiptItemService } from './services/RetrievalReceiptItemService';
import { RetrievalReceiptRequestService } from './services/RetrievalReceiptRequestService';
import { RetrievalReceiptResponseService } from './services/RetrievalReceiptResponseService';
import { RetrievalRetryRequestService } from './services/RetrievalRetryRequestService';
...
import { SchemaEvolutionLedgerService } from './services/SchemaEvolutionLedgerService';
...
import { SkillOptRouteOutcomeRequestService } from './services/SkillOptRouteOutcomeRequestService';
import { SkillOptRouteReceiptService } from './services/SkillOptRouteReceiptService';
import { SkillOptRouteRequestService } from './services/SkillOptRouteRequestService';
import { SkillOptRouteResponseService } from './services/SkillOptRouteResponseService';
import { SkillProfileService } from './services/SkillProfileService';
import { SkillSignalService } from './services/SkillSignalService';
...
import { StripeCheckoutSessionService } from './services/StripeCheckoutSessionService';
import { StripeCustomerLinkService } from './services/StripeCustomerLinkService';
import { StripeSubscriptionService } from './services/StripeSubscriptionService';
import { StripeWebhookEventService } from './services/StripeWebhookEventService';
...
import { TenantRuntimeBindingService } from './services/TenantRuntimeBindingService';
import { TenantSchemaAccessAuditService } from './services/TenantSchemaAccessAuditService';
import { TenantSchemaBundleService } from './services/TenantSchemaBundleService';
import { TenantSchemaOperationService } from './services/TenantSchemaOperationService';
import { TenantSchemaRegistryService } from './services/TenantSchemaRegistryService';
import { ThorApiGenerationRunService } from './services/ThorApiGenerationRunService';
import { ThorApiSpecRevisionService } from './services/ThorApiSpecRevisionService';
...
import { WorkforceSkillService } from './services/WorkforceSkillService';
import { WorkforceTransitionRecordService } from './services/WorkforceTransitionRecordService';
...
export const reducer = {
  ...
  [AppGenerationRequestService.reducerPath]: AppGenerationRequestService.reducer,
  [AppGenerationTraceResponseService.reducerPath]: AppGenerationTraceResponseService.reducer,
  [AppObjectModelService.reducerPath]: AppObjectModelService.reducer,
  [AppSpecDraftService.reducerPath]: AppSpecDraftService.reducer,
  ...
  [ApplicationDataPlaneBindingService.reducerPath]: ApplicationDataPlaneBindingService.reducer,
  ...
  [ContextCompressionReceiptService.reducerPath]: ContextCompressionReceiptService.reducer,
  [ContextPageService.reducerPath]: ContextPageService.reducer,
  [ContextPageCompileRequestService.reducerPath]: ContextPageCompileRequestService.reducer,
  [ContextPageHydrateRequestService.reducerPath]: ContextPageHydrateRequestService.reducer,
  [ContextPageItemService.reducerPath]: ContextPageItemService.reducer,
  [ContextPageRecompressRequestService.reducerPath]: ContextPageRecompressRequestService.reducer,
  [ContextPageResponseService.reducerPath]: ContextPageResponseService.reducer,
  [ContextPageTraverseRequestService.reducerPath]: ContextPageTraverseRequestService.reducer,
  [ContextTraversalEventService.reducerPath]: ContextTraversalEventService.reducer,
  ...
  [CreditDebitReceiptService.reducerPath]: CreditDebitReceiptService.reducer,
  [CreditPricingMatrixService.reducerPath]: CreditPricingMatrixService.reducer,
  [CreditReservationService.reducerPath]: CreditReservationService.reducer,
  ...
  [FileListResponseService.reducerPath]: FileListResponseService.reducer,
  ...
  [GeneratedArtifactService.reducerPath]: GeneratedArtifactService.reducer,
  [GeneratedArtifactSetService.reducerPath]: GeneratedArtifactSetService.reducer,
  [GenerationReceiptService.reducerPath]: GenerationReceiptService.reducer,
  ...
  [HydrationPointerService.reducerPath]: HydrationPointerService.reducer,
  ...
  [LlmCommandService.reducerPath]: LlmCommandService.reducer,
  [LlmCommandResultService.reducerPath]: LlmCommandResultService.reducer,
  ...
  [McpResponsePartService.reducerPath]: McpResponsePartService.reducer,
  [McpServerService.reducerPath]: McpServerService.reducer,
  [McpServiceContractsResponseService.reducerPath]: McpServiceContractsResponseService.reducer,
  ...
  [OpenClawLightsailLaunchEstimateService.reducerPath]: OpenClawLightsailLaunchEstimateService.reducer,
  [OpenClawLightsailLaunchRequestService.reducerPath]: OpenClawLightsailLaunchRequestService.reducer,
  [OpenClawLightsailLaunchResponseService.reducerPath]: OpenClawLightsailLaunchResponseService.reducer,
  [OpenClawLightsailProvisioningEventService.reducerPath]: OpenClawLightsailProvisioningEventService.reducer,
  ...
  [ProjectObjectLinkService.reducerPath]: ProjectObjectLinkService.reducer,
  ...
  [PublishMcpToolRequestService.reducerPath]: PublishMcpToolRequestService.reducer,
  [PublishMcpToolResponseService.reducerPath]: PublishMcpToolResponseService.reducer,
  ...
  [RefundRecordService.reducerPath]: RefundRecordService.reducer,
  ...
  [RetrievalCoverageService.reducerPath]: RetrievalCoverageService.reducer,
  [RetrievalEvaluatorResultService.reducerPath]: RetrievalEvaluatorResultService.reducer,
  [RetrievalPolicyDecisionService.reducerPath]: RetrievalPolicyDecisionService.reducer,
  [RetrievalProvenanceService.reducerPath]: RetrievalProvenanceService.reducer,
  [RetrievalQualityScoreService.reducerPath]: RetrievalQualityScoreService.reducer,
  [RetrievalReceiptService.reducerPath]: RetrievalReceiptService.reducer,
  [RetrievalReceiptItemService.reducerPath]: RetrievalReceiptItemService.reducer,
  [RetrievalReceiptRequestService.reducerPath]: RetrievalReceiptRequestService.reducer,
  [RetrievalReceiptResponseService.reducerPath]: RetrievalReceiptResponseService.reducer,
  [RetrievalRetryRequestService.reducerPath]: RetrievalRetryRequestService.reducer,
  ...
  [SchemaEvolutionLedgerService.reducerPath]: SchemaEvolutionLedgerService.reducer,
  ...
  [SkillOptRouteOutcomeRequestService.reducerPath]: SkillOptRouteOutcomeRequestService.reducer,
  [SkillOptRouteReceiptService.reducerPath]: SkillOptRouteReceiptService.reducer,
  [SkillOptRouteRequestService.reducerPath]: SkillOptRouteRequestService.reducer,
  [SkillOptRouteResponseService.reducerPath]: SkillOptRouteResponseService.reducer,
  [SkillProfileService.reducerPath]: SkillProfileService.reducer,
  [SkillSignalService.reducerPath]: SkillSignalService.reducer,
  ...
  [StripeCheckoutSessionService.reducerPath]: StripeCheckoutSessionService.reducer,
  [StripeCustomerLinkService.reducerPath]: StripeCustomerLinkService.reducer,
  [StripeSubscriptionService.reducerPath]: StripeSubscriptionService.reducer,
  [StripeWebhookEventService.reducerPath]: StripeWebhookEventService.reducer,
  ...
  [SupportTicketService.reducerPath]: SupportTicketService.reducer,
  ...
  [TenantRuntimeBindingService.reducerPath]: TenantRuntimeBindingService.reducer,
  [TenantSchemaAccessAuditService.reducerPath]: TenantSchemaAccessAuditService.reducer,
  [TenantSchemaBundleService.reducerPath]: TenantSchemaBundleService.reducer,
  [TenantSchemaOperationService.reducerPath]: TenantSchemaOperationService.reducer,
  [TenantSchemaRegistryService.reducerPath]: TenantSchemaRegistryService.reducer,
  [ThorApiGenerationRunService.reducerPath]: ThorApiGenerationRunService.reducer,
  [ThorApiSpecRevisionService.reducerPath]: ThorApiSpecRevisionService.reducer,
  [ThorapiRuleService.reducerPath]: ThorapiRuleService.reducer,
  [TicketCommentService.reducerPath]: TicketCommentService.reducer,
  ...
  [WorkforceSkillService.reducerPath]: WorkforceSkillService.reducer,
  [WorkforceTransitionRecordService.reducerPath]: WorkforceTransitionRecordService.reducer,
};
...
export const getMiddleWare : Middleware = () => {
  return () =>
    ...
    .concat(AppGenerationRequestService.middleware as Middleware)
    .concat(AppGenerationTraceResponseService.middleware as Middleware)
    .concat(AppObjectModelService.middleware as Middleware)
    .concat(AppSpecDraftService.middleware as Middleware)
    ...
    .concat(ApplicationDataPlaneBindingService.middleware as Middleware)
    ...
    .concat(ContextCompressionReceiptService.middleware as Middleware)
    .concat(ContextPageService.middleware as Middleware)
    .concat(ContextPageCompileRequestService.middleware as Middleware)
    .concat(ContextPageHydrateRequestService.middleware as Middleware)
    .concat(ContextPageItemService.middleware as Middleware)
    .concat(ContextPageRecompressRequestService.middleware as Middleware)
    .concat(ContextPageResponseService.middleware as Middleware)
    .concat(ContextPageTraverseRequestService.middleware as Middleware)
    .concat(ContextTraversalEventService.middleware as Middleware)
    ...
    .concat(CreditDebitReceiptService.middleware as Middleware)
    .concat(CreditPricingMatrixService.middleware as Middleware)
    .concat(CreditReservationService.middleware as Middleware)
    ...
    .concat(FileListResponseService.middleware as Middleware)
    ...
    .concat(GeneratedArtifactService.middleware as Middleware)
    .concat(GeneratedArtifactSetService.middleware as Middleware)
    .concat(GenerationReceiptService.middleware as Middleware)
    ...
    .concat(HydrationPointerService.middleware as Middleware)
    ...
    .concat(LlmCommandService.middleware as Middleware)
    .concat(LlmCommandResultService.middleware as Middleware)
    ...
    .concat(McpResponsePartService.middleware as Middleware)
    .concat(McpServerService.middleware as Middleware)
    .concat(McpServiceContractsResponseService.middleware as Middleware)
    ...
    .concat(OpenClawLightsailLaunchEstimateService.middleware as Middleware)
    .concat(OpenClawLightsailLaunchRequestService.middleware as Middleware)
    .concat(OpenClawLightsailLaunchResponseService.middleware as Middleware)
    .concat(OpenClawLightsailProvisioningEventService.middleware as Middleware)
    ...
    .concat(ProcedureService.middleware as Middleware)
    ...
    .concat(ProjectService.middleware as Middleware)
    .concat(ProjectObjectLinkService.middleware as Middleware)
    ...
    .concat(PublishMcpToolRequestService.middleware as Middleware)
    .concat(PublishMcpToolResponseService.middleware as Middleware)
    ...
    .concat(RefundRecordService.middleware as Middleware)
    ...
    .concat(RetrievalCoverageService.middleware as Middleware)
    .concat(RetrievalEvaluatorResultService.middleware as Middleware)
    .concat(RetrievalPolicyDecisionService.middleware as Middleware)
    .concat(RetrievalProvenanceService.middleware as Middleware)
    .concat(RetrievalQualityScoreService.middleware as Middleware)
    .concat(RetrievalReceiptService.middleware as Middleware)
    .concat(RetrievalReceiptItemService.middleware as Middleware)
    .concat(RetrievalReceiptRequestService.middleware as Middleware)
    .concat(RetrievalReceiptResponseService.middleware as Middleware)
    .concat(RetrievalRetryRequestService.middleware as Middleware)
    ...
    .concat(SchemaEvolutionLedgerService.middleware as Middleware)
    ...
    .concat(SkillOptRouteOutcomeRequestService.middleware as Middleware)
    .concat(SkillOptRouteReceiptService.middleware as Middleware)
    .concat(SkillOptRouteRequestService.middleware as Middleware)
    .concat(SkillOptRouteResponseService.middleware as Middleware)
    .concat(SkillProfileService.middleware as Middleware)
    .concat(SkillSignalService.middleware as Middleware)
    ...
    .concat(StripeCheckoutSessionService.middleware as Middleware)
    .concat(StripeCustomerLinkService.middleware as Middleware)
    .concat(StripeSubscriptionService.middleware as Middleware)
    .concat(StripeWebhookEventService.middleware as Middleware)
    ...
    .concat(SupportTicketService.middleware as Middleware)
    ...
    .concat(TenantRuntimeBindingService.middleware as Middleware)
    .concat(TenantSchemaAccessAuditService.middleware as Middleware)
    .concat(TenantSchemaBundleService.middleware as Middleware)
    .concat(TenantSchemaOperationService.middleware as Middleware)
    .concat(TenantSchemaRegistryService.middleware as Middleware)
    .concat(ThorApiGenerationRunService.middleware as Middleware)
    .concat(ThorApiSpecRevisionService.middleware as Middleware)
    .concat(ThorapiRuleService.middleware as Middleware)
    .concat(TicketCommentService.middleware as Middleware)
    ...
    .concat(WorkforceSkillService.middleware as Middleware)
    .concat(WorkforceTransitionRecordService.middleware as Middleware)
;
};
