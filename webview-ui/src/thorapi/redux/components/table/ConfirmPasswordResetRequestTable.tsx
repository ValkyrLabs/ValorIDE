...
const buildResourcePath = (rowId: string) =>
  `${BASE_PATH}/ConfirmPasswordResetRequest/${rowId}`;
...
const ConfirmPasswordResetRequestTable: React.FC = () => {
  ...
  // -------------------------------------------------------------------
  const [addConfirmPasswordResetRequest] =
    useAddConfirmPasswordResetRequestMutation();
  const [updateConfirmPasswordResetRequest] =
    useUpdateConfirmPasswordResetRequestMutation();
  const [deleteConfirmPasswordResetRequest] =
    useDeleteConfirmPasswordResetRequestMutation();
  const [deleteConfirmPasswordResetRequestCascade] =
    useDeleteConfirmPasswordResetRequestCascadeMutation();
  ...
  const [copiedRow, setCopiedRow] =
    useState<ConfirmPasswordResetRequest | null>(null);
  ...
  const reloadRowById = async (
    rowId: string,
  ): Promise<ConfirmPasswordResetRequest | null> => {
    ...
    try {
      ...
      console.warn(
        "Could not reload ConfirmPasswordResetRequest row",
        rowId,
        err,
      );
      return null;
  ...
  const persistRowUpdate = async (
    ...
    try {
      const saved = await updateConfirmPasswordResetRequest(
        updatedItem as any,
      ).unwrap();
  ...
  const handlePasteRow = async () => {
    ...
    try {
      ...
      console.error(
        "Failed to paste (create) ConfirmPasswordResetRequest:",
        error,
      );
  ...
  return (
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            Filter ConfirmPasswordResetRequest (Query By Example)
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <p>
