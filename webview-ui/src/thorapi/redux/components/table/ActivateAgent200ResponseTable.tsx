...
const buildResourcePath = (rowId: string) =>
  `${BASE_PATH}/ActivateAgent200Response/${rowId}`;
...
const ActivateAgent200ResponseTable: React.FC = () => {
  ...
  const [deleteActivateAgent200Response] =
    useDeleteActivateAgent200ResponseMutation();
  const [deleteActivateAgent200ResponseCascade] =
    useDeleteActivateAgent200ResponseCascadeMutation();
  ...
  const reloadRowById = async (
    rowId: string,
  ): Promise<ActivateAgent200Response | null> => {
  ...
  const persistRowUpdate = async (
    ...
    try {
      const saved = await updateActivateAgent200Response(
        updatedItem as any,
      ).unwrap();
