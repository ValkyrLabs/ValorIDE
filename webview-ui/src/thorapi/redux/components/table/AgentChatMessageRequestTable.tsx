...
const buildResourcePath = (rowId: string) =>
  `${BASE_PATH}/AgentChatMessageRequest/${rowId}`;
...
const AgentChatMessageRequestTable: React.FC = () => {
  ...
  const [deleteAgentChatMessageRequest] =
    useDeleteAgentChatMessageRequestMutation();
  const [deleteAgentChatMessageRequestCascade] =
    useDeleteAgentChatMessageRequestCascadeMutation();
  ...
  const reloadRowById = async (
    rowId: string,
  ): Promise<AgentChatMessageRequest | null> => {
  ...
  const persistRowUpdate = async (
    ...
    try {
      const saved = await updateAgentChatMessageRequest(
        updatedItem as any,
      ).unwrap();
