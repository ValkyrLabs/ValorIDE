...
const buildResourcePath = (rowId: string) =>
  `${BASE_PATH}/PublishFunnel200Response/${rowId}`;
...
const PublishFunnel200ResponseTable: React.FC = () => {
  ...
  const [deletePublishFunnel200Response] =
    useDeletePublishFunnel200ResponseMutation();
  const [deletePublishFunnel200ResponseCascade] =
    useDeletePublishFunnel200ResponseCascadeMutation();
  ...
  const reloadRowById = async (
    rowId: string,
  ): Promise<PublishFunnel200Response | null> => {
  ...
  const persistRowUpdate = async (
    ...
    try {
      const saved = await updatePublishFunnel200Response(
        updatedItem as any,
      ).unwrap();
