...
const buildResourcePath = (rowId: string) =>
  `${BASE_PATH}/InitiateTwoFactorRequest/${rowId}`;
...
const InitiateTwoFactorRequestTable: React.FC = () => {
  ...
  // -------------------------------------------------------------------
  const [addInitiateTwoFactorRequest] =
    useAddInitiateTwoFactorRequestMutation();
  const [updateInitiateTwoFactorRequest] =
    useUpdateInitiateTwoFactorRequestMutation();
  const [deleteInitiateTwoFactorRequest] =
    useDeleteInitiateTwoFactorRequestMutation();
  const [deleteInitiateTwoFactorRequestCascade] =
    useDeleteInitiateTwoFactorRequestCascadeMutation();
  ...
  const [copiedRow, setCopiedRow] = useState<InitiateTwoFactorRequest | null>(
    null,
  );
  ...
  const reloadRowById = async (
    rowId: string,
  ): Promise<InitiateTwoFactorRequest | null> => {
  ...
  const persistRowUpdate = async (
    ...
    try {
      const saved = await updateInitiateTwoFactorRequest(
        updatedItem as any,
      ).unwrap();
  ...
  const handlePasteRow = async () => {
    ...
    try {
      ...
      console.error(
        "Failed to paste (create) InitiateTwoFactorRequest:",
        error,
      );
  ...
  return (
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            Filter InitiateTwoFactorRequest (Query By Example)
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <p>
