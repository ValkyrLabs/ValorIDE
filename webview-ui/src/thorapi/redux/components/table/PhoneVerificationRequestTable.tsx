...
const buildResourcePath = (rowId: string) =>
  `${BASE_PATH}/PhoneVerificationRequest/${rowId}`;
...
const PhoneVerificationRequestTable: React.FC = () => {
  ...
  // -------------------------------------------------------------------
  const [addPhoneVerificationRequest] =
    useAddPhoneVerificationRequestMutation();
  const [updatePhoneVerificationRequest] =
    useUpdatePhoneVerificationRequestMutation();
  const [deletePhoneVerificationRequest] =
    useDeletePhoneVerificationRequestMutation();
  const [deletePhoneVerificationRequestCascade] =
    useDeletePhoneVerificationRequestCascadeMutation();
  ...
  const [copiedRow, setCopiedRow] = useState<PhoneVerificationRequest | null>(
    null,
  );
  ...
  const persistRowUpdate = async (
    ...
    try {
      const saved = await updatePhoneVerificationRequest(
        updatedItem as any,
      ).unwrap();
  ...
  const handlePasteRow = async () => {
    ...
    try {
      ...
      console.error(
        "Failed to paste (create) PhoneVerificationRequest:",
        error,
      );
  ...
  return (
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            Filter PhoneVerificationRequest (Query By Example)
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <p>
