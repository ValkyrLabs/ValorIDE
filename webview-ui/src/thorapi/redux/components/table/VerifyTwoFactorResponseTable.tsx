...
const buildResourcePath = (rowId: string) =>
  `${BASE_PATH}/VerifyTwoFactorResponse/${rowId}`;
...
const VerifyTwoFactorResponseTable: React.FC = () => {
  ...
  const [updateVerifyTwoFactorResponse] =
    useUpdateVerifyTwoFactorResponseMutation();
  const [deleteVerifyTwoFactorResponse] =
    useDeleteVerifyTwoFactorResponseMutation();
  const [deleteVerifyTwoFactorResponseCascade] =
    useDeleteVerifyTwoFactorResponseCascadeMutation();
  ...
  const [copiedRow, setCopiedRow] = useState<VerifyTwoFactorResponse | null>(
    null,
  );
  ...
  const reloadRowById = async (
    rowId: string,
  ): Promise<VerifyTwoFactorResponse | null> => {
  ...
  const persistRowUpdate = async (
    ...
    try {
      const saved = await updateVerifyTwoFactorResponse(
        updatedItem as any,
      ).unwrap();
  ...
  return (
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            Filter VerifyTwoFactorResponse (Query By Example)
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <p>
