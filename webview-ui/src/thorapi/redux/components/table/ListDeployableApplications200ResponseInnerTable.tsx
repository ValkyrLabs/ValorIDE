...
import ListDeployableApplications200ResponseInnerForm from '@thorapi/redux/components/form/ListDeployableApplications200ResponseInnerForm';
...
import {
  useLazyGetListDeployableApplications200ResponseInnersPagedQuery,
...
} from '@thorapi/redux/services/ListDeployableApplications200ResponseInnerService';
...
const reconcileSavedRow = (
  ...
  throw new Error(
    `ListDeployableApplications200ResponseInner update did not return persisted value for ${successField}; refusing to show an unverified edit.`,
  );
};

const buildResourcePath = (rowId: string) => `${BASE_PATH}/ListDeployableApplications200ResponseInner/${rowId}`;

const ListDeployableApplications200ResponseInnerTable: React.FC = () => {
  // -------------------------------------------------------------------
  ...
  const [allData, setAllData] = useState<ListDeployableApplications200ResponseInner[]>([]);
  ...
  const normalizePageRows = (result: unknown): ListDeployableApplications200ResponseInner[] => {
    if (Array.isArray(result)) return result as ListDeployableApplications200ResponseInner[];
    ...
    return Array.isArray(candidate) ? (candidate as ListDeployableApplications200ResponseInner[]) : [];
  };

  const mergeFetchedRows = (incomingRows: ListDeployableApplications200ResponseInner[], requestedPage: number) => {
  ...
  // -------------------------------------------------------------------
  const [addListDeployableApplications200ResponseInner] = useAddListDeployableApplications200ResponseInnerMutation();
  const [updateListDeployableApplications200ResponseInner] = useUpdateListDeployableApplications200ResponseInnerMutation();
  const [deleteListDeployableApplications200ResponseInner] = useDeleteListDeployableApplications200ResponseInnerMutation();
  const [deleteListDeployableApplications200ResponseInnerCascade] = useDeleteListDeployableApplications200ResponseInnerCascadeMutation();

  // -------------------------------------------------------------------
  // UI states (editing, modals, etc.)
  // -------------------------------------------------------------------
  const [editRowId, setEditRowId] = useState<string | null>(null);
  const [formData, setFormData] = useState<Partial<ListDeployableApplications200ResponseInner>>({});
  ...
  const [copiedRow, setCopiedRow] = useState<ListDeployableApplications200ResponseInner | null>(null);
  ...
  const reloadRowById = async (rowId: string): Promise<ListDeployableApplications200ResponseInner | null> => {
    ...
    try {
      ...
      return (await response.json()) as ListDeployableApplications200ResponseInner;
    } catch (err) {
      console.warn('Could not reload ListDeployableApplications200ResponseInner row', rowId, err);
      return null;
    }
  };
  ...
  const persistRowUpdate = async (
    rowId: string,
    updatedItem: Partial<ListDeployableApplications200ResponseInner>,
    successField?: string,
  ) => {
    try {
      const saved = await updateListDeployableApplications200ResponseInner(updatedItem as any).unwrap();
      ...
      setAllData((prev) => mergeUpdatedRow(prev as any[], rowId, hydrated as any) as ListDeployableApplications200ResponseInner[]);
      if (successField) {
      ...
      const errorMsg = error instanceof Error ? error.message : 'Failed to update ListDeployableApplications200ResponseInner';
      console.error('Failed to update ListDeployableApplications200ResponseInner:', error);
  ...
  const confirmDelete = async () => {
    ...
    try {
      await Promise.all(
        ids.map(async (id) => {
          try {
            await deleteListDeployableApplications200ResponseInnerCascade({ id, cascade: true, trash: true } as any).unwrap();
          } catch (e) {
            console.error('Failed to cascade delete id', id, e);
            try {
              await deleteListDeployableApplications200ResponseInner(id as any).unwrap();
            } catch (inner) {
...
// AddressToJSON(value?: Address)
  ...
  const handleAddRow = async () => {
    try {
      ...
      const payload: Partial<ListDeployableApplications200ResponseInner> = { ...source };
      delete (payload as any).id;
      const created = await addListDeployableApplications200ResponseInner(payload).unwrap();
      setAllData((prev) => [created as ListDeployableApplications200ResponseInner, ...prev]);
    } catch (error) {
      console.error('Failed to add ListDeployableApplications200ResponseInner:', error);
  ...
  const handlePasteRow = async () => {
    ...
    try {
      const payload: Partial<ListDeployableApplications200ResponseInner> = { ...copiedRow };
      delete (payload as any).id;
      const created = await addListDeployableApplications200ResponseInner(payload).unwrap();
      setAllData((prev) => [created as ListDeployableApplications200ResponseInner, ...prev]);
    } catch (error) {
      console.error('Failed to paste (create) ListDeployableApplications200ResponseInner:', error);
  ...
  const handleExportSelected = async () => {
    ...
    try {
      ...
      anchor.href = url;
      anchor.download = `ListDeployableApplications200ResponseInner-export-${stamp}.json`;
    ...
    try {
      ...
      for (const record of records) {
        ...
        if (incomingId == null || incomingId === '') {
          delete payload.id;
          try {
            await addListDeployableApplications200ResponseInner(payload).unwrap();
            created += 1;
          } catch (err) {
            failed += 1;
        ...
        try {
          ...
          try {
            await updateListDeployableApplications200ResponseInner(payload).unwrap();
            updated += 1;
          } catch (updateErr) {
            failed += 1;
      ...
      setQbePicker({ 
        ...
        resolve: async (picked) => {
          if (picked) {
            ...
            setAllData((prev) => mergeUpdatedRow(prev as any[], idToUpdate, updated as any) as ListDeployableApplications200ResponseInner[]);
            try {
              await persistRowUpdate(idToUpdate, updated, keyToUpdate);
              setEditRowId(null);
              setFormData({});
            } catch (error) {
              setAllData((prev) => mergeUpdatedRow(prev as any[], idToUpdate, row as any) as ListDeployableApplications200ResponseInner[]);
            }
          }
        }, 
        allowCreate: true 
  ...
  const handleBooleanCellToggle = async (rowId: string, key: string, nextValue: boolean) => {
    ...
    setAllData((prev) => mergeUpdatedRow(prev as any[], rowId, updatedItem as any) as ListDeployableApplications200ResponseInner[]);
    try {
      await persistRowUpdate(rowId, updatedItem, key);
      setEditRowId(null);
      setFormData({});
    } catch (error) {
      setAllData((prev) => mergeUpdatedRow(prev as any[], rowId, row as any) as ListDeployableApplications200ResponseInner[]);
    }
  };
  ...
  return (
    <>
            ...
            <RBGrid
              ...
              storageKey="ListDeployableApplications200ResponseInnerTable"
          ...
          >
            ...
            <FloatingControlPanel
              description="ListDeployableApplications200ResponseInner Actions"
          ...
          <Modal show={showCreateModal} onHide={() => setShowCreateModal(false)} centered size="lg">
            <Modal.Header closeButton>
              <Modal.Title>Create ListDeployableApplications200ResponseInner</Modal.Title>
            </Modal.Header>
            <Modal.Body>
              <ListDeployableApplications200ResponseInnerForm />
            </Modal.Body>
          </Modal>
          {/* QBE Modal */}
          <Modal show={showQbeModal} onHide={() => setShowQbeModal(false)} centered size="lg">
            <Modal.Header closeButton>
              <Modal.Title>Filter ListDeployableApplications200ResponseInner (Query By Example)</Modal.Title>
            </Modal.Header>
            <Modal.Body>
          ...
          <Modal show={modalVisible} onHide={() => setModalVisible(false)} centered>
            <Modal.Header closeButton>
              <Modal.Title>Editing ListDeployableApplications200ResponseInner</Modal.Title>
            </Modal.Header>
            <Modal.Body>
          ...
          <MarkdownEditorModal
            ...
            onSave={async (updatedText) => {
              try {
                ...
                const field = richModal.field as keyof ListDeployableApplications200ResponseInner;
                ...
                await updateListDeployableApplications200ResponseInner(updated).unwrap();
          ...
          {isError && (
            <div style={ { color: 'red', marginTop: 12 }}>
              Error fetching page {page} of ListDeployableApplications200ResponseInners.
            </div>
          )}
        ...
        <QBEPicker
          show={qbePicker.show}
          refType={qbePicker.refType || 'ListDeployableApplications200ResponseInner'}
...
export default ListDeployableApplications200ResponseInnerTable;
