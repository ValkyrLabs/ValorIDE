...
const buildResourcePath = (rowId: string) =>
  `${BASE_PATH}/AgentChatMessageResponse/${rowId}`;
...
const AgentChatMessageResponseTable: React.FC = () => {
  ...
  const [deleteAgentChatMessageResponse] =
    useDeleteAgentChatMessageResponseMutation();
  const [deleteAgentChatMessageResponseCascade] =
    useDeleteAgentChatMessageResponseCascadeMutation();
  ...
  const reloadRowById = async (
    rowId: string,
  ): Promise<AgentChatMessageResponse | null> => {
  ...
  const persistRowUpdate = async (
    ...
    try {
      const saved = await updateAgentChatMessageResponse(
        updatedItem as any,
      ).unwrap();
