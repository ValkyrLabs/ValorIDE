...
const GenerateTrustProofRequestForm: React.FC = () => {
  ...
  const handleSubmit = async (values: FormikValues, { setSubmitting }: FormikHelpers<GenerateTrustProofRequest>) => {
    try {
      ...
      console.log("GenerateTrustProofRequest form values:", values);

      // NOTE: depending on your generated endpoint, you may need { body: values }
      const result = await addGenerateTrustProofRequest(values as any).unwrap();
  ...
  return (
    <div>
      <Formik
        validateOnBlur={true}
        initialValues={initialValues as GenerateTrustProofRequest}
