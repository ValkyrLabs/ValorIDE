            ...
            <Accordion defaultActiveKey="1">
              ...
              <Accordion.Item eventKey="1">
                ...
                <Accordion.Body>
                    ...
                    <br />
                    <label htmlFor="useGrayMatter" className="nice-form-control">
                      <b>
                        Use Gray Matter:
                        {touched.useGrayMatter &&
                         !errors.useGrayMatter && (
                          <span className="okCheck"><FaCheckCircle /> looks good!</span>
                        )}
                      </b>
                          ...
                          <BSForm.Check
                            id="useGrayMatter"
                            name="useGrayMatter"
                            checked={values.useGrayMatter || false}
                            onChange={(e) => {
                              setFieldTouched('useGrayMatter', true);
                              setFieldValue('useGrayMatter', e.target.checked);
                            }}
                            isInvalid={!!errors.useGrayMatter}
                            className={errors.useGrayMatter ? 'error' : ''}
                          />
