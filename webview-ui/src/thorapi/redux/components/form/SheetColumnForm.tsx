...
const validationSchema = Yup.object().shape({
  sheetId: Yup.string(),
  colIndex: asNumber(
    Yup.number().integer().typeError("colIndex must be a number"),
  ),
  hidden: Yup.boolean(),
                  ...
                  <Accordion.Body>
                    ...
                    {(addSheetColumnResult.isError || errorMessage) && (
                      <Alert variant="danger" className="mt-3">
                        {errorMessage ||
                          JSON.stringify(
                            "data" in (addSheetColumnResult as any).error
                              ? (addSheetColumnResult as any).error.data
                              : (addSheetColumnResult as any).error,
                          )}
                      </Alert>
                    )}
