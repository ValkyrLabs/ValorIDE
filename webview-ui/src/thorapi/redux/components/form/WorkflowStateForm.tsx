                ...
                <Accordion.Item eventKey="1">
                  ...
                  <Accordion.Body>
                    ...
                    <label htmlFor="stateValue" className="nice-form-control">
                      <b>
                        State _ value:
                        {touched.stateValue && !errors.stateValue && (
                          <span className="okCheck">
                            <FaCheckCircle /> looks good!
                          </span>
                        )}
                    ...
                    {(addWorkflowStateResult.isError || errorMessage) && (
                      <Alert variant="danger" className="mt-3">
                        {errorMessage ||
                          JSON.stringify(
                            "data" in (addWorkflowStateResult as any).error
                              ? (addWorkflowStateResult as any).error.data
                              : (addWorkflowStateResult as any).error,
                          )}
                      </Alert>
                    )}

                    {(addWorkflowStateResult.isSuccess || successMessage) && (
