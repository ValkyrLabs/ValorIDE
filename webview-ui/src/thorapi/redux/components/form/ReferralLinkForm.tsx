...
import { ReferralLink, ReferralLinkReferralTypeEnum } from "@thorapi/model";
...
const validationSchema = Yup.object().shape({
  ...
  referralType: Yup.mixed().oneOf(
    ReferralTypeValidation(),
    "Invalid value for referralType",
  ),
  trashed: Yup.boolean(),
});
              ...
              <Accordion defaultActiveKey="1">
                  ...
                  <Accordion.Body>
                    ...
                    {(addReferralLinkResult.isError || errorMessage) && (
                      <Alert variant="danger" className="mt-3">
                        {errorMessage ||
                          JSON.stringify(
                            "data" in (addReferralLinkResult as any).error
                              ? (addReferralLinkResult as any).error.data
                              : (addReferralLinkResult as any).error,
                          )}
                      </Alert>
                    )}
                ...
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    ...
                    <br />
                    addReferralLinkResult:{" "}
                    {JSON.stringify(addReferralLinkResult)}
                  </Accordion.Body>
                </Accordion.Item>
              </Accordion>
            </form>
