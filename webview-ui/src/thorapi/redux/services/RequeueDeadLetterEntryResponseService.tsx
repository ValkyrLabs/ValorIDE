...
const toRequeueDeadLetterEntryResponseList = (
  result: unknown,
  ...
  return Array.isArray(candidate)
    ? (candidate as RequeueDeadLetterEntryResponseResponse)
    : [];
};
...
export const RequeueDeadLetterEntryResponseService = createApi({
  ...
  endpoints: (build) => ({
    ...
    deleteRequeueDeadLetterEntryResponseCascade: build.mutation<
      { success: boolean; id: string },
