...
type RequeueDeadLetterEntryResponsePagedQueryArg = {
  page: number
  size?: number
...
type RequeueDeadLetterEntryResponseListQueryArg = {
  example?: Partial<RequeueDeadLetterEntryResponse>
  /**
...
export const RequeueDeadLetterEntryResponseService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getRequeueDeadLetterEntryResponsesPaged: build.query<RequeueDeadLetterEntryResponseResponse, RequeueDeadLetterEntryResponsePagedQueryArg>({
      ...
      providesTags: (result, error, { page }) => {
        ...
        return [
          ...
          { type: 'RequeueDeadLetterEntryResponse', id: 'PARTIAL-LIST' },
        ]
      },
    }),

    // 2) Simple "get all" Query (optional)
    getRequeueDeadLetterEntryResponses: build.query<RequeueDeadLetterEntryResponseResponse, RequeueDeadLetterEntryResponseListQueryArg | void>({
      query: (arg) => {
    ...
    // 5) Update
    updateRequeueDeadLetterEntryResponse: build.mutation<RequeueDeadLetterEntryResponse, Pick<RequeueDeadLetterEntryResponse, 'id'> & Partial<RequeueDeadLetterEntryResponse>>({
      query: ({ id, ...patch }) => ({
