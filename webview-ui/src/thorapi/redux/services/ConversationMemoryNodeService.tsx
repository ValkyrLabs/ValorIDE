...
type ConversationMemoryNodePagedQueryArg = {
  page: number
  size?: number
  example?: Partial<ConversationMemoryNode>
  /**
...
type ConversationMemoryNodeListQueryArg = {
  example?: Partial<ConversationMemoryNode>
  /**
...
export const ConversationMemoryNodeService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getConversationMemoryNodesPaged: build.query<ConversationMemoryNodeResponse, ConversationMemoryNodePagedQueryArg>({
      ...
      providesTags: (result, error, { page }) => {
        ...
        return [
          ...
          { type: 'ConversationMemoryNode', id: 'PARTIAL-LIST' },
        ]
      },
    }),

    // 2) Simple "get all" Query (optional)
    getConversationMemoryNodes: build.query<ConversationMemoryNodeResponse, ConversationMemoryNodeListQueryArg | void>({
      query: (arg) => {
    ...
    // 5) Update
    updateConversationMemoryNode: build.mutation<ConversationMemoryNode, Pick<ConversationMemoryNode, 'id'> & Partial<ConversationMemoryNode>>({
      query: ({ id, ...patch }) => ({
