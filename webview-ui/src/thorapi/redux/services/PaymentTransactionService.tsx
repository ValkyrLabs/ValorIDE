...
type PaymentTransactionPagedQueryArg = {
  page: number
  size?: number
  example?: Partial<PaymentTransaction>
  /**
...
type PaymentTransactionListQueryArg = {
  example?: Partial<PaymentTransaction>
  /**
...
export const PaymentTransactionService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getPaymentTransactionsPaged: build.query<PaymentTransactionResponse, PaymentTransactionPagedQueryArg>({
      ...
      providesTags: (result, error, { page }) => {
        ...
        return [
          ...
          { type: 'PaymentTransaction', id: 'PARTIAL-LIST' },
        ]
      },
    }),

    // 2) Simple "get all" Query (optional)
    getPaymentTransactions: build.query<PaymentTransactionResponse, PaymentTransactionListQueryArg | void>({
      query: (arg) => {
    ...
    // 5) Update
    updatePaymentTransaction: build.mutation<PaymentTransaction, Pick<PaymentTransaction, 'id'> & Partial<PaymentTransaction>>({
      query: ({ id, ...patch }) => ({
