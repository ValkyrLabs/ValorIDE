...
type KeyMetricPagedQueryArg = {
  page: number
  size?: number
  example?: Partial<KeyMetric>
  /**
...
export const KeyMetricService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getKeyMetricsPaged: build.query<KeyMetricResponse, KeyMetricPagedQueryArg>({
      ...
      providesTags: (result, error, { page }) => {
        ...
        return [
          ...
          { type: 'KeyMetric', id: 'PARTIAL-LIST' },
        ]
      },
    }),

    // 2) Simple "get all" Query (optional)
    getKeyMetrics: build.query<KeyMetricResponse, KeyMetricListQueryArg | void>({
      query: (arg) => {
    ...
    // 5) Update
    updateKeyMetric: build.mutation<KeyMetric, Pick<KeyMetric, 'id'> & Partial<KeyMetric>>({
      query: ({ id, ...patch }) => ({
        url: `KeyMetric/${id}`,
        method: 'PUT',
        body: patch,
