...
type OrderFulfillmentTaskPagedQueryArg = {
  page: number
  size?: number
  example?: Partial<OrderFulfillmentTask>
  /**
...
type OrderFulfillmentTaskListQueryArg = {
  example?: Partial<OrderFulfillmentTask>
  /**
...
export const OrderFulfillmentTaskService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getOrderFulfillmentTasksPaged: build.query<OrderFulfillmentTaskResponse, OrderFulfillmentTaskPagedQueryArg>({
      ...
      providesTags: (result, error, { page }) => {
        ...
        return [
          ...
          { type: 'OrderFulfillmentTask', id: 'PARTIAL-LIST' },
        ]
      },
    }),

    // 2) Simple "get all" Query (optional)
    getOrderFulfillmentTasks: build.query<OrderFulfillmentTaskResponse, OrderFulfillmentTaskListQueryArg | void>({
      query: (arg) => {
    ...
    // 5) Update
    updateOrderFulfillmentTask: build.mutation<OrderFulfillmentTask, Pick<OrderFulfillmentTask, 'id'> & Partial<OrderFulfillmentTask>>({
      query: ({ id, ...patch }) => ({
