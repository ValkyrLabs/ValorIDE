...
type WorkflowGraphEdgeConnectionMappingPagedQueryArg = {
  page: number
  size?: number
...
type WorkflowGraphEdgeConnectionMappingListQueryArg = {
  example?: Partial<WorkflowGraphEdgeConnectionMapping>
  /**
...
export const WorkflowGraphEdgeConnectionMappingService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getWorkflowGraphEdgeConnectionMappingsPaged: build.query<WorkflowGraphEdgeConnectionMappingResponse, WorkflowGraphEdgeConnectionMappingPagedQueryArg>({
      ...
      providesTags: (result, error, { page }) => {
        ...
        return [
          ...
          { type: 'WorkflowGraphEdgeConnectionMapping', id: 'PARTIAL-LIST' },
        ]
      },
    }),

    // 2) Simple "get all" Query (optional)
    getWorkflowGraphEdgeConnectionMappings: build.query<WorkflowGraphEdgeConnectionMappingResponse, WorkflowGraphEdgeConnectionMappingListQueryArg | void>({
      query: (arg) => {
    ...
    // 5) Update
    updateWorkflowGraphEdgeConnectionMapping: build.mutation<WorkflowGraphEdgeConnectionMapping, Pick<WorkflowGraphEdgeConnectionMapping, 'id'> & Partial<WorkflowGraphEdgeConnectionMapping>>({
      query: ({ id, ...patch }) => ({
