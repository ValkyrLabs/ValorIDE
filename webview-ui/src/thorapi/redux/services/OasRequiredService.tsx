...
type OasRequiredPagedQueryArg = {
  page: number
  size?: number
  example?: Partial<OasRequired>
  /**
...
export const OasRequiredService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getOasRequiredsPaged: build.query<OasRequiredResponse, OasRequiredPagedQueryArg>({
      ...
      providesTags: (result, error, { page }) => {
        ...
        return [
          ...
          { type: 'OasRequired', id: 'PARTIAL-LIST' },
        ]
      },
    }),

    // 2) Simple "get all" Query (optional)
    getOasRequireds: build.query<OasRequiredResponse, OasRequiredListQueryArg | void>({
      query: (arg) => {
    ...
    // 5) Update
    updateOasRequired: build.mutation<OasRequired, Pick<OasRequired, 'id'> & Partial<OasRequired>>({
      query: ({ id, ...patch }) => ({
        url: `OasRequired/${id}`,
        method: 'PUT',
        body: patch,
