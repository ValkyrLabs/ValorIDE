...
type SwarmMessagePagedQueryArg = {
  page: number
  size?: number
  example?: Partial<SwarmMessage>
  /**
...
export const SwarmMessageService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getSwarmMessagesPaged: build.query<SwarmMessageResponse, SwarmMessagePagedQueryArg>({
      ...
      providesTags: (result, error, { page }) => {
        ...
        return [
          ...
          { type: 'SwarmMessage', id: 'PARTIAL-LIST' },
        ]
      },
    }),

    // 2) Simple "get all" Query (optional)
    getSwarmMessages: build.query<SwarmMessageResponse, SwarmMessageListQueryArg | void>({
      query: (arg) => {
    ...
    // 5) Update
    updateSwarmMessage: build.mutation<SwarmMessage, Pick<SwarmMessage, 'id'> & Partial<SwarmMessage>>({
      query: ({ id, ...patch }) => ({
        url: `SwarmMessage/${id}`,
        method: 'PUT',
        body: patch,
