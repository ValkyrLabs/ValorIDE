...
type ConfirmPasswordResetRequestPagedQueryArg = {
  page: number
  size?: number
...
type ConfirmPasswordResetRequestListQueryArg = {
  example?: Partial<ConfirmPasswordResetRequest>
  /**
...
export const ConfirmPasswordResetRequestService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getConfirmPasswordResetRequestsPaged: build.query<ConfirmPasswordResetRequestResponse, ConfirmPasswordResetRequestPagedQueryArg>({
      ...
      providesTags: (result, error, { page }) => {
        ...
        return [
          ...
          { type: 'ConfirmPasswordResetRequest', id: 'PARTIAL-LIST' },
        ]
      },
    }),

    // 2) Simple "get all" Query (optional)
    getConfirmPasswordResetRequests: build.query<ConfirmPasswordResetRequestResponse, ConfirmPasswordResetRequestListQueryArg | void>({
      query: (arg) => {
    ...
    // 5) Update
    updateConfirmPasswordResetRequest: build.mutation<ConfirmPasswordResetRequest, Pick<ConfirmPasswordResetRequest, 'id'> & Partial<ConfirmPasswordResetRequest>>({
      query: ({ id, ...patch }) => ({
