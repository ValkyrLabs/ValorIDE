...
type AclClassPagedQueryArg = {
  page: number
  size?: number
  example?: Partial<AclClass>
  /**
...
export const AclClassService = createApi({
  ...
  endpoints: (build) => ({
    ...
    getAclClasssPaged: build.query<AclClassResponse, AclClassPagedQueryArg>({
      ...
      providesTags: (result, error, { page }) => {
        ...
        return [
          ...
          { type: 'AclClass', id: 'PARTIAL-LIST' },
        ]
      },
    }),

    // 2) Simple "get all" Query (optional)
    getAclClasss: build.query<AclClassResponse, AclClassListQueryArg | void>({
      query: (arg) => {
    ...
    // 5) Update
    updateAclClass: build.mutation<AclClass, Pick<AclClass, 'id'> & Partial<AclClass>>({
      query: ({ id, ...patch }) => ({
        url: `AclClass/${id}`,
        method: 'PUT',
        body: patch,
