...
import { PrincipalRoles } from '@thorapi/model/PrincipalRoles'
...
export const PrincipalRolesService = createApi({
  ...
  endpoints: (build) => ({
    ...
    deletePrincipalRolesCascade: build.mutation<{ success: boolean; id: string }, { id: string; cascade?: boolean; trash?: boolean }>({
      query({ id, cascade = true, trash = true }) {
        const params = [`cascade=${cascade}`, `trash=${trash}`].join('&');
        return {
          url: `PrincipalRoles/${id}?${params}`,
          method: 'DELETE',
        }
      },
      invalidatesTags: (result, error, { id }) => [{ type: 'PrincipalRoles', id }, { type: 'PrincipalRoles', id: 'LIST' }],
    }),
  }),
})
