...
export const middlewares : Middleware[] = [
    ...
    AppGenerationRequestService.middleware as Middleware,
    AppGenerationTraceResponseService.middleware as Middleware,
    AppObjectModelService.middleware as Middleware,
    AppSpecDraftService.middleware as Middleware,
    ...
    ApplicationDataPlaneBindingService.middleware as Middleware,
    ...
    ContextCompressionReceiptService.middleware as Middleware,
    ContextPageService.middleware as Middleware,
    ContextPageCompileRequestService.middleware as Middleware,
    ContextPageHydrateRequestService.middleware as Middleware,
    ContextPageItemService.middleware as Middleware,
    ContextPageRecompressRequestService.middleware as Middleware,
    ContextPageResponseService.middleware as Middleware,
    ContextPageTraverseRequestService.middleware as Middleware,
    ContextTraversalEventService.middleware as Middleware,
    ...
    CreditDebitReceiptService.middleware as Middleware,
    CreditPricingMatrixService.middleware as Middleware,
    CreditReservationService.middleware as Middleware,
    ...
    FileListResponseService.middleware as Middleware,
    ...
    GeneratedArtifactService.middleware as Middleware,
    GeneratedArtifactSetService.middleware as Middleware,
    GenerationReceiptService.middleware as Middleware,
    ...
    HydrationPointerService.middleware as Middleware,
    ...
    LlmCommandService.middleware as Middleware,
    LlmCommandResultService.middleware as Middleware,
    ...
    McpResponsePartService.middleware as Middleware,
    McpServerService.middleware as Middleware,
    McpServiceContractsResponseService.middleware as Middleware,
    ...
    OpenClawLightsailLaunchEstimateService.middleware as Middleware,
    OpenClawLightsailLaunchRequestService.middleware as Middleware,
    OpenClawLightsailLaunchResponseService.middleware as Middleware,
    OpenClawLightsailProvisioningEventService.middleware as Middleware,
    ...
    ProcedureService.middleware as Middleware,
    ...
    ProjectObjectLinkService.middleware as Middleware,
    ...
    PublishMcpToolRequestService.middleware as Middleware,
    PublishMcpToolResponseService.middleware as Middleware,
    ...
    RefundRecordService.middleware as Middleware,
    ...
    RetrievalCoverageService.middleware as Middleware,
    RetrievalEvaluatorResultService.middleware as Middleware,
    RetrievalPolicyDecisionService.middleware as Middleware,
    RetrievalProvenanceService.middleware as Middleware,
    RetrievalQualityScoreService.middleware as Middleware,
    RetrievalReceiptService.middleware as Middleware,
    RetrievalReceiptItemService.middleware as Middleware,
    RetrievalReceiptRequestService.middleware as Middleware,
    RetrievalReceiptResponseService.middleware as Middleware,
    RetrievalRetryRequestService.middleware as Middleware,
    ...
    SchemaEvolutionLedgerService.middleware as Middleware,
    ...
    SkillOptRouteOutcomeRequestService.middleware as Middleware,
    SkillOptRouteReceiptService.middleware as Middleware,
    SkillOptRouteRequestService.middleware as Middleware,
    SkillOptRouteResponseService.middleware as Middleware,
    SkillProfileService.middleware as Middleware,
    SkillSignalService.middleware as Middleware,
    ...
    StripeCheckoutSessionService.middleware as Middleware,
    StripeCustomerLinkService.middleware as Middleware,
    StripeSubscriptionService.middleware as Middleware,
    StripeWebhookEventService.middleware as Middleware,
    ...
    SupportTicketService.middleware as Middleware,
    ...
    TenantRuntimeBindingService.middleware as Middleware,
    TenantSchemaAccessAuditService.middleware as Middleware,
    TenantSchemaBundleService.middleware as Middleware,
    TenantSchemaOperationService.middleware as Middleware,
    TenantSchemaRegistryService.middleware as Middleware,
    ThorApiGenerationRunService.middleware as Middleware,
    ThorApiSpecRevisionService.middleware as Middleware,
    ThorapiRuleService.middleware as Middleware,
    TicketCommentService.middleware as Middleware,
    ...
    WorkforceSkillService.middleware as Middleware,
    WorkforceTransitionRecordService.middleware as Middleware,
];
