...
function DownloadAccessFromJSON(json) {
    return {
        ...
        'digitalAsset': !(0, runtime_1.exists)(json, 'digitalAsset') ? undefined : (0, _1.DigitalAssetFromJSON)(json['digitalAsset']),
        'principal': !(0, runtime_1.exists)(json, 'principal') ? undefined : (0, _1.PrincipalFromJSON)(json['principal']),
        'downloadToken': !(0, runtime_1.exists)(json, 'downloadToken') ? undefined : json['downloadToken'],
        'downloadCount': !(0, runtime_1.exists)(json, 'downloadCount') ? undefined : json['downloadCount'],
        'maxDownloadsRemaining': !(0, runtime_1.exists)(json, 'maxDownloadsRemaining') ? undefined : json['maxDownloadsRemaining'],
        'grantedAt': !(0, runtime_1.exists)(json, 'grantedAt') ? undefined : new Date(json['grantedAt']),
        'expiresAt': !(0, runtime_1.exists)(json, 'expiresAt') ? undefined : new Date(json['expiresAt']),
        'lastDownloadedAt': !(0, runtime_1.exists)(json, 'lastDownloadedAt') ? undefined : new Date(json['lastDownloadedAt']),
        'revokedAt': !(0, runtime_1.exists)(json, 'revokedAt') ? undefined : new Date(json['revokedAt']),
        'revokedReason': !(0, runtime_1.exists)(json, 'revokedReason') ? undefined : json['revokedReason'],
