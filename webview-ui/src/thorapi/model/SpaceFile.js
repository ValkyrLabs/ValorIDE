...
exports.SpaceFileFromJSON = SpaceFileFromJSON;
exports.SpaceFileToJSON = SpaceFileToJSON;
// tslint:disable
/**
...
function SpaceFileFromJSON(json) {
    return {
        ...
        'pinnedById': !(0, runtime_1.exists)(json, 'pinnedById') ? undefined : json['pinnedById'],
