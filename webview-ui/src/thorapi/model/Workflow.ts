...
export function WorkflowFromJSON(json: any): Workflow {
  return {
    ...
    tasks: !exists(json, "tasks")
      ? undefined
      : (json["tasks"] as Array<any>).map(TaskFromJSON),
    workflowState: !exists(json, "workflow_state")
      ? undefined
      : (json["workflow_state"] as Array<any>).map(WorkflowStateFromJSON),
  ...
  return {
    ...
    tasks:
      value.tasks === undefined
        ? undefined
        : (value.tasks as Array<any>).map(TaskToJSON),
    workflow_state:
      value.workflowState === undefined
        ? undefined
        : (value.workflowState as Array<any>).map(WorkflowStateToJSON),
    status: value.status,
