...
export function SubmitTrustAttestationEvidenceResponseFromJSON(
  json: any,
...
export function SubmitTrustAttestationEvidenceResponseToJSON(
  value?: SubmitTrustAttestationEvidenceResponse,
): any {
  if (value === undefined) {
    return undefined;
  }
