...
export function PublishRestEndpointRequestFromJSON(
  json: any,
): PublishRestEndpointRequest {
  return {
    ...DataObjectFromJSON(json),
    controllerPath: !exists(json, "controllerPath")
      ? undefined
      : json["controllerPath"],
...
export function PublishRestEndpointRequestToJSON(
  value?: PublishRestEndpointRequest,
): any {
  if (value === undefined) {
    return undefined;
  }
