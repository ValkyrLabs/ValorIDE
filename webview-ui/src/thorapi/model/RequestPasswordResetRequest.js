...
function RequestPasswordResetRequestFromJSON(json) {
    return {
        ...
        'emailOrUsername': !(0, runtime_1.exists)(json, 'emailOrUsername') ? undefined : json['emailOrUsername'],
...
function RequestPasswordResetRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    return {
...
//# sourceMappingURL=RequestPasswordResetRequest.js.map