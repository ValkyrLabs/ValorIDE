...
function PrincipalFromJSON(json) {
    return {
        ...
        'roles': !(0, runtime_1.exists)(json, 'roles') ? undefined : json['roles'].map(_1.RoleFromJSON),
        'grantedAuthorities': !(0, runtime_1.exists)(json, 'grantedAuthorities') ? undefined : json['grantedAuthorities'].map(_1.AuthorityFromJSON),
...
function PrincipalToJSON(value) {
    ...
    return {
        ...
        'grantedAuthorities': value.grantedAuthorities === undefined ? undefined : value.grantedAuthorities.map(_1.AuthorityToJSON),
