...
function PrincipalFromJSON(json) {
    return {
        ...
        roles: !(0, runtime_1.exists)(json, "roles")
            ? undefined
            : json["roles"].map(_1.RoleFromJSON),
        grantedAuthorities: !(0, runtime_1.exists)(json, "grantedAuthorities")
            ? undefined
            : json["grantedAuthorities"].map(_1.AuthorityFromJSON),
        userPreferences: !(0, runtime_1.exists)(json, "userPreferences")
            ? undefined
            : json["userPreferences"].map(_1.UserPreferenceFromJSON),
        twoFactorEnabled: !(0, runtime_1.exists)(json, "twoFactorEnabled")
            ? undefined
            : json["twoFactorEnabled"],
        twoFactorSecret: !(0, runtime_1.exists)(json, "twoFactorSecret")
            ? undefined
            : (0, _1.TwoFactorSecretFromJSON)(json["twoFactorSecret"]),
        phoneVerifications: !(0, runtime_1.exists)(json, "phoneVerifications")
            ? undefined
            : json["phoneVerifications"].map(_1.PhoneVerificationFromJSON),
        lastLoginAt: !(0, runtime_1.exists)(json, "lastLoginAt")
            ? undefined
            : new Date(json["lastLoginAt"]),
        loginAttempts: !(0, runtime_1.exists)(json, "loginAttempts")
            ? undefined
            : json["loginAttempts"],
        lockoutUntil: !(0, runtime_1.exists)(json, "lockoutUntil")
            ? undefined
            : new Date(json["lockoutUntil"]),
        loginAudits: !(0, runtime_1.exists)(json, "loginAudits")
            ? undefined
            : json["loginAudits"].map(_1.LoginAuditFromJSON),
...
function PrincipalToJSON(value) {
    ...
    return {
        ...
        roles: value.roles === undefined
            ? undefined
            : value.roles.map(_1.RoleToJSON),
        grantedAuthorities: value.grantedAuthorities === undefined
            ? undefined
            : value.grantedAuthorities.map(_1.AuthorityToJSON),
        ...
        phoneVerifications: value.phoneVerifications === undefined
            ? undefined
            : value.phoneVerifications.map(_1.PhoneVerificationToJSON),
        ...
        loginAudits: value.loginAudits === undefined
            ? undefined
            : value.loginAudits.map(_1.LoginAuditToJSON),
