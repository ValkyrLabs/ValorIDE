...
export function TrustVerificationResultFromJSON(json: any): TrustVerificationResult {
    return {
        ...
        'checkedAt': !exists(json, 'checkedAt') ? undefined : new Date(json['checkedAt']),
...
export function TrustVerificationResultToJSON(value?: TrustVerificationResult): any {
    if (value === undefined) {
        return undefined;
    }
    return {
