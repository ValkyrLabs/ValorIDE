...
function StackFromJSON(json) {
    return {
        ...
        applicationId: !(0, runtime_1.exists)(json, "applicationId")
            ? undefined
            : json["applicationId"],
        adminServerHost: !(0, runtime_1.exists)(json, "adminServerHost")
            ? undefined
            : json["adminServerHost"],
        adminServerPort: !(0, runtime_1.exists)(json, "adminServerPort")
            ? undefined
        ...
        skipSwaggerGen: !(0, runtime_1.exists)(json, "skipSwaggerGen")
            ? undefined
            : json["skipSwaggerGen"],
        ...
        skipReactGen: !(0, runtime_1.exists)(json, "skipReactGen")
            ? undefined
            : json["skipReactGen"],
        dbGenDropTable: !(0, runtime_1.exists)(json, "dbGenDropTable")
            ? undefined
            : json["dbGenDropTable"],
        thorApiSecureKey: !(0, runtime_1.exists)(json, "thorApiSecureKey")
            ? undefined
        ...
        templateRepo: !(0, runtime_1.exists)(json, "templateRepo")
            ? undefined
            : json["templateRepo"],
        schemaData: !(0, runtime_1.exists)(json, "schemaData") ? undefined : json["schemaData"],
        schemaFileName: !(0, runtime_1.exists)(json, "schemaFileName")
            ? undefined
            : json["schemaFileName"],
