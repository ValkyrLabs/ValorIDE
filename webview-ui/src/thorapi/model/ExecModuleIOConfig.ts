...
export function ExecModuleIOConfigFromJSON(json: any): ExecModuleIOConfig {
    return {
        ...
        'flattenOutput': !exists(json, 'flatten_output') ? undefined : json['flatten_output'],
        ...
        'operationMode': !exists(json, 'operation_mode') ? undefined : json['operation_mode'],
        ...
        'outputField': !exists(json, 'output_field') ? undefined : json['output_field'],
        'prettyPrint': !exists(json, 'pretty_print') ? undefined : json['pretty_print'],
        'projection': !exists(json, 'projection') ? undefined : json['projection'],
        'schema': !exists(json, 'schema') ? undefined : json['schema'],
        'schemaRegistryUrl': !exists(json, 'schema_registry_url') ? undefined : json['schema_registry_url'],
        'sourcePath': !exists(json, 'source_path') ? undefined : json['source_path'],
        'timestampField': !exists(json, 'timestamp_field') ? undefined : json['timestamp_field'],
