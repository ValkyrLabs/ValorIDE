...
function RunFromJSON(json) {
    return {
        ...
        'heartbeatAt': !(0, runtime_1.exists)(json, 'heartbeatAt') ? undefined : new Date(json['heartbeatAt']),
        ...
        'retryReadyAt': !(0, runtime_1.exists)(json, 'retryReadyAt') ? undefined : new Date(json['retryReadyAt']),
