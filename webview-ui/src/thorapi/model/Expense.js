...
exports.ExpenseCategoryEnum = void 0;
...
function ExpenseFromJSON(json) {
    return {
        ...
        'expenseDate': !(0, runtime_1.exists)(json, 'expenseDate') ? undefined : new Date(json['expenseDate']),
...
})(ExpenseCategoryEnum || (exports.ExpenseCategoryEnum = ExpenseCategoryEnum = {}));
