...
export function ConversationMemoryNodeFromJSON(
  json: any,
): ConversationMemoryNode {
  return {
    ...DataObjectFromJSON(json),
    branch: !exists(json, "branch")
      ? undefined
      : ConversationBranchFromJSON(json["branch"]),
    ...
    contentChars: !exists(json, "contentChars")
      ? undefined
      : json["contentChars"],
    compressedPayload: !exists(json, "compressedPayload")
      ? undefined
...
export function ConversationMemoryNodeToJSON(
  value?: ConversationMemoryNode,
): any {
  if (value === undefined) {
    return undefined;
  }
