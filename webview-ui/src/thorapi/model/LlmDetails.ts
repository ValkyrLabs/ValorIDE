...
export type LlmDetails  = DataObject & {
    ...
    version?: string;
    /**
     * Whether to use GrayMatter for context management with this LLM.
     * @type {boolean}
     * @memberof LlmDetails
     */
    useGrayMatter?: boolean;
    /**
...
export function LlmDetailsFromJSON(json: any): LlmDetails {
    return {
        ...
        'useGrayMatter': !exists(json, 'useGrayMatter') ? undefined : json['useGrayMatter'],
