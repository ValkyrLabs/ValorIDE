...
function ExecModuleFromJSON(json) {
    return {
        ...
        'execModuleIntegrationAccount': !(0, runtime_1.exists)(json, 'execModuleIntegrationAccount') ? undefined : (0, _1.IntegrationAccountFromJSON)(json['execModuleIntegrationAccount']),
...
function ExecModuleToJSON(value) {
    ...
    return {
        ...
        'config': value.config,
        'status': value.status,
        'execModuleIntegrationAccount': (0, _1.IntegrationAccountToJSON)(value.execModuleIntegrationAccount),
