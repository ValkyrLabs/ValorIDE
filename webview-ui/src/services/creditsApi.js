...
// Export hooks
export const { useGetAccountBalanceQuery, useLazyGetAccountBalanceQuery, useRecordUsageTransactionMutation, useRecordPaymentTransactionMutation, } = creditsApi;
/**
...
export const isInsufficientFunds = (error) => {
    if (isErrorResponse(error)) {
        return (error.data.error === "INSUFFICIENT_FUNDS" ||
