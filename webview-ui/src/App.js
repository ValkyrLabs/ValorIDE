  ...
  return _jsx(_Fragment, {
    children:
      showWelcome && !hasStoredAuth
        ...
        : _jsxs(_Fragment, {
            children: [
              showSettings && _jsx(SettingsView, { onDone: hideSettings }),
              showHistory &&
                _jsx(HistoryView, { onDone: () => setShowHistory(false) }),
              showMcp &&
                _jsx(McpView, {
                  initialTab: mcpTab,
                  onDone: () => setShowMcp(false),
                }),
              showAccount &&
                _jsx(AccountView, { onDone: () => setShowAccount(false) }),
              showGeneratedFiles && _jsx(GeneratedFilesView, {}),
              showServerConsole && _jsx(ServerConsole, {}),
              showApplicationProgress &&
                _jsx("div", {
                  ...
                  children: _jsx(ApplicationProgress, {
              ...
              !isMainViewHidden &&
                _jsx(ChatErrorBoundary, {
                  ...
                  errorBody:
                    "Please reload the view or check connection settings.",
                  height: "100%",
                  children: _jsx(ChatView, {
                    showHistoryView: () => {
                      setShowSettings(false);
                      setShowMcp(false);
                      setShowAccount(false);
...
const App = () => {
  return _jsx(ExtensionStateContextProvider, {
    children: _jsx(MothershipProvider, {
      children: _jsxs(ChatMothershipProvider, {
        children: [
          _jsx(UsageTrackingHandler, {}),
          _jsx(ContentDataHandler, {}),
          _jsx(StartupDebit, {}),
          _jsx(AppContent, {}),
        ],
      }),
