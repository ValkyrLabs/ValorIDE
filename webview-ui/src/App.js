...
const AppContent = () => {
    ...
    if (!didHydrateState) {
        return (_jsx("div", { style: {
                ...
                height: "100vh",
                width: "100%",
            }, children: _jsx(LoadingSpinner, { label: "Loading ValorIDE\u2026", size: 72 }) }));
    }
    const isMainViewHidden = showSettings ||
        showHistory ||
        showMcp ||
        showAccount ||
        showGeneratedFiles ||
...
const App = () => {
    return (_jsx(ExtensionStateContextProvider, { children: _jsx(MothershipProvider, { children: _jsxs(ChatMothershipProvider, { children: [_jsx(UsageTrackingHandler, {}), _jsx(ContentDataHandler, {}), _jsx(StartupDebit, {}), _jsx(AppContent, {})] }) }) }));
};
