...
interface ContentDataFlipBoardProps {
  itemsPerPage?: number;
  autoScroll?: boolean;
...
const ContentDataFlipBoard: React.FC<ContentDataFlipBoardProps> = ({
  itemsPerPage = 5,
  autoScroll = true,
  ...
  if (isLoading || isFetching) {
    return (
      <div className="flipboard-loading">
        <LoadingSpinner label="Loading content carousel..." />
      </div>
    );
  }
  ...
  return (
    <div className="flipboard-container" ref={containerRef}>
      <canvas ref={canvasRef} className="flipboard-canvas" />
      ...
      {cards[currentIndex] && (
        <div className="flipboard-info">
          ...
          <div className="flipboard-meta">
            <span className="flipboard-status">
              {cards[currentIndex].status}
            </span>
            <span className="flipboard-count">
