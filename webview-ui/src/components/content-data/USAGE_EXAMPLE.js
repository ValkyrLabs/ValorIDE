...
export function BasicExample() {
  return _jsxs("div", {
    ...
    children: [
      _jsx("h1", { children: "Content Gallery" }),
      _jsx(ContentDataFlipBoard, {}),
    ],
  });
}
/**
...
export function CustomizedExample() {
  return _jsxs("div", {
    ...
    children: [
      _jsx("h1", { children: "Featured Content" }),
      _jsx(ContentDataFlipBoard, {
        itemsPerPage: 8,
        autoScroll: true,
...
export function ManualControlExample() {
  return _jsxs("div", {
    ...
    children: [
      _jsx("h1", { children: "Browse Content" }),
      _jsx("p", { children: "Use the navigation buttons to explore" }),
      _jsx(ContentDataFlipBoard, { itemsPerPage: 6, autoScroll: false }),
    ],
  });
}
/**
...
export function ResponsiveExample() {
  return _jsx("div", {
    ...
    children: _jsx(ContentDataFlipBoard, {
      itemsPerPage: 5,
      autoScroll: true,
    ...
    children: _jsxs("div", {
      ...
      children: [
        _jsx("h1", {
          ...
          children: "Explore Our Content Library",
        }),
        _jsx("p", {
          style: {
            textAlign: "center",
          ...
          children: "Browse through our curated collection of premium content",
        }),
        _jsx("div", {
          style: {
            height: "500px",
