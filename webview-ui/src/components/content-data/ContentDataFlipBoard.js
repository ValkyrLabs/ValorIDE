...
const ContentDataFlipBoard = ({
  ...
  // Fetch ContentData
  const { data: pageData = [], isLoading: isFetching } =
    useGetContentDatasPagedQuery({ page: 1 });
  ...
  // Auto-scroll effect
  useEffect(() => {
    if (!autoScroll || cards.length === 0) return undefined;
  ...
  if (isLoading || isFetching) {
    return _jsx("div", {
      className: "flipboard-loading",
      children: _jsx(LoadingSpinner, { label: "Loading content carousel..." }),
    });
  }
  if (cards.length === 0) {
    return _jsx("div", {
      className: "flipboard-empty",
      children: _jsx("p", { children: "No content available" }),
    });
  }
  return _jsxs("div", {
    className: "flipboard-container",
    ref: containerRef,
    children: [
      _jsx("canvas", { ref: canvasRef, className: "flipboard-canvas" }),
      _jsxs("div", {
        className: "flipboard-controls",
        children: [
          _jsx(CoolButton, {
            variant: "dark",
            ...
            "aria-label": "Previous",
            children: _jsx(FaChevronLeft, { size: 20 }),
          }),
          _jsx("div", {
            className: "flipboard-indicators",
            children: cards.map((_, idx) =>
              _jsx(
                "div",
                {
          ...
          _jsx(CoolButton, {
            ...
            "aria-label": "Next",
            children: _jsx(FaChevronRight, { size: 20 }),
          }),
        ],
      }),
      cards[currentIndex] &&
        _jsxs("div", {
          className: "flipboard-info",
          children: [
            _jsx("h2", { children: cards[currentIndex].title }),
            _jsx("p", {
              className: "flipboard-category",
              children: cards[currentIndex].category,
            }),
            _jsxs("p", {
              className: "flipboard-description",
              children: [
            ...
            _jsxs("div", {
              className: "flipboard-meta",
              children: [
                _jsx("span", {
                  className: "flipboard-status",
                  children: cards[currentIndex].status,
                }),
                _jsxs("span", {
                  className: "flipboard-count",
                  children: [currentIndex + 1, " / ", cards.length],
                }),
              ],
            }),
          ],
