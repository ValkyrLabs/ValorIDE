...
const FileExplorer = ({
  ...
  const detectServerType = (item) => {
    ...
    if (
      childNames.includes("pom.xml") ||
      item.name.toLowerCase().includes("spring-server")
    ) {
      return "spring-boot";
    }
    // Check for TypeScript client (has tsconfig.json and typically named typescript-client)
    if (
      childNames.includes("tsconfig.json") &&
    ...
    if (
      childNames.includes("package.json") &&
      (childNames.includes("nest-cli.json") ||
        ...
        children: [
          _jsxs("div", {
            ...
            children: [
              item.type === "directory" &&
                _jsx("span", {
                  className: `file-item-icon ${isExpanded ? "expanded" : ""}`,
                  children: isExpanded ? "📂" : "📁",
                }),
              item.type === "file" &&
                _jsx("span", {
      ...
      children: [
        ...
        _jsxs("div", {
          ...
          children: [
            ...
            _jsx("span", { children: "Loading workspace files..." }),
          ],
        }),
      ],
    });
    ...
    return _jsxs(_Fragment, {
      children: [
        ...
        _jsxs("div", {
          ...
          children: [
            _jsxs("p", { children: ["Error loading files: ", error] }),
            _jsx(VSCodeButton, { onClick: fetchFiles, children: "Retry" }),
          ],
        }),
      ],
    });
      ...
      _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            ...
            children: [
              _jsx("h3", { children: "ThorAPI Generated Files" }),
              _jsx(VSCodeButton, {
                appearance: "icon",
                onClick: fetchFiles,
                title: "Refresh",
          ...
          _jsxs("div", {
            className: "file-explorer-location",
            children: [
              _jsx("span", { children: "Output folder: " }),
              _jsx("code", { children: folderDisplayPath }),
              showConfigHint &&
                _jsxs("span", {
                  className: "file-explorer-config-hint",
                  children: [
                    "(configured as ",
                    _jsx("code", { children: configuredThorapiFolder }),
                    ")",
                  ],
                }),
            ],
            ...
            children:
              files.length === 0
                ? _jsx("div", {
                    ...
                    children: _jsx("p", {
                      children: "No files found in workspace",
                    }),
                  })
                : _jsx("div", {
                    className: "file-explorer-tree",
                    children: files.map((item) => renderFileItem(item)),
                  }),
          }),
        ],
      }),
      _jsx(AddToProjectModal, {
        isOpen: modalOpen,
