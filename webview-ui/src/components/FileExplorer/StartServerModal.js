...
const StartServerModal = ({
  ...
  return _jsx("div", {
    className: "start-server-modal-backdrop",
    onClick: handleBackdropClick,
    children: _jsxs("div", {
      className: "start-server-modal-content",
      children: [
        _jsx("div", {
          className: "start-server-modal-header",
          children: _jsx("h3", { children: serverInfo.title }),
        }),
        _jsxs("div", {
          className: "start-server-modal-body",
          children: [
            _jsxs("p", {
              children: [
                "Do you want to start ",
                _jsx("strong", { children: folderName }),
                " for testing?",
              ],
            }),
            _jsx("p", {
              className: "start-server-modal-path",
              children: _jsx("code", { children: folderPath }),
            }),
            _jsxs("div", {
              className: "start-server-modal-details",
              children: [
                _jsx("p", { children: serverInfo.description }),
                _jsxs("div", {
                  className: "start-server-modal-command",
                  children: [
                    _jsx("strong", { children: "Command:" }),
                    " ",
                    _jsx("code", { children: serverInfo.command }),
                  ],
                }),
                serverInfo.port &&
                  _jsxs("div", {
                    className: "start-server-modal-port",
                    children: [
                      _jsx("strong", { children: "Port:" }),
                      " ",
                      _jsxs("code", {
                        children: ["http://localhost:", serverInfo.port],
                      }),
                    ],
                  }),
                _jsxs("div", {
                  className: "start-server-modal-features",
                  children: [
                    _jsx("p", {
                      children: _jsx("strong", { children: "This will:" }),
                    }),
                    _jsx("ul", {
        ...
        _jsxs("div", {
          className: "start-server-modal-footer",
          children: [
            _jsx(VSCodeButton, {
