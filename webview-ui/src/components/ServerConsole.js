...
const ServerConsole = () => {
    ...
    return (_jsxs("div", { style: {
            ...
            color: "var(--vscode-editor-foreground)",
                    ...
                    paddingBottom: "10px",
                }, children: [_jsx("h2", { style: { margin: "0 0 10px 0" }, children: "Server Console & WebSocket Testing" }), _jsxs("div", { style: {
                            display: "flex",
                            alignItems: "center",
                            gap: "10px",
                            marginBottom: "10px",
                                ...
                                } }), _jsxs("span", { children: ["Status: ", connectionStatus.phase] }), _jsxs("span", { style: { opacity: 0.7 }, children: ["(ThorAPI Connected: ", connectionStatus.thorConnected ? "Yes" : "No", ")"] })] }), _jsx(VSCodeButton, { onClick: handleConnect, children: connectionStatus.phase === "connected" ? "Reconnect" : "Connect" })] }), _jsxs("div", { style: { flex: "1", display: "flex", gap: "20px", minHeight: 0 }, children: [_jsxs("div", { style: {
                            flex: "1",
                            display: "flex",
                            flexDirection: "column",
                            minHeight: 0,
                        }, children: [_jsx("h3", { style: { margin: "0 0 10px 0" }, children: "Connection Logs" }), _jsxs("div", { style: {
                                    flex: "1",
                                ...
                                }, children: [logs.map((log, index) => (_jsx("div", { style: { marginBottom: "4px", whiteSpace: "pre-wrap" }, children: log }, index))), _jsx("div", { ref: messagesEndRef })] })] }), _jsxs("div", { style: {
                            flex: "1",
                            display: "flex",
                            flexDirection: "column",
                            minHeight: 0,
                        }, children: [_jsxs("h3", { style: { margin: "0 0 10px 0" }, children: ["WebSocket Messages (", messages.length, ")"] }), _jsxs("div", { style: {
                                    flex: "1",
                                    border: "1px solid var(--vscode-panel-border)",
                                    borderRadius: "4px",
                                    padding: "10px",
