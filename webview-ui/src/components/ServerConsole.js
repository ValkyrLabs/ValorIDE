      ...
      _jsxs("div", {
        ...
        children: [
          _jsx("h2", {
            ...
            children: "Server Console & WebSocket Testing",
          }),
          _jsxs("div", {
            style: {
              display: "flex",
            ...
            children: [
              ...
              _jsxs("span", { children: ["Status: ", connectionStatus.phase] }),
              _jsxs("span", {
                style: { opacity: 0.7 },
                children: [
                  "(Thor Connected: ",
                  connectionStatus.thorConnected ? "Yes" : "No",
                  ")",
                ],
              }),
            ],
        ...
        children: [
          ...
          _jsxs("div", {
            ...
            children: [
              _jsxs("h3", {
                style: { margin: "0 0 10px 0" },
                children: ["WebSocket Messages (", messages.length, ")"],
              }),
              _jsxs("div", {
                style: {
                  flex: "1",
                    ...
                    _jsxs(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          _jsxs("div", {
                            style: { color: "#608b4e", fontSize: "11px" },
                            children: [
                              "ID: ",
                              message.messageId,
                              " | Time:",
        ...
        children: [
          ...
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx(VSCodeButton, {
                ...
                disabled:
                  !connectionStatus.thorConnected || !testMessage.trim(),
                children: "Send Test",
              }),
            ],
          }),
          !connectionStatus.thorConnected &&
            _jsx("div", {
              ...
              children: "Must be connected to send messages",
            }),
        ],
      }),
    ],
