  ...
  const getStepIcon = (status) => {
    switch (status) {
      case "completed":
        return "✅";
      case "active":
        return _jsx(VSCodeProgressRing, {
  ...
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            className: "application-progress-header",
            children: [
              _jsx("h2", { children: "Application Generation" }),
              applicationId &&
                _jsxs("div", {
                  className: "application-id",
                  children: [
                    _jsx("span", { children: applicationName }),
                    _jsxs("span", { children: ["ID: ", applicationId] }),
                  ],
                }),
            ],
          }),
          _jsx("div", {
            className: "application-progress-content",
            children: hasError
              ? _jsxs("div", {
                  className: "application-progress-error",
                  children: [
                    _jsx("div", {
                      className: "error-icon",
                      children: "\u274C",
                    }),
                    _jsx("h3", { children: "Generation Failed" }),
                    _jsx("p", { children: errorMessage }),
                    _jsx(VSCodeButton, { onClick: onClose, children: "Close" }),
                  ],
                })
              : isComplete
                ? _jsxs("div", {
                    className: "application-progress-success",
                    children: [
                      _jsx("div", {
                      ...
                      resultDetails.extractedPath &&
                        _jsxs("div", {
                          ...
                          children: [
                            _jsx("h4", { children: "Project Details:" }),
                            _jsxs("ul", {
                              children: [
                                _jsxs("li", {
                                  children: [
                ...
                : _jsx("div", {
                    className: "application-progress-steps",
                        ...
                        "div",
                        {
                          ...
                          children: [
                            ...
                            _jsxs("div", {
                              ...
                              children: [
                                _jsx("h4", { children: step.title }),
                                _jsx("p", {
                                  children: step.details || step.description,
                                }),
                              ],
                            }),
          ...
          !isComplete &&
            !hasError &&
            _jsx("div", {
              className: "application-progress-footer",
              children: _jsx("p", {
                children:
