            ...
            children: [
              ...
              _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx(VSCodeButton, { onClick: onDone, children: "Done" }),
                ],
              }),
            ],
          }),
          _jsx("div", {
            style: { padding: "5px 17px 6px 17px" },
            children: _jsxs("div", {
              style: {
                display: "flex",
                flexDirection: "column",
              ...
              children: [
                ...
                _jsxs(VSCodeRadioGroup, {
                  ...
                  children: [
                    _jsx(VSCodeRadio, { value: "newest", children: "Newest" }),
                    _jsx(VSCodeRadio, { value: "oldest", children: "Oldest" }),
                    _jsx(VSCodeRadio, {
                      value: "mostExpensive",
                          ...
                          children: [
                            _jsxs("div", {
                              ...
                              children: [
                                ...
                                !item.totalCost &&
                                  _jsx(ExportButton, { itemId: item.id }),
                              ],
                            }),
                            !!item.cacheWrites &&
                              _jsxs("div", {
...
const ExportButton = ({ itemId }) =>
  _jsx(VSCodeButton, {
    ...
    children: _jsx("div", {
      style: { fontSize: "11px", fontWeight: 500, opacity: 1 },
      children: "EXPORT",
    }),
  });
