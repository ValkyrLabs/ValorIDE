            ...
            _jsxs(Card.Body, {
              children: [
                resetResult.isSuccess &&
                  _jsx(Alert, {
                    variant: "success",
                    children: "If the account exists, instructions were sent.",
                  }),
                resetResult.isError &&
                  _jsx(Alert, {
                    variant: "warning",
                    children: "We could not process that request. Try again.",
                  }),
                _jsx(Formik, {
                  initialValues: { email: "", phoneNumber: "" },
                  validationSchema: validationSchema,
                  onSubmit: (values) => resetRequest(values),
                  children: ({ handleSubmit, isSubmitting, values }) =>
                    _jsxs("form", {
                        ...
                        _jsxs(Row, {
                          children: [
                            _jsxs(Col, {
                              md: 6,
                              children: [
                                _jsx(RBForm.Label, { children: "Email" }),
                                _jsx(Field, {
                ...
                _jsx("hr", {}),
                _jsxs("h5", {
                  children: [_jsx(FiUser, { size: 20 }), " Forgot username?"],
                }),
                _jsx(Formik, {
                  initialValues: { email: "", phoneNumber: "" },
                  validationSchema: validationSchema,
