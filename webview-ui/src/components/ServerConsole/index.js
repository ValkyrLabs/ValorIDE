...
const ServerConsole = () => {
  ...
  const getStatusIcon = () => {
    if (isConnecting) return _jsx(FiActivity, {});
    if (connected && mothershipConnected) return _jsx(FiWifi, {});
    if (connected) return _jsx(FiActivity, {});
    if (mothershipConnected) return _jsx(FiWifi, {});
  ...
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsxs(Card, {
        ...
        children: [
          _jsx(Card.Header, {
            className: "console-header p-3",
            children: _jsxs(Row, {
              className: "align-items-center",
              children: [
                _jsx(Col, {
                  children: _jsxs("h6", {
                    className: "console-title d-flex align-items-center mb-0",
                    children: [
                      _jsx(FiTerminal, { className: "icon", size: 18 }),
                      "ValkyrAI Chat",
                    ],
                  }),
                }),
                _jsx(Col, {
                  xs: "auto",
                  children: _jsxs("div", {
                    className: "connection-status d-flex align-items-center",
                    children: [
                      _jsx("div", {
                    ...
                    children: [
                      ...
                      _jsx(CoolButton, {
                        ...
                        children: isMaximized
                          ? _jsx(FiMinimize2, { size: 14 })
                          : _jsx(FiMaximize2, { size: 14 }),
                      }),
                    ],
                  }),
                }),
                ...
                ? messages.map((message, index) => {
                    ...
                    return _jsxs(
                      "div",
                      {
                        ...
                        children: [
                          _jsx(Badge, {
                            className: `message-badge badge-${variant}`,
                            children: type || "msg",
                          }),
                          _jsx("div", {
                          ...
                          _jsxs("div", {
                            ...
                            children: [
                              ...
                              _jsx("span", {
                                ...
                                children: message.user?.username || "anon",
                              }),
                            ],
                          }),
                          _jsx("div", {
                            className: "message-content",
                            children: payload || "Empty message",
                          }),
                        ],
                      },
                      index
            ...
            children: _jsxs(InputGroup, {
              children: [
                ...
                _jsx("button", {
                  ...
                  onClick: sendMessage,
                  disabled:
                    !connected || !mothershipConnected || !chatText.trim(),
                  title: "Send Message",
