...
const SwarmPanel2 = ({ organizationId, userId, workspaceId }) => {
  ...
  return _jsxs("div", {
    className: "swarm-panel-v2",
    children: [
      _jsxs("div", {
        className: "swarm-header",
        children: [
          _jsxs("div", {
            className: "swarm-title",
            children: [
              _jsx("span", { children: "\uD83D\uDE80 SWARM v2" }),
              _jsx(Badge, {
                count: onlineCount,
      ...
      !isConnected &&
        _jsx(Alert, {
          ...
          description:
            "Real-time updates are unavailable. Refresh to reconnect.",
          type: "warning",
          showIcon: true,
          closable: true,
      ...
      _jsx(Tabs, {
        ...
        items: [
              ...
              children: _jsx("div", {
                ...
                children: _jsxs(Space, {
                  ...
                  children: [
                    ...
                    agents.length === 0
                      ? _jsx(Empty, { description: "No agents found" })
                      : _jsx(AgentListPanel, {
                          agents: agents,
          ...
          },
          {
            key: "chat",
            label: _jsxs(_Fragment, {
              children: [_jsx(MessageOutlined, {}), " Chat"],
            }),
            children: selectedAgentId
              ? _jsx(ChatPanel, {
                  ...
                  conversationId:
                    ...
                    `conv_${selectedAgentId}_${userId}`,
                })
              : _jsx(Empty, {
          ...
          },
          {
            key: "settings",
            label: _jsxs(_Fragment, {
              children: [_jsx(SettingOutlined, {}), " Settings"],
            }),
            children: _jsx(SettingsPanel, {
              organizationId: organizationId,
