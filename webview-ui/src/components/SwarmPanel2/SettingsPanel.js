...
const SettingsPanel = ({ organizationId, onAgentAdded }) => {
  ...
  return _jsx(Card, {
    className: "swarm-settings-panel",
    ...
    children: _jsxs(Space, {
      ...
      children: [
        ...
        lastError
          ? _jsx(Alert, { type: "error", showIcon: true, message: lastError })
          : null,
        _jsxs(Form, {
          form: form,
          layout: "vertical",
              ...
              rules: [
                {
                  required: true,
                  message:
                    "Please provide a human-friendly name for the agent.",
                },
              ],
              children: _jsx(Input, { placeholder: "e.g. Research Assistant" }),
            }),
            _jsx(Form.Item, {
              label: "Model",
              name: "model",
