...
const AgentListPanel = ({ agents, selectedAgentId, onSelectAgent }) => {
  return _jsx(List, {
    ...
    renderItem: (agent) => {
      ...
      return _jsxs(List.Item, {
        onClick: () => onSelectAgent(agent.id),
        className: isSelected
          ? "swarm-agent-item selected"
          : "swarm-agent-item",
        children: [
          _jsxs(Space, {
            direction: "vertical",
            ...
            children: [
              _jsxs(Space, {
                align: "center",
                children: [
                  _jsx(Text, { strong: true, children: title }),
                  renderStatus(agent.status),
                  typeof agent.version === "string" && agent.version.length > 0
                    ? _jsxs(Tag, {
                        color: "blue",
                        children: ["v", agent.version],
                      })
                    : null,
                ],
              }),
              _jsxs(Space, {
                split: _jsx("span", { children: "\u2022" }),
                size: "small",
                children: [
                  _jsx(Text, { type: "secondary", children: agent.id }),
                  location
                    ? _jsx(Text, { type: "secondary", children: location })
                    : null,
                  typeof agent.latency === "number"
                    ? _jsxs(Text, {
                        type: "secondary",
                        children: [agent.latency.toFixed(0), " ms"],
                      })
                    : null,
                ],
              }),
          ...
          _jsx(Badge, { status: isSelected ? "processing" : "default" }),
        ],
      });
    },
  });
