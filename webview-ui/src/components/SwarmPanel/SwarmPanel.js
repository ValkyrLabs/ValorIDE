...
export const SwarmPanel = () => {
    ...
    const loadBilling = async () => {
      try {
        ...
        if (status && status.billingStatus === "SUSPENDED") {
          addAlert(
            "warning",
            "🚨 Billing suspended - cannot create new agents. Contact support to reactivate.",
          );
        } else if (
          status &&
  ...
  const doRollcall = useCallback(
    () =>
      sendApp("presence:rollcall", {
  ...
  const renderHierarchyTree = (nodes, depth = 0) => {
    return nodes.map((node) =>
      _jsxs(
        "div",
        {
          style: { marginLeft: depth * 20, padding: 4 },
          children: [
            _jsxs("div", {
              ...
              style: {
                ...
                padding: 4,
                backgroundColor:
                  selected === node.agentId ? "#e3f2fd" : "transparent",
                borderRadius: 4,
              },
              children: [
                "▶".repeat(Math.max(0, depth)),
                " ",
                _jsx("strong", { children: node.agentId }),
                " ",
                "(depth: ",
                node.depth,
                ")",
      ...
      _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            ...
            children: ["Agents (", filteredAgents.length, ")"],
          }),
          _jsx("div", {
            onClick: () => setActiveTab("hierarchy"),
            style: tabStyle("hierarchy"),
            children: "Hierarchy",
          }),
          _jsx("div", {
                      ...
                      children: [
                        ...
                        _jsxs("select", {
                          ...
                          children: [
                            ...
                            _jsx("option", { value: "IDLE", children: "IDLE" }),
                            _jsx("option", { value: "BUSY", children: "BUSY" }),
                            _jsx("option", {
                              value: "ERROR",
                              children: "ERROR",
                            }),
          ...
          activeTab === "hierarchy" &&
            _jsxs("div", {
              ...
              children: [
                _jsx("h4", {
                  style: { marginTop: 0 },
                  children: "Agent Tree (Max 12 children, 12 levels)",
                }),
                hierarchy.length > 0
          ...
          children: billingStatus
            ? _jsxs("div", {
                children: [
                  ...
                  billingStatus.activeAgentCount >=
                    billingStatus.quotaAgents * 0.8 &&
                    _jsxs("div", {
                      style: {
                        padding: 12,
                        marginBottom: 16,
                        ...
                        children: [
                          ...
                          _jsxs("div", {
                            style: {
                              ...
                              fontWeight: "bold",
                              color:
                                billingStatus.remainingQuota > 0
                                  ? "#4CAF50"
                                  : "#FF6B6B",
                            },
                            children: [billingStatus.remainingQuota, " agents"],
                          }),
                        ],
                      }),
                      _jsxs("div", {
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          ...
                          _jsx("div", {
                            ...
                            children: billingStatus.billingStatus,
                          }),
                        ],
                      }),
                    ],
