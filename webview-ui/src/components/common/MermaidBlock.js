...
export default function MermaidBlock({ code }) {
    ...
    return (_jsxs(MermaidBlockContainer, { children: [isLoading && (_jsx(LoadingMessage, { children: "Generating mermaid diagram..." })), _jsx(ButtonContainer, { children: _jsx(StyledVSCodeButton, { onClick: handleCopyCode, title: "Copy Code", "aria-label": "Copy Code", children: _jsx(FaCopy, {}) }) }), _jsx(SvgContainer, { onClick: handleClick, ref: containerRef, "$isLoading": isLoading })] }));
}
