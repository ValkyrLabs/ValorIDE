...
export const CheckmarkControl = ({
  ...
  const handleRestoreTask = async () => {
    ...
    try {
      const restoreType: ValorIDECheckpointRestore = "task";
  ...
  const handleRestoreWorkspace = async () => {
    ...
    try {
      const restoreType: ValorIDECheckpointRestore = "workspace";
      await CheckpointsServiceClient.checkpointRestore({
        number: messageTs,
        restoreType,
      });
  ...
  const handleRestoreBoth = async () => {
    ...
    try {
      const restoreType: ValorIDECheckpointRestore = "taskAndWorkspace";
      await CheckpointsServiceClient.checkpointRestore({
        number: messageTs,
        restoreType,
      });
