...
*/
export const cleanPathPrefix = (path) =>
          ...
          children: [
            isFeedback || isConsoleLogs
              ? _jsxs("div", {
                  ...
                  children: [
                    isFeedback
                      ? _jsx(VscFeedback, { style: { marginRight: "6px" } })
                      : _jsx(VscOutput, { style: { marginRight: "6px" } }),
                    _jsx("span", {
                      style: {
                        whiteSpace: "nowrap",
                        overflow: "hidden",
            ...
            numberOfEdits !== undefined &&
              _jsxs("div", {
                ...
                children: [
                  _jsx(VscDiff, { style: { marginRight: "4px" } }),
                  _jsx("span", { children: numberOfEdits }),
                ],
              }),
            isExpanded ? _jsx(VscChevronUp, {}) : _jsx(VscChevronDown, {}),
          ],
        }),
