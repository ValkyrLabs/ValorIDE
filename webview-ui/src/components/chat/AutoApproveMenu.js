          ...
          _jsxs(CollapsibleSection, {
            ...
            children: [
              ...
              _jsx("span", {
                ...
                children: !hasEnabledActions ? "None" : enabledActionsList,
              }),
              isExpanded && _jsx(FaArrowUp, {}),
              isExpanded && _jsx(FaArrowDown, {}),
            ],
          }),
        ],
      }),
        ...
        _jsxs("div", {
          ...
          children: [
            _jsx("div", {
              ...
              children:
                "Auto-approve allows ValorIDE to perform the following actions without asking for permission. Please use with caution and only enable if you understand the risks.",
            }),
            ACTION_METADATA.map((action) => {
              ...
              if (
                ...
                return _jsx(
                  SubOptionAnimateIn,
                  {
                    show: autoApprovalSettings.actions[parentAction] ?? false,
                    children: _jsxs("div", {
                      style: {
                        margin: "3px 0",
                        marginLeft: "28px",
            ...
            _jsx("div", {
              ...
              children:
                "ValorIDE will automatically make this many API requests before asking for approval to proceed with the task.",
            }),
            _jsxs("div", {
              style: { margin: "6px 0" },
              children: [
                ...
                _jsx("div", {
                  ...
                  children:
                    "Receive system notifications when ValorIDE requires approval to proceed or when a task is completed.",
                }),
              ],
            }),
          ],
