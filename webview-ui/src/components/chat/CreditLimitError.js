          ...
          _jsxs("div", {
            ...
            children: [
              ...
              _jsxs("span", {
                ...
                children: ["$", currentBalance.toFixed(2)],
              }),
            ],
          }),
          _jsxs("div", {
            style: { color: "var(--vscode-foreground)" },
            children: ["Total Spent: $", totalSpent.toFixed(2)],
          }),
          _jsxs("div", {
            style: { color: "var(--vscode-foreground)" },
            children: ["Total Promotions: $", totalPromotions.toFixed(2)],
          }),
        ],
      }),
      _jsxs(VSCodeButtonLink, {
        href: "https://valkyrlabs.com/buy-credits",
        style: {
          width: "100%",
          marginBottom: "8px",
        },
        children: [_jsx(FaCreditCard, {}), "Buy Credits"],
      }),
      _jsxs(VSCodeButton, {
        onClick: () => {
          vscode.postMessage({
