  ...
  return _jsxs("div", {
    ...
    children: [
      ...
      isVisible &&
        _jsxs("div", {
          className:
            "fixed left-[15px] right-[15px] border border-[var(--vscode-editorGroup-border)] p-3 rounded z-[1000] overflow-y-auto",
          style: {
          ...
          children: [
            _jsx("div", {
              className:
                "fixed w-[10px] h-[10px] z-[-1] rotate-45 border-r border-b border-[var(--vscode-editorGroup-border)]",
              style: {
                    ...
                    _jsx(Tooltip, {
                      ...
                      children: _jsx(VSCodeButton, {
                        ...
                        children: isLoading
                          ...
                          : _jsx(FaSync, { style: { fontSize: "10px" } }),
                      }),
                    }),
                    _jsx(VSCodeButton, {
                      appearance: "icon",
                      ...
                      children: _jsx(FaCog, { style: { fontSize: "10px" } }),
                    }),
                  ],
                }),
              ],
            ...
            isLoading && !mcpServers
              ? _jsxs("div", {
                  ...
                  children: [
                    _jsx(VSCodeProgressRing, {}),
                    _jsx("span", { children: "Loading MCP servers..." }),
                  ],
                })
              : error
                ? _jsxs("div", {
                    className: "error-message py-2",
                    style: { color: "var(--vscode-errorForeground)" },
                    children: [
                      _jsx("div", {
                        style: { marginBottom: "8px" },
                        children: _jsx("strong", {
                          children: "Failed to load MCP servers:",
                        }),
                      }),
                      _jsx("div", {
                      ...
                      _jsx("div", {
                        style: { marginTop: "8px" },
                        children: _jsxs(VSCodeButton, {
                          appearance: "secondary",
                          onClick: handleRefresh,
                          style: { fontSize: "11px", padding: "2px 8px" },
                          children: [
                            _jsx(FaSync, { style: { marginRight: "4px" } }),
                            "Retry",
                          ],
                        }),
                      }),
                ...
                : _jsx("div", {
                    ...
                    children: _jsx(ServersToggleList, {
