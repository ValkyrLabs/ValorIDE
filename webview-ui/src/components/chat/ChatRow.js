...
const CompletionChangesSummary = ({ summary, disabled, onOpenAllChanges, onOpenFileDiff, }) => {
    ...
    const totalFilesLabel = summary.totalFiles === 1 ? "1 file" : `${summary.totalFiles} files`;
...
export const ChatRowContent = ({ message, isExpanded, onToggleExpand, lastModifiedMessage, isLast, inputValue, setInputValue, sendMessageFromChatRow, }) => {
    ...
    const seeNewChangesSinceLastCompletion = message.ask === "completion_result" || message.say === "completion_result";
        ...
        switch (type) {
            ...
            case "command":
                return [
                    ...
                    _jsx("span", { style: { color: normalColor, fontWeight: "bold" }, children: "ValorIDE executing command:" }),
                ];
            case "use_mcp_server":
                ...
                return [
                    ...
                    _jsxs("span", { style: {
                            ...
                            fontWeight: "bold",
                            wordBreak: "break-word",
                        }, children: ["ValorIDE executing", " ", mcpServerUse.type === "use_mcp_tool"
                                ? "use a tool"
        ...
        switch (tool.tool) {
            case "editedExistingFile":
                return (_jsxs(_Fragment, { children: [_jsxs("div", { style: headerStyle, children: [toolIcon(FaEdit), tool.operationIsLocatedInWorkspace === false &&
                                    toolIcon(FaSignOutAlt, "yellow", -90, "This file is outside of your workspace"), _jsx("span", { style: { fontWeight: "bold" }, children: "ValorIDE editing:" })] }), _jsx(CodeAccordian
            ...
            case "newFileCreated":
                return (_jsxs(_Fragment, { children: [_jsxs("div", { style: headerStyle, children: [toolIcon(FaPlus), tool.operationIsLocatedInWorkspace === false &&
                                    toolIcon(FaSignOutAlt, "yellow", -90, "This file is outside of your workspace"), _jsx("span", { style: { fontWeight: "bold" }, children: "ValorIDE creating a new file:" })] }), _jsx(CodeAccordian, { isLoading: message.partial, code: tool.content, path: tool.path, isExpanded: isExpanded, onToggleExpand: onToggleExpand })] }));
            case "precisionSearchAndReplace": {
                ...
                let editSummary;
                if (Array.isArray(parsedContent?.edits) &&
            ...
            case "readFile":
                return (_jsxs(_Fragment, { children: [_jsxs("div", { style: headerStyle, children: [toolIcon(FaFileCode), tool.operationIsLocatedInWorkspace === false &&
                                    toolIcon(FaSignOutAlt, "yellow", -90, "This file is outside of your workspace"), _jsx("span", { style: { fontWeight: "bold" }, children: "ValorIDE reading this file:" })] }), _jsx("div", { style: {
                                borderRadius: 3,
            ...
            case "searchFiles":
                return (_jsxs(_Fragment, { children: [_jsxs("div", { style: headerStyle, children: [toolIcon(FaSearch), tool.operationIsLocatedInWorkspace === false &&
                                    toolIcon(FaSignOutAlt, "yellow", -90, "This is outside of your workspace"), _jsxs("span", { style: { fontWeight: "bold" }, children: ["ValorIDE searching this directory for ", _jsx("code", { children: tool.regex }), ":"] })] }), _jsx(CodeAccordian, { code: tool.content, path: tool.path + (tool.filePattern ? `/(${tool.filePattern})` : ""), language: "plaintext", isExpanded: isExpanded, onToggleExpand: onToggleExpand })] }));
            default:
                return null;
        }
    }
    ...
    switch (message.type) {
                    ...
                    return (_jsx(_Fragment, { children: _jsxs("div", { style: {
                                ...
                                fontSize: 12,
                                        ...
                                        marginBottom: 4,
                                                ...
                                                fontWeight: 500,
                                                color: "#FFA500",
                                            }, children: "Outside Workspace" })] }), _jsxs("div", { children: ["ValorIDE can only operate inside the opened workspace. The file ", _jsx("code", { children: message.text }), " lives elsewhere. Open the folder that contains it or share the contents manually if it should be accessible."] })] }) }));
        ...
        case "ask":
            switch (message.ask) {
                ...
                case "new_task":
                    return (_jsxs(_Fragment, { children: [_jsxs("div", { style: headerStyle, children: [_jsx(FaFileUpload, {}), _jsx("span", { style: { color: normalColor, fontWeight: "bold" }, children: "ValorIDE starting a new task:" })] }), _jsx(NewTaskPreview, { context: message.text || "" })] }));
                case "condense":
                    return (_jsxs(_Fragment, { children: [_jsxs("div", { style: headerStyle, children: [_jsx(FaFileUpload, {}), _jsx("span", { style: { color: normalColor, fontWeight: "bold" }, children: "ValorIDE condensing your conversation:" })] }), _jsx(NewTaskPreview, { context: message.text || "" })] }));
