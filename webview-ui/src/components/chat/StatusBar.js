        ...
        children: [
          ...
          _jsx(StatusBadge, {
            ...
            value: wsConnected
              ...
              : "Disconnected",
            kind: wsConnected ? "ok" : "warn",
            title: wsConnected
              ? `Connected to mothership with ${wsInstanceCount} other instances`
              : "Not connected to websocket mothership",
            style: isConnectingMothership
              ? {
          ...
          _jsx(VSCodeButton, {
            ...
            title: isConnectingMothership
              ? "Connecting…"
              : "Reconnect to websocket mothership",
            children: isConnectingMothership
              ? _jsx(FaSpinner, {
                  style: { animation: "spin 1s linear infinite" },
                })
              : _jsx(FaPlug, {}),
          }),
          multipleInstances && _jsx(RobotIconComponent, {}),
        ],
      }),
      _jsxs("div", {
