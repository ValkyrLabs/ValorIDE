...
const BrowserSessionRow = memo((props) => {
  ...
  const [browserSessionRow, { height }] = useSize(
    ...
    _jsxs(BrowserSessionRowContainer, {
      style: { marginBottom: -10 },
      children: [
        _jsxs("div", {
          style: browserSessionRowContainerInnerStyle,
          children: [
            isBrowsing && !isLastMessageResume
              ? _jsx(ProgressIndicator, {})
              : _jsx(FaSearch, { style: browserIconStyle }),
            _jsx("span", {
              style: approveTextStyle,
              children: _jsx(_Fragment, {
                children: isAutoApproved
                  ? "ValorIDE is using the browser:"
                  : "ValorIDE wants to use the browser:",
              }),
            }),
          ],
        }),
        _jsxs("div", {
          ...
          children: [
            _jsxs("div", {
              ...
              children: [
                _jsx("div", {
                  ...
                  children: _jsx("div", {
                    style: urlTextStyle,
                    children: displayState.url || "http",
                  }),
                }),
                _jsx(BrowserSettingsMenu, {}),
              ],
            }),
            _jsxs("div", {
              style: {
              ...
              children: [
                displayState.screenshot
                  ...
                  : _jsx("div", {
                      style: noScreenshotContainerStyle,
                      children: _jsx(FaGlobe, { style: noScreenshotIconStyle }),
                    }),
                displayState.mousePosition &&
                  _jsx(BrowserCursor, {
                    style: {
            ...
            _jsxs("div", {
              style: consoleLogsContainerStyle,
              children: [
                _jsxs("div", {
                  onClick: () => {
        ...
        _jsx("div", {
          style: { minHeight: maxActionHeight },
        ...
        pages.length > 1 &&
          _jsxs("div", {
            ...
            children: [
              _jsxs("div", {
                children: ["Step ", currentPageIndex + 1, " of ", pages.length],
              }),
              _jsxs("div", {
                style: paginationButtonGroupStyle,
                children: [
                  _jsx(VSCodeButton, {
                  ...
                  _jsx(VSCodeButton, {
                    disabled:
                      currentPageIndex === pages.length - 1 || isBrowsing,
                    onClick: () => setCurrentPageIndex((i) => i + 1),
                    children: "Next",
                  }),
                ],
    ...
    return _jsxs(_Fragment, {
      children: [
        _jsx("div", {
          style: headerStyle,
          children: _jsx("span", {
            style: browserSessionStartedTextStyle,
            children: "Browser Session Started",
          }),
        }),
        _jsx("div", {
  ...
  switch (message.type) {
    case "say":
      switch (message.say) {
        ...
        case "reasoning":
          return _jsx("div", {
            style: chatRowContentContainerStyle,
...
const BrowserActionBox = ({ action, coordinate, text }) => {
  ...
  return _jsx("div", {
    style: browserActionBoxContainerStyle,
    children: _jsx("div", {
      style: browserActionBoxContainerInnerStyle,
      children: _jsx("div", {
        style: browseActionRowContainerStyle,
        children: _jsxs("span", {
          style: browseActionRowStyle,
          children: [
            _jsx("span", {
              style: browseActionTextStyle,
              children: "Browse Action: ",
            }),
