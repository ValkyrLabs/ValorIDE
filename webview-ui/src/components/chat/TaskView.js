...
const TaskView = ({
  ...
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsxs("div", {
        style: { flexGrow: 1, display: "flex", position: "relative" },
          ...
          isChatLoading &&
            ...
            _jsx("div", {
              style: {
                ...
                right: "20px",
                background:
                  "color-mix(in srgb, var(--vscode-editor-background) 95%, transparent)",
                borderRadius: "8px",
                border: "1px solid var(--vscode-editorGroup-border)",
                boxShadow: "0 4px 12px rgba(0,0,0,0.15)",
                zIndex: 1000,
              },
              children: _jsx(LoadingSpinner, { label: "Working...", size: 24 }),
            }),
          showScrollToBottom &&
            _jsx("div", {
              style: { position: "absolute", bottom: "20px", right: "20px" },
              children: _jsx(ScrollToBottomButton, {
                onClick: () => {
                  virtuosoRef.current?.scrollToIndex({ index: "LAST" });
                  disableAutoScrollRef.current = false;
                },
                children: _jsx(VscChevronDown, {}),
              }),
            }),
        ],
      }),
      _jsxs(ActionButtonsContainer, {
        children: [
          enableButtons &&
            secondaryButtonText &&
            _jsx(VSCodeButton, {
