...
const TaskHeader = ({
  ...
  const ContextWindowComponent = _jsx(_Fragment, {
    children:
      isTaskExpanded &&
      contextWindow &&
      _jsxs("div", {
        ...
        children: [
          ...
          _jsxs("div", {
            ...
            children: [
              _jsx("span", {
                children: formatLargeNumber(lastApiReqTotalTokens || 0),
              }),
              _jsxs("div", {
                style: {
                  display: "flex",
          ...
          children: [
                ...
                _jsxs("div", {
                  ...
                  children: [
                    _jsxs("span", {
                      ...
                      children: ["Task", !isTaskExpanded && ":"],
                    }),
                    !isTaskExpanded &&
                      _jsx("span", {
                        style: { marginLeft: 4 },
                        children: highlightText(task.text, false),
                      }),
                  ],
                }),
              ],
            ...
            !isTaskExpanded &&
              ...
              _jsx(VSCodeButton, {
                ...
                children: copied ? _jsx(FaCheck, {}) : _jsx(FaCopy, {}),
              }),
            !isTaskExpanded &&
              isCostAvailable &&
              _jsxs("div", {
          ...
          _jsxs(_Fragment, {
            children: [
              ...
              task.images &&
                ...
                _jsx(Thumbnails, { images: task.images }),
              _jsxs("div", {
                style: {
                  display: "flex",
                  flexDirection: "column",
                            ...
                            checkpointTrackerErrorMessage.endsWith(
                              ...
                              _jsx(_Fragment, {
                                children: _jsx("a", {
                                  ...
                                  children: "disabling checkpoints.",
                                }),
                              }),
                              ...
                              _jsxs(_Fragment, {
                                children: [
                                  ...
                                  _jsx("a", {
                                    ...
                                    children: "Git Installation Instructions",
                                  }),
                                ],
                              }),
                          ],
...
const DeleteButton = ({ taskSize, taskId }) =>
  _jsx(VSCodeButton, {
    appearance: "icon",
    onClick: () =>
