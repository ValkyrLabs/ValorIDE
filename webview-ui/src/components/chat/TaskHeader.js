                ...
                zIndex: 1,
                        ...
                        alignItems: "center",
                                ...
                                minWidth: 0, // This allows the div to shrink below its content size
                                        ...
                                        flexGrow: 1,
                                        minWidth: 0, // This allows the div to shrink below its content size
                                    }, children: [_jsxs("span", { style: { fontSize: 14, fontWeight: "bold" }, children: ["Task", !isTaskExpanded && ":"] }), !isTaskExpanded && (_jsx("span", { style: { marginLeft: 4 }, children: highlightText(task.text, false) }))] })] }), !isTaskExpanded && isCostAvailable && (_jsx(VSCodeButton, { appearance: "icon", title: copied ? "Copied" : "Copy task text", onClick: async (e) => {
                                e.stopPropagation();
                                try {
