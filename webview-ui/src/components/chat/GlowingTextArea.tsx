...
interface GlowingTextAreaProps
  extends React.ComponentProps<typeof DynamicTextArea> {
  borderState: "happy" | "waiting" | "sad";
  isStubborn: boolean;
  isExtendedThinking?: boolean;
}

const GlowingTextArea = forwardRef<HTMLTextAreaElement, GlowingTextAreaProps>(
  ({ borderState, isStubborn, isExtendedThinking, ...props }, ref) => {
