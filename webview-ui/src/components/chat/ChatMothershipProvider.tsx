...
export const ChatMothershipProvider: React.FC<ChatMothershipProviderProps> = ({
  ...
  useEffect(() => {
    if (currentTaskId && currentTaskId !== lastTaskIdRef.current) {
      console.log(
        "🛸 ChatMothershipProvider: Setting current task:",
        currentTaskId,
      );
  ...
  useEffect(() => {
    ...
    const handleChatMessage = (event: CustomEvent) => {
      ...
      console.log("🛸 ChatMothershipProvider: Chat message event received:", {
        messageId,
        content,
        taskId,
      });
    ...
    const handleToolUse = (event: CustomEvent) => {
      ...
      console.log("🛸 ChatMothershipProvider: Tool use event received:", {
        toolName,
        args,
        taskId,
      });
    ...
    const handleFileEdit = (event: CustomEvent) => {
      ...
      console.log("🛸 ChatMothershipProvider: File edit event received:", {
        fileName,
        taskId,
      });
    ...
    const handleCommandExecute = (event: CustomEvent) => {
      ...
      console.log(
        "🛸 ChatMothershipProvider: Command execute event received:",
        { command, taskId },
      );
    ...
    const handleTaskComplete = (event: CustomEvent) => {
      ...
      console.log("🛸 ChatMothershipProvider: Task complete event received:", {
        taskId,
        result,
      });
    ...
    const handleTaskStart = (event: CustomEvent) => {
      ...
      console.log("🛸 ChatMothershipProvider: Task start event received:", {
        taskId,
        description,
      });
    ...
    const handleActiveToolsUpdate = (event: CustomEvent) => {
      ...
      console.log(
        "🛸 ChatMothershipProvider: Active tools update event received:",
        { tools },
      );
    ...
    const handleOpenFilesUpdate = (event: CustomEvent) => {
      ...
      console.log(
        "🛸 ChatMothershipProvider: Open files update event received:",
        { files },
      );
    ...
    const handleApiData = (event: CustomEvent) => {
      ...
      console.log("🛸 ChatMothershipProvider: API data event received:", {
        type,
        timestamp,
      });
    ...
    const handleRemoteMessage = (event: CustomEvent) => {
      ...
      console.log("🛸 ChatMothershipProvider: Remote message received:", {
        text,
        sender,
        instanceId,
      });
    ...
    const handleCrossInstanceChat = (event: CustomEvent) => {
      ...
      console.log("🛸 ChatMothershipProvider: Cross-instance chat event:", {
        message,
        targetInstanceId,
      });
    ...
    const handleRemoteApiCommand = (event: CustomEvent) => {
      ...
      console.log("🛸 ChatMothershipProvider: Remote API command event:", {
        apiAction,
        targetInstanceId,
      });
    ...
    const handleRemoteChatMessage = (event: CustomEvent) => {
      ...
      console.log("🛸 ChatMothershipProvider: Remote chat message event:", {
        message,
        targetInstanceId,
        sender,
      });
    ...
    window.addEventListener(
      "valoride-chat-message",
      handleChatMessage as EventListener,
    );
    window.addEventListener(
      "valoride-tool-use",
      handleToolUse as EventListener,
    );
    window.addEventListener(
      "valoride-file-edit",
      handleFileEdit as EventListener,
    );
    window.addEventListener(
      "valoride-command-execute",
      handleCommandExecute as EventListener,
    );
    window.addEventListener(
      "valoride-task-complete",
      handleTaskComplete as EventListener,
    );
    window.addEventListener(
      "valoride-task-start",
      handleTaskStart as EventListener,
    );
    window.addEventListener(
      "valoride-active-tools-update",
      handleActiveToolsUpdate as EventListener,
    );
    window.addEventListener(
      "valoride-open-files-update",
      handleOpenFilesUpdate as EventListener,
    );
    window.addEventListener(
      "valoride-api-data",
      handleApiData as EventListener,
    );
    window.addEventListener(
      "valoride-remote-message",
      handleRemoteMessage as EventListener,
    );
    window.addEventListener(
      "valoride-cross-instance-chat",
      handleCrossInstanceChat as EventListener,
    );
    window.addEventListener(
      "valoride-remote-api-command",
      handleRemoteApiCommand as EventListener,
    );
    window.addEventListener(
      "valoride-remote-chat-message",
      handleRemoteChatMessage as EventListener,
    );
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      console.log(
        "🛸 ChatMothershipProvider: Global dispatch function removed",
      );
    };
  }, [dispatchChatAction]);
...
export const MothershipTracking = {
  trackChatMessage: (messageId: string, content: string, taskId?: string) => {
    console.log("🛸 MothershipTracking.trackChatMessage called:", {
      messageId,
      content,
      taskId,
    });
  ...
  trackToolUse: (toolName: string, args?: any, taskId?: string) => {
    console.log("🛸 MothershipTracking.trackToolUse called:", {
      toolName,
      args,
      taskId,
    });
  ...
  trackFileEdit: (fileName: string, content?: string, taskId?: string) => {
    console.log("🛸 MothershipTracking.trackFileEdit called:", {
      fileName,
      taskId,
    });
    const dispatch = (window as any).valorideDispatchChatAction;
  ...
  trackCommandExecute: (command: string, taskId?: string) => {
    console.log("🛸 MothershipTracking.trackCommandExecute called:", {
      command,
      taskId,
    });
    const dispatch = (window as any).valorideDispatchChatAction;
  ...
  trackTaskComplete: (taskId: string, result?: any) => {
    console.log("🛸 MothershipTracking.trackTaskComplete called:", {
      taskId,
      result,
    });
    const dispatch = (window as any).valorideDispatchChatAction;
  ...
  sendCrossInstanceMessage: (message: string, targetInstanceId?: string) => {
    console.log("🛸 MothershipTracking.sendCrossInstanceMessage called:", {
      message,
      targetInstanceId,
    });
    const dispatch = (window as any).valorideDispatchChatAction;
  ...
  injectApiResponse: (content: string, targetInstanceId?: string) => {
    console.log("🛸 MothershipTracking.injectApiResponse called:", {
      content,
      targetInstanceId,
    });
    const dispatch = (window as any).valorideDispatchChatAction;
  ...
  triggerRemoteApiCall: (
    model: string,
    messages: any[],
    targetInstanceId?: string,
  ) => {
    console.log("🛸 MothershipTracking.triggerRemoteApiCall called:", {
      model,
      targetInstanceId,
    });
    const dispatch = (window as any).valorideDispatchChatAction;
  ...
  sendRemoteChatMessage: (message: string, targetInstanceId?: string) => {
    console.log("🛸 MothershipTracking.sendRemoteChatMessage called:", {
      message,
      targetInstanceId,
    });
    const dispatch = (window as any).valorideDispatchChatAction;
