          ...
          children: [
            showSlashCommandsMenu &&
              _jsx("div", {
                ...
                children: _jsx(SlashCommandMenu, {
            ...
            _jsx("div", {
              ...
              children: _jsx("div", {
                ...
                children: _jsx("button", {
                  ...
                  children: _jsx(FaPaperPlane, {}),
                }),
              }),
            }),
          ],
        }),
        _jsxs(ControlsContainer, {
          children: [
            imagesToastVisible &&
              _jsx("div", {
                style: {
            ...
            _jsxs(ButtonGroup, {
              children: [
                ...
                _jsx(ServersToggleModal, {}),
                _jsx(ValorIDERulesToggleModal, {}),
                _jsx(Tooltip, {
                  tipText: "Auto Repeat Check [stubborn mode]",
                  children: _jsx(VSCodeButton, {
                    appearance: chatSettings.stubbornMode
                      ? "primary"
                      : "secondary",
                ...
                _jsxs(ModelContainer, {
                  ref: modelSelectorRef,
                  children: [
                    _jsx(ModelButtonWrapper, {
                      ref: buttonRef,
                      children: _jsx(ModelDisplayButton, {
                        role: "button",
                        ...
                        // }}
                        tabIndex: 0,
                        children: _jsx(ModelButtonContent, {
                          children: modelDisplayName,
                        }),
                      }),
                    }),
                    showModelSelector &&
                      _jsx(ModelSelectorTooltip, {
                        arrowPosition: arrowPosition,
                        menuPosition: menuPosition,
                        style: {
                          bottom: `calc(100vh - ${menuPosition}px + 6px)`,
                        },
                        children: _jsx(ApiOptions, {
            ...
            _jsx(Tooltip, {
              ...
              tipText: `In ${shownTooltipMode === "act" ? "Act" : "Plan"}  mode, ValorIDE will ${shownTooltipMode === "act" ? "complete the task immediately" : "gather information to architect a plan"}`,
              hintText: `Toggle w/ ${metaKeyChar}+Shift+A`,
              children: _jsxs(SwitchContainer, {
