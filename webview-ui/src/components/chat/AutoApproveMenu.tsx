    ...
    >
      ...
      {isExpanded && (
        <div style={{ padding: "0" }}>
          ...
          >
            Auto-approve allows ValorIDE to perform the following actions
            without asking for permission. Please use with caution and only
            enable if you understand the risks.
          </div>
          ...
          >
            ValorIDE will automatically make this many API requests before
            asking for approval to proceed with the task.
          </div>
          <div style={{ margin: "6px 0" }}>
            ...
            >
              Receive system notifications when ValorIDE requires approval to
