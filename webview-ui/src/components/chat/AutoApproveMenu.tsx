			...
			{isExpanded && (
				<div style={{ padding: "0" }}>
					<div
						...
						Auto-approve allows ValorIDE to perform the following actions without asking for permission. Please use
					...
					<div
						...
						ValorIDE will automatically make this many API requests before asking for approval to proceed with the
						task.
					</div>
