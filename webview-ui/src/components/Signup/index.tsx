		...
		<div style={{ margin: "2em" }}>
			<Row>
				...
				<Col md={6}>
					<Card style={{ padding: "1em", marginBottom: "3em" }}>
						<Card.Header>
							...
							<h5>
								Claim your <Badge bg="info">FREE</Badge> Valkyr Labs user account.
							</h5>
						</Card.Header>
						<Card.Body>
							<Form />
				...
				<Col md={3}>
					...
					<br />
					<FiHeart size={28} /> At Valkyr Labs, our customer's privacy and security are a top priority. We will never
