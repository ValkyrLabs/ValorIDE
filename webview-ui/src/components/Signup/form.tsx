...
const Form: React.FC = () => {
	...
	const principalExists = (addPrincipalResult.error as any)?.status === 400 && addPrincipalResult.status === "rejected"
						...
						if (principalExists) {
							...
							if (existingPrincipalName === values.username) {
								...
								if (isBadRequest) {
									...
									errors.username = maybeError.data || "Username is invalid or already taken."
								}
							} else {
							...
							<form onSubmit={handleSubmit} className="form">
								...
								<Row>
									<Col md={12}>
										...
										{existingPrincipalName === values.username && principalExists && (
											<div className="error">
								...
								<Row>
									<Col md={12}>
										<label htmlFor="acceptedTos" className="nice-form-control">
											...
											<b>
												<Nav.Link href="https://valkyrlabs.com/v1/docs/Legal/tos" target="_blank">
