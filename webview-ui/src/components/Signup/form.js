...
const Form = () => {
    ...
    return (_jsxs("div", { children: [signupSuccess && (_jsxs("div", { className: "success", children: [_jsx("h1", { children: "Success!" }), _jsx("p", { children: "Your account has been created. Please check your email for a verification link." }), _jsx(Link, { to: "/login", children: "Click here to Sign In" }), _jsx("br", {}), _jsx("br", {}), _jsx("br", {})] })), !signupSuccess && (_jsx(Formik, { validateOnBlur: true, initialValues: initialValues, validationSchema: validationSchema, onSubmit: handleSubmit, enableReinitialize: true, children: ({ isSubmitting, errors, values, setFieldValue, resetForm, touched, setFieldTouched, handleSubmit, isValid, }) => {
                    ...
                    return (_jsxs("form", { onSubmit: handleSubmit, className: "form", children: [_jsx(Row, { children: _jsx(Col, { md: 12, children: _jsxs("label", { htmlFor: "firstName", className: "nice-form-control", children: [_jsxs("b", { children: ["First Name:", touched.firstName && !errors.firstName && (_jsxs("span", { className: "okCheck", children: [_jsx(FaCheckCircle, {}), " looks good!"] }))] }), _jsx(Field, { name: "firstName", type: "text", className: errors.firstName
                                            ...
                                            principalExists && (_jsx(ErrorModal, { variant: "inline", severity: "warning", title: "Username Unavailable", errorMessage: `"${addPrincipalResult?.originalArgs?.username}" is unavailable. Try another.`, callback: () => {
                                                /* user can edit field to dismiss */
                                            } })), _jsxs("label", { htmlFor: "username", className: "nice-form-control", children: [_jsxs("b", { children: ["User Name:", touched.username && !errors.username && (_jsxs("span", { className: "okCheck", children: [_jsx(FaCheckCircle, {}), " looks good!"] }))] }), _jsx(Field, { name: "username", type: "text", className: errors.username
                                                        ? "form-control field-error"
                                                    ...
                                                    }, isInvalid: !!errors.acceptedTos, className: errors.acceptedTos ? "errorCheck" : "okCheck" }) }), _jsx(ErrorMessage, { className: "error", name: "acceptedTos", component: "div" }), " "] }) }) }), _jsx("br", {}), _jsx("br", {}), _jsx(Row, { children: _jsx(Col, { children: _jsxs(CoolButton, { variant: touched && isValid
                                            ? isSubmitting
                                                ? "disabled"
                                                : "success"
                                            : "warning", type: "submit", onClick: () => { }, children: [isSubmitting && (_jsx(LoadingSpinner, { size: 18, style: { marginRight: 8 } })), _jsx(FiUserCheck, { size: 30 }), " Register Account"] }) }) }), isSubmitting && (_jsx(LoadingSpinner, { label: "Creating your account..." }))] }));
                } }))] }));
};
export default Form;
