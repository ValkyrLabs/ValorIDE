...
const Form = () => {
  ...
  const principalExists =
    addPrincipalResult.error?.status === 400 &&
          ...
          children: ({
            ...
            return _jsxs("form", {
              ...
              children: [
                ...
                isSubmitting &&
                  _jsx(LoadingSpinner, { label: "Creating your account..." }),
              ],
            });
          },
        }),
