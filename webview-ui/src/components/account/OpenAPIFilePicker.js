...
const OpenAPIFilePicker = ({ onFileSelected }) => {
  ...
  return _jsxs("div", {
    className: "openapi-file-picker",
    children: [
      _jsxs("div", {
        className: "file-picker-header",
        style: { marginBottom: "16px" },
        children: [
          _jsx("h3", { children: "Import Application from OpenAPI" }),
          _jsx("p", {
            style: {
              fontSize: "14px",
      ...
      _jsx("div", {
        className: "file-picker-controls",
        style: { marginBottom: "16px" },
        children: _jsxs("div", {
        ...
        _jsxs("div", {
          ...
          children: [
            ...
            _jsxs("div", {
              style: { fontSize: "14px" },
              children: [
                _jsxs("div", { children: ["Name: ", selectedFile.name] }),
                _jsxs("div", {
                  children: [
                    "Size: ",
                ...
                _jsxs("div", {
                  children: ["Type: ", selectedFile.type || "Unknown"],
                }),
              ],
            }),
          ],
