...
const AccountView = ({ onDone }) => {
  ...
  return _jsxs("div", {
    ...
    children: [
      ...
      _jsx("div", {
        className: "scroll-tabs-container",
        children: _jsx("div", {
      ...
      activeTab === "login"
        ...
        : activeTab === "applications"
          ? _jsxs("div", {
              className: "h-full flex flex-col pr-3 overflow-y-auto",
              children: [
                loading &&
                  _jsx("div", {
                    style: {
                ...
                _jsxs("div", {
                  ...
                  children: [
                    _jsx(OpenAPIFilePicker, {
                      onFileSelected: handleOpenAPIFileSelected,
                    }),
                    _jsx(ApplicationsList, {
                      showTitle: true,
          ...
          : activeTab === "generatedFiles"
            ...
            : activeTab === "userPreferences"
              ...
              : activeTab === "account"
                ? _jsx(_Fragment, {
                    children: _jsxs("div", {
                      ...
                      children: [
                        _jsxs("div", {
                          className:
                            "w-full flex gap-2 flex-col min-[225px]:flex-row mt-4",
                          children: [
                            _jsx("div", {
                              className: "w-full min-[225px]:w-1/2",
                              children: _jsx(VSCodeButtonLink, {
                        ...
                        _jsxs("div", {
                          ...
                          children: [
                            _jsx("div", {
                              className:
                                "text-sm text-[var(--vscode-descriptionForeground)] mb-3",
                              children: "CURRENT BALANCE",
                            }),
                            _jsx("div", {
                              className:
                                "text-4xl font-bold text-[var(--vscode-foreground)] mb-6 flex items-center gap-2",
                              children: loading
                                ? _jsx(LoadingSpinner, {
                        ...
                        _jsx(VSCodeDivider, { className: "mt-6 mb-3 w-full" }),
                        _jsx("div", {
                          className: "flex-grow flex flex-col min-h-0 pb-[0px]",
                          children: _jsx(CreditsHistoryTable, {
                            isLoading: loading,
                            usageData: usageData || [],
                ...
                : _jsx(_Fragment, { children: "nothing selected" }),
    ],
  });
};
