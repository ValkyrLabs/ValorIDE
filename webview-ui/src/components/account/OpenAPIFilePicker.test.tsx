...
describe("OpenAPIFilePicker - Validation & Upload", () => {
  ...
  describe("Component Rendering", () => {
    it("should render component with Select File button", () => {
      ...
      expect(
        screen.getByText("Import Application from OpenAPI"),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("File Extension Validation", () => {
    it("should reject .txt files", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/Please select a valid OpenAPI spec file/),
        ).toBeInTheDocument();
      });
    });
  ...
  describe("YAML Upload & Validation", () => {
    ...
    it("should reject YAML without openapi/swagger key", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/does not appear to be an OpenAPI specification/),
        ).toBeInTheDocument();
      });
    });
