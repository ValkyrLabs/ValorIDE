...
const UserPreferences = memo(({ className }) => {
      ...
      children: [
        _jsx(Tab, {
          ...
          title: _jsxs(_Fragment, {
            children: [
              _jsx(FaCog, { className: "me-2" }),
              "Layout (",
              preferencesByType["ux-layout"].length,
              ")",
            ],
          }),
          children: renderPreferenceList(preferencesByType["ux-layout"]),
        }),
        _jsx(Tab, {
          eventKey: "uxmode",
          title: _jsxs(_Fragment, {
            children: [
              _jsx(FaUser, { className: "me-2" }),
              "Mode (",
              preferencesByType["ux-mode"].length,
              ")",
            ],
          }),
          children: renderPreferenceList(preferencesByType["ux-mode"]),
        }),
        _jsx(Tab, {
          eventKey: "uxtheme",
          title: _jsxs(_Fragment, {
            children: [
              _jsx(FaCog, { className: "me-2" }),
              "Theme (",
              preferencesByType["ux-theme"].length,
              ")",
            ],
          }),
          children: renderPreferenceList(preferencesByType["ux-theme"]),
        }),
        _jsx(Tab, {
          eventKey: "measurement",
          title: _jsxs(_Fragment, {
            children: [
              _jsx(FaChartLine, { className: "me-2" }),
              "Measurements (",
              preferencesByType["measurement"].length,
              ")",
            ],
          }),
          children: renderPreferenceList(preferencesByType["measurement"]),
        }),
      ],
    });
  // Render preference list for each tab
  const renderPreferenceList = (preferences) =>
    _jsxs(Card, {
      children: [
        _jsxs(Card.Header, {
          ...
          children: [
            _jsxs("h6", {
              className: "mb-0",
              children: ["Preferences (", preferences.length, ")"],
            }),
            _jsxs(CoolButton, {
              variant: "primary",
              size: "sm",
              ...
              disabled: isAdding,
              children: [_jsx(FaPlus, { className: "me-1" }), "Add Preference"],
            }),
          ],
        }),
        _jsx(Card.Body, {
          children:
            preferences.length === 0
              ? _jsxs("div", {
                  ...
                  children: [
                    _jsx("p", {
                      children: "No preferences found for this category.",
                    }),
                    _jsxs(CoolButton, {
                      variant: "outline-primary",
                      onClick: () => handleEditPreference(null),
                      children: [
                        _jsx(FaPlus, { className: "me-1" }),
      ...
      children: [
        _jsx(Col, {
          ...
          children: _jsx(Card, {
            ...
            children: _jsxs(Card.Body, {
              children: [
                _jsx(FaCog, { size: 24, className: "text-primary mb-2" }),
                _jsx("h5", { children: stats.totalPreferences }),
                _jsx("small", {
                  className: "text-muted",
          ...
          children: _jsx(Card, {
            ...
            children: _jsxs(Card.Body, {
              children: [
                ...
                _jsx("h5", { children: stats.totalSalesOrders }),
                _jsx("small", {
                  className: "text-muted",
        ...
        _jsx(Col, {
          ...
          children: _jsx(Card, {
            ...
            children: _jsxs(Card.Body, {
              children: [
                _jsx(FaUser, { size: 24, className: "text-info mb-2" }),
                _jsx("h5", { children: stats.totalCustomers }),
                _jsx("small", {
                  className: "text-muted",
                  children: "Customers",
                }),
          ...
          children: _jsx(Card, {
            ...
            children: _jsxs(Card.Body, {
              children: [
                ...
                _jsx("h5", { children: stats.totalInvoices }),
                _jsx("small", {
                  className: "text-muted",
                  children: "Invoices",
                }),
                ...
                children: salesOrdersLoading
                  ...
                  : stats.recentOrders.length > 0
                              ...
                              _jsxs(
                                "tr",
                                {
                                  ...
                                  children: [
                                    ...
                                    _jsx("td", {
                                      children:
                                        order.customer?.principal?.firstName ||
                                        "Unknown",
                                    }),
                                    _jsxs("td", {
                                      children: [
                    ...
                    : _jsx("div", {
                        className: "text-center text-muted py-3",
                        children: _jsx("p", {
                          children: "No recent sales orders found.",
                        }),
                      }),
              }),
            ],
        ...
        _jsx(Col, {
          ...
          children: _jsxs(Card, {
            children: [
              _jsxs(Card.Header, {
                children: [
                  _jsx(FaFileInvoice, { className: "me-2" }),
                  "Recent Invoices",
                  _jsx(VSCodeLink, {
                  ...
                  : stats.recentInvoices.length > 0
                    ? _jsxs(Table, {
                        ...
                        children: [
                          ...
                          _jsx("tbody", {
                            children: stats.recentInvoices.map((invoice) =>
                              _jsxs(
                                "tr",
                                {
                                  style: { cursor: "pointer" },
                                  children: [
                                    ...
                                    _jsx("td", {
                                      children:
                                        "N/A" /* TODO: Add customer relationship */,
                                    }),
                                    _jsxs("td", {
                                      children: [
                                        "$",
                    ...
                    : _jsx("div", {
                        className: "text-center text-muted py-3",
                        children: _jsx("p", {
                          children: "No recent invoices found.",
                        }),
                      }),
              }),
            ],
                  ...
                  children: [
                    _jsx(Col, {
                      ...
                      children: _jsxs(Form.Group, {
                        className: "mb-3",
                        children: [
                          _jsx(Form.Label, { children: "Preference Type" }),
                          _jsxs(Form.Select, {
                            ...
                            children: [
                              ...
                              _jsx("option", {
                                value: UserPreferencePreferenceTypeEnum.UXMODE,
                                children: "UX Mode",
                              }),
                              _jsx("option", {
                                value: UserPreferencePreferenceTypeEnum.UXTHEME,
                                children: "UX Theme",
                              }),
                              _jsx("option", {
                                value:
                                  UserPreferencePreferenceTypeEnum.MEASUREMENT,
                    ...
                    _jsx(Col, {
                      ...
                      children: _jsxs(Form.Group, {
                        className: "mb-3",
                        children: [
                          _jsx(Form.Label, { children: "Principal ID" }),
                          _jsx(Form.Control, {
                            type: "text",
                            value:
                              editingPreference.principalId ||
                              currentPrincipalId ||
                              "",
                            onChange: (e) =>
                              setEditingPreference({
                ...
                _jsx(Row, {
                  children: _jsx(Col, {
                    children: _jsxs(Form.Group, {
                      className: "mb-3",
                      children: [
                        _jsx(Form.Label, { children: "Preference Value" }),
                        _jsx(Form.Control, {
                          as: "textarea",
                          rows: 3,
                          ...
                          placeholder:
                            "Enter preference value (JSON, string, etc.)",
                        }),
                        _jsx(Form.Text, {
                          className: "text-muted",
                          children:
        ...
        _jsxs(Modal.Footer, {
          children: [
            _jsxs(VSCodeButton, {
              ...
              children: [_jsx(FaTimes, { className: "me-1" }), "Cancel"],
            }),
            _jsxs(CoolButton, {
              variant: "primary",
            ...
            _jsxs(Row, {
              children: [
                _jsx(Col, {
                  ...
                  children: _jsxs(Card, {
                    children: [
                      _jsx(Card.Header, { children: "Basic Information" }),
                      _jsx(Card.Body, {
                        children: _jsxs("dl", {
                          className: "row",
                          children: [
                            ...
                            _jsx("dd", {
                              className: "col-sm-8",
                              children: selectedPreference.id || "N/A",
                            }),
                            _jsx("dt", {
                              className: "col-sm-4",
                              children: "Type:",
                            ...
                            _jsx("dd", {
                              ...
                              children: _jsx(Badge, {
                                bg: "primary",
                                children: selectedPreference.preferenceType,
                              }),
                            }),
                            _jsx("dt", {
                              className: "col-sm-4",
                            ...
                            _jsx("dd", {
                              className: "col-sm-8",
                              children: selectedPreference.principalId || "N/A",
                            }),
                            _jsx("dt", {
                              className: "col-sm-4",
                              children: "Owner ID:",
                            ...
                            _jsx("dd", {
                              className: "col-sm-8",
                              children: selectedPreference.ownerId || "N/A",
                            }),
                          ],
                        }),
                      }),
                ...
                _jsx(Col, {
                  ...
                  children: _jsxs(Card, {
                    children: [
                      _jsx(Card.Header, { children: "Audit Information" }),
                      _jsx(Card.Body, {
                        children: _jsxs("dl", {
                          className: "row",
                          children: [
                ...
                _jsx(Col, {
                  ...
                  children: _jsxs(Card, {
                    children: [
                      _jsx(Card.Header, { children: "Preference Value" }),
                      _jsx(Card.Body, {
                        children: _jsx("pre", {
  ...
  if (
    ...
    return _jsx("div", {
      className: `user-preferences-error ${className}`,
      children: _jsxs(Alert, {
        variant: "danger",
        children: [
          _jsx("h5", { children: "Error Loading Data" }),
          _jsx("p", {
            children:
          ...
          _jsxs("ul", {
            children: [
              preferencesError &&
                _jsxs("li", {
                  children: ["User Preferences: ", String(preferencesError)],
                }),
              salesOrdersError &&
                _jsxs("li", {
                  children: ["Sales Orders: ", String(salesOrdersError)],
                }),
              customersError &&
                _jsxs("li", {
                  children: ["Customers: ", String(customersError)],
                }),
              invoicesError &&
                _jsxs("li", {
                  children: ["Invoices: ", String(invoicesError)],
                }),
              principalsError &&
                _jsxs("li", {
                  children: ["Principals: ", String(principalsError)],
                }),
            ],
          }),
          _jsx(CoolButton, {
  ...
  return _jsxs("div", {
    className: `user-preferences ${className}`,
    children: [
      _jsxs("div", {
      ...
      _jsxs("div", {
        ...
        children: [
          _jsxs("h4", {
            className: "mb-3",
            children: [_jsx(FaCog, { className: "me-2" }), "Your Preferences"],
          }),
