...
const ApplicationsList = ({
  ...
  const renderHeader = () =>
    _jsxs("div", {
      ...
      children: [
        showTitle && _jsx("h2", { style: { margin: 0 }, children: title }),
        _jsx(VSCodeButton, {
      ...
      children: [
        ...
        _jsxs("div", {
          ...
          children: [
            ...
            _jsx("span", { children: "Loading applications..." }),
          ],
        }),
      ],
    });
  ...
  if (!applications || applications.length === 0) {
    return _jsxs("div", {
      ...
      children: [
        renderHeader(),
        _jsx("div", { children: "No available applications found." }),
      ],
    });
  }
  ...
  const renderLoadingSteps = (app) => {
    ...
    return _jsx("div", {
      className: "application-loading-steps",
      children: _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx("span", { children: "Receiving Application" }),
              !loadingStates[app.id]?.steps?.receiving &&
                _jsx("span", {
                  style: { marginLeft: "8px", fontSize: "12px", opacity: 0.7 },
                  children: "Downloading application payload...",
                }),
            ],
          }),
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx("span", { children: "Processing Data" }),
              loadingStates[app.id]?.steps?.receiving &&
                !loadingStates[app.id]?.steps?.processing &&
                _jsx("span", {
                  style: { marginLeft: "8px", fontSize: "12px", opacity: 0.7 },
                  children: "Analyzing application structure...",
                }),
            ],
          }),
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx("span", { children: "Extracting Files" }),
              loadingStates[app.id]?.steps?.processing &&
                !loadingStates[app.id]?.steps?.extracting &&
                _jsx("span", {
                  style: { marginLeft: "8px", fontSize: "12px", opacity: 0.7 },
                  children: "Creating project structure...",
                }),
            ],
          }),
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx("span", { children: "Finalizing Setup" }),
              loadingStates[app.id]?.steps?.extracting &&
                !loadingStates[app.id]?.steps?.finalizing &&
                _jsx("span", {
                  style: { marginLeft: "8px", fontSize: "12px", opacity: 0.7 },
                  children: "Preparing development environment...",
                }),
            ],
          }),
          loadingStates[app.id]?.generating
              ...
              children: [
                ...
                ownedApps.map((app) =>
                  _jsx(
                                ...
                                _jsxs("div", {
                                  ...
                                  children: [
                                    _jsx(VSCodeButtonLink, {
                                      href:
                                        "http://localhost:5173/application-detail/" +
                                        app.id,
                                      appearance: "secondary",
                                      className: "w-full",
                                      children: "Open",
                                    ...
                                    _jsx(VSCodeButton, {
                                      ...
                                      children: loadingStates[app.id]?.deploying
                                        ? "Deploying..."
                                        : "Deploy",
                                    }),
                                  ],
                    ...
                    app.id || app.name || JSON.stringify(app),
                  ),
                ),
              ],
            }),
                        ...
                        children: [
                          _jsxs("div", {
                            ...
                            children: [
                              _jsx("div", {
                                className: "application-name",
                                children: app.name || app.title || app.id,
                              }),
                              app.description &&
                                _jsx("div", {
                                  className: "application-description",
        ...
        _jsxs("div", {
          ...
          children: [
            _jsxs("div", {
              ...
              children: [
                _jsx("h3", { children: "Generated Files" }),
                _jsx(VSCodeButton, {
                  appearance: "secondary",
            ...
            hasCompletedApplications &&
              _jsxs("div", {
                ...
                children: [
                  _jsx("h4", { children: "Recently Generated Applications" }),
                              ...
                              children: [
                                _jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    _jsx("span", {
                                      children: "Receiving Application",
                                    }),
                                  ],
                                }),
                                _jsxs("div", {
