...
const ApplicationsList = ({ showTitle = true, title = "Available Applications", }) => {
    const { userInfo, jwtToken, authenticatedPrincipal, authenticatedUser } = useExtensionState();
    // Get the current user's ID for owner comparison
    const currentUserId = authenticatedUser?.id || authenticatedPrincipal?.id || userInfo?.id;
    ...
    const { data: applications, error, isLoading, isFetching, refetch, } = useGetApplicationsQuery(undefined, {
    ...
    const isOwnedByCurrentUser = (app) => {
    ...
    const renderHeader = () => (_jsxs("div", { className: "applications-header", style: {
            display: "flex",
            alignItems: "center",
            justifyContent: showTitle ? "space-between" : "flex-end",
            gap: "12px",
            marginBottom: "12px",
        }, children: [showTitle && _jsx("h2", { style: { margin: 0 }, children: title }), _jsx(VSCodeButton, { appearance: "secondary", onClick: () => refetch(), disabled: isLoading || isFetching, "aria-label": "Refresh applications", role: "button", title: "Refresh applications", children: isFetching ? "Refreshing..." : "Refresh" })] }));
    if (isLoading) {
        return (_jsxs("div", { className: "applications-list", children: [renderHeader(), _jsxs("div", { className: "loading-container", children: [_jsx(VSCodeProgressRing, {}), _jsx("span", { children: "Loading applications..." })] })] }));
    }
    if (error) {
        return (_jsxs("div", { className: "applications-list", children: [renderHeader(), _jsxs("div", { className: "error-message", children: ["Failed to load applications:", " ", error
    ...
    if (!applications || applications.length === 0) {
        return (_jsxs("div", { className: "applications-list", children: [renderHeader(), _jsx("div", { children: "No available applications found." })] }));
    }
    ...
    const renderLoadingSteps = (app) => {
        if (!(loadingStates[app.id]?.generating ||
        ...
        return (_jsx("div", { className: "application-loading-steps", children: _jsxs("div", { className: "loading-steps", style: {
                    marginTop: "16px",
                    padding: "12px",
                    ...
                    borderRadius: "4px",
                            ...
                            marginBottom: "8px",
                                    ...
                                    marginRight: "8px",
                                }, children: "\u2705" })) : (_jsx(VSCodeProgressRing, { style: { width: "16px", height: "16px", marginRight: "8px" } })), _jsx("span", { children: "Receiving Application" }), !loadingStates[app.id]?.steps?.receiving && (_jsx("span", { style: { marginLeft: "8px", fontSize: "12px", opacity: 0.7 }, children: "Downloading application payload..." }))] }), _jsxs("div", { className: "loading-step", style: {
                            display: "flex",
                            alignItems: "center",
                            marginBottom: "8px",
                                    ...
                                    color: "var(--vscode-charts-green)",
                                    marginRight: "8px",
                                }, children: "\u2705" })) : loadingStates[app.id]?.steps?.receiving ? (_jsx(VSCodeProgressRing, { style: { width: "16px", height: "16px", marginRight: "8px" } })) : (_jsx("span", { style: {
                                    color: "var(--vscode-descriptionForeground)",
                                    marginRight: "8px",
                                }, children: "\u23F3" })), _jsx("span", { children: "Processing Data" }), loadingStates[app.id]?.steps?.receiving &&
                                !loadingStates[app.id]?.steps?.processing && (_jsx("span", { style: { marginLeft: "8px", fontSize: "12px", opacity: 0.7 }, children: "Analyzing application structure..." }))] }), _jsxs("div", { className: "loading-step", style: {
                            display: "flex",
                            alignItems: "center",
                            marginBottom: "8px",
                                    ...
                                    color: "var(--vscode-charts-green)",
                                    marginRight: "8px",
                                }, children: "\u2705" })) : loadingStates[app.id]?.steps?.processing ? (_jsx(VSCodeProgressRing, { style: { width: "16px", height: "16px", marginRight: "8px" } })) : (_jsx("span", { style: {
                                    color: "var(--vscode-descriptionForeground)",
                                    marginRight: "8px",
                                }, children: "\u23F3" })), _jsx("span", { children: "Extracting Files" }), loadingStates[app.id]?.steps?.processing &&
                                !loadingStates[app.id]?.steps?.extracting && (_jsx("span", { style: { marginLeft: "8px", fontSize: "12px", opacity: 0.7 }, children: "Creating project structure..." }))] }), _jsxs("div", { className: "loading-step", style: {
                            display: "flex",
                            alignItems: "center",
                            marginBottom: "8px",
                                    ...
                                    color: "var(--vscode-charts-green)",
                                    marginRight: "8px",
                                }, children: "\u2705" })) : loadingStates[app.id]?.steps?.extracting ? (_jsx(VSCodeProgressRing, { style: { width: "16px", height: "16px", marginRight: "8px" } })) : (_jsx("span", { style: {
                                    color: "var(--vscode-descriptionForeground)",
                                    marginRight: "8px",
                                }, children: "\u23F3" })), _jsx("span", { children: "Finalizing Setup" }), loadingStates[app.id]?.steps?.extracting &&
                                !loadingStates[app.id]?.steps?.finalizing && (_jsx("span", { style: { marginLeft: "8px", fontSize: "12px", opacity: 0.7 }, children: "Preparing development environment..." }))] }), loadingStates[app.id]?.generating ? (_jsx("div", { style: { marginTop: "12px", fontSize: "12px", opacity: 0.8 }, children: "Please wait while your application is being generated..." })) : (_jsx("div", { style: {
                            marginTop: "12px",
                            fontSize: "12px",
                            color: "var(--vscode-charts-green)",
                        }, children: "\u2705 Application generated successfully!" }))] }) }));
    };
    ...
    return (_jsxs("div", { className: "applications-list", children: [renderHeader(), _jsxs("div", { className: "applications-container", children: [ownedApps.length > 0 && (_jsxs("div", { className: "applications-section", style: { marginBottom: "24px" }, children: [_jsxs("div", { style: {
                                    display: "flex",
                                    alignItems: "center",
                                    gap: "8px",
                                    marginBottom: "12px",
                                    ...
                                    marginBottom: "12px",
                                                        ...
                                                        gap: "8px",
                                                                ...
                                                                ? "Deploying..."
                                                                : "Deploy" })] }))] }), renderLoadingSteps(app)] }) }, app.id || app.name || JSON.stringify(app))))] })), sharedApps.length > 0 && (_jsxs("div", { className: "applications-section", children: [_jsxs("div", { style: {
                                    display: "flex",
                                    alignItems: "center",
                                    gap: "8px",
                                    marginBottom: "12px",
                                    ...
                                    borderBottom: "2px solid var(--vscode-descriptionForeground)",
                                }, children: [_jsx(FaUserFriends, { style: {
                                            color: "var(--vscode-descriptionForeground)",
                                            fontSize: "16px",
                                        } }), _jsx("h3", { style: {
                                            margin: 0,
                                            ...
                                            fontSize: "14px",
                                            fontWeight: 600,
                                        }, children: "Shared Applications" }), _jsx("span", { style: {
                                            fontSize: "12px",
                                            color: "var(--vscode-descriptionForeground)",
                                            marginLeft: "auto",
                                            fontWeight: 500,
                                        }, children: sharedApps.length })] }), sharedApps.map((app) => (_jsx("div", { className: "application-card", style: { marginBottom: "12px" }, children: _jsxs("div", { className: "application-card-content", children: [_jsxs("div", { className: "application-info", children: [_jsx("div", { className: "application-name", children: app.name || app.title || app.id }), app.description && (_jsx("div", { className: "application-description", children: app.description })), _jsxs("div", { className: "application-meta", children: [app.type && (_jsx("span", { className: "application-type", children: app.type })), app.status && (_jsx("span", { className: `application-status status-${app.status}`, children: app.status }))] }), app.id && (_jsxs("div", { className: "application-buttons", children: [_jsx(VSCodeButtonLink, { href: "http://localhost:5173/application-detail/" + app.id, appearance: "secondary", className: "w-full", children: "Open" }), _jsx(VSCodeButton, { appearance: "primary", onClick: () => handleGenerate(app.id), disabled: loadingStates[app.id]?.generating, children: loadingStates[app.id]?.generating
                                                                ? "Generating..."
                                                                : "Generate" }), _jsx(VSCodeButton, { appearance: "secondary", onClick: () => handleDeploy(app.id), disabled: loadingStates[app.id]?.deploying, children: loadingStates[app.id]?.deploying
                                                                ? "Deploying..."
                                                                : "Deploy" })] }))] }), renderLoadingSteps(app)] }) }, app.id || app.name || JSON.stringify(app))))] }))] }), showFileExplorer && (_jsxs("div", { style: { marginTop: "20px" }, children: [_jsxs("div", { className: "file-explorer-header", style: {
                            display: "flex",
