...
const CreditsHistoryTable = ({ isLoading, usageData, paymentsData }) => {
  ...
  return _jsxs("div", {
    ...
    children: [
      ...
      _jsx("div", {
        className: "mt-[15px] mb-[0px] rounded-md overflow-auto flex-grow",
        children: isLoading
          ? _jsx("div", {
                            ...
                            children: [
                              ...
                              usageData.map((row, index) =>
                                _jsxs(
                                  ...
                                  {
                                    onClick: (event) =>
                                      handleUsageRowClick(index, event),
                                    style: {
                                      cursor: "pointer",
                                      backgroundColor:
                                    ...
                                    children: [
                                      _jsx(VSCodeDataGridCell, {
                                        "grid-column": "1",
                                        children: row.spentAt
                                          ? formatTimestamp(String(row.spentAt))
                                          : "",
                                      }),
                                      _jsx(VSCodeDataGridCell, {
                                        "grid-column": "2",
                                        children: `${row.modelProvider}/${row.model}`,
                                      }),
                                      _jsx(VSCodeDataGridCell, {
                                        "grid-column": "3",
                                        children: `$${Number(row.credits).toFixed(7)}`,
                                      }),
                                    ],
                                  },
                                  index
                            ...
                            children: [
                              ...
                              paymentsData.map((row, index) =>
                                _jsxs(
                                  ...
                                  {
                                    onClick: (event) =>
                                      handlePaymentRowClick(index, event),
                                    style: {
                                      cursor: "pointer",
                                      backgroundColor:
                                    ...
                                    children: [
                                      ...
                                      _jsx(VSCodeDataGridCell, {
                                        "grid-column": "2",
                                        children: `$${formatDollars(row.amountCents)}`,
                                      }),
                                      _jsx(VSCodeDataGridCell, {
                                        "grid-column": "3",
