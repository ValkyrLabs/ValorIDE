      ...
      children: [
        _jsx(Modal.Header, {
          ...
          children: _jsxs(Modal.Title, {
            children: [_jsx(FaLock, {}), " Access Denied"],
          }),
        }),
        _jsx(Modal.Body, {
          children: _jsx(Alert, {
            variant: "warning",
            children:
              "You do not have permission to manage permissions for this object. Only owners and administrators can modify object permissions.",
          }),
        }),
        _jsx(Modal.Footer, {
      ...
      _jsxs(Modal.Body, {
        children: [
          ...
          _jsxs("div", {
            ...
            children: [
              _jsxs("h5", {
                children: [_jsx(FaUsers, {}), " Current Permissions"],
              }),
              _jsxs("div", {
                className: "mb-2",
                children: [
                ...
                : _jsxs(Table, {
                    ...
                    children: [
                      _jsx("thead", {
                        children: _jsxs("tr", {
                          children: [
                            _jsx("th", { children: _jsx(FaTrash, {}) }),
                            _jsx("th", { children: "User/Role" }),
                            _jsx("th", { children: "R" }),
                            _jsx("th", { children: "W" }),
                            _jsx("th", { children: "C" }),
                            _jsx("th", { children: "D" }),
                            _jsx("th", { children: _jsx(FaSuperpowers, {}) }),
                          ],
                        }),
                      }),
                      _jsxs("tbody", {
              ...
              !entriesLoading &&
                existingEntries.some((e) => !e.granted) &&
                _jsxs("div", {
                  className: "mt-2",
                  children: [
                    _jsx("h6", { children: "Explicit Denies" }),
                    _jsxs(Table, {
                      bordered: true,
                      size: "sm",
                      children: [
                        _jsx("thead", {
                          children: _jsxs("tr", {
                            children: [
                              _jsx("th", { children: "User/Role" }),
                              _jsx("th", { children: "Permission" }),
                              _jsx("th", { children: "Status" }),
                            ],
                          }),
                        }),
                        _jsx("tbody", {
                          children: existingEntries
                            .filter((e) => !e.granted)
                            .map((e, i) =>
                              _jsxs(
                                "tr",
                                {
                                  children: [
                                    _jsx("td", { children: e.username }),
                                    _jsx("td", { children: e.permission }),
                                    _jsx("td", {
          ...
          _jsxs("div", {
            ...
            children: [
              _jsx("h5", { children: "Add New Permission" }),
              _jsxs(Row, {
                children: [
                  _jsx(Col, {
                    md: 6,
                    children: _jsxs(BSForm.Group, {
                      className: "mb-3",
                      children: [
                        _jsx(BSForm.Label, { children: "Assignment Type" }),
                        _jsxs(ButtonGroup, {
                          className: "d-block",
                          children: [
                            _jsxs(CoolButton, {
                              variant: !newAssignment.isRole
                                ? "primary"
                                : "outline-primary",
                              onClick: () =>
                                setNewAssignment((prev) => ({
                              ...
                              children: [_jsx(FaUserShield, {}), " User"],
                            }),
                            _jsxs(CoolButton, {
                              variant: newAssignment.isRole
                                ? "primary"
                              ...
                              children: [
                                ...
                                rolesPlusSystem.map((role) =>
                                  _jsx(
                                    "option",
                                    {
                                      value: role.roleName || role.role,
                                      children: role.roleName || role.role,
                                    },
                                    role.id,
                                  ),
                                ),
              ...
              _jsxs(BSForm.Group, {
                className: "mb-3",
                children: [
                  _jsx(BSForm.Label, { children: "Permissions" }),
                  _jsx(Row, {
                    children: Object.values(PermissionType).map((permission) =>
                      _jsx(
                        Col,
                        {
                          md: 4,
                          ...
                          children: _jsx(BSForm.Check, {
                            ...
                            label: permission,
                            checked:
                              newAssignment.permissions.includes(permission),
                            onChange: (e) =>
