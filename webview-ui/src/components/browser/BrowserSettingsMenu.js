  ...
  return _jsxs("div", {
    ...
    children: [
        ...
        _jsxs(InfoPopover, {
          ...
          children: [
            _jsx("h4", {
              ...
              children: "Browser Connection",
            }),
            _jsxs(InfoRow, {
              children: [
                _jsx(InfoLabel, { children: "Status:" }),
                _jsx(InfoValue, {
                  style: {
                  ...
                  children: connectionInfo.isConnected
                    ? "Connected"
                    : "Disconnected",
                }),
              ],
            ...
            connectionInfo.isConnected &&
              _jsxs(InfoRow, {
                children: [
                  _jsx(InfoLabel, { children: "Type:" }),
                  _jsx(InfoValue, {
                    children: connectionInfo.isRemote ? "Remote" : "Local",
                  }),
                ],
              }),
            connectionInfo.isConnected &&
              ...
              _jsxs(InfoRow, {
                children: [
                  _jsx(InfoLabel, { children: "Remote Host:" }),
                  _jsx(InfoValue, { children: connectionInfo.host }),
                ],
              }),
          ],
        }),
      _jsx(VSCodeButton, {
        ...
        children: _jsx(FaCog, { style: { fontSize: "14.5px" } }),
      }),
    ],
  });
};
