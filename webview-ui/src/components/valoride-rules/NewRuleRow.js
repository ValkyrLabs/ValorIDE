  ...
  return _jsxs("div", {
    ...
    children: [
        ...
        children: isExpanded
          ? _jsxs("form", {
              ...
              children: [
                _jsx("input", {
                  ...
                  className:
                    "flex-1 bg-[var(--vscode-input-background)] text-[var(--vscode-input-foreground)] border-0 outline-0 rounded focus:outline-none focus:ring-0 focus:border-transparent",
                  style: {
                    outline: "none",
                  },
                }),
                _jsx("div", {
                  ...
                  children: _jsx(VSCodeButton, {
                    ...
                    style: { padding: "0px" },
                    children: _jsx(FaPlus, { style: { fontSize: "14px" } }),
                  }),
                }),
              ],
            })
          : _jsxs(_Fragment, {
              children: [
                _jsx("span", {
                  className:
                    "flex-1 text-[var(--vscode-descriptionForeground)] bg-[var(--vscode-input-background)] italic text-xs",
                  children: "New rule file...",
                }),
                _jsx("div", {
                  className: "flex items-center ml-2 space-x-2",
                  children: _jsx(VSCodeButton, {
      ...
      isExpanded &&
        error &&
        _jsx("div", {
          className: "text-[var(--vscode-errorForeground)] text-xs mt-1 ml-2",
          children: error,
        }),
    ],
  });
