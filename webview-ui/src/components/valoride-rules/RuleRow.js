  ...
  return _jsx("div", {
    ...
    children: _jsxs("div", {
      ...
      children: [
        _jsx("span", {
          className:
            "flex-1 overflow-hidden break-all whitespace-normal flex items-center mr-1",
          title: rulePath,
          children: username,
        }),
        _jsxs("div", {
          ...
          children: [
            ...
            _jsx(VSCodeButton, {
              ...
              style: { height: "20px" },
              children: _jsx(FaEdit, { style: { fontSize: "14px" } }),
            }),
            _jsx(VSCodeButton, {
              appearance: "icon",
              ...
              style: { height: "20px" },
              children: _jsx(FaTrash, { style: { fontSize: "14px" } }),
            }),
          ],
        }),
      ],
