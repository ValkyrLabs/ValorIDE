  ...
  return _jsxs("div", {
    ...
    children: [
      ...
      _jsxs("div", {
        ...
        children: [
          _jsx("label", {
            htmlFor: "llm-details-search",
            children: _jsx("span", {
              style: { fontWeight: 500 },
              children: "Select ValkyrAI Coding Agent (LLM Model)",
            }),
          }),
          featuredModels.length > 0 &&
            _jsxs("div", {
              ...
              children: [
                _jsx(ModelHeader, { children: "Featured Models" }),
                _jsx(FeaturedGrid, {
                  children: modelIds
                    .filter((id) =>
                      featuredModels.some(
                    ...
                    .map((id) =>
                      _jsxs(
                        FeatureCard,
                        {
                          ...
                          children: [
                            _jsx("div", { children: llmModels[id].name }),
              ...
              _jsx(VSCodeTextField, {
                ...
                children:
                  ...
                  _jsx("div", {
                    ...
                    children: _jsx(FaTimes, { size: 14 }),
                  }),
              }),
              isDropdownVisible &&
                modelSearchResults.length > 0 &&
                _jsx(DropdownList, {
                  children: modelSearchResults.map((result, index) =>
                    _jsx(
                      DropdownItem,
                      {
                        ref: (el) => {
              ...
              isDropdownVisible &&
                ...
                _jsx(DropdownList, {
                  children: _jsxs(DropdownItem, {
                    ...
                    children: ['No models found matching "', searchTerm, '"'],
                  }),
                }),
            ],
          }),
          currentSelection &&
            _jsxs("div", {
              ...
              children: [
                _jsxs("div", {
                  children: [
                    _jsx("strong", { children: currentSelection.name }),
                    " (",
                ...
                currentSelection.version &&
                  _jsxs("div", {
                    ...
                    children: ["Version: ", currentSelection.version],
                  }),
