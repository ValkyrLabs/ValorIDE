...
import { Fragment, JSX, memo, useCallback, useEffect, useMemo, useState } from "react"
	...
	*/
	...
	return (
		<div style={{ display: "flex", flexDirection: "column", gap: 5, marginBottom: isPopup ? -10 : 0 }}>
				...
				<div>
					...
					<p
						...
						<span style={{ color: "var(--vscode-errorForeground)" }}>
							(<span style={{ fontWeight: 500 }}>Note:</span> ValorIDE uses complex prompts and works best with
			...
			{(selectedProvider === "openrouter" || selectedProvider === "valoride") && showModelOptions && (
				<>
					<VSCodeCheckbox
						style={{ marginTop: -10 }}
