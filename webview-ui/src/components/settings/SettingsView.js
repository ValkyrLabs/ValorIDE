...
const SettingsView = ({ onDone }) => {
  ...
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsxs("div", {
        className:
          "fixed top-0 left-0 right-0 bottom-0 pt-[10px] pr-0 pb-0 pl-5 flex flex-col overflow-hidden",
        children: [
          _jsxs("div", {
            className: "flex justify-between items-center mb-[13px] pr-[17px]",
            children: [
              _jsx("h3", {
                ...
                children: [
                  ...
                  _jsx(VSCodeButton, {
                    ...
                    children: _jsxs("span", {
                      className: "flex items-center gap-2",
                      children: [
                        _jsx(FaShareAlt, { size: 18 }),
                        " ",
                        copied ? _jsx(FaCheck, { size: 18 }) : _jsx(FaTag, {}),
                      ],
                    }),
                  }),
                  _jsx(StatusBadge, {
                    ...
                    kind: kind,
                    title: hasError
                      ? String(communicationService.error)
                      : undefined,
                  }),
                  _jsx("div", {
                    className: "flex items-center gap-2",
                    title:
                      "Store and load the JWT in local storage to avoid logging in every time",
                    children: _jsx(VSCodeCheckbox, {
                      checked: persistJwt,
                      onChange: (e) => setPersistJwt(!!e?.target?.checked),
          ...
          _jsxs("div", {
            className: "grow overflow-y-scroll pr-2 flex flex-col",
            children: [
              peers.length > 0 &&
                _jsxs("div", {
                  className:
                    "border border-solid border-[var(--vscode-panel-border)] rounded-md p-[10px] mb-3 bg-[var(--vscode-panel-background)] text-[var(--vscode-foreground)]",
                  children: [
                    _jsx("div", {
              ...
              planActSeparateModelsSetting
                ? _jsxs("div", {
                    className:
                      "border border-solid border-[var(--vscode-panel-border)] rounded-md p-[10px] mb-5 bg-[var(--vscode-panel-background)]",
                    children: [
                      _jsxs("div", {
                        className:
                          "flex gap-[1px] mb-[10px] -mt-2 border-0 border-b border-solid border-[var(--vscode-panel-border)]",
                        children: [
                          _jsx(TabButton, {
              ...
              _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx("p", {
                    className:
                      "text-xs mt-[5px] text-[var(--vscode-descriptionForeground)]",
                    children:
              ...
              _jsxs("div", {
                ...
                children: [
                  _jsx(VSCodeCheckbox, {
                    ...
                    children: "Use different models for Plan and Act modes",
                  }),
                  _jsx("p", {
                    className:
                      "text-xs mt-[5px] text-[var(--vscode-descriptionForeground)]",
              ...
              _jsxs("div", {
                ...
                children: [
                  _jsx(VSCodeCheckbox, {
                    ...
                    children: "Allow anonymous error and usage reporting",
                  }),
                  _jsxs("p", {
                    className:
                      "text-xs mt-[5px] text-[var(--vscode-descriptionForeground)]",
                    children: [
                      "Help improve ValorIDE by sending anonymous usage data and error reports. No code, prompts, or personal information are ever sent. See our",
                      " ",
                      _jsx(VSCodeLink, {
                        href: "https://valkyrlabs.com/v1/docs/Legal/privacy/",
                        className: "text-inherit",
                        children: "telemetry overview",
                      }),
                      " ",
                      "and",
                      " ",
              ...
              _jsxs("div", {
                className:
                  "border border-solid border-[var(--vscode-panel-border)] rounded-md p-[10px] mb-[15px] bg-[var(--vscode-panel-background)]",
                id: "valkyrai-backend-section",
                children: [
                  _jsx("div", {
                    className: "font-semibold mb-2",
                    children: "ValkyrAI Backend",
                  }),
                  _jsx("p", {
                    className:
                      "text-xs text-[var(--vscode-descriptionForeground)] mb-2",
                    children:
                      "Configure which ValkyrAI backend this IDE uses. Changes apply immediately and sync via VS Code settings.",
                  }),
                  _jsx(VSCodeTextField, {
                    value: valkyraiHostInput,
                    onInput: (e) => setValkyraiHostInput(e.target?.value ?? ""),
                  ...
                  _jsxs("div", {
                    ...
                    children: [
                      _jsx(VSCodeButton, {
                        ...
                        children: isTestingValkyraiHost
                    ...
                    children: [
                      ...
                      _jsx("p", {
                        className:
                          "text-xs text-[var(--vscode-descriptionForeground)] mb-2",
                        children:
                          "Select which ValkyrAI prompt collection this backend should use. Changes apply immediately for the active backend.",
                      }),
                      selectedLlmDetails &&
                        _jsxs("div", {
                          className:
                            "text-xs mb-2 text-[var(--vscode-descriptionForeground)] flex items-center gap-2",
                          children: [
                            _jsxs("span", {
                              children: [
                                "Active prompt: ",
                                _jsx("strong", {
                                  children: selectedLlmDetails.name,
                                }),
                              ],
                            }),
                            _jsx(StatusBadge, {
                              ...
                              kind:
                                selectedLlmDetails.mode === "SYSTEM"
                                  ? "warn"
                                  : "ok",
                            }),
                          ],
                        }),
                      _jsx(LLMDetailsSelector, {
              ...
              _jsx(BrowserSettingsSection, {}),
              _jsx("div", {
                className: "mt-auto pr-2 flex justify-center",
                children: _jsxs(SettingsButton, {
                  onClick: () =>
                    vscode.postMessage({ type: "openExtensionSettings" }),
                  className: "mt-0 mr-0 mb-4 ml-0",
                  children: [_jsx(VscSettingsGear, {}), "Advanced Settings"],
                }),
              }),
              IS_DEV &&
                _jsxs(_Fragment, {
              ...
              _jsxs("div", {
                className:
                  "text-center text-[var(--vscode-descriptionForeground)] text-xs leading-[1.2] px-0 py-0 pr-2 pb-[15px] mt-auto",
                children: [
                  _jsxs("p", {
                    className: "break-words m-0 p-0",
                    children: [
                      ...
                      _jsx(VSCodeLink, {
                        ...
                        className: "inline",
                        children: "https://github.com/valkyrlabs/valoride",
                      }),
                    ],
                  }),
                  _jsxs("p", {
                    className: "italic mt-[10px] mb-0 p-0",
                    children: ["v", version],
                  }),
                ],
              }),
