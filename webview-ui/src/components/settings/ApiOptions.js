...
const ApiOptions = ({
  ...
  const createDropdown = (models) => {
    return _jsxs(VSCodeDropdown, {
      id: "model-id",
      value: selectedModelId,
      onChange: handleInputChange("apiModelId"),
      style: { width: "100%" },
      children: [
        _jsx(VSCodeOption, { value: "", children: "Select a model..." }),
    ...
    children: [
        ...
        children: [
          ...
          _jsxs(VSCodeDropdown, {
            ...
            children: [
              _jsx(VSCodeOption, {
                value: "valkyrai",
                children: "Valkyrai (LLM Details)",
              }),
              _jsx(VSCodeOption, { value: "valoride", children: "ValorIDE" }),
              _jsx(VSCodeOption, {
                value: "openrouter",
                children: "OpenRouter",
              }),
              _jsx(VSCodeOption, { value: "anthropic", children: "Anthropic" }),
              _jsx(VSCodeOption, {
                value: "bedrock",
              ...
              _jsx(VSCodeOption, {
                value: "vertex",
                children: "GCP Vertex AI",
              }),
              _jsx(VSCodeOption, {
                value: "gemini",
                children: "Google Gemini",
              }),
              _jsx(VSCodeOption, { value: "deepseek", children: "DeepSeek" }),
              _jsx(VSCodeOption, { value: "mistral", children: "Mistral" }),
              _jsx(VSCodeOption, {
                value: "openai-native",
                children: "OpenAI",
              }),
              _jsx(VSCodeOption, {
                value: "vscode-lm",
                children: "VS Code LM API",
              }),
              _jsx(VSCodeOption, { value: "requesty", children: "Requesty" }),
              _jsx(VSCodeOption, { value: "together", children: "Together" }),
              _jsx(VSCodeOption, { value: "qwen", children: "Alibaba Qwen" }),
              _jsx(VSCodeOption, {
                value: "doubao",
                children: "Bytedance Doubao",
              }),
              _jsx(VSCodeOption, { value: "lmstudio", children: "LM Studio" }),
              _jsx(VSCodeOption, { value: "ollama", children: "Ollama" }),
              _jsx(VSCodeOption, { value: "litellm", children: "LiteLLM" }),
              _jsx(VSCodeOption, { value: "asksage", children: "AskSage" }),
              _jsx(VSCodeOption, { value: "xai", children: "xAI" }),
              _jsx(VSCodeOption, { value: "sambanova", children: "SambaNova" }),
            ],
          }),
        ],
      }),
      selectedProvider === "valoride" &&
        _jsx("div", {
          ...
          children: _jsx(ValorIDEAccountInfoCard, {}),
        }),
      selectedProvider === "valkyrai" &&
        _jsx("div", {
          style: { marginBottom: 14, marginTop: 4 },
          children: _jsx(LlmDetailsModelPicker, {}),
        }),
        ...
        _jsxs("div", {
          children: [
            _jsxs(DropdownContainer, {
              ...
              children: [
                _jsx("label", {
                  htmlFor: "qwen-line-provider",
                  children: _jsx("span", {
                    style: { fontWeight: 500, marginTop: 5 },
                    children: "Alibaba API Line",
                  }),
                }),
                _jsxs(VSCodeDropdown, {
              ...
              children: [
                ...
                !apiConfiguration?.qwenApiKey &&
                  _jsx(VSCodeLink, {
                    ...
                    children: "You can get a Qwen API key by signing up here.",
                  }),
              ],
            }),
          ],
        ...
        _jsxs("div", {
          ...
          children: [
            _jsxs(VSCodeRadioGroup, {
              value: apiConfiguration?.awsUseProfile
                ? "profile"
                : "credentials",
              onChange: (e) => {
                ...
                _jsxs(VSCodeDropdown, {
                  ...
                  children: [
                    ...
                    _jsx(VSCodeOption, {
                      ...
                      children: "ap-northeast-2",
                    }),
                    _jsx(VSCodeOption, {
                      value: "ap-northeast-3",
                      children: "ap-northeast-3",
                    }),
                    _jsx(VSCodeOption, {
                    ...
                    _jsx(VSCodeOption, {
                      ...
                      children: "ap-southeast-2",
                    }),
                    _jsx(VSCodeOption, {
                      value: "ca-central-1",
                      children: "ca-central-1",
                    }),
                    _jsx(VSCodeOption, {
                      value: "eu-central-1",
                    ...
                    _jsx(VSCodeOption, {
                      value: "us-gov-east-1",
                      children: "us-gov-east-1",
                    }),
                    _jsx(VSCodeOption, {
                      value: "us-gov-west-1",
                      children: "us-gov-west-1",
                    }),
                  ],
                }),
              ],
            ...
            _jsxs("div", {
              ...
              children: [
                _jsx(VSCodeCheckbox, {
                  ...
                  children: "Use custom VPC endpoint",
                }),
                awsEndpointSelected &&
                  _jsx(VSCodeTextField, {
                ...
                _jsx(VSCodeCheckbox, {
                  ...
                  children: "Use cross-region inference",
                }),
            ...
            _jsx("p", {
              ...
              children: apiConfiguration?.awsUseProfile
                ? _jsx(_Fragment, {
                    children:
          ...
          children: [
              ...
              children: [
                ...
                _jsxs(VSCodeDropdown, {
                  ...
                  children: [
                    ...
                    _jsx(VSCodeOption, {
                      value: "europe-west1",
                      children: "europe-west1",
                    }),
                    _jsx(VSCodeOption, {
                      value: "europe-west4",
                      children: "europe-west4",
                    }),
                    _jsx(VSCodeOption, {
                      value: "asia-southeast1",
                      children: "asia-southeast1",
                    }),
                  ],
                }),
              ],
            ...
            _jsxs("p", {
              ...
              children: [
                ...
                _jsx(VSCodeLink, {
                  href: "https://cloud.google.com/vertex-ai/generative-ai/docs/partner-models/use-valoride#before_you_begin",
        ...
        _jsxs("div", {
          children: [
            ...
            (() => {
              ...
              return _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx("div", {
                    children: headerEntries.map(([key, value], index) =>
                      _jsxs(
                        "div",
                        {
            ...
            _jsx(VSCodeCheckbox, {
              ...
              children: "Set Azure API version",
            }),
            ...
            _jsxs("div", {
              ...
              children: [
                modelConfigurationSelected
                  ? _jsx(FaChevronDown, { style: { marginRight: "4px" } })
                  : _jsx(FaChevronRight, { style: { marginRight: "4px" } }),
                _jsx("span", {
                  style: {
                    fontWeight: 700,
            ...
            modelConfigurationSelected &&
              _jsxs(_Fragment, {
                children: [
                  _jsx(VSCodeCheckbox, {
                    checked:
                      !!apiConfiguration?.openAiModelInfo?.supportsImages,
                    onChange: (e) => {
                      const isChecked = e.target.checked === true;
                  ...
                  _jsx(VSCodeCheckbox, {
                    ...
                    children: "Enable R1 messages format",
                  }),
                  _jsxs("div", {
                    style: { display: "flex", gap: 10, marginTop: "5px" },
                    children: [
                      _jsx(VSCodeTextField, {
                        value: apiConfiguration?.openAiModelInfo?.contextWindow
                      ...
                      _jsx(VSCodeTextField, {
                        value: apiConfiguration?.openAiModelInfo?.maxTokens
                  ...
                  _jsxs("div", {
                    ...
                    children: [
                      _jsx(VSCodeTextField, {
                        value: apiConfiguration?.openAiModelInfo?.inputPrice
                      ...
                      _jsx(VSCodeTextField, {
                        value: apiConfiguration?.openAiModelInfo?.outputPrice
                  ...
                  _jsx("div", {
                    ...
                    children: _jsx(VSCodeTextField, {
                      value: apiConfiguration?.openAiModelInfo?.temperature
            ...
            _jsx("p", {
              ...
              children: _jsxs("span", {
                ...
                children: [
                  ...
                  " ValorIDE uses complex prompts and works best with Claude models. Less capable models may not work as expected.)",
                ],
              }),
            }),
          ],
        ...
        _jsxs("div", {
          children: [
            ...
            !apiConfiguration?.requestyApiKey &&
              _jsx("a", {
                href: "https://app.requesty.ai/manage-api",
      ...
      selectedProvider === "vscode-lm" &&
        _jsx("div", {
          children: _jsxs(DropdownContainer, {
            zIndex: DROPDOWN_Z_INDEX - 2,
            className: "dropdown-container",
            children: [
              _jsx("label", {
                htmlFor: "vscode-lm-model",
                children: _jsx("span", {
                  style: { fontWeight: 500 },
          ...
          children: [
            ...
            lmStudioModels.length > 0 &&
              _jsx(VSCodeRadioGroup, {
                ...
                children: lmStudioModels.map((model) =>
                  _jsx(
                    VSCodeRadio,
                    {
                      value: model,
                ...
                _jsxs(_Fragment, {
                  children: [
                    _jsx(VSCodeCheckbox, {
                      ...
                      children: "Use prompt caching (GA)",
                    }),
                    _jsx("p", {
                      style: {
                        fontSize: "12px",
                ...
                _jsxs("p", {
                  ...
                  children: [
                    ...
                    _jsx(VSCodeLink, {
                      ...
                      style: { display: "inline", fontSize: "inherit" },
                      children: "thinking mode configuration",
                    }),
                  ],
                }),
              ],
          ...
          children: [
            ...
            ollamaModels.length > 0 &&
              _jsx(VSCodeRadioGroup, {
                ...
                children: ollamaModels.map((model) =>
                  _jsx(
                    VSCodeRadio,
                    {
                      value: model,
              ...
              children: [
                ...
                !apiConfiguration?.xaiApiKey &&
                  _jsx(VSCodeLink, {
                    href: "https://x.ai",
                    style: { display: "inline", fontSize: "inherit" },
                    children: "You can get an X AI API key by signing up here.",
                  }),
              ],
            }),
          ],
      ...
      (selectedProvider === "openrouter" || selectedProvider === "valoride") &&
        showModelOptions &&
        _jsxs(_Fragment, {
          children: [
            _jsx(VSCodeCheckbox, {
              ...
              children: "Sort underlying provider routing",
            }),
                ...
                children: [
                  _jsx(DropdownContainer, {
                    ...
                    children: _jsxs(VSCodeDropdown, {
                      ...
                      children: [
                        _jsx(VSCodeOption, { value: "", children: "Default" }),
                        _jsx(VSCodeOption, {
                          value: "price",
                          children: "Price",
                        }),
              ...
              _jsxs(_Fragment, {
                children: [
                  _jsx(VSCodeCheckbox, {
                    ...
                    children: "Modify reasoning effort",
                  }),
                  reasoningEffortSelected &&
                    _jsxs("div", {
                      children: [
                        _jsx("label", {
                          htmlFor: "reasoning-effort-dropdown",
                          children: _jsx("span", {
                            style: {},
      ...
      (selectedProvider === "openrouter" || selectedProvider === "valoride") &&
        showModelOptions &&
        _jsx(OpenRouterModelPicker, { isPopup: isPopup }),
      selectedProvider === "requesty" &&
        showModelOptions &&
        _jsx(RequestyModelPicker, { isPopup: isPopup }),
      modelIdErrorMessage &&
        _jsx("p", {
          style: {
            margin: "-10px 0 4px 0",
      ...
      "span",
      {
        ...
        children: [
          ...
          tier.tokenLimit === Number.POSITIVE_INFINITY
            ? _jsxs("span", { children: ["> ", prevLimit.toLocaleString()] })
            : _jsxs("span", {
                children: ["<= ", tier.tokenLimit.toLocaleString()],
              }),
          " tokens)",
...
export const ModelInfoView = ({
  ...
  if (
    ...
    outputPriceElement = _jsxs(
      Fragment,
      {
        children: [
          _jsx("span", {
            style: { fontWeight: 500 },
            children: "Output price (Standard):",
          }),
          " ",
          ...
          _jsx("span", {
            style: { fontWeight: 500 },
            children: "Output price (Thinking Budget > 0):",
          }),
          " ",
          formatPrice(modelInfo.thinkingConfig.outputPrice),
          "/million tokens",
        ],
      },
      ...
      Fragment,
      {
        children: [
          ...
          _jsx("span", {
            ...
            children: " (based on input tokens)",
          }),
          _jsx("br", {}),
        ...
        "span",
        {
          ...
          children: [
            ...
            _jsx(VSCodeLink, {
              ...
              style: { display: "inline", fontSize: "inherit" },
              children: "For more info, see pricing details.",
            }),
          ],
        },
        "geminiInfo"
