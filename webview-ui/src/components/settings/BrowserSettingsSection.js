  ...
  return _jsx(StatusContainer, {
    children: isChecking
      ? _jsxs(_Fragment, {
          children: [
            _jsx(Spinner, {}),
            _jsx(StatusText, { children: "Checking connection..." }),
          ],
        })
      : isConnected === true
        ? _jsxs(_Fragment, {
          ...
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx(VSCodeDropdown, {
                ...
                onChange: (event) => handleViewportChange(event),
                children: Object.entries(BROWSER_VIEWPORT_PRESETS).map(
                  ([name]) =>
                    _jsx(VSCodeOption, { value: name, children: name }, name),
                ),
              }),
            ],
          }),
      ...
      _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            ...
            children: [
              _jsx(VSCodeCheckbox, {
                ...
                onChange: (e) => updateRemoteBrowserEnabled(e.target.checked),
                children: "Use remote browser connection",
              }),
              _jsx(ConnectionStatusIndicator, {
          ...
          _jsxs("p", {
            ...
            children: [
              "Enable ValorIDE to use your Chrome",
              isBundled
              ...
              browserSettings.remoteBrowserEnabled
                ? _jsxs(_Fragment, {
                    children: [
                      ...
                      "manually (",
                      _jsx("code", {
                        children: "--remote-debugging-port=9222",
                      }),
              ...
              children: [
                ...
                relaunchResult &&
                  _jsx("div", {
                    ...
                    children: relaunchResult.message,
                  }),
                _jsx("p", {
                  style: {
                    fontSize: "12px",
