      ...
      _jsxs("div", {
        ...
        children: [
          ...
          apiConfiguration?.apiProvider === "valoride" &&
            _jsx("div", {
              style: { marginBottom: "6px", marginTop: 4 },
              children: featuredModels.map((model) =>
                _jsx(
                  FeaturedModelCard,
                  {
                    modelId: model.id,
              ...
              _jsx(VSCodeTextField, {
                ...
                children:
                  ...
                  _jsx("div", {
                    ...
                    children: _jsx(FaTimes, { style: { fontSize: "14px" } }),
                  }),
              }),
              isDropdownVisible &&
                _jsx(DropdownList, {
                  ref: dropdownListRef,
                  children: modelSearchResults.map((item, index) => {
                    const isFavorite = (
            ...
            children: _jsxs(_Fragment, {
              children: [
                ...
                _jsx(VSCodeLink, {
                  ...
                  children: "anthropic/claude-3.7-sonnet.",
                }),
...
export const ModelDescriptionMarkdown = memo(
  ({ markdown, key, isExpanded, setIsExpanded, isPopup }) => {
