    ...
    children: [
      _jsxs("div", {
        ...
        children: [
          ...
          " ",
          _jsx("code", { children: "valoride_mcp_settings.json" }),
          ". You'll need to specify the server name, command, arguments, and any required environment variables in the JSON configuration. Learn more",
          _jsx(VSCodeLink, {
