  ...
  return (
    <FormContainer>
      <div className="text-[var(--vscode-foreground)]">
        ...
        <code>valoride_mcp_settings.json</code>. You'll need to specify the
        server name, command, arguments, and any required environment variables
      ...
      >
        Open valoride_mcp_settings.json
      </VSCodeButton>
    </FormContainer>
  );
};
