...
const AddRemoteServerForm = ({ onServerAdded }) => {
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsxs("div", {
        className: "text-[var(--vscode-foreground)] mb-2",
        children: [
      ...
      _jsxs("form", {
        ...
        children: [
          ...
          error &&
            _jsx("div", {
              className: "mb-3 text-[var(--vscode-errorForeground)]",
              children: error,
            }),
          _jsxs("div", {
            ...
            children: [
              _jsx(VSCodeButton, {
                ...
                disabled: isSubmitting,
                className: "w-full",
                children: isSubmitting ? "Adding..." : "Add Server",
              }),
              showConnectingMessage &&
                _jsx("div", {
                  className:
                    "ml-3 text-[var(--vscode-notificationsInfoIcon-foreground)] text-sm",
                  children:
