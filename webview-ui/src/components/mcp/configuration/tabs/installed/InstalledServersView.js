        ...
        children: [
          _jsxs("div", {
            ...
            children: [
              ...
              " ",
              "enables communication with locally running MCP servers that provide additional tools and resources to extend ValorIDE's capabilities. You can use",
              " ",
              _jsx(VSCodeLink, {
                href: "https://github.com/modelcontextprotocol/servers",
                style: { display: "inline" },
                children: "community-made servers",
              }),
              " ",
              'or ask ValorIDE to create new tools specific to your workflow (e.g., "add a tool that gets the latest npm docs").',
              " ",
              _jsx(VSCodeLink, {
                href: "https://x.com/sdrzn/status/1867271665086074969",
                style: { display: "inline" },
                children: "See a demo here.",
              }),
            ],
          }),
          _jsx("div", {
                  ...
                  children: [
                    ...
                    isRetryableError(error) &&
                      _jsxs(VSCodeButton, {
                        ...
                        children: [
                          _jsx(VscRefresh, { style: { marginRight: "4px" } }),
                          isLoading ? "Retrying..." : "Retry",
                        ],
                      }),
                  ],
                })
              : _jsx(ServersToggleList, {
          ...
          _jsxs("div", {
            ...
            children: [
              _jsxs(VSCodeButton, {
                ...
                children: [
                  _jsx(VscServer, { style: { marginRight: "6px" } }),
              ...
              _jsx("div", {
                ...
                children: _jsx(VSCodeLink, {
                  ...
                  style: { fontSize: "12px" },
                  children: "Advanced MCP Settings",
                }),
              }),
            ],
          }),
