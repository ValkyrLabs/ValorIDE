...
const ServerRow = ({ server, isExpandable = true, hasTrashIcon = true, }) => {
    ...
    return (_jsxs("div", { style: { marginBottom: "10px" }, children: [_jsxs("div", { style: {
                ...
                }, onClick: handleRowClick, children: [!server.error &&
                        isExpandable &&
                        (isExpanded ? (_jsx(FaChevronDown, { style: { marginRight: "8px" } })) : (_jsx(FaChevronRight, { style: { marginRight: "8px" } }))), _jsx("span", { style: {
                            flex: 1,
                            overflow: "hidden",
                            wordBreak: "break-all",
                            whiteSpace: "normal",
