        ...
        children: [
          !server.error &&
            ...
            (isExpanded
              ...
              : _jsx(FaChevronRight, { style: { marginRight: "8px" } })),
          _jsx("span", {
            style: {
              flex: 1,
              overflow: "hidden",
        ...
        ? _jsxs("div", {
            ...
            children: [
              ...
              _jsx(DangerButton, {
                ...
                children: isDeleting ? "Deleting..." : "Delete Server",
              }),
            ],
          })
        : isExpanded &&
              ...
              _jsxs(VSCodePanels, {
                children: [
                  _jsxs(VSCodePanelTab, {
                    id: "tools",
                    children: ["Tools (", server.tools?.length || 0, ")"],
                  }),
                  _jsxs(VSCodePanelTab, {
                    id: "resources",
                    children: [
                            ...
                            children: [
                              ...
                              server.name &&
                                ...
                                _jsx(VSCodeCheckbox, {
                                  ...
                                  "data-tool": "all-tools",
                                  children: "Auto-approve all tools",
                                }),
                            ],
                          })
                        : _jsx("div", {
