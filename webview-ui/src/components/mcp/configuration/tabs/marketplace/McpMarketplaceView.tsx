...
import { convertThorMcpServersToShared, convertThorMcpMarketplaceCatalogsToShared } from "@/utils/mcpTypeConversions"
			...
			<div style={{ display: "flex", flexDirection: "column" }}>
				{filteredItems.length === 0 ? (
					...
					filteredItems.map((item) => (
						<McpMarketplaceCard key={item.mcpId} item={item} installedServers={sharedMcpServers} />
					))
				)}
				<McpSubmitCard />
			</div>
