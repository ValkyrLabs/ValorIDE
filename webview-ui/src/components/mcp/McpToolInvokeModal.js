...
export const McpToolInvokeModal = ({ tool, visible, onClose, onInvoke }) => {
  ...
  return _jsx("div", {
    ...
    children: _jsxs("div", {
      ...
      children: [
        _jsx("h3", { style: { marginTop: 0 }, children: tool.name }),
        _jsx("div", {
          style: { marginBottom: 16, fontSize: 13, opacity: 0.8 },
            ...
            "div",
            {
              ...
              children: [
                ...
                _jsx(VSCodeTextField, {
                  ...
                  placeholder:
                    schemaObj && typeof schemaObj.description === "string"
