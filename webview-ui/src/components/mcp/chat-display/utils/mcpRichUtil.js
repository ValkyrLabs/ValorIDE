...
export const safeCreateUrl = (url) => {
    try {
...
// Get hostname safely
export const getSafeHostname = (url) => {
    try {
...
export const normalizeRelativeUrl = (relativeUrl, baseUrl) => {
...
export const formatUrlForOpening = (url) => {
...
export const checkIfImageUrl = async (url) => {
...
//# sourceMappingURL=mcpRichUtil.js.map