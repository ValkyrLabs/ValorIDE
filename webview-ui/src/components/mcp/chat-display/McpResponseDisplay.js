...
const McpResponseDisplay = ({ responseText }) => {
    ...
    if (error) {
      return _jsxs(_Fragment, {
        children: [
          ...
          _jsx(UrlText, { children: responseText }),
        ],
      });
    }
  ...
  try {
    return _jsxs(ResponseContainer, {
      children: [
        _jsxs(ResponseHeader, {
          children: [
            _jsx("span", { className: "header-title", children: "Response" }),
            _jsxs(ToggleSwitch, {
              children: [
                _jsx("span", {
                ...
                _jsx("div", {
                  ...
                  children: _jsx("div", { className: "toggle-handle" }),
                }),
              ],
            }),
          ],
    ...
    return _jsxs(ResponseContainer, {
      children: [
        ...
        _jsxs("div", {
          className: "response-content",
          children: [
            _jsx("div", { children: "Error parsing response:" }),
            _jsx(UrlText, { children: responseText }),
          ],
        }),
      ],
...
const McpResponseDisplayWithErrorBoundary = (props) => {
  return _jsx(ChatErrorBoundary, {
    children: _jsx(McpResponseDisplay, { ...props }),
  });
};
