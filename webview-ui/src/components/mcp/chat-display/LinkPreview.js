            ...
            _jsxs("div", {
              ...
              children: [
                ...
                _jsx("div", {
                  ...
                  children: data.siteName || getSafeHostname(url),
                }),
              ],
            }),
            _jsx("div", {
...
const LinkPreviewWithErrorBoundary = (props) => {
  return _jsx(ChatErrorBoundary, {
    errorTitle: "Something went wrong displaying this link preview",
    children: _jsx(MemoizedLinkPreview, { ...props }),
  });
};
