...
export const McpServerDetailsModal: React.FC<{
  ...
  const [editState, setEditState] = useState<
    McpServer & { userRating?: number }
  >({ ...server, userRating: undefined });
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          {isOwner && editing ? (
            <VSCodeTextField
              ...
              onInput={(e) =>
                handleChange("config", (e.target as HTMLInputElement).value)
              }
              style={{ width: "100%" }}
            />
          ) : (
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          {isOwner && editing ? (
            <VSCodeCheckbox
              ...
              onChange={(e) =>
                handleChange("disabled", (e.target as HTMLInputElement).checked)
              }
            >
              Disabled
            </VSCodeCheckbox>
        ...
        >
          <span>
            Last health check: {/* TODO: Wire up health check timestamp */}{" "}
            ...
            {[1, 2, 3, 4, 5].map((star) => (
              <span
                ...
                style={{
                  fontSize: 22,
                  color:
                    star <= (editState.userRating || 0) ? "#FFD700" : "#222",
                  cursor: "pointer",
