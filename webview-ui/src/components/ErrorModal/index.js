...
const ErrorModal = (props) => {
  ...
  if (variant === "inline") {
    return _jsxs(Card, {
      className: `mb-3 border-${bsVariant}`,
      "data-testid": "error-inline",
      children: [
        _jsx(Card.Header, {
          className: `text-${bsVariant}`,
          children: _jsxs("div", {
            style: { display: "flex", alignItems: "center", gap: 8 },
            children: [
              pickIcon(severity),
              _jsx("strong", { children: resolvedTitle }),
            ],
          }),
        }),
        _jsxs(Card.Body, {
    ...
    children: [
      _jsx(Modal.Header, {
        ...
        children: _jsx(Modal.Title, {
          ...
          children: _jsxs("div", {
            style: { display: "flex", alignItems: "center", gap: 8 },
            children: [pickIcon(severity), " ", resolvedTitle],
          }),
        }),
      }),
      _jsxs(Modal.Body, {
        className: "errorDialogMessage",
        children: [
          _jsx(Alert, {
            variant: bsVariant,
            className: "mb-0",
