...
export const { setViewMode, setActivePanel, toggleSidebar, setSidebarCollapsed, toggleRightPanel, setSplitPaneSize, toggleMinimap, toggleLineNumbers, toggleWordWrap, setFontSize, addNotification, removeNotification, clearNotifications, toggleFullscreen, toggleSearch, toggleValidationPanel, updateShortcut, } = uiSlice.actions;
