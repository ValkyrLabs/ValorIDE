...
export type BootswatchTheme = (typeof BOOTSWATCH_THEMES)[number];
...
const themeSlice = createSlice({
  ...
  reducers: {
    ...
    setBootswatchTheme: (state, action: PayloadAction<BootswatchTheme>) => {
      state.bootswatch = action.payload;
      loadBootswatchTheme(action.payload);
    },
    setCustomThemeUrl: (state, action: PayloadAction<string | undefined>) => {
