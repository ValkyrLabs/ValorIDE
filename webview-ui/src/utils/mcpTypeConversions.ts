 ...
 */
export function convertThorMcpServerToShared(
  thorServer: ThorMcpServer | null | undefined,
 ...
 */
export function convertThorMcpServersToShared(
  thorServers: ThorMcpServer[] | null | undefined,
): SharedMcpServer[] {
