 ...
 */
import { filterIgnoredFields, hasIgnoredFields, isCleanSpec, getIgnoredFieldsPresent, cloneWithoutIgnoredFields, toCleanJSON, mergeSpecsClean, cleanSpecForRoundTrip, OAS_IGNORED_FIELDS, } from "../OpenAPISpecUtils";
describe("OpenAPISpecUtils", () => {
    describe("filterIgnoredFields", () => {
        ...
        it("should handle arrays of objects", () => {
            ...
            expect(filtered[0].openapi).toBe("3.0.3");
            expect(filtered[0].id).toBeUndefined();
            expect(filtered[1].id).toBeUndefined();
        });
    ...
    describe("cloneWithoutIgnoredFields", () => {
        it("should create deep copy without ignored fields", () => {
            ...
            expect(cloned.info.nested).toBeUndefined();
    ...
    describe("mergeSpecsClean", () => {
        it("should merge specs with override taking precedence", () => {
            ...
            expect(merged.info.title).toBe("Override");
            expect(merged.id).toBeUndefined();
            expect(merged.createdDate).toBeUndefined();
        });
    });
...
//# sourceMappingURL=OpenAPISpecUtils.test.js.map