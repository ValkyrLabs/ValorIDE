...
export const AuroraNavbar = {
  background:
    "linear-gradient(90deg, rgba(5, 6, 11, 0.95), rgba(20, 26, 34, 0.9))",
  border: `2px solid ${AuroraColors.border}`,
 ...
 */
export function getAuroraCSSVariables(): string {
  return `
 ...
 */
export function applyAuroraTheme(
  componentType: "button" | "input" | "card" | "modal" | "navbar",
 ...
 */
export function getAuroraColorWithOpacity(
  colorKey: keyof typeof AuroraColors,
  opacity: number = 1,
): string {
