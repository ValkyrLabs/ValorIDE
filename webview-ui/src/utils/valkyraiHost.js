...
const rawDefault = (import.meta.env?.VITE_basePath &&
...
let currentHost = (typeof window !== "undefined" &&
...
export const getValkyraiWsBase = () => deriveWsUrlFromHost(currentHost) ?? "ws://localhost:8080";
