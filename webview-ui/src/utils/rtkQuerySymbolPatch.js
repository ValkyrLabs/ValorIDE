 ...
 */
export function initializeRTKQuerySymbolPatch() {
    ...
    Array.prototype.join = function (separator = ",") {
        try {
            ...
            const stringified = this.map((element) => {
        ...
        try {
            ...
            return entries
                ...
                val && typeof val === "object"
                    ? (() => {
                        try {
                            JSON.stringify(val, (k, v) => typeof v === "symbol" ? undefined : v);
                            return val;
                        }
                        catch {
                            return String(val);
    ...
    console.debug("[RTK Query Symbol Patch] Initialized - Array.join and Object methods patched");
}
//# sourceMappingURL=rtkQuerySymbolPatch.js.map