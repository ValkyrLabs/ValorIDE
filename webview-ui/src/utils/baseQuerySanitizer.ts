 ...
 */
export function sanitizeForRedux(obj: any, depth = 0, maxDepth = 100): any {
 ...
 * ```
 */
export function sanitizeBaseQuery(baseQuery: BaseQueryFn): BaseQueryFn {
 ...
 */
export function initializeSymbolProtection(): void {
