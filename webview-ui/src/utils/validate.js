...
export function validateApiConfiguration(apiConfiguration) {
    if (apiConfiguration) {
        switch (apiConfiguration.apiProvider) {
            ...
            case "openrouter":
                ...
                break;
            case "vertex":
                if (!apiConfiguration.vertexProjectId ||
...
export function validateModelId(apiConfiguration, openRouterModels) {
    if (apiConfiguration) {
        switch (apiConfiguration.apiProvider) {
            case "openrouter":
            case "valoride":
