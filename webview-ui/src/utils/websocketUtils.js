...
import { getJwtToken, isAuthenticated as isAuthed, } from "../redux/auth/session";
...
export class WebSocketUtils {
    ...
    sendMessage(payload, destination = "/app/chat") {
        if (!this.client || !this.connected) {
    ...
    sendCommand(command, destination = "/app/command") {
        if (!this.client || !this.connected) {
